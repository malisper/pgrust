...
- MERGE source grammar/data-modifying CTE gaps remain: joined-source syntax errors, one data-modifying CTE merge syntax error, one trailing semicolon parse error, plus one subquery column-count error.
