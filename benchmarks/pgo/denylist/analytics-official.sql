-- DENYLIST (do not train on these). Verbatim published analytics measurement
-- vector, copied from fleet/jobs/clickbench-assets-cbstore/queries.sql. This file
-- exists ONLY so pgo/lint-training-overlap.sh can prove the training corpus is
-- disjoint from it. Nothing in the build reads it as input.
