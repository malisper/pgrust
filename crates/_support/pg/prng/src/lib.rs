...
thread_local! {
    /// `pg_global_prng_state` (prng.c) lives in backend-private memory —
...
pub fn init_seams() {
    prng_seams::pg_global_prng_uint32::set(|| global_prng(PgPrng::next_u32));
    prng_seams::pg_global_prng_uint64_range::set(|rmin, rmax| {
