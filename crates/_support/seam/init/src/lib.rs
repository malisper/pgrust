...
pub fn init_all() {
    ...
    extra_encnames_fgram::init_seams();
    detoast::init_seams();
    toast_compression::init_seams();
    heaptuple::init_seams();
    indextuple::init_seams();
    next::init_seams();
    bufmask::init_seams();
    ...
    tidstore::init_seams();
    tupdesc::init_seams();
    core_probe::init_seams();
    ginfast::init_seams();
    ginget::init_seams();
    gininsert::init_seams();
    ginscan::init_seams();
    ginutil::init_seams();
    ...
    ginbulk::init_seams();
    ginvacuum::init_seams();
    ginxlog::init_seams();
    hashvalidate::init_seams();
    heapam::init_seams();
    heapam_handler_core::init_seams();
    heapam_handler_dml::init_seams();
    heapam_visibility::init_seams();
    heapam_xlog::init_seams();
    heaptoast::init_seams();
    toast_helper::init_seams();
    hio::init_seams();
    pruneheap::init_seams();
    rewriteheap::init_seams();
    vacuumlazy::init_seams();
    visibilitymap::init_seams();
    index_amapi::init_seams();
    index_amvalidate::init_seams();
    genam::init_seams();
    indexam::init_seams();
    spg_proc::init_seams();
    quadtree::init_seams();
    gist_proc::init_seams();
    gist_core::init_seams();
    ...
    dedup::init_seams();
    nbt_xlog::init_seams();
    nbtree_nbtree::init_seams();
    replorigindesc::init_seams();
    rmgrdesc_small::init_seams();
    smgrdesc::init_seams();
    xactdesc::init_seams();
    xlogdesc::init_seams();
    access_sequence::init_seams();
    table::init_seams();
    table_tableam::init_seams();
    brin_xlog::init_seams();
    message::init_seams();
    spgist_core::init_seams();
    insert_vacuum::init_seams();
    minmax::init_seams();
    hash_xlog::init_seams();
    clog::init_seams();
    commit_ts::init_seams();
    generic_xlog::init_seams();
    multixact::init_seams();
    transam_parallel::init_seams();
    subtrans::init_seams();
    timeline::init_seams();
    transam::init_seams();
    twophase::init_seams();
    varsup::init_seams();
    transam_xact::init_seams();
    ...
    xlogstats::init_seams();
    xlogutils::init_seams();
    backup_copy::init_seams();
    copy_dest::init_seams();
    gzip::init_seams();
    lz4::init_seams();
    zstd::init_seams();
    incremental::init_seams();
    basebackup::init_seams();
    basebackup_target::init_seams();
    server::init_seams();
    sink::init_seams();
    sink_support::init_seams();
    throttle::init_seams();
    bootstrap::init_seams();
    bootparse::init_seams();
    catalog_data::init_seams();
    catalog_catalog::init_seams();
    catalog_storage::init_seams();
    catalog_namespace::init_seams();
    objectaccess::init_seams();
    objectaddress::init_seams();
    catalog_partition::init_seams();
    partbounds::init_seams();
    partdesc::init_seams();
    partitioning_core::init_seams();
    indexing::init_seams();
    heap::init_seams();
    index::init_seams();
    pg_cast::init_seams();
    pg_class::init_seams();
    pg_conversion::init_seams();
    pg_collation::init_seams();
    pg_parameter_acl::init_seams();
    pg_database::init_seams();
    pg_db_role_setting::init_seams();
    pg_constraint::init_seams();
    pg_attrdef::init_seams();
    pg_depend::init_seams();
    dependency::init_seams();
    pg_enum::init_seams();
    pg_operator::init_seams();
    pg_aggregate::init_seams();
    pg_type::init_seams();
    pg_inherits::init_seams();
    pg_range::init_seams();
    pg_largeobject::init_seams();
    pg_namespace::init_seams();
    pg_authid::init_seams();
    pg_proc::init_seams();
    pg_publication::init_seams();
    pg_subscription::init_seams();
    publicationcmds::init_seams();
    subscriptioncmds::init_seams();
    pg_shdepend::init_seams();
    toasting::init_seams();
    amcmds::init_seams();
    commands_analyze::init_seams();
    constraint::init_seams();
    statistics_core::init_seams();
    extended_stats::init_seams();
    mvdistinct::init_seams();
    dependencies::init_seams();
    mcv::init_seams();
    import::init_seams();
    ...
    collationcmds::init_seams();
    conversioncmds::init_seams();
    statscmds::init_seams();
    copyto::init_seams();
    copyfrom::init_seams();
    commands_copy::init_seams();
    createas::init_seams();
    view::init_seams();
    define::init_seams();
    alter::init_seams();
    ...
    commands_explain::init_seams();
    commands_foreigncmds::init_seams();
    lockcmds::init_seams();
    functioncmds::init_seams();
    ...
    seclabel::init_seams();
    commands_sequence::init_seams();
    tablespace::init_seams();
    commands_trigger::init_seams();
    tsearchcmds::init_seams();
    pg_ts::init_seams();
    dict_init_dispatch::init_seams();
    ts_locale::init_seams();
    ts_utils::init_seams();
    typecmds::init_seams();
    utf8_and_big5::init_seams();
    utf8_and_cyrillic::init_seams();
    utf8_and_euc2004::init_seams();
    utf8_and_euc_cn::init_seams();
    utf8_and_euc_jp::init_seams();
    utf8_and_euc_kr::init_seams();
    utf8_and_euc_tw::init_seams();
    execAmi::init_seams();
    execCurrent::init_seams();
    execExpr::init_seams();
    execExprInterp::init_seams();
    execIndexing::init_seams();
    execJunk::init_seams();
    execMain::init_seams();
    execParallel::init_seams();
    execPartition::init_seams();
    execProcnode::init_seams();
    execReplication::init_seams();
    execScan::init_seams();
    execSRF::init_seams();
    execTuples::init_seams();
    execUtils::init_seams();
    execGrouping::init_seams();
    nodeFunctionscan::init_seams();
    nodeTableFuncscan::init_seams();
    spi::init_seams();
    instrument::init_seams();
    nodeAgg::init_seams();
    nodeAppend::init_seams();
    nodeBitmapAnd::init_seams();
    nodeBitmapHeapscan::init_seams();
    nodeCtescan::init_seams();
    nodeBitmapOr::init_seams();
    nodeCustom::init_seams();
    nodeForeignscan::init_seams();
    foreign::init_seams();
    jit::init_seams();
    nodeGather::init_seams();
    nodeGatherMerge::init_seams();
    nodeGroup::init_seams();
    nodeHash::init_seams();
    nodeHashjoin::init_seams();
    nodeBitmapIndexscan::init_seams();
    ...
    nodeModifyTable::init_seams();
    nodeRecursiveunion::init_seams();
    nodeProjectSet::init_seams();
    nodeNamedtuplestorescan::init_seams();
    nodeResult::init_seams();
    nodeSamplescan::init_seams();
    tablesample_core::init_seams();
    nodeSeqscan::init_seams();
    nodeSetOp::init_seams();
    nodeSubqueryscan::init_seams();
    nodeSort::init_seams();
    nodeIncrementalSort::init_seams();
    nodeSubplan::init_seams();
    tqueue::init_seams();
    nodeUnique::init_seams();
    nodeValuesscan::init_seams();
    geqo_all::init_seams();
    bloomfilter::init_seams();
    dshash::init_seams();
    radixtree::init_seams();
    main_main::init_seams();
    auth::init_seams();
    be_fsstubs::init_seams();
    hba::init_seams();
    be_gssapi_common::init_seams();
    be_secure_common::init_seams();
    be_secure::init_seams();
    be_secure_openssl::init_seams();
    ...
    be_secure_openssl_ffi::init_seams();
    scram::init_seams();
    crypt::init_seams();
    pqcomm::init_seams();
    pqmq::init_seams();
    ...
    fe::init_seams();
    copyfuncs::init_seams();
    nodes_core::init_seams();
    equalfuncs::init_seams();
    outfuncs::init_seams();
    queryjumble::init_seams();
    readfuncs::init_seams();
    hash_core::init_seams();
    hashfunc::init_seams();
    entry::init_seams();
    nodes_extensible::init_seams();
    rte_seams::init_seams();
    allpaths::init_seams();
    indxpath::init_seams();
    joinrels::init_seams();
    relnode::init_seams();
    appendinfo::init_seams();
    inherit::init_seams();
    plancat::init_seams();
    pathkeys::init_seams();
    compare::init_seams();
    nbt_validate::init_seams();
    nbtree_core::init_seams();
    nbtsort::init_seams();
    relpath::init_seams();
    costsize::init_seams();
    joinpath::init_seams();
    equivclass::init_seams();
    init_subselect::init_seams();
    path_small::init_seams();
    joininfo::init_seams();
    paramassign::init_seams();
    vars::init_seams();
    ...
    clauses::init_seams();
    prepqual::init_seams();
    prepjointree::init_seams();
    preptlist::init_seams();
    prepunion::init_seams();
    prepagg::init_seams();
    subselect_pullup::init_seams();
    analyzejoins::init_seams();
    createplan::init_seams();
    planner::init_seams();
    setrefs::init_seams();
    inherit_predtest::init_seams();
    pathnode::init_seams();
    coerce::init_seams();
    ...
    postmaster_autovacuum::init_seams();
    postmaster_bgworker::init_seams();
    bgwriter::init_seams();
    interrupt::init_seams();
    launch_backend::init_seams();
    fork_process::init_seams();
    auxprocess::init_seams();
    postmaster_pgarch::init_seams();
    pmchild::init_seams();
    postmaster::init_seams();
    checkpointer::init_seams();
    postmaster_startup::init_seams();
    syslogger::init_seams();
    walsummary::init_seams();
    postmaster_walsummarizer::init_seams();
    walwriter::init_seams();
    regex_core::init_seams();
    replication_libpqwalreceiver::init_seams();
    applyparallelworker::init_seams();
    conflict::init_seams();
    decode::init_seams();
    launcher::init_seams();
    worker::init_seams();
    logical_logical::init_seams();
    ...
    syncrep_scanner::init_seams();
    repl_scanner::init_seams();
    syncrep::init_seams();
    replication_slot::init_seams();
    slotfuncs::init_seams();
    replication_walreceiver::init_seams();
    walreceiverfuncs::init_seams();
    walsender::init_seams();
    rmgrdesc_next::init_seams();
    rewrite_core::init_seams();
    rewriteDefine::init_seams();
    rewriteRemove::init_seams();
    rewritehandler::init_seams();
    buffile::init_seams();
    fd::init_seams();
    fileset::init_seams();
    ...
    page::init_seams();
    checksum::init_seams();
    bulkwrite::init_seams();
    md::init_seams();
    smgr::init_seams();
    sync::init_seams();
    backend_startup::init_seams();
    tcop_dest::init_seams();
    tstoreReceiver::init_seams();
    fastpath::init_seams();
    postgres::init_seams();
    pquery::init_seams();
    functions::init_seams();
    utility::init_seams();
    localtime::init_seams();
    timezone_pgtz::init_seams();
    dict_snowball::init_seams();
    strftime::init_seams();
    dict::init_seams();
    ispell_regis::init_seams();
    parse::init_seams();
    spell::init_seams();
    activity_small::init_seams();
    status::init_seams();
    // Per-kind pgstat owner crates must register their builtin kinds BEFORE
    // activity_pgstat::init_seams() seals the kind table.
    pgstat_io::init_seams();
    pgstat_wal::init_seams();
    pgstat_replslot::init_seams();
    pgstat_subscription::init_seams();
    pgstat_slru::init_seams();
    pgstat_backend::init_seams();
    pgstat_database::init_seams();
    pgstat_function::init_seams();
    pgstat_relation::init_seams();
    activity_pgstat::init_seams();
    waitevent::init_seams();
    activity_xact::init_seams();
    misc2::init_seams();
    misc::init_seams();
    pgstatfuncs::init_seams();
    aclchk::init_seams();
    adt_acl::init_seams();
    catalog_perm::init_seams();
    adt_datetime::init_seams();
    array_selfuncs::init_seams();
    geo_selfuncs::init_seams();
    array_typanalyze::init_seams();
    tsvector_typanalyze::init_seams();
    arrayfuncs::init_seams();
    arrayutils::init_seams();
    dbsize::init_seams();
    char::init_seams();
    oid::init_seams();
    xid::init_seams();
    ...
    ascii::init_seams();
    amutils::init_seams();
    mcxtfuncs::init_seams();
    oracle_compat::init_seams();
    tsginidx::init_seams();
    tsgistidx::init_seams();
    varbit::init_seams();
    xid8funcs::init_seams();
    name::init_seams();
    float::init_seams();
    ...
    lsn_trigfuncs::init_seams();
    // libm provider: binds the float8 erf/erfc/tgamma/lgamma seams to the
    // system math library (same `<math.h>` PostgreSQL links).
    float_libm_ffi::init_seams();
    adt_format_type::init_seams();
    ruleutils::init_seams();
    adt_xml::init_seams();
    xml_libxml_ffi::init_seams();
    geo_ops::init_seams();
    formatting::init_seams();
    adt_json::init_seams();
    adt_jsonb::init_seams();
    jsonb_gin::init_seams();
    adt_jsonfuncs::init_seams();
    jsonapi::init_seams();
    jsonbsubs::init_seams();
    adt_jsonpath::init_seams();
    jsonpath_gram::init_seams();
    like::init_seams();
    md5::init_seams();
    cryptohash::init_seams();
    cryptohashfuncs::init_seams();
    pg_crc::init_seams();
    encode::init_seams();
    multirangetypes::init_seams();
    adt_network::init_seams();
    network_gist::init_seams();
    network_selfuncs::init_seams();
    mac::init_seams();
    mac8::init_seams();
    adt_numeric::init_seams();
    adt_uuid::init_seams();
    pseudorandomfuncs::init_seams();
    numutils::init_seams();
    pg_locale::init_seams();
    pg_locale_builtin::init_seams();
    pg_locale_icu::init_seams();
    quote::init_seams();
    range_selfuncs::init_seams();
    adt_selfuncs::init_seams();
    adt_rangetypes::init_seams();
    rangetypes_gist::init_seams();
    rangetypes_typanalyze::init_seams();
    regexp::init_seams();
    pseudotypes::init_seams();
    adt_enum::init_seams();
    scalar_datum_core::init_seams();
    skipsupport::init_seams();
    ts_small::init_seams();
    tsvector_core::init_seams();
    tsquery_core::init_seams();
    ...
    varlena::init_seams();
    version::init_seams();
    adt_ri_triggers::init_seams();
    attoptcache::init_seams();
    catcache::init_seams();
    cache_evtcache::init_seams();
    cache_funccache::init_seams();
    inval::init_seams();
    lsyscache::init_seams();
    partcache::init_seams();
    cache_plancache::init_seams();
    relcache::init_seams();
    relcache_nodexform::init_seams();
    ...
    cyrillic_and_mic::init_seams();
    latin_and_mic::init_seams();
    latin2_and_win1250::init_seams();
    euc_cn_and_mic::init_seams();
    euc_jp_and_sjis::init_seams();
    euc_kr_and_mic::init_seams();
    euc_tw_and_big5::init_seams();
    euc2004_sjis2004::init_seams();
    conv_string_helpers::init_seams();
    utf8_and_gb18030::init_seams();
    utf8_and_gbk::init_seams();
    utf8_and_iso8859_1::init_seams();
    utf8_and_iso8859::init_seams();
    utf8_and_johab::init_seams();
    utf8_and_sjis::init_seams();
    utf8_and_sjis2004::init_seams();
    utf8_and_uhc::init_seams();
    utf8_and_win::init_seams();
    mbutils::init_seams();
    wstrcmp::init_seams();
    wstrncmp::init_seams();
    misc_guc::init_seams();
    ...
    more::init_seams();
    pg_rusage::init_seams();
    queryenvironment::init_seams();
    prng::init_seams();
    sampling::init_seams();
    stack_depth::init_seams();
    misc_timeout::init_seams();
    mmgr_dsa::init_seams();
    mmgr_freepage::init_seams();
    portalmem::init_seams();
    resowner_resowner::init_seams();
    sort_small::init_seams();
    sort_sortsupport::init_seams();
    sort_storage::init_seams();
    tuplesort::init_seams();
    combocid::init_seams();
    snapmgr::init_seams();
    common_blkreftable::init_seams();
    checksum_helper::init_seams();
    controldata_utils::init_seams();
    hashfn::init_seams();
    unicode_category::init_seams();
    ip::init_seams();
    pglz::init_seams();
    prng_base64::init_seams();
    saslprep::init_seams();
    scram_common::init_seams();
    string::init_seams();
    legacy_pqsignal::init_seams();
    crc32c::init_seams();
    pg_strong_random::init_seams();
    pgsleep::init_seams();
    noblock::init_seams();
    pg_numa::init_seams();
    port_pqsignal::init_seams();
    adt_scalar_bool::init_seams();
    jsonpath_exec::init_seams();
    comp::init_seams();
    exec::init_seams();
    handler::init_seams();
}
...
[").map(|x| x + 1).unwrap_or(after.len());
    ...
    const CONTRACT_RECONCILE_PENDING: &[(&str, &str)] = &[
        ...
        ("foreign", "foreign_rel_updatable_events"),
        ...
        // calls `cache_syscache::search_syscache1_tid` — a new
        ...
        //       `ginqueryarrayextract` are on the bare-word `datum::Datum`
        //       (`struct Datum(usize)`) lane — they call `deconstruct_array`,
        //       which returns `(datum::Datum, bool)`. The GIN scan/index
        ...
        ("ginutil", "gin_extract_query"),
        ("ginutil", "gin_compare_partial"),
        ...
        // `opclass::OpFamilyMember` and the trimmed per-AM `OpFamilyMember`
        ...
        // TOWER-A unified the scan descriptor (nodes::nodeindexonlyscan
        ...
        // execProcnode were RELOCATED to execMain-seams (their
        ...
        ("foreign", "begin_direct_modify"),
        ("foreign", "begin_foreign_scan"),
        ("foreign", "end_direct_modify"),
        ("foreign", "end_foreign_scan"),
        ("foreign", "estimate_dsm_foreign_scan"),
        ("foreign", "fdw_import_foreign_schema"),
        ("foreign", "foreign_async_configure_wait"),
        ("foreign", "foreign_async_notify"),
        ("foreign", "foreign_async_request"),
        ("foreign", "initialize_dsm_foreign_scan"),
        ("foreign", "initialize_worker_foreign_scan"),
        ("foreign", "iterate_direct_modify"),
        ("foreign", "iterate_foreign_scan"),
        ("foreign", "recheck_foreign_scan"),
        ("foreign", "reinitialize_dsm_foreign_scan"),
        ("foreign", "rescan_foreign_scan"),
        ("foreign", "shutdown_foreign_scan"),
        ("foreign", "stamp_scan_slot_tableoid"),
        ...
        // `nodeWorktablescan::publish_wtparam_slot` directly,
        ...
        // `utility_out_seams::call_stmt_result_desc` seam, reading
        ...
        // case above (`foreign` begin/end/iterate_foreign_scan
        ...
        ("nodes_extensible", "begin_custom_scan"),
        ("nodes_extensible", "create_custom_scan_state"),
        ("nodes_extensible", "end_custom_scan"),
        ("nodes_extensible", "estimate_dsm_custom_scan"),
        ("nodes_extensible", "exec_custom_scan"),
        ("nodes_extensible", "initialize_dsm_custom_scan"),
        ("nodes_extensible", "initialize_worker_custom_scan"),
        ("nodes_extensible", "mark_pos_custom_scan"),
        ("nodes_extensible", "reinitialize_dsm_custom_scan"),
        ("nodes_extensible", "rescan_custom_scan"),
        ("nodes_extensible", "restr_pos_custom_scan"),
        ("nodes_extensible", "shutdown_custom_scan"),
        ...
        ("fmgr_dfmgr", "load_archive_module_init"),
        ...
        // value-typed `portal::Portal` (`Rc<RefCell<PortalData>>`),
        ...
        // bridges the arena `nodes::rawnodes::TypeName<'mcx>` into the owned
        // `parsenodes::TypeName` (the arena->owned reconcile mirrors
        ...
        ("pg_database", "aclnewowner_datacl"),
        ...
        ("pg_subscription", "check_subscription_relkind"),
