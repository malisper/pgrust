...
pub struct ResultRelInfo<'mcx> {
    ...
    /// here it is a [`rel::Relation::alias`] of that handle (shared
    /// data, no release authority).
    pub ri_RelationDesc: Option<rel::Relation<'mcx>>,
    ...
    pub ri_IndexRelationDescs: Option<PgVec<'mcx, Option<rel::Relation<'mcx>>>>,
...
pub struct ScanStateData<'mcx> {
    ...
    pub ss_currentRelation: Option<rel::Relation<'mcx>>,
...
// re-exported at `nodes::ModifyTableState`. execPartition's tuple-routing
...
pub struct EStateData<'mcx> {
    ...
    pub es_snapshot: Option<alloc::rc::Rc<snapshot::SnapshotData>>,
    ...
    /// `InvalidSnapshot`.
    pub es_crosscheck_snapshot: Option<alloc::rc::Rc<snapshot::SnapshotData>>,
    ...
    pub es_relations: PgVec<'mcx, Option<rel::Relation<'mcx>>>,
    ...
    pub es_query_dsa: Option<execparallel::DsaAreaHandle>,
