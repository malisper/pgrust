// NodeTag values transcribed from PG 18.3 nodetags.h (vendor/nodetags.h);
// the tags_match_c_header test re-verifies every name/value pair against it.
macro_rules! node_tags {
    ($($name:ident = $val:literal),+ $(,)?) => {
        ...
        #[cfg(test)]
        pub(crate) const NODE_TAG_TABLE: &[(&str, u16)] = &[$((stringify!($name), $val)),+];
    };
}
