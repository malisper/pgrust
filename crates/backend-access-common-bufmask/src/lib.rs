...
//! already-ported [`backend_storage_page`] page views. The field/range writes
...
pub fn init_seams() {
    ...
    backend_access_common_bufmask_seams::mask_page_hint_bits::set(|page| {
        mask_page_hint_bits(page).expect("mask_page_hint_bits: malformed page")
    });
    backend_access_common_bufmask_seams::mask_unused_space::set(mask_unused_space);
    backend_access_common_bufmask_seams::mask_lp_flags::set(|page| {
        mask_lp_flags(page).expect("mask_lp_flags: malformed page")
    });
    backend_access_common_bufmask_seams::mask_page_content::set(|page| {
