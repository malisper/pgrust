...
use common_pglz::{pglz_compress, pglz_decompress_to_slice, PGLZ_MAX_OUTPUT};
use mcx::{Mcx, PgVec};
use types_datum::VARHDRSZ;
use types_error::{PgError, PgResult, ERRCODE_DATA_CORRUPTED, ERRCODE_FEATURE_NOT_SUPPORTED};

use backend_access_common_toast_compression_seams as seams;
...
pub fn pglz_compress_datum<'mcx>(
    ...
    let strategy = common_pglz::PGLZ_strategy_default();
