...
fn install_test_seams() {
    ...
    INSTALL.call_once(|| {
        backend_catalog_catalog_seams::is_catalog_relation_oid::set(|relid| {
            relid == TEST_CATALOG_RELID
        });
        backend_utils_cache_syscache_seams::search_type_attr_info::set(stub_type_info);
        ...
        common_hashfn_seams::hash_bytes_uint32::set(|k| k.wrapping_mul(2654435761));
    });
}
