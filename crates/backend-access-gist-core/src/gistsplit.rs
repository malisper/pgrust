...
fn generic_pick_split<'mcx>(
    ...
    v.spl_ldatum = Some(backend_access_gist_dispatch_seams::gist_union::call(
        mcx,
        proc_oid,
    ...
    evec.vector = entryvec.vector[FIRST_OFFSET_NUMBER as usize + left_n
        ...
        .to_vec();
    v.spl_rdatum = Some(backend_access_gist_dispatch_seams::gist_union::call(
        mcx,
        proc_oid,
        giststate.supportCollation[attno],
        &evec,
...
fn gist_user_picksplit<'mcx>(
    ...
    backend_access_gist_dispatch_seams::gist_picksplit::call(
        mcx,
        proc_oid,
        giststate.supportCollation[attno],
        entryvec,
