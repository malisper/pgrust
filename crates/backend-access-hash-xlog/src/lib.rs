...
use types_xlog_records::hash_xlog::{
...
use backend_storage_page::{PageAddItemExtended, PageIndexMultiDelete, PageInit, PageMut};

use backend_access_common_bufmask_seams as bufmask;
...
pub fn init_seams() {
    backend_access_hash_xlog_seams::hash_redo::set(hash_redo);
    backend_access_hash_xlog_seams::hash_mask::set(hash_mask);
}
