...
pub use types_snapshot::snapshot::HTSV_Result::{self, *};
...
use backend_utils_time_snapmgr_pc_seams as snapmgr_seam;
...
pub fn HeapTupleIsSurelyDead(
    htup: &HeapTupleData,
    vistest: types_snapshot::snapshot::GlobalVisStateHandle,
) -> PgResult<bool> {
    let tuple = data_ref(htup);
