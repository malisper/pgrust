...
use backend_access_transam_transam::{TransactionIdDidAbort as TxnDidAbort, TransactionIdEquals};
...
use backend_nodes_core_seams as bms_seam;
...
use backend_utils_cache_relcache_seams::IndexAttrBitmapKind;
use backend_utils_time_combocid_seams as combocid_seam;

use backend_access_common_heaptuple::{heap_deform_tuple, heap_getsysattr, heap_tuple_to_disk_image};
...
const TOAST_TUPLE_THRESHOLD: usize = backend_access_heap_heaptoast::TOAST_TUPLE_THRESHOLD;
...
pub fn heap_update<'mcx>(
    ...
    if !bms_seam::bms_overlap::call(modified_attrs.as_deref(), key_attrs.as_deref()) {
         ...
         */
        backend_access_transam_multixact_seams::multi_xact_id_set_oldest_member::call()?;
    } else {
        lockmode = LockTupleMode::LockTupleExclusive;
...
fn heap_attr_equals(
    ...
    if attrnum <= 0 {
        ...
        backend_utils_adt_scalar_datum_core::datum_is_equal(
            value1,
            value2,
            att.attbyval,
            att.attlen as i32,
