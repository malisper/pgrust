...
pub fn init_seams() {
    backend_access_nbt_xlog_seams::btree_redo::set(btree_redo);
    backend_access_nbt_xlog_seams::btree_xlog_startup::set(btree_xlog_startup);
    backend_access_nbt_xlog_seams::btree_xlog_cleanup::set(btree_xlog_cleanup);
    backend_access_nbt_xlog_seams::btree_mask::set(btree_mask);
}
