...
//! directly on the owned [`types_spgist`] vocabulary structs, with the `text`
...
//! `backend_utils_adt_varlena::comparison` bodies; `collate_is_c` /
...
use backend_utils_adt_varlena::comparison::{text_starts_with, varstr_cmp};
