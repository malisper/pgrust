...
use backend_access_transam_multixact_seams as multixact_seams;
...
use backend_commands_async_seams as async_seams;
use backend_commands_tablecmds_seams as tablecmds_seams;
use backend_commands_trigger_seams as trigger_seams;
use backend_libpq_be_fsstubs_seams as fsstubs_seams;
use backend_replication_logical_launcher_seams as launcher_seams;
use backend_replication_logical_logical_seams as logical_seams;
use backend_replication_logical_origin_seams as origin_seams;
use backend_replication_logical_snapbuild_seams as snapbuild_seams;
use backend_replication_logical_worker_seams as lrworker_seams;
use backend_replication_syncrep_seams as syncrep_seams;
...
fn StartTransaction() -> PgResult<()> {
    ...
    // Determine if statements are logged in this transaction.
    {
        ...
        let sampled =
            rate != 0.0 && (rate == 1.0 || pg_prng::global_prng(|p| p.next_f64()) <= rate);
