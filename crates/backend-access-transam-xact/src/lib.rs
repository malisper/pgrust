...
pub fn init_seams() {
    ...
    seams::get_current_transaction_start_timestamp::set(GetCurrentTransactionStartTimestamp);
    seams::get_current_transaction_stop_timestamp::set(GetCurrentTransactionStopTimestamp);
