...
use types_control::{CheckPoint, DBState};
...
fn check_point_guts(_check_point_redo: XLogRecPtr, flags: i32) -> PgResult<()> {
    ...
    backend_access_transam_clog_seams::check_point_clog::call()?;
    backend_access_transam_commit_ts_seams::check_point_commit_ts::call()?;
