...
//! a direct call into the landed [`backend_backup_server`] crate (no cycle).
//!
//! # The owned model
//!
...
//! [`Box<Bbsink>`](backend_backup_sink::Bbsink) chain from
...
use backend_backup_sink::Bbsink;
use backend_backup_server::bbsink_server_new;
