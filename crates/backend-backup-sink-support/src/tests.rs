...
fn install_seams() {
    INSTALL.call_once(|| {
        backend_utils_activity_status_seams::my_be_entry_present::set(|| true);
        backend_utils_activity_status_seams::track_activities::set(|| true);
        backend_utils_activity_status_seams::with_my_beentry::set(|f| {
