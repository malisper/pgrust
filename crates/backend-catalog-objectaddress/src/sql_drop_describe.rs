...
fn obtain_object_name_namespace<'mcx>(
    ...
    let catalog =
        backend_access_common_relation_seams::relation_open::call(mcx, object.classId, AccessShareLock)?;
...
fn fetch_owning_relid<'mcx>(
    ...
    let catalog =
        backend_access_common_relation_seams::relation_open::call(mcx, class_id, AccessShareLock)?;
