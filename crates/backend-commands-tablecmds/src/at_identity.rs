...
use backend_utils_cache_syscache::{SearchSysCacheCopyAttName, SysCacheGetAttrNotNull, ATTNAME};
...
pub fn ATExecAddIdentity<'mcx>(
    ...
    if attnotnull {
        let contup = backend_catalog_pg_constraint::findNotNullConstraintAttnum(
        ...
        let con_form =
            backend_utils_cache_syscache_seams::read_constraint_form::call(&contup)?;
...
pub fn ATExecDropIdentity<'mcx>(
    ...
    if !recursing {
        ...
        let seqid = backend_catalog_pg_depend_seams::getIdentitySequence::call(
