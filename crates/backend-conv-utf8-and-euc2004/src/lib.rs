//! Port of `src/backend/utils/mb/conversion_procs/utf8_and_euc2004/utf8_and_euc2004.c` —
...
use types_wchar::encoding::{pg_enc, PG_EUC_JIS_2004, PG_UTF8};

/// `euc_jis_2004_to_utf8` (utf8_and_euc2004.c): convert PG_EUC_JIS_2004 <-> PG_UTF8.
pub fn euc_jis_2004_to_utf8(
    src_encoding: pg_enc,
    dest_encoding: pg_enc,
    src: &[u8],
    no_error: bool,
) -> PgResult<ConversionResult> {
    check_encoding_conversion_args::call(src_encoding, dest_encoding, src.len() as i32, PG_EUC_JIS_2004, PG_UTF8)?;
    LocalToUtf(
        src,
        Some(&tables::euc_jis_2004_to_unicode_tree()),
        &tables::LUMAP_EUC_JIS_2004_COMBINED,
        None,
        PG_EUC_JIS_2004,
        no_error,
    )
}
/// `utf8_to_euc_jis_2004` (utf8_and_euc2004.c): convert PG_UTF8 <-> PG_EUC_JIS_2004.
pub fn utf8_to_euc_jis_2004(
    src_encoding: pg_enc,
    dest_encoding: pg_enc,
    src: &[u8],
    no_error: bool,
) -> PgResult<ConversionResult> {
    check_encoding_conversion_args::call(src_encoding, dest_encoding, src.len() as i32, PG_UTF8, PG_EUC_JIS_2004)?;
    UtfToLocal(
        src,
        Some(&tables::euc_jis_2004_from_unicode_tree()),
        &tables::ULMAP_EUC_JIS_2004_COMBINED,
        None,
        PG_EUC_JIS_2004,
        no_error,
    )
...
pub fn init_seams() {
    backend_utils_fmgr_core::register_builtins_native([
        make_conversion_builtin(4382, "euc_jis_2004_to_utf8", euc_jis_2004_to_utf8),
        make_conversion_builtin(4383, "utf8_to_euc_jis_2004", utf8_to_euc_jis_2004),
    ]);
}
