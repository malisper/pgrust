...
//! callback the [`with_running_cursor`](backend_utils_mmgr_portalmem_seams::with_running_cursor)
...
use types_nodes::{CurrentOfExpr, EStateData, ExprContext, PlanStateNode};
