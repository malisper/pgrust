...
use types_nodes::{EcxtId, ResultRelInfo, RriId, SlotId};
...
pub fn init_seams() {
    ...
    backend_executor_execPartition_seams::exec_setup_partition_tuple_routing::set(
        seam_exec_setup_partition_tuple_routing,
    );
    backend_executor_execPartition_seams::exec_find_partition::set(seam_exec_find_partition);
    ...
    backend_executor_execPartition_seams::adjust_partition_colnos_using_map::set(
