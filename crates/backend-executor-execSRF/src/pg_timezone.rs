...
//! [`backend_utils_adt_datetime::tz_views`].
//!
...
use backend_utils_adt_datetime::Interval;
...
fn pg_timezone_names<'mcx>(
    ...
    let rows = backend_utils_adt_datetime::tz_views::pg_timezone_names_rows()?;
...
fn pg_timezone_abbrevs_zone<'mcx>(
    ...
    let rows = backend_utils_adt_datetime::tz_views::pg_timezone_abbrevs_zone_rows();
...
fn pg_timezone_abbrevs_abbrevs<'mcx>(
    ...
    let rows =
        backend_utils_adt_datetime::tz_abbrev_install::pg_timezone_abbrevs_abbrevs_rows()?;
