...
fn target_list_lengths() {
    ...
    tlist.push(TargetEntry { expr: None, resno: 0, resname: None, ressortgroupref: 0, resorigtbl: 0, resorigcol: 0, resjunk: false });
    tlist.push(TargetEntry { expr: None, resno: 0, resname: None, ressortgroupref: 0, resorigtbl: 0, resorigcol: 0, resjunk: true });
    tlist.push(TargetEntry { expr: None, resno: 0, resname: None, ressortgroupref: 0, resorigtbl: 0, resorigcol: 0, resjunk: false });
...
fn tlist_matching() {
    ...
    non_var.push(TargetEntry { expr: None, resno: 0, resname: None, ressortgroupref: 0, resorigtbl: 0, resorigcol: 0, resjunk: false });
