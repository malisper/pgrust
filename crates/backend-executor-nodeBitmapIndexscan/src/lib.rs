...
use types_nodes::nodebitmapindexscan::{BitmapIndexScan, BitmapIndexScanState};
use types_nodes::nodeindexonlyscan::{IndexScanInstrumentation, SharedIndexScanInstrumentation};
...
fn exec_proc_node_trampoline<'mcx>(
    _pstate: &mut types_nodes::PlanStateNode<'mcx>,
...
pub fn init_seams() {
    ...
    backend_executor_nodeBitmapIndexscan_seams::exec_bitmapindexscan_initialize_worker::set(
        bridge_initialize_worker,
    );
    backend_executor_nodeBitmapIndexscan_seams::exec_bitmapindexscan_retrieve_instrumentation::set(
