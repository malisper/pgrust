...
pub fn ExecModifyTable<'mcx>(
    ...
    loop {
        ...
        let plan_slot = {
            ...
            backend_executor_execProcnode_seams::exec_proc_node::call(subplanstate, estate)?
        };
...
/// owner lands.
#[inline]
fn reset_expr_context(estate: &mut EStateData<'_>, ecxt: types_nodes::EcxtId) {
    let _ = (estate, ecxt);
}
...
/// canonical owned [`types_nodes::EPQState`] (it lands with the execMain
...
#[inline]
fn eval_plan_qual_set_slot(epqstate: &mut types_nodes::EPQState<'_>, slot: SlotId) {
