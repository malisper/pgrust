...
//! [`backend_libpq_be_gssapi_common_seams`]; their slots are deliberately
...
use backend_libpq_be_gssapi_common_seams as gss_seam;
...
mod tests {
    use super::*;
    use backend_libpq_be_gssapi_common_seams as s;
    ...
    fn setup() -> MutexGuard<'static, ()> {
        ...
        SETUP.call_once(|| {
            ...
            backend_utils_error::config::set_log_min_messages(types_error::WARNING);
