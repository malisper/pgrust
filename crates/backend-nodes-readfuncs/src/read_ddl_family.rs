...
pub(crate) fn try_read<'mcx>(mcx: Mcx<'mcx>, label: &[u8]) -> Option<PgResult<Node<'mcx>>> {
    let node = match label {
        b"INTOCLAUSE" => (|| Ok(Node::IntoClause(read_into_clause(mcx)?)))(),
        b"ROLESPEC" => (|| Ok(Node::RoleSpec(read_role_spec(mcx)?)))(),
        b"TABLELIKECLAUSE" => (|| Ok(Node::TableLikeClause(read_table_like_clause(mcx)?)))(),
        b"INDEXELEM" => (|| Ok(Node::IndexElem(read_index_elem(mcx)?)))(),
        b"DEFELEM" => (|| Ok(Node::DefElem(read_def_elem(mcx)?)))(),
        b"PARTITIONELEM" => (|| Ok(Node::PartitionElem(read_partition_elem(mcx)?)))(),
        b"PARTITIONSPEC" => (|| Ok(Node::PartitionSpec(read_partition_spec(mcx)?)))(),
        b"PARTITIONBOUNDSPEC" => (|| Ok(Node::PartitionBoundSpec(read_partition_bound_spec(mcx)?)))(),
        b"PARTITIONRANGEDATUM" => (|| Ok(Node::PartitionRangeDatum(read_partition_range_datum(mcx)?)))(),
        b"PARTITIONCMD" => (|| Ok(Node::PartitionCmd(read_partition_cmd(mcx)?)))(),
        b"RETURNSTMT" => (|| Ok(Node::ReturnStmt(read_return_stmt(mcx)?)))(),
        b"PLASSIGNSTMT" => (|| Ok(Node::PLAssignStmt(read_p_l_assign_stmt(mcx)?)))(),
        b"CREATESCHEMASTMT" => (|| Ok(Node::CreateSchemaStmt(read_create_schema_stmt(mcx)?)))(),
        b"ALTERTABLESTMT" => (|| Ok(Node::AlterTableStmt(read_alter_table_stmt(mcx)?)))(),
        b"ALTERTABLECMD" => (|| Ok(Node::AlterTableCmd(read_alter_table_cmd(mcx)?)))(),
        b"ATALTERCONSTRAINT" => (|| Ok(Node::ATAlterConstraint(read_a_t_alter_constraint(mcx)?)))(),
        b"REPLICAIDENTITYSTMT" => (|| Ok(Node::ReplicaIdentityStmt(read_replica_identity_stmt(mcx)?)))(),
        b"ALTERCOLLATIONSTMT" => (|| Ok(Node::AlterCollationStmt(read_alter_collation_stmt(mcx)?)))(),
        b"ALTERDOMAINSTMT" => (|| Ok(Node::AlterDomainStmt(read_alter_domain_stmt(mcx)?)))(),
        b"GRANTSTMT" => (|| Ok(Node::GrantStmt(read_grant_stmt(mcx)?)))(),
        b"OBJECTWITHARGS" => (|| Ok(Node::ObjectWithArgs(read_object_with_args(mcx)?)))(),
        b"ACCESSPRIV" => (|| Ok(Node::AccessPriv(read_access_priv(mcx)?)))(),
        b"GRANTROLESTMT" => (|| Ok(Node::GrantRoleStmt(read_grant_role_stmt(mcx)?)))(),
        b"ALTERDEFAULTPRIVILEGESSTMT" => (|| Ok(Node::AlterDefaultPrivilegesStmt(read_alter_default_privileges_stmt(mcx)?)))(),
        b"COPYSTMT" => (|| Ok(Node::CopyStmt(read_copy_stmt(mcx)?)))(),
        b"VARIABLESETSTMT" => (|| Ok(Node::VariableSetStmt(read_variable_set_stmt(mcx)?)))(),
        b"VARIABLESHOWSTMT" => (|| Ok(Node::VariableShowStmt(read_variable_show_stmt(mcx)?)))(),
        b"CREATESTMT" => (|| Ok(Node::CreateStmt(read_create_stmt(mcx)?)))(),
        b"CONSTRAINT" => (|| Ok(Node::Constraint(read_constraint(mcx)?)))(),
        b"CREATETABLESPACESTMT" => (|| Ok(Node::CreateTableSpaceStmt(read_create_table_space_stmt(mcx)?)))(),
        b"DROPTABLESPACESTMT" => (|| Ok(Node::DropTableSpaceStmt(read_drop_table_space_stmt(mcx)?)))(),
        b"ALTERTABLESPACEOPTIONSSTMT" => (|| Ok(Node::AlterTableSpaceOptionsStmt(read_alter_table_space_options_stmt(mcx)?)))(),
        b"ALTERTABLEMOVEALLSTMT" => (|| Ok(Node::AlterTableMoveAllStmt(read_alter_table_move_all_stmt(mcx)?)))(),
        b"CREATEEXTENSIONSTMT" => (|| Ok(Node::CreateExtensionStmt(read_create_extension_stmt(mcx)?)))(),
        b"ALTEREXTENSIONSTMT" => (|| Ok(Node::AlterExtensionStmt(read_alter_extension_stmt(mcx)?)))(),
        b"ALTEREXTENSIONCONTENTSSTMT" => (|| Ok(Node::AlterExtensionContentsStmt(read_alter_extension_contents_stmt(mcx)?)))(),
        b"CREATEFDWSTMT" => (|| Ok(Node::CreateFdwStmt(read_create_fdw_stmt(mcx)?)))(),
        b"ALTERFDWSTMT" => (|| Ok(Node::AlterFdwStmt(read_alter_fdw_stmt(mcx)?)))(),
        b"CREATEFOREIGNSERVERSTMT" => (|| Ok(Node::CreateForeignServerStmt(read_create_foreign_server_stmt(mcx)?)))(),
        b"ALTERFOREIGNSERVERSTMT" => (|| Ok(Node::AlterForeignServerStmt(read_alter_foreign_server_stmt(mcx)?)))(),
        b"CREATEFOREIGNTABLESTMT" => (|| Ok(Node::CreateForeignTableStmt(read_create_foreign_table_stmt(mcx)?)))(),
        b"CREATEUSERMAPPINGSTMT" => (|| Ok(Node::CreateUserMappingStmt(read_create_user_mapping_stmt(mcx)?)))(),
        b"ALTERUSERMAPPINGSTMT" => (|| Ok(Node::AlterUserMappingStmt(read_alter_user_mapping_stmt(mcx)?)))(),
        b"DROPUSERMAPPINGSTMT" => (|| Ok(Node::DropUserMappingStmt(read_drop_user_mapping_stmt(mcx)?)))(),
        b"IMPORTFOREIGNSCHEMASTMT" => (|| Ok(Node::ImportForeignSchemaStmt(read_import_foreign_schema_stmt(mcx)?)))(),
        b"CREATEPOLICYSTMT" => (|| Ok(Node::CreatePolicyStmt(read_create_policy_stmt(mcx)?)))(),
        b"ALTERPOLICYSTMT" => (|| Ok(Node::AlterPolicyStmt(read_alter_policy_stmt(mcx)?)))(),
        b"CREATEAMSTMT" => (|| Ok(Node::CreateAmStmt(read_create_am_stmt(mcx)?)))(),
        b"CREATETRIGSTMT" => (|| Ok(Node::CreateTrigStmt(read_create_trig_stmt(mcx)?)))(),
        b"CREATEEVENTTRIGSTMT" => (|| Ok(Node::CreateEventTrigStmt(read_create_event_trig_stmt(mcx)?)))(),
        b"ALTEREVENTTRIGSTMT" => (|| Ok(Node::AlterEventTrigStmt(read_alter_event_trig_stmt(mcx)?)))(),
        b"CREATEPLANGSTMT" => (|| Ok(Node::CreatePLangStmt(read_create_p_lang_stmt(mcx)?)))(),
        b"CREATEROLESTMT" => (|| Ok(Node::CreateRoleStmt(read_create_role_stmt(mcx)?)))(),
        b"ALTERROLESTMT" => (|| Ok(Node::AlterRoleStmt(read_alter_role_stmt(mcx)?)))(),
        b"ALTERROLESETSTMT" => (|| Ok(Node::AlterRoleSetStmt(read_alter_role_set_stmt(mcx)?)))(),
        b"DROPROLESTMT" => (|| Ok(Node::DropRoleStmt(read_drop_role_stmt(mcx)?)))(),
        b"CREATESEQSTMT" => (|| Ok(Node::CreateSeqStmt(read_create_seq_stmt(mcx)?)))(),
        b"ALTERSEQSTMT" => (|| Ok(Node::AlterSeqStmt(read_alter_seq_stmt(mcx)?)))(),
        b"DEFINESTMT" => (|| Ok(Node::DefineStmt(read_define_stmt(mcx)?)))(),
        b"CREATEDOMAINSTMT" => (|| Ok(Node::CreateDomainStmt(read_create_domain_stmt(mcx)?)))(),
        b"CREATEOPCLASSSTMT" => (|| Ok(Node::CreateOpClassStmt(read_create_op_class_stmt(mcx)?)))(),
        b"CREATEOPCLASSITEM" => (|| Ok(Node::CreateOpClassItem(read_create_op_class_item(mcx)?)))(),
        b"CREATEOPFAMILYSTMT" => (|| Ok(Node::CreateOpFamilyStmt(read_create_op_family_stmt(mcx)?)))(),
        b"ALTEROPFAMILYSTMT" => (|| Ok(Node::AlterOpFamilyStmt(read_alter_op_family_stmt(mcx)?)))(),
        b"DROPSTMT" => (|| Ok(Node::DropStmt(read_drop_stmt(mcx)?)))(),
        b"TRUNCATESTMT" => (|| Ok(Node::TruncateStmt(read_truncate_stmt(mcx)?)))(),
        b"COMMENTSTMT" => (|| Ok(Node::CommentStmt(read_comment_stmt(mcx)?)))(),
        b"SECLABELSTMT" => (|| Ok(Node::SecLabelStmt(read_sec_label_stmt(mcx)?)))(),
        b"DECLARECURSORSTMT" => (|| Ok(Node::DeclareCursorStmt(read_declare_cursor_stmt(mcx)?)))(),
        b"CLOSEPORTALSTMT" => (|| Ok(Node::ClosePortalStmt(read_close_portal_stmt(mcx)?)))(),
        b"FETCHSTMT" => (|| Ok(Node::FetchStmt(read_fetch_stmt(mcx)?)))(),
        b"INDEXSTMT" => (|| Ok(Node::IndexStmt(read_index_stmt(mcx)?)))(),
        b"CREATESTATSSTMT" => (|| Ok(Node::CreateStatsStmt(read_create_stats_stmt(mcx)?)))(),
        b"STATSELEM" => (|| Ok(Node::StatsElem(read_stats_elem(mcx)?)))(),
        b"ALTERSTATSSTMT" => (|| Ok(Node::AlterStatsStmt(read_alter_stats_stmt(mcx)?)))(),
        b"CREATEFUNCTIONSTMT" => (|| Ok(Node::CreateFunctionStmt(read_create_function_stmt(mcx)?)))(),
        b"FUNCTIONPARAMETER" => (|| Ok(Node::FunctionParameter(read_function_parameter(mcx)?)))(),
        b"ALTERFUNCTIONSTMT" => (|| Ok(Node::AlterFunctionStmt(read_alter_function_stmt(mcx)?)))(),
        b"DOSTMT" => (|| Ok(Node::DoStmt(read_do_stmt(mcx)?)))(),
        b"CALLSTMT" => (|| Ok(Node::CallStmt(read_call_stmt(mcx)?)))(),
        b"RENAMESTMT" => (|| Ok(Node::RenameStmt(read_rename_stmt(mcx)?)))(),
        b"ALTEROBJECTDEPENDSSTMT" => (|| Ok(Node::AlterObjectDependsStmt(read_alter_object_depends_stmt(mcx)?)))(),
        b"ALTEROBJECTSCHEMASTMT" => (|| Ok(Node::AlterObjectSchemaStmt(read_alter_object_schema_stmt(mcx)?)))(),
        b"ALTEROWNERSTMT" => (|| Ok(Node::AlterOwnerStmt(read_alter_owner_stmt(mcx)?)))(),
        b"ALTEROPERATORSTMT" => (|| Ok(Node::AlterOperatorStmt(read_alter_operator_stmt(mcx)?)))(),
        b"ALTERTYPESTMT" => (|| Ok(Node::AlterTypeStmt(read_alter_type_stmt(mcx)?)))(),
        b"RULESTMT" => (|| Ok(Node::RuleStmt(read_rule_stmt(mcx)?)))(),
        b"NOTIFYSTMT" => (|| Ok(Node::NotifyStmt(read_notify_stmt(mcx)?)))(),
        b"LISTENSTMT" => (|| Ok(Node::ListenStmt(read_listen_stmt(mcx)?)))(),
        b"UNLISTENSTMT" => (|| Ok(Node::UnlistenStmt(read_unlisten_stmt(mcx)?)))(),
        b"TRANSACTIONSTMT" => (|| Ok(Node::TransactionStmt(read_transaction_stmt(mcx)?)))(),
        b"COMPOSITETYPESTMT" => (|| Ok(Node::CompositeTypeStmt(read_composite_type_stmt(mcx)?)))(),
        b"CREATEENUMSTMT" => (|| Ok(Node::CreateEnumStmt(read_create_enum_stmt(mcx)?)))(),
        b"CREATERANGESTMT" => (|| Ok(Node::CreateRangeStmt(read_create_range_stmt(mcx)?)))(),
        b"ALTERENUMSTMT" => (|| Ok(Node::AlterEnumStmt(read_alter_enum_stmt(mcx)?)))(),
        b"VIEWSTMT" => (|| Ok(Node::ViewStmt(read_view_stmt(mcx)?)))(),
        b"LOADSTMT" => (|| Ok(Node::LoadStmt(read_load_stmt(mcx)?)))(),
        b"CREATEDBSTMT" => (|| Ok(Node::CreatedbStmt(read_createdb_stmt(mcx)?)))(),
        b"ALTERDATABASESTMT" => (|| Ok(Node::AlterDatabaseStmt(read_alter_database_stmt(mcx)?)))(),
        b"ALTERDATABASEREFRESHCOLLSTMT" => (|| Ok(Node::AlterDatabaseRefreshCollStmt(read_alter_database_refresh_coll_stmt(mcx)?)))(),
        b"ALTERDATABASESETSTMT" => (|| Ok(Node::AlterDatabaseSetStmt(read_alter_database_set_stmt(mcx)?)))(),
        b"DROPDBSTMT" => (|| Ok(Node::DropdbStmt(read_dropdb_stmt(mcx)?)))(),
        b"ALTERSYSTEMSTMT" => (|| Ok(Node::AlterSystemStmt(read_alter_system_stmt(mcx)?)))(),
        b"CLUSTERSTMT" => (|| Ok(Node::ClusterStmt(read_cluster_stmt(mcx)?)))(),
        b"VACUUMSTMT" => (|| Ok(Node::VacuumStmt(read_vacuum_stmt(mcx)?)))(),
        b"VACUUMRELATION" => (|| Ok(Node::VacuumRelation(read_vacuum_relation(mcx)?)))(),
        b"EXPLAINSTMT" => (|| Ok(Node::ExplainStmt(read_explain_stmt(mcx)?)))(),
        b"CREATETABLEASSTMT" => (|| Ok(Node::CreateTableAsStmt(read_create_table_as_stmt(mcx)?)))(),
        b"REFRESHMATVIEWSTMT" => (|| Ok(Node::RefreshMatViewStmt(read_refresh_mat_view_stmt(mcx)?)))(),
        b"CHECKPOINTSTMT" => (|| Ok(Node::CheckPointStmt(read_check_point_stmt(mcx)?)))(),
        b"DISCARDSTMT" => (|| Ok(Node::DiscardStmt(read_discard_stmt(mcx)?)))(),
        b"LOCKSTMT" => (|| Ok(Node::LockStmt(read_lock_stmt(mcx)?)))(),
        b"CONSTRAINTSSETSTMT" => (|| Ok(Node::ConstraintsSetStmt(read_constraints_set_stmt(mcx)?)))(),
        b"REINDEXSTMT" => (|| Ok(Node::ReindexStmt(read_reindex_stmt(mcx)?)))(),
        b"CREATECONVERSIONSTMT" => (|| Ok(Node::CreateConversionStmt(read_create_conversion_stmt(mcx)?)))(),
        b"CREATECASTSTMT" => (|| Ok(Node::CreateCastStmt(read_create_cast_stmt(mcx)?)))(),
        b"CREATETRANSFORMSTMT" => (|| Ok(Node::CreateTransformStmt(read_create_transform_stmt(mcx)?)))(),
        b"PREPARESTMT" => (|| Ok(Node::PrepareStmt(read_prepare_stmt(mcx)?)))(),
        b"EXECUTESTMT" => (|| Ok(Node::ExecuteStmt(read_execute_stmt(mcx)?)))(),
        b"DEALLOCATESTMT" => (|| Ok(Node::DeallocateStmt(read_deallocate_stmt(mcx)?)))(),
        b"DROPOWNEDSTMT" => (|| Ok(Node::DropOwnedStmt(read_drop_owned_stmt(mcx)?)))(),
        b"REASSIGNOWNEDSTMT" => (|| Ok(Node::ReassignOwnedStmt(read_reassign_owned_stmt(mcx)?)))(),
        b"ALTERTSDICTIONARYSTMT" => (|| Ok(Node::AlterTSDictionaryStmt(read_alter_t_s_dictionary_stmt(mcx)?)))(),
        b"ALTERTSCONFIGURATIONSTMT" => (|| Ok(Node::AlterTSConfigurationStmt(read_alter_t_s_configuration_stmt(mcx)?)))(),
        b"PUBLICATIONTABLE" => (|| Ok(Node::PublicationTable(read_publication_table(mcx)?)))(),
        b"PUBLICATIONOBJSPEC" => (|| Ok(Node::PublicationObjSpec(read_publication_obj_spec(mcx)?)))(),
        b"CREATEPUBLICATIONSTMT" => (|| Ok(Node::CreatePublicationStmt(read_create_publication_stmt(mcx)?)))(),
        b"ALTERPUBLICATIONSTMT" => (|| Ok(Node::AlterPublicationStmt(read_alter_publication_stmt(mcx)?)))(),
        b"CREATESUBSCRIPTIONSTMT" => (|| Ok(Node::CreateSubscriptionStmt(read_create_subscription_stmt(mcx)?)))(),
        b"ALTERSUBSCRIPTIONSTMT" => (|| Ok(Node::AlterSubscriptionStmt(read_alter_subscription_stmt(mcx)?)))(),
        b"DROPSUBSCRIPTIONSTMT" => (|| Ok(Node::DropSubscriptionStmt(read_drop_subscription_stmt(mcx)?)))(),
        _ => return None,
    };
    Some(node)
}
...
mod tests {
    ...
    fn notifystmt_round_trips() {
        ...
        let text = rt(&Node::NotifyStmt(ns));
    ...
    fn partitionboundspec_round_trips() {
        ...
        let text = rt(&Node::PartitionBoundSpec(pbs));
