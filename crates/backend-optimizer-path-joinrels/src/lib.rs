...
//! [`RelId`](types_pathnodes::RelId)/[`PathId`](types_pathnodes::PathId)/
//! [`RinfoId`](types_pathnodes::RinfoId) handle indexes the matching arena, and
...
use backend_partitioning_partbounds_seams as partbounds;
...
#[inline]
pub fn is_simple_rel(rel: &types_pathnodes::RelOptInfo) -> bool {
...
#[inline]
pub fn is_partitioned_rel(rel: &types_pathnodes::RelOptInfo) -> bool {
...
#[inline]
pub fn rel_has_all_part_props(rel: &types_pathnodes::RelOptInfo) -> bool {
...
fn restriction_is_constant_false(
    ...
    for &rinfo in restrictlist {
        ...
        if let types_nodes::primnodes::Expr::Const(con) = root.node(clause_id) {
...
#[inline]
fn scheme_partnatts(rel: &types_pathnodes::RelOptInfo) -> i16 {
