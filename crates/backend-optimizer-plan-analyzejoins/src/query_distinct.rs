...
//! sub-`Query` inline on the [`RangeTblEntry`](types_nodes::parsenodes::RangeTblEntry)
...
use backend_optimizer_util_vars::tlist::get_sortgroupclause_tle;
use backend_utils_cache_lsyscache::opfamily_operator::equality_ops_are_compatible;
