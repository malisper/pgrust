...
use backend_optimizer_path_allpaths as allpaths;
...
use backend_optimizer_plan_init_subselect_seams as analyzejoins_seam;
use backend_optimizer_plan_small_seams as initsplan_seam;
use backend_optimizer_util_appendinfo_seams as appendinfo_seam;
...
pub fn query_planner<'mcx>(
     ...
     */
    joinlist = analyzejoins_seam::remove_useless_self_joins::call(root, joinlist);
     ...
     */
    initsplan_seam::add_other_rels_to_query::call(root);
...
fn trivial_path_varno(jointree: &types_nodes::rawnodes::FromExpr) -> Option<i32> {
