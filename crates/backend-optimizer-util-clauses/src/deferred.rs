...
pub fn contain_mutable_functions_after_planning(mcx: Mcx<'_>, expr: Expr) -> PgResult<bool> {
...
pub fn contain_volatile_functions_after_planning(mcx: Mcx<'_>, expr: Expr) -> PgResult<bool> {
    let planned = crate::fold::eval_const_expressions(mcx, expr)?;
