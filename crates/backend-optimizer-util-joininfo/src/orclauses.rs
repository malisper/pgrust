...
const RELOPT_BASEREL: types_pathnodes::RelOptKind = types_pathnodes::RELOPT_BASEREL;
...
fn init_dummy_sjinfo(
    left_relids: types_pathnodes::Relids,
    right_relids: types_pathnodes::Relids,
) -> types_pathnodes::SpecialJoinInfo {
    types_pathnodes::SpecialJoinInfo {
