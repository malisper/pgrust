...
use types_nodes::partition::{PartitionKeyData, PartitionStrategy};
...
use backend_parser_coerce_seams as coerce_seams;
...
/// `types_datum::Datum` the fmgr boundary expects; the by-value boolean result
...
fn fc_satisfies_hash_partition(
    ...
    Ok(types_datum::Datum::from_usize(word))
}
...
pub fn register() {
    fmgr_core::register_builtins_native([(
        ...
        fc_satisfies_hash_partition as types_fmgr::PgFnNative,
    )]);
}
