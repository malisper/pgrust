...
//! [`core_yylex`](backend_parser_scan_seams::core_yylex) seam) and adds:
//!
...
use backend_parser_scan::tokens;
use backend_parser_scan_seams as scan_seam;
use backend_pl_plpgsql_comp_seams::{self as comp_seam, CwordResolution, WordResolution};
use mcx::Mcx;
use types_error::{PgError, PgResult, ERRCODE_SYNTAX_ERROR};
use types_plpgsql::{IdentifierLookup, PLcword, PLwdatum, PLword};
