...
fn internal_ipc_memory_create(
    ...
    backend_utils_init_miscinit_seams::add_to_data_dir_lock_file::call(
...
pub fn GetHugePageSize() -> (Size, i32) {
    #[cfg(target_os = "linux")]
    {
        ...
        let huge_page_size = backend_utils_misc_guc_tables::vars::huge_page_size.read();
...
fn create_anonymous_segment(size: Size) -> PgResult<(*mut libc::c_void, Size)> {
    let huge_pages = backend_utils_misc_guc_tables::vars::huge_pages.read();
...
pub fn PGSharedMemoryCreate(
    ...
    let huge_pages = backend_utils_misc_guc_tables::vars::huge_pages.read();
    let shared_memory_type = backend_utils_misc_guc_tables::vars::shared_memory_type.read();
    ...
    let mem_address: *mut libc::c_void = loop {
        ...
        match state {
            ...
            IpcMemoryState::Unattached => {
                ...
                if dsm_control != 0 {
                    backend_storage_ipc_dsm_core_seams::dsm_cleanup_using_control_segment::call(
