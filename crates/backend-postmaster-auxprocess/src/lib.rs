...
//!
//!  * `InitAuxiliaryProcess()` -> [`backend_storage_lmgr_proc::InitAuxiliaryProcess`]
//!  * `ProcSignalInit(NULL, 0)` -> [`backend_storage_ipc_procsignal::ProcSignalInit`]
...
use backend_storage_ipc_procsignal::ProcSignalInit;
use backend_storage_lmgr_proc::proc_lifecycle::InitAuxiliaryProcess;
...
pub fn AuxiliaryProcessMainCommon() -> PgResult<()> {
    ...
    let top_mcx = backend_utils_mmgr_mcxt_seams::top_memory_context::call();
