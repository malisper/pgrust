...
//!
//! The compiled regex crosses this boundary as [`types_regex::RegexCompiled`],
...
use types_regex::{RegMatch, RegcompResult, RegexCompiled, RegexecResult, RegprefixResult};
