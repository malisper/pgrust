...
//! surface routes through [`interfaces_libpq_fe_seams`] (aliased `rt`), each
...
//!
//! Across the inward [`backend_replication_libpqwalreceiver_seams`] boundary the
...
/// (`backend_replication_libpqwalreceiver_seams`).
pub fn init_seams() {
