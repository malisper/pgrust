...
//! [`backend_replication_logical_message::LogLogicalMessage`].
//!
...
//! and drains [`backend_replication_logical_logical_seams::sql_srf_take_rows`])
//! is the final step.
...
use backend_replication_logical_logical as logical;
