...
pub fn InitWalSender() {
    ...
    // WAL after this.
    backend_postmaster_postmaster_seams::mark_postmaster_child_wal_sender::call();
    backend_postmaster_postmaster_seams::send_postmaster_signal_advance_state_machine::call();
    ...
    if !found {
        ...
        unsafe {
            ...
            let header = WalSndCtlData {
                ...
                wal_flush_cv: types_condvar::ConditionVariable::new(),
                wal_replay_cv: types_condvar::ConditionVariable::new(),
                wal_confirm_rcv_cv: types_condvar::ConditionVariable::new(),
            };
        ...
        while i < max {
            ...
            backend_storage_lmgr_s_lock::s_init_lock(&slot.mutex);
            i += 1;
        }
