...
//! `stemmer_modules[]` table, here [`backend_snowball_runtime::STEMMER_MODULES`]),
...
//! [`types_tsearch::SnowballEnvHandle`], resolved through this crate's
...
use backend_snowball_runtime::{SN_env, SN_set_current, STEMMER_MODULES, PG_SQL_ASCII, PG_UTF8};
use backend_tsearch_ts_utils_seams::{readstoplist, searchstoplist};
