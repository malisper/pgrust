...
static mut s_1_107: [symbol; 3] = [
    0xf1 as ::core::ffi::c_int as symbol,
    'o' as i32 as symbol,
    'a' as i32 as symbol,
];
...
unsafe fn r_mark_regions(mut z: *mut SN_env) -> ::core::ffi::c_int {
    ...
    *(*z).I.offset(0 as ::core::ffi::c_int as isize) = (*z).l;
    ...
    {
        current_block = 5367058775261672736;
    } else {
        ...
        {
            current_block = 15028482720320530512;
        } else {
            ...
            if ret < 0 as ::core::ffi::c_int {
                ...
                (*z).c += ret;
                current_block = 15629372267209124663;
            }
        }
        match current_block {
            15629372267209124663 => {}
            _ => {
                (*z).c = c3;
                if in_grouping(
                    z,
    ...
    match current_block {
        5367058775261672736 => {
            ...
            {
                current_block = 4694300212491851090;
            } else {
                ...
                {
                    current_block = 8526160914405263351;
                } else {
...
pub unsafe fn basque_ISO_8859_1_stem(
    mut z: *mut SN_env,
) -> ::core::ffi::c_int {
...
pub unsafe fn basque_ISO_8859_1_create_env() -> *mut SN_env {
    return SN_create_env(0 as ::core::ffi::c_int, 3 as ::core::ffi::c_int);
}
pub unsafe fn basque_ISO_8859_1_close_env(mut z: *mut SN_env) {
