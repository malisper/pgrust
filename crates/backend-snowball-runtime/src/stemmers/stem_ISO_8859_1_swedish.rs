...
pub unsafe fn swedish_ISO_8859_1_stem(
    mut z: *mut SN_env,
) -> ::core::ffi::c_int {
...
pub unsafe fn swedish_ISO_8859_1_create_env() -> *mut SN_env {
    return SN_create_env(0 as ::core::ffi::c_int, 2 as ::core::ffi::c_int);
}
pub unsafe fn swedish_ISO_8859_1_close_env(mut z: *mut SN_env) {
