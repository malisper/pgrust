...
unsafe fn r_prelude(mut z: *mut SN_env) -> ::core::ffi::c_int {
    ...
    's_201: loop {
        ...
        loop {
            ...
            ) != 0)
            {
                ...
                if (*z).c == (*z).l
                    || *(*z).p.offset((*z).c as isize) as ::core::ffi::c_int
                        != 'i' as i32
                {
                    current_block = 3860974910462960519;
                } else {
                    (*z).c += 1;
                    (*z).ket = (*z).c;
                    if in_grouping_U(
                    ...
                    ) != 0
                    {
                        ...
                        current_block = 4915791303283632573;
                    }
                }
                match current_block {
                    3860974910462960519 => {
                        ...
                        if (*z).c == (*z).l
                            || *(*z).p.offset((*z).c as isize) as ::core::ffi::c_int
                                != 'y' as i32
                        {
                            current_block = 15980290088583332561;
                        } else {
                            (*z).c += 1;
                            (*z).ket = (*z).c;
            ...
            (*z).c = c5;
            let mut ret_8: ::core::ffi::c_int = skip_utf8(
                (*z).p,
                (*z).c,
                (*z).l,
                1 as ::core::ffi::c_int,
                    ...
                    match current_block {
                        9241535491006583629 => {
                            ...
                            if !(ret_8 == 0 as ::core::ffi::c_int) {
                                ...
                                {
                                    current_block = 16511663442480078438;
                                } else {
                                    (*z).bra = (*z).c;
                                    ...
                                    if ret_10 == 0 as ::core::ffi::c_int {
                                                ...
                                                as ::core::ffi::c_int != 'e' as i32
                                        {
                                            ...
                                            current_block = 17427985523523033101;
                                        } else {
                                            (*z).c -= 1;
                                            current_block = 16511663442480078438;
                                        }
                ...
                & 1 as ::core::ffi::c_int == 0)
        {
                ...
                == 0)
            {
                ...
                ) != 0)
                {
                    (*z).c = (*z).l - m_test10;
                    (*z).ket = (*z).c;
                    let mut ret_22: ::core::ffi::c_int = skip_b_utf8(
                        (*z).p,
                        (*z).c,
                        (*z).lb,
                        1 as ::core::ffi::c_int,
...
pub unsafe fn dutch_UTF_8_stem(mut z: *mut SN_env) -> ::core::ffi::c_int {
    let mut c1: ::core::ffi::c_int = (*z).c;
...
pub unsafe fn dutch_UTF_8_create_env() -> *mut SN_env {
    return SN_create_env(0 as ::core::ffi::c_int, 4 as ::core::ffi::c_int);
}
pub unsafe fn dutch_UTF_8_close_env(mut z: *mut SN_env) {
