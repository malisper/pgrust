...
static mut s_7_12: [symbol; 4] = [
    'm' as i32 as symbol,
    'p' as i32 as symbol,
    0xc3 as ::core::ffi::c_int as symbol,
    0xa4 as ::core::ffi::c_int as symbol,
];
static mut s_7_13: [symbol; 5] = [
    'i' as i32 as symbol,
    'm' as i32 as symbol,
    'p' as i32 as symbol,
    0xc3 as ::core::ffi::c_int as symbol,
...
static mut s_5: [symbol; 2] = ['p' as i32 as symbol, 'o' as i32 as symbol];
static mut s_6: [symbol; 2] = ['p' as i32 as symbol, 'o' as i32 as symbol];
    ...
    match among_var {
        ...
        5 => {
            if (*z).c - 2 as ::core::ffi::c_int <= (*z).lb
                || *(*z).p.offset(((*z).c - 1 as ::core::ffi::c_int) as isize)
                    as ::core::ffi::c_int != 164 as ::core::ffi::c_int
            {
                return 0 as ::core::ffi::c_int;
            }
...
unsafe fn r_case_ending(mut z: *mut SN_env) -> ::core::ffi::c_int {
    ...
    match among_var {
        ...
        5 => {
            if eq_s_b(z, 2 as ::core::ffi::c_int, &raw const s_2 as *const symbol) == 0 {
                return 0 as ::core::ffi::c_int;
            }
        }
        6 => {
        ...
        7 => {
            ...
            if ret == 0 as ::core::ffi::c_int {
                (*z).c = (*z).l - m4;
                if eq_s_b(z, 2 as ::core::ffi::c_int, &raw const s_4 as *const symbol)
                    == 0
                {
                    (*z).c = (*z).l - m2;
...
unsafe fn r_other_endings(mut z: *mut SN_env) -> ::core::ffi::c_int {
    ...
    match among_var {
        1 => {
            let mut m2: ::core::ffi::c_int = (*z).l - (*z).c;
            if eq_s_b(z, 2 as ::core::ffi::c_int, &raw const s_5 as *const symbol) == 0 {
                (*z).c = (*z).l - m2;
            } else {
                return 0 as ::core::ffi::c_int
            }
...
pub unsafe fn finnish_UTF_8_stem(mut z: *mut SN_env) -> ::core::ffi::c_int {
...
pub unsafe fn finnish_UTF_8_create_env() -> *mut SN_env {
    return SN_create_env(1 as ::core::ffi::c_int, 3 as ::core::ffi::c_int);
}
pub unsafe fn finnish_UTF_8_close_env(mut z: *mut SN_env) {
