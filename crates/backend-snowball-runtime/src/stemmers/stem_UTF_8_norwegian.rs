...
pub unsafe fn norwegian_UTF_8_stem(mut z: *mut SN_env) -> ::core::ffi::c_int {
...
pub unsafe fn norwegian_UTF_8_create_env() -> *mut SN_env {
    return SN_create_env(0 as ::core::ffi::c_int, 2 as ::core::ffi::c_int);
}
pub unsafe fn norwegian_UTF_8_close_env(mut z: *mut SN_env) {
