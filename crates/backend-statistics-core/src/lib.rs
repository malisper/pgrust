...
fn statext_mcv_build<'mcx>(
    ...
    totalrows: f64,
    stattarget: i32,
) -> PgResult<Option<types_statistics::MCVList<'mcx>>> {
    use types_statistics::{MCVItem, MCVList, STATS_MCV_MAGIC, STATS_MCV_TYPE_BASIC};
    ...
    let mut mcvlist = MCVList {
        ...
        types: [Oid::from(0u32); types_statistics::STATS_MAX_DIMENSIONS],
