...
fn install_substrate_once() {
    ...
    ONCE.call_once(|| {
        ...
        backend_utils_init_small_seams::my_proc_number::set(|| 0 as ProcNumber);
        ...
        backend_storage_file_seams::reserve_external_fd::set(|| {
            NUM_EXTERNAL_FDS.with(|c| c.set(c.get() + 1));
        });
        backend_storage_file_seams::release_external_fd::set(|| {
        ...
        backend_utils_init_small_seams::set_interrupt_pending::set(|_v| {});
        backend_utils_init_small_seams::set_proc_die_pending::set(|_v| {});
        backend_utils_init_small_seams::set_query_cancel_pending::set(|_v| {});
        backend_utils_init_small_seams::set_interrupt_holdoff_count::set(|v| {
        ...
        backend_storage_lmgr_lwlock::CreateLWLocks(top_mcx(), false)
...
pub fn dsm_test_bringup() -> Mcx<'static> {
    ...
    if !THREAD_BROUGHT_UP.with(Cell::get) {
        ...
        pg_prng::global_prng(|prng| prng.seed(seed));
