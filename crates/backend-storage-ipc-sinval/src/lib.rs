...
use backend_storage_lmgr_s_lock::{s_lock, s_unlock};
...
pub fn init_seams() {
    backend_storage_ipc_sinval_seams::send_shared_invalid_messages::set(SendSharedInvalidMessages);
    backend_storage_ipc_sinval_seams::receive_shared_invalid_messages::set(
        ReceiveSharedInvalidMessages,
    );
    backend_storage_ipc_sinval_seams::handle_catchup_interrupt::set(HandleCatchupInterrupt);
    backend_storage_ipc_sinval_seams::shared_inval_backend_init::set(SharedInvalBackendInit);
    backend_storage_ipc_sinval_seams::get_next_local_transaction_id::set(GetNextLocalTransactionId);
    backend_storage_ipc_sinval_seams::shared_invalid_message_counter::set(
        SharedInvalidMessageCounter,
    );
    backend_storage_ipc_sinval_seams::shared_inval_shmem_size::set(SharedInvalShmemSize);
    backend_storage_ipc_sinval_seams::shared_inval_shmem_init::set(SharedInvalShmemInit);
}
