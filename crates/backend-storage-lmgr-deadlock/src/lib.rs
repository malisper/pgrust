...
pub fn init_seams() {
    backend_storage_lmgr_deadlock_seams::init_dead_lock_checking::set(detector::init_dead_lock_checking);
    backend_storage_lmgr_deadlock_seams::dead_lock_check::set(detector::dead_lock_check);
    backend_storage_lmgr_deadlock_seams::get_blocking_auto_vacuum_pgproc::set(
        detector::get_blocking_auto_vacuum_pgproc,
    );
    backend_storage_lmgr_deadlock_seams::dead_lock_report::set(detector::dead_lock_report);
    backend_storage_lmgr_deadlock_seams::remember_simple_dead_lock::set(
