...
//! [`DictThesaurus`](types_tsearch::DictThesaurus)'s `arena`, reproducing
...
use backend_commands_define_seams::{def_get_string, DefElemArg};
use backend_tsearch_dict_seams::{get_ts_dict_oid_from_name, subdict_lexize};
