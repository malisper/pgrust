...
pub fn init_seams() {
    backend_tsearch_ispell_regis_seams::dispell_init::set(dict_ispell::dispell_init);
    backend_tsearch_ispell_regis_seams::dispell_lexize::set(dict_ispell::dispell_lexize);
}
