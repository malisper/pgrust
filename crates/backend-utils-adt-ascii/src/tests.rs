...
fn install_seams() {
    INSTALL.call_once(|| {
        common_encnames_seams::pg_char_to_encoding::set(|name| match name {
            "LATIN1" => PG_LATIN1,
            "LATIN2" => PG_LATIN2,
            "WIN1250" => PG_WIN1250,
            "UTF8" => PG_UTF8,
        ...
        common_encnames_seams::pg_encoding_to_char::set(|enc| match enc {
            PG_LATIN1 => "LATIN1",
            PG_LATIN2 => "LATIN2",
            PG_WIN1250 => "WIN1250",
            PG_UTF8 => "UTF8",
        ...
        backend_utils_mb_mbutils_seams::get_database_encoding::set(|| PG_LATIN2);
    });
}
