...
//! `backend_access_transam_xact` crate (the SQL `now()` returns the
...
//! `backend_timezone_strftime_seams::pg_strftime`.
...
mod tests {
    use super::*;
    use backend_access_transam_xact::SetParallelStartTimestamps;
