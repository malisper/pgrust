...
//! [`backend_utils_adt_numeric::NumericVar`]), and the `*_trunc` cores.
//!
...
//! No raw pointers, `extern "C"`, `c_int`, `libc`, or `pgrust_pg_ffi`.

use types_pgtime::pg_tm;
use mcx::Mcx;
use backend_utils_adt_numeric::kernel_transcendental::int64_to_numericvar;
use backend_utils_adt_numeric::kernel_var::{add_var, div_var, round_var, select_div_scale, sub_var};
