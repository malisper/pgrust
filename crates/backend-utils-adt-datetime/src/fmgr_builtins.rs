...
pub fn register_datetime_builtins() {
    backend_utils_fmgr_core::register_builtins([
        ...
        builtin(1373, "isfinite", 1, true, false, fc_date_finite),
        ...
        builtin(4133, "in_range", 5, true, false, fc_in_range_date_interval),
        builtin(6199, "extract", 2, true, false, fc_extract_date),
        ...
        builtin(2024, "timestamp", 1, true, false, fc_date_timestamp),
        builtin(2029, "date", 1, true, false, fc_timestamp_date),
        builtin(1174, "timestamptz", 1, true, false, fc_date_timestamptz),
        builtin(1178, "date", 1, true, false, fc_timestamptz_date),
        // ---- date.c: TIME ----
        ...
        builtin(1968, "time", 2, true, false, fc_time_scale),
        ...
        builtin(1308, "overlaps", 4, false, false, fc_overlaps_time),
        builtin(1316, "time", 1, true, false, fc_timestamp_time),
        builtin(2019, "time", 1, true, false, fc_timestamptz_time),
        builtin(2025, "timestamp", 2, true, false, fc_datetime_timestamp),
        builtin(1370, "interval", 1, true, false, fc_time_interval),
        builtin(1419, "time", 1, true, false, fc_interval_time),
        ...
        builtin(4137, "in_range", 5, true, false, fc_in_range_time_interval),
        builtin(1385, "date_part", 2, true, false, fc_time_part),
        builtin(6200, "extract", 2, true, false, fc_extract_time),
        // ---- date.c: TIMETZ ----
        ...
        builtin(1969, "timetz", 2, true, false, fc_timetz_scale),
        ...
        builtin(4138, "in_range", 5, true, false, fc_in_range_timetz_interval),
        builtin(1271, "overlaps", 4, false, false, fc_overlaps_timetz),
        builtin(2046, "time", 1, true, false, fc_timetz_time),
        builtin(2047, "timetz", 1, true, false, fc_time_timetz),
        builtin(1388, "timetz", 1, true, false, fc_timestamptz_timetz),
        builtin(1359, "timestamptz", 2, true, false, fc_datetimetz_timestamptz),
        builtin(1273, "date_part", 2, true, false, fc_timetz_part),
        builtin(6201, "extract", 2, true, false, fc_extract_timetz),
        builtin(2037, "timezone", 2, true, false, fc_timetz_zone),
        builtin(2038, "timezone", 2, true, false, fc_timetz_izone),
        builtin(6336, "timezone", 1, true, false, fc_timetz_at_local),
        ...
        builtin(1961, "timestamp", 2, true, false, fc_timestamp_scale),
        ...
        builtin(3463, "make_timestamptz", 7, true, false, fc_make_timestamptz_at_timezone),
        builtin(1158, "to_timestamp", 1, true, false, fc_float8_timestamptz),
        ...
        builtin(1967, "timestamptz", 2, true, false, fc_timestamptz_scale),
        ...
        builtin(1200, "interval", 2, true, false, fc_interval_scale),
        builtin(3464, "make_interval", 7, true, false, fc_make_interval),
        // ---- timestamp.c: now-family ----
        builtin(1299, "now", 0, true, false, fc_now),
        builtin(2647, "transaction_timestamp", 0, true, false, fc_transaction_timestamp),
        ...
        // ---- timestamp.c: finite ----
        builtin(1389, "isfinite", 1, true, false, fc_timestamp_finite),
        builtin(2048, "isfinite", 1, true, false, fc_timestamp_finite),
        builtin(1390, "isfinite", 1, true, false, fc_interval_finite),
        // ---- timestamp.c: comparisons (1152-row = timestamptz, 205x = timestamp; same core) ----
        builtin(1152, "timestamptz_eq", 2, true, false, fc_timestamp_eq),
        builtin(2052, "timestamp_eq", 2, true, false, fc_timestamp_eq),
        builtin(1153, "timestamptz_ne", 2, true, false, fc_timestamp_ne),
        builtin(2053, "timestamp_ne", 2, true, false, fc_timestamp_ne),
        builtin(1154, "timestamptz_lt", 2, true, false, fc_timestamp_lt),
        builtin(2054, "timestamp_lt", 2, true, false, fc_timestamp_lt),
        builtin(1157, "timestamptz_gt", 2, true, false, fc_timestamp_gt),
        builtin(2057, "timestamp_gt", 2, true, false, fc_timestamp_gt),
        builtin(1155, "timestamptz_le", 2, true, false, fc_timestamp_le),
        builtin(2055, "timestamp_le", 2, true, false, fc_timestamp_le),
        builtin(1156, "timestamptz_ge", 2, true, false, fc_timestamp_ge),
        builtin(2056, "timestamp_ge", 2, true, false, fc_timestamp_ge),
        builtin(1314, "timestamptz_cmp", 2, true, false, fc_timestamp_cmp),
        ...
        builtin(1304, "overlaps", 4, false, false, fc_overlaps_timestamp),
        builtin(2041, "overlaps", 4, false, false, fc_overlaps_timestamp),
        builtin(1195, "timestamptz_smaller", 2, true, false, fc_timestamp_smaller),
        builtin(2035, "timestamp_smaller", 2, true, false, fc_timestamp_smaller),
        builtin(1196, "timestamptz_larger", 2, true, false, fc_timestamp_larger),
        builtin(2036, "timestamp_larger", 2, true, false, fc_timestamp_larger),
        builtin(1188, "timestamptz_mi", 2, true, false, fc_timestamp_mi),
        builtin(2031, "timestamp_mi", 2, true, false, fc_timestamp_mi),
        // ---- timestamp.c: justify / arithmetic ----
        builtin(2711, "justify_interval", 1, true, false, fc_interval_justify_interval),
        builtin(1175, "justify_hours", 1, true, false, fc_interval_justify_hours),
        builtin(1295, "justify_days", 1, true, false, fc_interval_justify_days),
        ...
        builtin(6221, "date_add", 2, true, false, fc_timestamptz_pl_interval),
        builtin(1190, "timestamptz_mi_interval", 2, true, false, fc_timestamptz_mi_interval),
        builtin(6223, "date_subtract", 2, true, false, fc_timestamptz_mi_interval),
        builtin(6222, "date_add", 3, true, false, fc_timestamptz_pl_interval_at_zone),
        builtin(6273, "date_subtract", 3, true, false, fc_timestamptz_mi_interval_at_zone),
        ...
        builtin(4135, "in_range", 5, true, false, fc_in_range_timestamptz_interval),
        builtin(4134, "in_range", 5, true, false, fc_in_range_timestamp_interval),
        builtin(4136, "in_range", 5, true, false, fc_in_range_interval_interval),
        // ---- timestamp.c: age / bin / trunc / part / zone / conversions ----
        builtin(2058, "age", 2, true, false, fc_timestamp_age),
        builtin(1199, "age", 2, true, false, fc_timestamptz_age),
        builtin(6177, "date_bin", 3, true, false, fc_timestamp_bin),
        builtin(2020, "date_trunc", 2, true, false, fc_timestamp_trunc),
        builtin(6178, "date_bin", 3, true, false, fc_timestamptz_bin),
        builtin(1217, "date_trunc", 2, true, false, fc_timestamptz_trunc),
        builtin(1284, "date_trunc", 3, true, false, fc_timestamptz_trunc_zone),
        builtin(1218, "date_trunc", 2, true, false, fc_interval_trunc),
        builtin(2021, "date_part", 2, true, false, fc_timestamp_part),
        builtin(6202, "extract", 2, true, false, fc_extract_timestamp),
        builtin(1171, "date_part", 2, true, false, fc_timestamptz_part),
        builtin(6203, "extract", 2, true, false, fc_extract_timestamptz),
        builtin(1172, "date_part", 2, true, false, fc_interval_part),
        builtin(6204, "extract", 2, true, false, fc_extract_interval),
        builtin(2069, "timezone", 2, true, false, fc_timestamp_zone),
        builtin(2070, "timezone", 2, true, false, fc_timestamp_izone),
        builtin(2028, "timestamptz", 1, true, false, fc_timestamp_timestamptz),
        builtin(2027, "timestamp", 1, true, false, fc_timestamptz_timestamp),
        builtin(1159, "timezone", 2, true, false, fc_timestamptz_zone),
        builtin(1026, "timezone", 2, true, false, fc_timestamptz_izone),
        builtin(6335, "timezone", 1, true, false, fc_timestamp_at_local),
        builtin(6334, "timezone", 1, true, false, fc_timestamptz_at_local),
    ]);
}
