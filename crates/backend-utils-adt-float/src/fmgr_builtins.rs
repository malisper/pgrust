...
pub fn register_float_builtins() {
    backend_utils_fmgr_core::register_builtins([
        ...
        builtin(1394, "abs", 1, true, false, fc_float4abs),
        // ---- unary float8 ----
        ...
        builtin(1395, "abs", 1, true, false, fc_float8abs),
        // ---- math (float8) ----
        ...
        builtin(1194, "log10", 1, true, false, fc_dlog10),
        builtin(1339, "dlog10", 1, true, false, fc_dlog10),
        builtin(1340, "log", 1, true, false, fc_dlog10),
        builtin(1341, "ln", 1, true, false, fc_dlog1),
        builtin(1342, "round", 1, true, false, fc_dround),
        builtin(1343, "trunc", 1, true, false, fc_dtrunc),
        builtin(1344, "sqrt", 1, true, false, fc_dsqrt),
        builtin(1345, "cbrt", 1, true, false, fc_dcbrt),
        builtin(1346, "pow", 2, true, false, fc_dpow),
        builtin(1347, "exp", 1, true, false, fc_dexp),
        builtin(1368, "power", 2, true, false, fc_dpow),
        builtin(2308, "ceil", 1, true, false, fc_dceil),
        builtin(2309, "floor", 1, true, false, fc_dfloor),
        builtin(2310, "sign", 1, true, false, fc_dsign),
        builtin(2320, "ceiling", 1, true, false, fc_dceil),
        // ---- trig (radians) ----
        builtin(1600, "asin", 1, true, false, fc_dasin),
        builtin(1601, "acos", 1, true, false, fc_dacos),
        builtin(1602, "atan", 1, true, false, fc_datan),
        builtin(1603, "atan2", 2, true, false, fc_datan2),
        builtin(1604, "sin", 1, true, false, fc_dsin),
        builtin(1605, "cos", 1, true, false, fc_dcos),
        builtin(1606, "tan", 1, true, false, fc_dtan),
        builtin(1607, "cot", 1, true, false, fc_dcot),
        builtin(1608, "degrees", 1, true, false, fc_degrees),
        builtin(1609, "radians", 1, true, false, fc_radians),
        builtin(1610, "pi", 0, true, false, fc_dpi),
        // ---- trig (degrees) ----
        builtin(2731, "asind", 1, true, false, fc_dasind),
        builtin(2732, "acosd", 1, true, false, fc_dacosd),
        builtin(2733, "atand", 1, true, false, fc_datand),
        builtin(2734, "atan2d", 2, true, false, fc_datan2d),
        builtin(2735, "sind", 1, true, false, fc_dsind),
        builtin(2736, "cosd", 1, true, false, fc_dcosd),
        builtin(2737, "tand", 1, true, false, fc_dtand),
        builtin(2738, "cotd", 1, true, false, fc_dcotd),
        // ---- hyperbolic ----
        builtin(2462, "sinh", 1, true, false, fc_dsinh),
        builtin(2463, "cosh", 1, true, false, fc_dcosh),
        builtin(2464, "tanh", 1, true, false, fc_dtanh),
        builtin(2465, "asinh", 1, true, false, fc_dasinh),
        builtin(2466, "acosh", 1, true, false, fc_dacosh),
        builtin(2467, "atanh", 1, true, false, fc_datanh),
        // ---- erf / gamma ----
        builtin(6219, "erf", 1, true, false, fc_derf),
        builtin(6220, "erfc", 1, true, false, fc_derfc),
        builtin(6383, "gamma", 1, true, false, fc_dgamma),
        builtin(6384, "lgamma", 1, true, false, fc_dlgamma),
        // ---- conversions ----
        builtin(235, "float8", 1, true, false, fc_i2tod),
        builtin(236, "float4", 1, true, false, fc_i2tof),
        builtin(237, "int2", 1, true, false, fc_dtoi2),
        builtin(238, "int2", 1, true, false, fc_ftoi2),
        builtin(311, "float8", 1, true, false, fc_ftod),
        builtin(312, "float4", 1, true, false, fc_dtof),
        builtin(316, "float8", 1, true, false, fc_i4tod),
        builtin(317, "int4", 1, true, false, fc_dtoi4),
        builtin(318, "float4", 1, true, false, fc_i4tof),
        builtin(319, "int4", 1, true, false, fc_ftoi4),
        // ---- float48 arithmetic ----
        ...
        // ---- in_range / width_bucket ----
        builtin(4139, "in_range", 5, true, false, fc_in_range_float8_float8),
        builtin(4140, "in_range", 5, true, false, fc_in_range_float4_float8),
        builtin(320, "width_bucket", 4, true, false, fc_width_bucket_float8),
    ]);
}
