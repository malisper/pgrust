...
#[inline]
fn erf(x: f64) -> f64 {
    backend_utils_adt_float_seams::erf::call(x)
}

#[inline]
fn erfc(x: f64) -> f64 {
    backend_utils_adt_float_seams::erfc::call(x)
}

#[inline]
fn tgamma(x: f64) -> f64 {
    backend_utils_adt_float_seams::tgamma::call(x)
}

#[inline]
fn lgamma(x: f64) -> f64 {
    backend_utils_adt_float_seams::lgamma::call(x)
}
...
mod tests {
    ...
    fn install_libm_seams() {
        ...
        ONCE.call_once(|| {
            backend_utils_adt_float_seams::erf::set(test_erf);
            backend_utils_adt_float_seams::erfc::set(|x| 1.0 - test_erf(x));
            backend_utils_adt_float_seams::tgamma::set(test_tgamma);
            backend_utils_adt_float_seams::lgamma::set(|x| test_tgamma(x).abs().ln());
        });
    }
