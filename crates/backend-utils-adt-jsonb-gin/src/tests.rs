...
//! built with the sibling `backend_utils_adt_jsonb_util` engine, the
...
use super::*;
use backend_utils_adt_jsonb_util::{JsonbPair, JsonbValueToJsonb};
...
fn install_seams() {
    ...
    ONCE.call_once(|| {
        ...
        common_hashfn_seams::hash_bytes::set(common_hashfn::hash_bytes);
        common_hashfn_seams::hash_bytes_extended::set(common_hashfn::hash_bytes_extended);
        common_hashfn_seams::hash_bytes_uint32_extended::set(
            common_hashfn::hash_bytes_uint32_extended,
        );
    });
}
...
fn numeric_normalize_strips_trailing_zeroes() {
    ...
    use backend_utils_adt_numeric::convert::make_result;
    use backend_utils_adt_numeric::io::set_var_from_str;
