...
use super::*;
use backend_utils_adt_jsonb_util::{JsonbValueToJsonb, VARHDRSZ};
...
fn install_seams() {
    INSTALL.call_once(|| {
        ...
        backend_utils_adt_numeric_seams::numeric_cmp::set(|a, b| match a.cmp(b) {
            core::cmp::Ordering::Less => -1,
            core::cmp::Ordering::Equal => 0,
            core::cmp::Ordering::Greater => 1,
        });
        backend_utils_adt_varlena_seams::varstr_cmp::set(|a, b, _coll| {
            Ok(match a.cmp(b) {
                core::cmp::Ordering::Less => -1,
                core::cmp::Ordering::Equal => 0,
                core::cmp::Ordering::Greater => 1,
        ...
        common_hashfn_seams::hash_bytes::set(|k| {
        ...
        common_hashfn_seams::hash_bytes_extended::set(|k, seed| {
        ...
        common_hashfn_seams::hash_bytes_uint32_extended::set(|k, seed| {
        ...
        backend_utils_adt_array_more_seams::deconstruct_text_array::set(|arr| {
...
fn jobj(pairs: &[(&str, JsonbValue)]) -> JsonbValue {
    use backend_utils_adt_jsonb_util::JsonbPair;
