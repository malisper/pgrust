...
use backend_utils_adt_jsonb_util::{JsonbToJsonbValue, JsonbValueToJsonb};
...
pub fn init_seams() {
    backend_utils_adt_jsonbsubs_seams::jsonb_subscript_fetch::set(jsonb_subscript_fetch);
    backend_utils_adt_jsonbsubs_seams::jsonb_subscript_assign::set(jsonb_subscript_assign);
    backend_utils_adt_jsonbsubs_seams::jsonb_subscript_fetch_old::set(jsonb_subscript_fetch_old);
}
