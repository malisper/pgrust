...
use backend_access_common_heaptuple::{heap_deform_tuple, HeapTupleGetDatum};
...
fn populate_recordset_record<'mcx>(
    ...
    if typcat == TypeCat::CompositeDomain {
        ...
        backend_utils_adt_misc2::domains::domain_check(mcx, &datum, false, argtype)?;
    }
    ...
    if is_json {
        ...
        match parse {
            ...
            Ok(res) => {
                ...
                common_jsonapi_seams::errsave_error::call(res, json, true, None)?;
