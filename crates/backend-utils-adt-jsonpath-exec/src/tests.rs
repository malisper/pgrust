...
use backend_utils_adt_jsonb::jsonb_out;
use backend_utils_adt_jsonb_util::JsonbValueToJsonb;
use backend_utils_adt_jsonpath::jsonpath_in;
use backend_utils_adt_jsonpath::JsonPathItemType;
use types_jsonb::backend_utils_adt_jsonb_util::{JsonbPair, JsonbValue, JsonbValueData};
...
fn install_seams() {
    INIT.call_once(|| {
        ...
        backend_utils_adt_numeric_seams::numeric_eq::set(real_numeric_eq);
        backend_utils_adt_numeric_seams::numeric_cmp::set(real_numeric_cmp);
...
fn num_bytes(mcx: Mcx<'_>, n: i64) -> Vec<u8> {
    backend_utils_adt_numeric::convert::int64_to_numeric(mcx, n)
        .unwrap()
        .to_vec()
}
