...
use backend_utils_adt_numeric::convert::{numericvar_to_uint64, set_var_from_num};
use backend_utils_adt_numeric::io::numeric_in;
use backend_utils_adt_numeric::ops_sql::{numeric_add, numeric_sub};
...
/// [`common_hashfn::hash_bytes_uint32`] (== `common/hashfn.c`'s `hash_uint32`).
///
/// ```c
