...
pub fn register_misc2_builtins() {
    backend_utils_fmgr_core::register_builtins([
        ...
        builtin(1079, "text_regclass", 1, false, false, fc_text_regclass),
        ...
        builtin(2624, "pg_read_file_off_len", 3, false, false, fc_pg_read_file_off_len),
        builtin(3293, "pg_read_file_off_len_missing", 4, false, false, fc_pg_read_file_off_len_missing),
        builtin(3826, "pg_read_file_all", 1, false, false, fc_pg_read_file_all),
        builtin(6208, "pg_read_file_all_missing", 2, false, false, fc_pg_read_file_all_missing),
        builtin(3827, "pg_read_binary_file_off_len", 3, false, false, fc_pg_read_binary_file_off_len),
        builtin(3295, "pg_read_binary_file_off_len_missing", 4, false, false, fc_pg_read_binary_file_off_len_missing),
        builtin(3828, "pg_read_binary_file_all", 1, false, false, fc_pg_read_binary_file_all),
        builtin(6209, "pg_read_binary_file_all_missing", 2, false, false, fc_pg_read_binary_file_all_missing),
        // ---- partitionfuncs.c ----
        builtin(3424, "pg_partition_root", 1, false, false, fc_pg_partition_root),
        // ---- lockfuncs.c: advisory locks (int8) ----
        builtin(2880, "pg_advisory_lock_int8", 1, false, false, fc_pg_advisory_lock_int8),
        builtin(2881, "pg_advisory_lock_shared_int8", 1, false, false, fc_pg_advisory_lock_shared_int8),
        builtin(2882, "pg_try_advisory_lock_int8", 1, false, false, fc_pg_try_advisory_lock_int8),
        builtin(2883, "pg_try_advisory_lock_shared_int8", 1, false, false, fc_pg_try_advisory_lock_shared_int8),
        builtin(2884, "pg_advisory_unlock_int8", 1, false, false, fc_pg_advisory_unlock_int8),
        builtin(2885, "pg_advisory_unlock_shared_int8", 1, false, false, fc_pg_advisory_unlock_shared_int8),
        builtin(3089, "pg_advisory_xact_lock_int8", 1, false, false, fc_pg_advisory_xact_lock_int8),
        builtin(3090, "pg_advisory_xact_lock_shared_int8", 1, false, false, fc_pg_advisory_xact_lock_shared_int8),
        builtin(3091, "pg_try_advisory_xact_lock_int8", 1, false, false, fc_pg_try_advisory_xact_lock_int8),
        builtin(3092, "pg_try_advisory_xact_lock_shared_int8", 1, false, false, fc_pg_try_advisory_xact_lock_shared_int8),
        // ---- lockfuncs.c: advisory locks (int4, int4) ----
        builtin(2886, "pg_advisory_lock_int4", 2, false, false, fc_pg_advisory_lock_int4),
        builtin(2887, "pg_advisory_lock_shared_int4", 2, false, false, fc_pg_advisory_lock_shared_int4),
        builtin(2888, "pg_try_advisory_lock_int4", 2, false, false, fc_pg_try_advisory_lock_int4),
        builtin(2889, "pg_try_advisory_lock_shared_int4", 2, false, false, fc_pg_try_advisory_lock_shared_int4),
        builtin(2890, "pg_advisory_unlock_int4", 2, false, false, fc_pg_advisory_unlock_int4),
        builtin(2891, "pg_advisory_unlock_shared_int4", 2, false, false, fc_pg_advisory_unlock_shared_int4),
        builtin(3093, "pg_advisory_xact_lock_int4", 2, false, false, fc_pg_advisory_xact_lock_int4),
        builtin(3094, "pg_advisory_xact_lock_shared_int4", 2, false, false, fc_pg_advisory_xact_lock_shared_int4),
        builtin(3095, "pg_try_advisory_xact_lock_int4", 2, false, false, fc_pg_try_advisory_xact_lock_int4),
        builtin(3096, "pg_try_advisory_xact_lock_shared_int4", 2, false, false, fc_pg_try_advisory_xact_lock_shared_int4),
