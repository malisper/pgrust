...
//! bodies here operate directly on the owned [`types_spgist`] vocabulary structs,
...
//! reuse the ported implementations in [`backend_utils_adt_network`].
//!
...
use backend_utils_adt_network::{bitncmp, bitncommon, cidr_set_masklen_internal};
use mcx::Mcx;
