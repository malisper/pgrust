...
/// [`backend_utils_adt_network_seams::sortsupport`] seam together with
...
/// [`backend_utils_adt_network_seams::sortsupport::register`] seam. The pure
