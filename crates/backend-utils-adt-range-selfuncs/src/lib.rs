...
use backend_utils_adt_selfuncs_seams::release_variable_stats;
...
fn lookup_null_empty_frac(
    ...
    if let Some(stats_tuple) = vardata.stats_tuple {
        let null_frac =
            backend_utils_adt_selfuncs_seams::stats_tuple_stanullfrac::call(stats_tuple);
...
pub(crate) fn calc_hist_prologue<'mcx>(
    ...
    use backend_utils_adt_selfuncs_seams::statistic_proc_security_check;
