...
use backend_utils_adt_multirangetypes_seams as mr_seams;
...
///
/// The signature matches [`types_statistics::AnalyzeAttrComputeStatsFunc`] so
...
pub fn compute_range_stats<'mcx>(
    ...
    fetchfunc: types_statistics::AnalyzeAttrFetchFunc,
    samplerows: i32,
    _totalrows: f64,
) {
