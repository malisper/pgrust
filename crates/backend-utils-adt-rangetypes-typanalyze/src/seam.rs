...
pub fn init_seams() {
    ...
    backend_utils_adt_rangetypes_typanalyze_seams::range_typanalyze::set(range_typanalyze_seam);
    backend_utils_adt_rangetypes_typanalyze_seams::multirange_typanalyze::set(
