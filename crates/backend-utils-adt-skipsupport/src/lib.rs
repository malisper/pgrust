...
//!     through `backend_utils_cache_lsyscache_seams::get_opfamily_proc`.
//!
...
//!     function OID, through `backend_access_nbt_compare_seams::run_skipsupport`
...
//! via `backend_utils_adt_skipsupport_seams::prepare_skip_support_from_opclass`,
...
use backend_utils_adt_skipsupport_seams as seams;
