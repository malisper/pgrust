...
use backend_utils_hash_small_seams as crc;
use mcx::{vec_with_capacity_in, Mcx, PgVec};
use types_error::{PgError, PgResult, ERRCODE_FEATURE_NOT_SUPPORTED};
use types_reloptions::local_relopts;
use types_tsearch::tsearch::{ExecPhraseData, QueryItem, QueryOperand, TSTernaryValue, TS_EXEC_PHRASE_NO_POS};
use types_tsearch::tsgistidx::{
