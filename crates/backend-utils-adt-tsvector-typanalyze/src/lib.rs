...
use types_statistics::{AnalyzeAttrFetchFunc, VacAttrStats, STATISTIC_NUM_SLOTS};
...
pub fn init_seams() {
    backend_utils_adt_tsvector_typanalyze_seams::ts_typanalyze::set(ts_typanalyze);
}
