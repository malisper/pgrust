...
pub fn register_varbit_builtins() {
    backend_utils_fmgr_core::register_builtins([
        ...
        builtin(1666, "varbiteq", 2, true, false, fc_biteq),
        builtin(1667, "varbitne", 2, true, false, fc_bitne),
        builtin(1671, "varbitlt", 2, true, false, fc_bitlt),
        builtin(1670, "varbitle", 2, true, false, fc_bitle),
        builtin(1669, "varbitgt", 2, true, false, fc_bitgt),
        builtin(1668, "varbitge", 2, true, false, fc_bitge),
        builtin(1672, "varbitcmp", 2, true, false, fc_bitcmp),
        // bitwise logical / shift / concat
        builtin(1673, "bitand", 2, true, false, fc_bitand),
        builtin(1674, "bitor", 2, true, false, fc_bitor),
