...
fn DecodeTextArrayToBitmapset<'mcx>(
    ...
    //     pfree(str);
    // }
    let mut bms: Option<mcx::PgBox<'mcx, types_nodes::Bitmapset<'mcx>>> = None;
...
fn InvalidateEventCacheCallback(_arg: types_datum::datum::Datum, _cacheid: i32, _hashvalue: u32) {
...
pub fn init_seams() {
    backend_utils_cache_evtcache_seams::event_cache_lookup::set(EventCacheLookup);
}
