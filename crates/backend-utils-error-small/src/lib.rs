...
use backend_utils_error::{backend_log_context, config, reset_formatted_start_time};
...
pub fn init_seams() {
    backend_utils_error_small_seams::write_csvlog::set(write_csvlog);
    backend_utils_error_small_seams::write_jsonlog::set(write_jsonlog);
}
