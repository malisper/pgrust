...
//! ([`backend_utils_misc_guc_tables::GucSlot`]). Core GUCs declare those slots as
...
pub fn mark_guc_prefix_reserved(class_name: &str) {
    ...
    crate::live::with_store_mut(|reg| {
        ...
        for victim in to_remove {
            ...
            let e = backend_utils_error::ereport(WARNING)
...
leak_hook!(leak_check_bool, backend_utils_misc_guc_tables::GucBoolCheckHook, GucBoolCheckFn);
leak_hook!(leak_assign_bool, backend_utils_misc_guc_tables::GucBoolAssignHook, GucBoolAssignFn);
leak_hook!(leak_check_int, backend_utils_misc_guc_tables::GucIntCheckHook, GucIntCheckFn);
leak_hook!(leak_assign_int, backend_utils_misc_guc_tables::GucIntAssignHook, GucIntAssignFn);
leak_hook!(leak_check_real, backend_utils_misc_guc_tables::GucRealCheckHook, GucRealCheckFn);
leak_hook!(leak_assign_real, backend_utils_misc_guc_tables::GucRealAssignHook, GucRealAssignFn);
leak_hook!(leak_check_string, backend_utils_misc_guc_tables::GucStringCheckHook, GucStringCheckFn);
leak_hook!(leak_assign_string, backend_utils_misc_guc_tables::GucStringAssignHook, GucStringAssignFn);
leak_hook!(leak_check_enum, backend_utils_misc_guc_tables::GucEnumCheckHook, GucEnumCheckFn);
leak_hook!(leak_assign_enum, backend_utils_misc_guc_tables::GucEnumAssignHook, GucEnumAssignFn);
leak_hook!(leak_show, backend_utils_misc_guc_tables::GucShowHook, GucShowFn);
