...
pub fn init_seams() {
    backend_utils_mmgr_freepage_seams::free_page_manager_initialize::set(
        free_page_manager_initialize,
    );
    backend_utils_mmgr_freepage_seams::free_page_manager_get::set(free_page_manager_get);
    backend_utils_mmgr_freepage_seams::free_page_manager_put::set(free_page_manager_put);
}
