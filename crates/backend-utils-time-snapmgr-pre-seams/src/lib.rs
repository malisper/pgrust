...
//! [`types_execparallel::SnapshotHandle`] (inherited opacity,
...
seam_core::seam!(
    ...
    /// [`types_execparallel::SnapshotHandle`] the consumer hands to
    /// `PortalStart`.
    pub fn get_active_snapshot() -> Option<types_execparallel::SnapshotHandle>
);
