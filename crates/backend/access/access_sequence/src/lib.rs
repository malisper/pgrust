...
pub fn init_seams() {
    sequence_seams::sequence_open::set(sequence_open);
    sequence_seams::sequence_close::set(sequence_close);
}
...
pub fn sequence_open<'mcx>(
    ...
    let r = common_relation_seams::relation_open::call(mcx, relationId, lockmode)?;
