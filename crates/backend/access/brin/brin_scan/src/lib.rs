...
fn brinbuild_am<'mcx>(
    ...
    insert_vacuum_seams::brinbuild::call(
        mcx,
        heap_relation,
        index_relation,
        index_info,
...
fn brinbuildempty_am<'mcx>(mcx: Mcx<'mcx>, index_relation: &Relation<'mcx>) -> PgResult<()> {
    insert_vacuum_seams::brinbuildempty::call(mcx, index_relation)
}
...
pub fn brinoptions(
    ...
    reloptions_seams::build_reloptions_brin::call(reloptions, validate)
}
...
fn bringetbitmap_am<'mcx>(
    ...
    // over the concrete `tidbitmap::TIDBitmap`. Downcast it.
    let tbm_concrete = tbm
        .payload
        .as_mut()
        .and_then(|p| p.downcast_mut::<tidbitmap::TIDBitmap>())
...
fn brininsert_am<'mcx>(
    ...
    insert_vacuum_seams::brininsert::call(
        mcx,
        index_relation,
        values,
        isnull,
...
fn brininsertcleanup_am<'mcx>(
    ...
    insert_vacuum_seams::brininsertcleanup::call(
        mcx,
        index_relation,
        index_info,
    )
...
fn brinbulkdelete_am<'mcx>(
    ...
    insert_vacuum_seams::brinbulkdelete::call(
        mcx,
        info,
        stats,
        callback_state,
...
fn brinvacuumcleanup_am<'mcx>(
    ...
    insert_vacuum_seams::brinvacuumcleanup::call(mcx, info, stats)
}
...
pub fn bringetbitmap<'mcx>(
    ...
    pgstat_count_index_scan::call(idx_rel.rd_id, idx_rel.rd_rel.relisshared, idx_rel.pgstat_enabled);
