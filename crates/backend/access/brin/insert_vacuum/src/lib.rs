...
//!
//! This is the F3 partner of the F2 scan crate ([`brin_scan`]):
...
//! [`insert_vacuum_seams`] this crate installs in
        ...
        for keyno in 0..natts {
            ...
            if !b_allnulls {
                for i in 0..nstored {
                    ...
                    let v = scalar_seams::datum_copy::call(
                        mcx,
...
pub fn init_seams() {
    use insert_vacuum_seams as seams;
