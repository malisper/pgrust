...
use misc2_seams as eoh_seam;
use pglz_seams as pglz_seam;
...
pub fn init_seams() {
    detoast_seams::detoast_external_attr::set(detoast_external_attr);
    detoast_seams::detoast_attr::set(detoast_attr);
    detoast_seams::pg_detoast_datum_packed::set(pg_detoast_datum_packed);
    detoast_seams::toast_datum_size::set(toast_datum_size_seam);
    detoast_seams::toast_raw_datum_size::set(toast_raw_datum_size_seam);
    detoast_seams::toast_chunk_id::set(toast_chunk_id);
    detoast_seams::pg_varsize_any::set(pg_varsize_any);
}
