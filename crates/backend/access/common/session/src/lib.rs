...
fn init_shared_record_typmod_registry(
    ...
    typcache_seams::shared_registry_import::call(
...
fn attach_shared_record_typmod_registry(
    ...
    typcache_seams::shared_registry_attach_check::call()?;
...
fn find_or_make_matching_shared_tupledesc<'mcx>(
    ...
    typcache_seams::find_or_make_matching_shared_tupledesc::call(
        mcx,
        tupdesc,
        record_table,
        typmod_table,
...
fn shared_typmod_table_find<'mcx>(
    ...
    typcache_seams::shared_typmod_table_find::call(
        mcx,
        typmod,
        typmod_table,
        area,
...
pub fn init_seams() {
    session_seams::initialize_session::set(initialize_session);
    session_seams::get_session_dsm_handle::set(get_session_dsm_handle);
    session_seams::shared_registry_estimate::set(shared_registry_estimate);
    session_seams::shared_registry_attached::set(shared_registry_attached);
    session_seams::find_or_make_matching_shared_tupledesc::set(
        find_or_make_matching_shared_tupledesc,
    );
    session_seams::shared_typmod_table_find::set(shared_typmod_table_find);
    ...
    parallel_rt_seams::attach_session::set(attach_session);
    parallel_rt_seams::detach_session::set(detach_session);
}
