...
pub fn hashhandler() -> IndexAmRoutine {
    IndexAmRoutine {
        ...
        // needs the real `nodes::execnodes::IndexInfo<'mcx>` which the
...
pub fn hashbuild<'mcx>(
    ...
    let (_relpages, reltuples, _allvisfrac) =
        plancat_seams::estimate_rel_size::call(heap)?;
    ...
    if index.rd_rel.relpersistence != RELPERSISTENCE_TEMP {
        ...
        let nloc = init_small_seams::nloc_buffer::call() as usize;
...
pub fn hashbuildempty(index: &rel::Relation) -> PgResult<()> {
...
fn hashbuildempty_am<'mcx>(_mcx: Mcx<'mcx>, index_relation: &rel::Relation<'mcx>) -> PgResult<()> {
...
pub fn hashgetbitmap<'mcx>(
    ...
    while res {
        ...
        nodes_core_seams::tbm_add_tuples::call(&mut *tbm, &[heap_tid], true)?;
        ntids += 1;
...
pub fn hashbulkdelete<'mcx>(
    ...
    // XLOG stuff
    if relcache_seams::relation_needs_wal::call(rel) {
        ...
        xloginsert_seams::xlog_register_data::call(&xlrec)?;
        xloginsert_seams::xlog_register_buffer::call(
    ...
    loop {
        ...
        if ndeletable > 0 {
            ...
            if relcache_seams::relation_needs_wal::call(rel) {
                ...
                xloginsert_seams::xlog_register_buf_data::call(1, &offs)?;
...
pub fn init_seams() {
    hash_entry_seams::hashbucketcleanup_split_cleanup::set(
