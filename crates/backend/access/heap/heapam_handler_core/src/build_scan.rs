...
pub fn heapam_index_build_range_scan<'mcx>(
    ...
    let slot_data = table_tableam::table_slot_create(mcx, heap_relation)?;
    ...
    if !miscinit::IsBootstrapProcessingMode() && !index_info.ii_Concurrent {
        oldest_xmin = procarray_seams::get_oldest_non_removable_transaction_id::call(
            heap_relation.rd_id,
        )?;
    }
    ...
    loop {
        ...
        if cblock != root_blkno {
            ...
            root_offsets = pruneheap_seams::heap_get_root_tuples::call(mcx, cbuf)?;
        ...
        if is_heap_only {
            ...
            let offnum = page::ItemPointerGetOffsetNumber(&t_self);
            ...
            if !offset_number_is_valid(root_off) {
                return Err(ereport(ERROR)
                    ...
                    .errmsg_internal(format!(
                        ...
                        page::ItemPointerGetBlockNumber(&t_self),
                        offnum,
                        rel_name(heap_relation),
                    ))
                    .into_error());
...
fn classify_vacuum_result<'mcx>(
    ...
    Ok(match htsv {
        ...
        HEAPTUPLE_INSERT_IN_PROGRESS => {
            ...
            if !transam_xact_seams::transaction_id_is_current_transaction_id::call(xwait)
            {
