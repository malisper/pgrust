...
pub fn init_seams() {
    heaptoast_seams::toast_flatten_tuple_to_datum::set(
        toast_flatten_tuple_to_datum,
    );
    heaptoast_seams::toast_flatten_tuple::set(toast_flatten_tuple);
    // The composite/record-Datum carrier bridge (task #161) is now buildable.
    heaptoast_seams::heap_tuple_header_get_datum::set(
