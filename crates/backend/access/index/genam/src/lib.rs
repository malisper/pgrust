...
fn systable_inplace_update<'mcx>(
    ...
    loop {
        ...
        let locked = {
            ...
            heapam_seams::heap_inplace_lock::call(
                mcx,
                &heap_rel,
                &oldtup.tuple,
                buffer,
        ...
        if dirty {
            ...
            heapam_seams::heap_inplace_update_and_unlock::call(
                mcx,
                &heap_rel,
                &oldtup.tuple,
                &newtuple.tuple,
            ...
            heapam_seams::heap_inplace_unlock::call(
                &heap_rel,
                &oldtup.tuple,
                buffer,
            )?;
