...
use nbtree_core_seams as seams;
...
pub fn init_seams() {
    ...
    nbtree_seams_2::btree_shmem_size::set(utils::bt_shmem_size);
    nbtree_seams_2::btree_shmem_init::set(utils::bt_shmem_init);
    ...
    build_seams::bt_truncate::set(|mcx, rel, lastleft, firstright, itup_key| {
        utils::bt_truncate(
            mcx,
            rel,
            lastleft,
    ...
    build_seams::bt_check_third_page::set(utils::bt_check_third_page);
    build_seams::bt_load_compare_index_tuples::set(
