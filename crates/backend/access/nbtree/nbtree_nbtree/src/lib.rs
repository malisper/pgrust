...
// `nodes::execnodes::IndexInfo<'mcx>` type-erased and downcastable. But
...
fn vacuum_tid_is_dead(tid: ItemPointerData, callback_state_handle: u64) -> bool {
    vacuum_seams::vacuum_tid_is_dead::call(tid, callback_state_handle)
}
...
pub fn init_seams() {
    nbtree_seams::bt_parallel_seize::set(seam_bt_parallel_seize);
    nbtree_seams::bt_parallel_release::set(seam_bt_parallel_release);
    nbtree_seams::bt_parallel_done::set(seam_bt_parallel_done);
    nbtree_seams::bt_parallel_primscan_schedule::set(
