...
use kdtree as kd;
use text as text;
use geo_spgist_only as boxq;
use network_spgist as inet;
use rangetypes_spgist as range;
...
pub fn init_seams() {
    spg_core_seams::spg_config::set(dispatch_config);
    spg_core_seams::spg_choose::set(dispatch_choose);
    spg_core_seams::spg_picksplit::set(dispatch_picksplit);
    spg_core_seams::spg_inner_consistent::set(dispatch_inner_consistent);
    spg_core_seams::spg_leaf_consistent::set(dispatch_leaf_consistent);
}
