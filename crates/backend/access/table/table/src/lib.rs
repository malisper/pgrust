...
pub fn init_seams() {
    ...
    table_seams::relation_close::set(relation_close);
}
...
pub fn try_table_open<'mcx>(
    ...
    let r =
        common_relation_seams::try_relation_open::call(mcx, relationId, lockmode)?;
...
pub fn table_openrv<'mcx>(
    ...
    let r = common_relation_seams::relation_openrv::call(mcx, relation, lockmode)?;
...
pub fn table_openrv_extended<'mcx>(
    ...
    let r = common_relation_seams::relation_openrv_extended::call(
