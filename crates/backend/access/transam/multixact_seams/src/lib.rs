...
seam_core::seam!(
    ...
    pub fn get_multi_xact_id_members<'mcx>(
        ...
        mcx::PgVec<'mcx, xlog_records::multixact::MultiXactMember>,
    >
);
...
seam_core::seam!(
    ...
    pub fn multi_xact_id_create_from_members(
        members: &[xlog_records::multixact::MultiXactMember],
...
seam_core::seam!(
    ...
    pub fn multi_xact_id_create(
        ...
        status1: xlog_records::multixact::MultiXactStatus,
        xid2: types_core::primitive::TransactionId,
        status2: xlog_records::multixact::MultiXactStatus,
    ) -> types_error::PgResult<types_core::primitive::MultiXactId>
);
...
seam_core::seam!(
    ...
    pub fn multi_xact_id_expand(
        ...
        status: xlog_records::multixact::MultiXactStatus,
    ) -> types_error::PgResult<types_core::primitive::MultiXactId>
);
...
seam_core::seam!(
    ...
    pub fn multixact_redo(
        record: &mut wal::rmgr::XLogReaderState<'_>,
    ) -> types_error::PgResult<()>
);
