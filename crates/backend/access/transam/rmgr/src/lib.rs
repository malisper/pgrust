...
use brindesc_seams as brindesc;
use clogdesc_seams as clogdesc;
use committsdesc_seams as committsdesc;
use dbasedesc_seams as dbasedesc;
use genericdesc_seams as genericdesc;
use gindesc_seams as gindesc;
use gistdesc_seams as gistdesc;
use hashdesc_seams as hashdesc;
use heapdesc_seams as heapdesc;
use logicalmsgdesc_seams as logicalmsgdesc;
use mxactdesc_seams as mxactdesc;
use nbtdesc_seams as nbtdesc;
use relmapdesc_seams as relmapdesc;
use replorigindesc_seams as replorigindesc;
use seqdesc_seams as seqdesc;
use smgrdesc_seams as smgrdesc;
use spgdesc_seams as spgdesc;
use standbydesc_seams as standbydesc;
use tblspcdesc_seams as tblspcdesc;
use xactdesc_seams as xactdesc;
use xlogdesc_seams as xlogdesc;
use spg_xlog_seams as spgxlog;
use clog_seams as clog;
use commit_ts_seams as commit_ts;
use generic_xlog_seams as generic_xlog;
...
use sequence_seams_2 as sequence;
use tablespace_seams as tablespace;
use decode_seams as decode;
use message_seams as message;
