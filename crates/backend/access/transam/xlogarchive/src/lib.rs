...
use archive_seams as common_archive;
use wait_error_seams as wait_error;
...
pub fn ExecuteRecoveryCommand<'mcx>(
    ...
    let xlogRecoveryCmd = percentrepl::replace_percent_placeholders(
        mcx,
        command,
        commandName,
