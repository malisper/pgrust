...
pub fn init_seams() {
    catalog_seams::is_pinned_object::set(IsPinnedObject);
    ...
    catalog_seams::is_catalog_namespace::set(IsCatalogNamespace);
    catalog_seams::is_toast_namespace::set(IsToastNamespace);
    catalog_seams::is_reserved_name::set(|name| Ok(IsReservedName(&name)));
    catalog_seams::is_system_relation::set(is_system_relation_seam);
    catalog_seams::is_system_class::set(is_system_class_seam);
    catalog_seams::is_system_class_by_namespace::set(IsSystemClassByNamespace);
    catalog_seams::get_new_relfilenumber::set(get_new_relfilenumber_seam);
    catalog_seams::relation_invalidates_snapshots_only::set(
