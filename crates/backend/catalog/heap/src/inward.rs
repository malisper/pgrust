...
fn relation_clear_missing_seam(rel: &rel::Relation<'_>) -> PgResult<()> {
...
pub fn init_seams() {
    plancat_ext_seams::system_attribute_definition::set(
    ...
    syscache_seams::clear_attribute_has_default::set(
    ...
    tablecmds_seams::add_relation_new_constraints::set(
        crate::AddRelationNewConstraints,
    );
    tablecmds_seams::add_relation_not_null_constraints::set(
    ...
    tablecmds_seams::heap_truncate_find_fks::set(crate::heap_truncate_find_FKs);
    tablecmds_seams::heap_truncate_check_fks::set(heap_truncate_check_fks_seam);
    ...
    tablecmds_seams::heap_truncate_one_rel::set(crate::truncate::heap_truncate_one_rel);
    tablecmds_seams::heap_truncate::set(crate::truncate::heap_truncate);
}
