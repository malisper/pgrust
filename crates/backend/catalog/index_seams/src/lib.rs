...
pub struct IndexCreateArgs<'mcx> {
    ...
    /// `IndexInfo *indexInfo`.
    pub index_info: nodes::execnodes::IndexInfo<'mcx>,
...
seam_core::seam!(
    ...
    ) -> types_error::PgResult<nodes::execnodes::IndexInfo<'mcx>>
);
...
seam_core::seam!(
    ...
    /// [`types_tuple::heaptuple::Datum`] so a
    ...
    pub fn form_index_datum<'mcx>(
        index_info: &nodes::execnodes::IndexInfo<'_>,
        slot: nodes::execnodes::SlotId,
