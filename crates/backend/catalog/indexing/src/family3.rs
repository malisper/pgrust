...
fn build_text_array<'mcx>(mcx: Mcx<'mcx>, strs: &[std::string::String]) -> PgResult<Datum<'mcx>> {
    ...
    let buf = arrayfuncs::construct::build_text_array(mcx, &refs)?;
    Ok(Datum::ByRef(buf))
}
...
/// [`crate::init_seams`].
pub fn install() {
    indexing_seams::catalog_tuple_insert_pg_policy::set(
        catalog_tuple_insert_pg_policy,
    );
    indexing_seams::catalog_tuple_insert_pg_trigger::set(
        catalog_tuple_insert_pg_trigger,
    );
    indexing_seams::catalog_tuple_insert_pg_event_trigger::set(
        catalog_tuple_insert_pg_event_trigger,
    );
    indexing_seams::catalog_tuple_update_pg_event_trigger_enabled::set(
        catalog_tuple_update_pg_event_trigger_enabled,
    );
    indexing_seams::catalog_tuple_update_pg_event_trigger_owner::set(
        catalog_tuple_update_pg_event_trigger_owner,
    );
    indexing_seams::catalog_tuple_update_pg_policy::set(
        catalog_tuple_update_pg_policy,
    );
    indexing_seams::rename_policy_tuple::set(rename_policy_tuple);
    indexing_seams::catalog_tuple_insert_pg_class::set(
        catalog_tuple_insert_pg_class,
    );
    indexing_seams::catalog_insert_pg_attribute_tuples::set(
        catalog_insert_pg_attribute_tuples,
    );
    indexing_seams::append_attribute_tuples::set(append_attribute_tuples);
    indexing_seams::catalog_tuple_update_pg_attribute::set(
        catalog_tuple_update_pg_attribute,
    );
    indexing_seams::catalog_tuple_update_relchecks_pg_class::set(
        catalog_tuple_update_relchecks_pg_class,
    );
    indexing_seams::catalog_tuple_update_relowner_pg_class::set(
        catalog_tuple_update_relowner_pg_class,
    );
    indexing_seams::catalog_tuple_insert_pg_attrdef::set(
        catalog_tuple_insert_pg_attrdef,
    );
    indexing_seams::catalog_tuple_insert_pg_index::set(
