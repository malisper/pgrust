...
pub fn init_seams() {
    use objectaddress_seams as seams;
    ...
    syscache_seams::rewrite_class_name::set(
        rewrite_lookup::rewrite_class_name,
    );
    syscache_seams::rewrite_name_evclass::set(
    ...
    syscache_seams::trigger_relid_name::set(
        trigger_lookup::trigger_relid_name,
    );
    syscache_seams::trigger_name_relid::set(
    ...
    syscache_seams::auth_member_member_role::set(
    ...
    syscache_seams::amop_description_row::set(
        amop_amproc_lookup::amop_description_row,
    );
    syscache_seams::amproc_description_row::set(
    ...
    syscache_seams::amop_identity::set(
        amop_amproc_lookup::amop_identity,
    );
    syscache_seams::amproc_identity::set(
    ...
    syscache_seams::policy_relid_name::set(
