...
fn register_constraint_inval_callback() -> PgResult<()> {
    inval_pc_seams::register_syscache_callback::call(
...
fn constraint_inval_callback_adapter(_cacheid: i32, hashvalue: u32) {
    ri_triggers_seams::invalidate_constraint_cache_callback::call(hashvalue)
}
...
pub fn init_seams() {
    use pg_constraint_seams as seams;
    ...
    domains_seams::scan_domain_check_constraints::set(
