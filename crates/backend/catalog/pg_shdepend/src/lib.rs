...
use init_small_seams as miscadmin_seams;
...
pub fn init_seams() {
    use pg_shdepend_seams as seams;
    ...
    user_seams::shdep_drop_owned::set(|role_ids, behavior| {
        shdepDropOwned(&role_ids, behavior)
    });
    user_seams::shdep_reassign_owned::set(|role_ids, newrole| {
