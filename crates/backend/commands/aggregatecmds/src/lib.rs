...
/// `TypeName` (`opclass`) that the `parse_type.c` seams
...
pub fn DefineAggregate(
    ...
    let parameterDefaults: functioncmds_seams::CookedParameterDefaults;
    ...
    if oldstyle {
        ...
        parameterModes = None;
        parameterNames = None;
        parameterDefaults = functioncmds_seams::CookedParameterDefaults::default();
