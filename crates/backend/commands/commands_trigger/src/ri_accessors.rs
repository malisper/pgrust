...
fn with_tg_relation<R>(
    what: &str,
    f: impl FnOnce(&rel::Relation<'static>) -> R,
) -> PgResult<R> {
...
#[inline]
fn att_index(rel: &rel::Relation<'static>, attnum: i16) -> usize {
...
pub fn init_seams() {
    ...
    fmgr_seams::render_slot_columns::set(
