...
use pg_shdepend_seams as shdepend;
use dbcommands_seams as dbcommands;
use event_trigger_seams as event_trigger;
use transam_xact_seams as xact;
use parse_utilcmd_seams as parse_utilcmd;
use utility_fc_seams as utility;
...
/// [`schemacmds_seams`] and the `create_schema_command`
