...
//! the [`tablecmds_seams`] outward seams (MergeAttributes /
...
pub fn init_seams() {
    ...
    partbounds_seams::check_default_partition_contents::set(
        |mcx, parent_data, default_data, new_spec| {
            ...
            let default_rel =
                common_relation::relation_open(mcx, default_data.rd_id, NoLock)?;
    ...
    createas_seams::create_ctas_relation::set(create::create_ctas_relation);
    ...
    index_seams::check_relation_table_space_move::set(
    ...
    tablecmds_seams::alter_relation_namespace_internal::set(
    ...
    parse_utilcmd_outward_seams::transformPartitionBound::set(
    ...
    utility_out_seams::execute_truncate::set(execute_truncate_arm);
    utility_out_seams::remove_relations::set(remove_relations_arm);
    ...
    utility_out_seams::define_relation::set(create::define_relation);
    ...
    utility_out_seams::create_toast_for_relation::set(create::create_toast_for_relation);

    // --- ProcessUtilitySlow ALTER TABLE arm (utility.c:1270-1331) ---
    utility_out_seams::alter_table_slow::set(alter_table_slow_arm);

    // --- ProcessUtilitySlow ALTER ... ALL IN TABLESPACE arm (utility.c:1767) ---
    utility_out_seams::alter_table_move_all::set(alter_table_move_all_arm);
...
fn alter_table_slow_arm<'mcx>(
    ...
    if OidIsValid(relid) {
        ...
        utility_out_seams::event_trigger_alter_table_start::call(parsetree)?;
        utility_out_seams::event_trigger_alter_table_relid::call(relid);
