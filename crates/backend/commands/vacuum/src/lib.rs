...
use ::mcx::Mcx;
use ::tableam_vocab::{
    VacOptValue, VacuumCutoffs, VacuumParams, VACOPT_DISABLE_PAGE_SKIPPING, VACOPT_FREEZE,
    VACOPT_FULL, VACOPT_ONLY_DATABASE_STATS, VACOPT_PROCESS_MAIN, VACOPT_PROCESS_TOAST,
...
pub fn ExecVacuum<'mcx>(
    ...
    for opt_node in vacstmt.options.iter() {
        ...
        match opt.defname.unwrap_or("") {
            ...
            name @ ("analyze" | "process_main" | "process_toast" | "parallel"
