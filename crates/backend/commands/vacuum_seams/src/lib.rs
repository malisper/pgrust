...
seam_core::seam!(pub fn def_get_int32(defname: String, arg: Option<define_seams::DefElemArg>) -> PgResult<i32>);
seam_core::seam!(
    ...
    pub fn def_get_string_text(defname: String, arg: Option<define_seams::DefElemArg>) -> PgResult<String>
);
seam_core::seam!(
