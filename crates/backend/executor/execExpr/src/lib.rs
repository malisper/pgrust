...
//!
//! [`ExprEvalStep`]: nodes::execexpr::ExprEvalStep
//! [`ExprState`]: nodes::execexpr::ExprState
//! [`ProjectionInfo`]: nodes::execexpr::ProjectionInfo
...
pub fn init_seams() {
    ...
    inherit_predtest_seams::eval_const_test::set(
    ...
    clauses_seams::evaluate_expr_fallback::set(
    ...
    domains_seams::exec_init_expr::set(execExpr_domain::exec_init_expr);
    domains_seams::domain_check_exec::set(execExpr_domain::domain_check_exec);
    domains_seams::free_ctx_exprstates::set(
