...
pub fn init_seams() {
    execExprInterp_seams::exec_ready_interpreted_expr::set(
        dispatch::ExecReadyInterpretedExpr,
    );
    execExprInterp_seams::exec_eval_expr_switch_context::set(
        dispatch::ExecInterpExprStillValid,
    );
    execExprInterp_seams::exec_eval_expr_no_return::set(
