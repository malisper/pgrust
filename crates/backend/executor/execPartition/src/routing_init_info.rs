...
pub(crate) fn ExecInitPartitionInfo<'mcx>(
    ...
    let on_conflict_action =
        nodeModifyTable_seams::exec_get_on_conflict_action::call(mtstate);
    ...
    let partrel =
        common_relation_seams::relation_open::call(mcx, part_oid, RowExclusiveLock)?;
    ...
    nodeModifyTable_seams::exec_open_partition_indices::call(
        mcx,
        mtstate,
        estate,
        leaf_part_rri_id,
    ...
    nodeModifyTable_seams::exec_init_partition_with_check_options::call(
        mcx,
        mtstate,
        estate,
        leaf_part_rri_id,
    ...
    nodeModifyTable_seams::exec_init_partition_returning::call(
        mcx,
        mtstate,
        estate,
        leaf_part_rri_id,
    ...
    // clause).
    nodeModifyTable_seams::exec_init_partition_on_conflict::call(
        mcx,
        mtstate,
        estate,
        leaf_part_rri_id,
    ...
    nodeModifyTable_seams::exec_init_partition_merge::call(
        mcx,
        mtstate,
        estate,
        leaf_part_rri_id,
