...
seam_core::seam!(
    ...
    pub fn exec_init_node<'mcx>(
        mcx: mcx::Mcx<'mcx>,
        node: Option<&'mcx nodes::nodes::Node<'mcx>>,
        estate: &mut nodes::EStateData<'mcx>,
        eflags: i32,
    ) -> types_error::PgResult<Option<mcx::PgBox<'mcx, nodes::PlanStateNode<'mcx>>>>
);
...
seam_core::seam!(
    ...
    pub fn exec_proc_node<'mcx>(
        node: &mut nodes::PlanStateNode<'mcx>,
        estate: &mut nodes::EStateData<'mcx>,
...
seam_core::seam!(
    ...
    pub fn multi_exec_proc_node<'mcx>(
        node: &mut nodes::PlanStateNode<'mcx>,
        estate: &mut nodes::EStateData<'mcx>,
    ) -> types_error::PgResult<mcx::PgBox<'mcx, tidbitmap::TIDBitmap>>
);
...
seam_core::seam!(
    ...
    pub fn exec_set_tuple_bound<'mcx>(
        ...
        child: &mut nodes::PlanStateNode<'mcx>,
        estate: &mut nodes::EStateData<'mcx>,
    ) -> types_error::PgResult<()>
);
