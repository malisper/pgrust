...
seam_core::seam!(
    ...
    /// the [`SetExprState`](nodes::execexpr::SetExprState) for a
    ...
    pub fn exec_init_function_result_set<'mcx>(
        ...
        mcx::PgBox<'mcx, nodes::execexpr::SetExprState<'mcx>>,
    >
);

seam_core::seam!(
    /// `RestartSetExprState(fcache)` (execSRF, owned-model addition): reset a
    /// [`SetExprState`](nodes::execexpr::SetExprState) abandoned mid
    ...
    pub fn restart_set_expr_state<'mcx>(
        fcache: &mut nodes::execexpr::SetExprState<'mcx>,
    ) -> types_error::PgResult<()>
);
...
seam_core::seam!(
    ...
    /// [`Datum`](types_tuple::heaptuple::Datum):
...
seam_core::seam!(
    ...
    /// [`Tuplestorestate`](nodes::funcapi::Tuplestorestate). This is the
    /// value-per-call / materialize-mode SRF execution loop that reads back the
    /// live [`ReturnSetInfo`](nodes::funcapi::ReturnSetInfo) the callee
    ...
    pub fn exec_make_table_function_result<'mcx>(
        setexpr: &mut nodes::execexpr::SetExprState<'mcx>,
        econtext: nodes::EcxtId,
        arg_context: &mut mcx::MemoryContext,
        expected_desc: &types_tuple::heaptuple::TupleDescData<'mcx>,
        random_access: bool,
        estate: &mut nodes::EStateData<'mcx>,
    ) -> types_error::PgResult<mcx::PgBox<'mcx, nodes::funcapi::Tuplestorestate<'mcx>>>
);
...
seam_core::seam!(
    ...
    ) -> types_error::PgResult<(types_tuple::heaptuple::Datum<'mcx>, bool)>
);
