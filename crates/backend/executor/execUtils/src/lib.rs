...
use execExpr_seams as execExpr_seams;
...
use jit_seams as jit_seams;
use nodes_core_seams as bms_seams;
use parser_relation_seams as parse_relation_seams;
...
pub fn init_seams() {
    ...
    execUtils_seams::create_executor_state::set(create_executor_state_in);
    execUtils_seams::free_executor_state::set(free_executor_state_in);

    execUtils_seams::exec_create_scan_slot_from_outer_plan::set(
        ExecCreateScanSlotFromOuterPlan,
    );
    execUtils_seams::exec_get_common_child_slot_ops::set(
        ExecGetCommonChildSlotOps,
    );
    execUtils_seams::exec_assign_expr_context::set(ExecAssignExprContext);
    execUtils_seams::create_expr_context::set(CreateExprContext);
    execUtils_seams::create_work_expr_context::set(CreateWorkExprContext);
    execUtils_seams::create_standalone_expr_context::set(
        CreateStandaloneExprContext,
    );
    execUtils_seams::exec_assign_projection_info::set(ExecAssignProjectionInfo);
    ...
    execUtils_seams::exec_open_scan_relation::set(|estate, scanrelid, eflags| {
        ...
        let is_parallel_worker = execUtils_seams::is_parallel_worker::call();
    ...
    execUtils_seams::exec_rt_fetch_rellockmode::set(|estate, scanrelid| {
    ...
    execUtils_seams::reset_expr_context::set(|estate, econtext| {
    ...
    execUtils_seams::reset_per_tuple_expr_context::set(|estate, ps| {
        let id = ps
            .ps_ExprContext
    ...
    execUtils_seams::re_scan_expr_context::set(|estate, econtext| {
    ...
    execUtils_seams::clear_agg_values::set(|estate, econtext, numaggs| {
    ...
    // use.
    execUtils_seams::get_per_tuple_expr_context::set(MakePerTupleExprContext);
    ...
    execParallel_support_seams::get_per_tuple_expr_context_owned::set(
    ...
    execUtils_seams::update_changed_param_set::set(|mcx, node, newchg| {
    ...
    execUtils_seams::exec_get_all_null_slot::set(ExecGetAllNullSlot);

    execUtils_seams::exec_get_result_slot_ops_isfixed::set(|planstate, estate| {
    ...
    execUtils_seams::exec_get_root_to_child_map::set(
    ...
    execUtils_seams::exec_get_updated_cols::set(|mcx, estate, rri| {
    ...
    execUtils_seams::exec_get_all_updated_cols::set(|mcx, estate, rri| {
    ...
    execUtils_seams::exec_get_common_slot_ops::set(
    ...
    execUtils_seams::exec_assign_scan_projection_info::set(
        ExecAssignScanProjectionInfo,
    );

    // `ExecAssignScanProjectionInfoWithVarno(node, varno)` (execScan.c): as
    // above, but the caller supplies the varno.
    execUtils_seams::exec_assign_scan_projection_info_with_varno::set(
