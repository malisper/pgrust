...
seam_core::seam!(
    ...
    pub fn create_executor_state<'mcx>(
        mcx: mcx::Mcx<'mcx>,
    ) -> types_error::PgResult<mcx::PgBox<'mcx, nodes::EStateData<'mcx>>>
);
...
seam_core::seam!(
    ...
    pub fn free_executor_state<'mcx>(
        estate: mcx::PgBox<'mcx, nodes::EStateData<'mcx>>,
...
seam_core::seam!(
    ...
    pub fn create_expr_context<'mcx>(
        estate: &mut nodes::EStateData<'mcx>,
    ) -> types_error::PgResult<nodes::EcxtId>
);
...
seam_core::seam!(
    ...
    /// the owned [`ExprContext`](nodes::execnodes::ExprContext) by value
    ...
    pub fn create_standalone_expr_context<'mcx>(
        mcx: mcx::Mcx<'mcx>,
    ) -> types_error::PgResult<nodes::execnodes::ExprContext<'mcx>>
);
...
seam_core::seam!(
    ...
    pub fn exec_get_common_slot_ops<'mcx>(
        planstates: &[Option<mcx::PgBox<'mcx, nodes::PlanStateNode<'mcx>>>],
        nplans: i32,
        estate: &nodes::EStateData<'mcx>,
    ) -> types_error::PgResult<Option<nodes::TupleSlotKind>>
);
...
seam_core::seam!(
    ...
    pub fn update_changed_param_set<'mcx>(
        mcx: mcx::Mcx<'mcx>,
        node: &mut nodes::execnodes::PlanStateData<'mcx>,
        newchg: &nodes::Bitmapset<'_>,
    ) -> types_error::PgResult<()>
);
...
seam_core::seam!(
    ...
    pub fn exec_get_common_child_slot_ops<'mcx>(
        ps: &nodes::execnodes::PlanStateData<'mcx>,
        estate: &nodes::EStateData<'mcx>,
    ) -> Option<nodes::TupleSlotKind>
);
