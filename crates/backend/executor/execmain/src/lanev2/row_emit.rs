...
//!
//! The CI cluster A/B ladder (GL-FUNNEL-1..4) proved the band: qualed selective
...
// with the CI cluster A/B, per the plan's migration discipline). Allow dead_code so
