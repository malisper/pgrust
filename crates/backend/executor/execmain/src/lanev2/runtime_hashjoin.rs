...
/// CI cluster A/B proves ≥ parity (the low-distinct/skew CAS-contention crossover
...
/// PROVENANCE (constants discipline, 2026-07-21): GL-HJSEAT-1 census (CI cluster
...
/// the CI cluster arms ride the env spelling).
#[cfg(test)]
#[allow(dead_code)]
