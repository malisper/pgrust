...
// (reference run-m0-parallel-accept.sh: `MORSEL|WFIN|qid=|pipe=|worker=|t_us=|
...
pub(super) fn try_own_plain_agg_runtime<'mcx>(
    ...
    // --- Engage.
    engage(agg, estate, rt, dop, total_granules, nrgs, source)
}
