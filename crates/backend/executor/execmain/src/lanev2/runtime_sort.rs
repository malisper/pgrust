...
pub(super) enum TopnLocal {
    ...
    // visibility is deliberate API shape; widening is a design decision deferred
...
/// every zonetopn/ladder leg, local + CI cluster jobs 61f2/3efc/5509 @
...
/// ~82ns/granule (0.2ms @ 2442 granules, CI cluster job 3efc @ 0296033fd,
...
/// the hostile/semi-hostile band the arm wins (CI cluster ladder @ 0296033fd,
