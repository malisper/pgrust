...
fn epq_fetch_row_mark<'mcx, N: ScanNode<'mcx>>(
    ...
    match rm {
        ...
        ::executils::EpqRowMarkFetch::Copy { whole_attno, .. } => {
            ...
            // SAFETY: a non-null wholerow junk datum is a live composite
            // image, valid in the origslot for this row.
            ...
            // SAFETY: an aligned flat composite image readable for its datum
            // length.
            let tup = unsafe {
