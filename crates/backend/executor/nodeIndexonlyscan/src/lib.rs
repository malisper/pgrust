...
pub fn init_seams() {
    nodeIndexonlyscan_seams::exec_indexonlyscan_estimate::set(
        bridge_estimate,
    );
    nodeIndexonlyscan_seams::exec_indexonlyscan_initialize_dsm::set(
        bridge_initialize_dsm,
    );
    nodeIndexonlyscan_seams::exec_indexonlyscan_reinitialize_dsm::set(
        bridge_reinitialize_dsm,
    );
    nodeIndexonlyscan_seams::exec_indexonlyscan_initialize_worker::set(
        bridge_initialize_worker,
    );
    nodeIndexonlyscan_seams::exec_indexonlyscan_retrieve_instrumentation::set(
