...
use datum_seams as datum;
use fmgr_seams as fmgr;
use nodeHash_seams as nodeHash;
...
fn chgparam_has_non_key_difference(node: &MemoizeScanState) -> bool {
    ...
    nodes_core_seams::bms_nonempty_difference::call(outer_chg, keyparamids)
}
...
pub fn ExecMemoizeInitializeDSM<'mcx>(
    ...
    panic!(
        "transam_parallel::shared_dsm_object: SharedMemoizeInfo DSM \
...
pub fn init_seams() {
    ...
    costsize_seams::exec_estimate_cache_entry_overhead_bytes::set(
