...
use execAmi_seams as exec_ami;
use execExpr_seams as exec_expr;
use execGrouping_seams as exec_grouping;
use execProcnode_seams as exec_procnode;
...
use execMain_seams as exec_main;
use execTuples_seams as exec_tuples;
...
pub fn init_seams() {
    nodeSubplan_seams::exec_re_scan_set_param_plan::set(ExecReScanSetParamPlan);
    nodeSubplan_seams::exec_set_param_plan::set(ExecSetParamPlan);
    nodeSubplan_seams::exec_sub_plan::set(ExecSubPlan);
    nodeSubplan_seams::exec_init_sub_plan::set(ExecInitSubPlan);
    ...
    execParallel_support_seams::exec_set_param_plan_multi::set(
