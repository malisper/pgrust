...
seam_core::seam!(
    ...
    pub fn remove_nulling_relids<'mcx>(
        mcx: mcx::Mcx<'mcx>,
        node: Expr<'mcx>,
        removable_relids: &pathnodes::Relids,
        except_relids: &pathnodes::Relids,
    ) -> Expr<'mcx>
);
...
seam_core::seam!(
    ...
    pub fn get_sortgroupref_clause_noerr(
        root: &pathnodes::PlannerInfo,
        sortref: u32,
        clauses: &[pathnodes::NodeId],
    ) -> Option<pathnodes::NodeId>
);
