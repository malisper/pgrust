...
pub fn init_seams() {
    ...
    relnode_ext_seams::make_coalesce_expr::set(make_coalesce_expr);
}
...
) -> nodeFuncs_seams::SortGroupClauseInfo {
...
) -> nodeFuncs_seams::TargetEntryInfo {
...
fn seam_expr_type_info(
    expr: &Expr,
) -> PgResult<nodeFuncs_seams::ExprTypeInfo> {
    Ok(nodeFuncs_seams::ExprTypeInfo {
...
fn seam_expr_type(expr: fmgr::ExternalFnExpr) -> Oid {
    match expr
        .node
        .as_ref()
...
fn seam_call_expr_argtype(_expr: fmgr::ExternalFnExpr, _argnum: i32) -> Oid {
    InvalidOid
}
...
fn seam_call_expr_arg_stable(_expr: fmgr::ExternalFnExpr, _argnum: i32) -> bool {
    false
}
...
fn seam_expr_variadic(_expr: fmgr::ExternalFnExpr) -> bool {
    false
}
