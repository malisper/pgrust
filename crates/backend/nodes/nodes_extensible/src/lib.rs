...
pub fn init_seams() {
    extensible_seams::RegisterExtensibleNodeMethods::set(RegisterExtensibleNodeMethods);
    extensible_seams::RegisterCustomScanMethods::set(RegisterCustomScanMethods);
    extensible_seams::GetExtensibleNodeMethods::set(GetExtensibleNodeMethods);
    extensible_seams::GetCustomScanMethods::set(GetCustomScanMethods);
}
