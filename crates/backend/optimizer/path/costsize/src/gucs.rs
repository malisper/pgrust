...
// Gather width 16, THREE transinfos, transitionSpace 0; CI cluster
...
// 3.03e9 / (1e7 * 96) = 3.16 -> 3.2. Both CI cluster anchors are reproduced at
...
// byte-identical-at-1GB CI cluster bar before any merge.
