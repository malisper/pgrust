...
pub fn init_seams() {
    ...
    init_subselect_ext_seams::cost_subplan::set(
    ...
    relnode_ext_seams::enable_partitionwise_join::set(
    ...
    relnode_ext_seams::clamp_width_est::set(crate::clamp_width_est);
    joininfo_ext_seams::clamp_width_est::set(crate::clamp_width_est);
    ...
    relnode_ext_seams::set_joinrel_size_estimates::set(
    ...
    relnode_ext_seams::get_parameterized_baserel_size::set(
        crate::joins::get_parameterized_baserel_size,
    );
    relnode_ext_seams::get_parameterized_joinrel_size::set(
    ...
    joininfo_ext_seams::cost_qual_eval_node_expr::set(
    ...
    planner_pc_seams::cpu_operator_cost::set(
    ...
    ps::work_mem::set(|| init_small_seams::work_mem::call());
