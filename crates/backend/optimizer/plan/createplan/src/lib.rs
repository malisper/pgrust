...
//!   [`createplan_seams`]; each loud-panics until its
        ...
        match paramval {
            ...
            Expr::PlaceHolderVar(mut phv) => {
                ...
                if outer_parallel_safe {
                    outer_parallel_safe =
                        equivclass_ext_seams::is_parallel_safe::call(
                            root, &phv_for_tle,
                        );
                }
...
pub fn init_seams() {
    ...
    setrefs_seams::minmax_replacement_param::set(
    ...
    init_subselect_ext_seams::materialize_finished_plan::set(
