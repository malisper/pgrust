...
seam_core::seam!(
    ...
    pub fn record_inval_item(
        inval_items: &mut alloc::vec::Vec<nodes::nodeindexscan::PlanInvalItem>,
        cache_id: i32,
        oid: types_core::Oid,
...
seam_core::seam!(
    ...
    pub fn multiexpr_param_lookup(
        ...
        subqueryid: usize,
        colno: usize,
    ) -> types_error::PgResult<nodes::primnodes::Expr<'static>>
);
...
seam_core::seam!(
    ...
    pub fn minmax_replacement_param(
        ...
        cur_target_expr: &nodes::primnodes::Expr,
    ) -> types_error::PgResult<Option<nodes::primnodes::Param>>
);
...
seam_core::seam!(
    ...
    pub fn mark_partial_aggref(
        ...
        aggsplit: nodes::AggSplit,
    ) -> types_error::PgResult<()>
);

/// The three dependency out-params the VALUE `extract_query_dependencies` writes
/// (mirrors `copyfuncs_pc_seams::QueryDependencies`, but the
...
seam_core::seam!(
    ...
    /// `copyfuncs_pc_seams::extract_query_dependencies` that
