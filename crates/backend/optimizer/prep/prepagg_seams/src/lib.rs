...
//! [`ArenaNode::AggTransInfo`](pathnodes::ArenaNode::AggTransInfo)). The C
...
//! arena ([`ArenaNode::Expr`](pathnodes::ArenaNode::Expr)`(Expr::Aggref)`)
...
pub struct AggCatalogInfo {
    ...
    pub agginitval: datum::datum::Datum,
...
seam_core::seam!(
    ...
    pub fn preprocess_aggrefs<'mcx>(
        ...
        clause: &mut nodes::primnodes::Expr,
...
seam_core::seam!(
    ...
    pub fn get_agg_clause_costs(
        ...
        costs: &mut pathnodes::AggClauseCosts,
    ) -> types_error::PgResult<()>
);
...
seam_core::seam!(
    ...
    pub fn datum_is_equal(
        value1: datum::datum::Datum,
        value2: datum::datum::Datum,
        typ_byval: bool,
        typ_len: i32,
