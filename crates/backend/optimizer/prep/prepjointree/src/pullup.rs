...
pub fn preprocess_function_rtes<'mcx>(
    ...
    for i in 0..n {
        ...
        let funcquery = {
            ...
            clauses_seams::inline_set_returning_function::call(
                mcx,
                root,
                &rte_snapshot,
            )?
...
pub fn expand_virtual_generated_columns<'mcx>(
    ...
    for lc in 0..n {
        ...
        let tlist = prepjointree_seams::build_virtual_generated_columns_tlist::call(
...
pub(crate) fn build_virtual_generated_columns_tlist<'mcx>(
    ...
    // The seam wants a `rel::Relation`; wrap the projected `RelationData`
    ...
    for i in 0..natts {
        ...
        if attr.attgenerated == ATTRIBUTE_GENERATED_VIRTUAL {
            // defexpr = build_generation_expression(rel, i + 1);
            let defbox = rewritehandler_seams::build_generation_expression::call(
                mcx,
                &relation,
                (i + 1) as i32,
            )?;
