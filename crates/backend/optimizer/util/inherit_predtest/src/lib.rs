...
/// (`inval_seams::cache_register_syscache_callback`), so it
/// needs no consumer-owned seam.
pub fn init_seams() {
    predtest_seams::predicate_implied_by::set(predicate_implied_by);
    predtest_seams::predicate_implied_by_exprs::set(
        predtest::predicate_implied_by_exprs,
    );
    predtest_seams::predicate_refuted_by_exprs::set(
    ...
    plancat_ext_seams::predicate_refuted_by::set(
