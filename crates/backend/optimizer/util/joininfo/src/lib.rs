...
use geqo_all_seams as geqo_seam;
use costsize_seams as costsize_seam;
use equivclass_ext_seams as ec_ext_seam;
use joinpath_seams as joinpath_seam;
...
pub fn init_seams() {
    ...
    init_subselect_ext_seams::phinfo_add_needed::set(
...
pub(crate) use relnode_seams as bms;
pub(crate) use pathnode_seams as bms_path;
