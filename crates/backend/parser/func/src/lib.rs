...
pub fn init_seams() {
    ...
    functioncmds_seams::funcname_signature_string::set(
    ...
    functioncmds_seams::name_list_to_string::set(|names| Ok(names.join(".")));
    ...
    functioncmds_seams::lookup_func_with_args::set(
    ...
    // here.
    clauses_seams::recheck_cast_function_args::set(
