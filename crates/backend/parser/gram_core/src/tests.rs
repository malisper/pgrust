...
// ---------------------------------------------------------------------------
// gram_core_diff fleet-campaign regressions (lane p1-new2, 2026-08-01).
...
fn regress_stack_exhaustion_error_shape() {
    ...
    // exact value is pinned by the fleet-validated differential (an
...
// Defect 7 (final fleet floor, 2026-08-01): the "at or near" tail must stop
