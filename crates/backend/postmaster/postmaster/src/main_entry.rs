...
pub fn PostmasterMain(argv: &[&str]) -> ! {
     ...
     */
    let _ = init_small::InitProcessGlobals();
    ...
    init_small::globals::SetPostmasterPid(
     ...
     */
    portalmem::top_context::create_postmaster_context();
    ...
    common_exec_seams::resolve_standalone_paths::call(&argv_owned[0])
    ...
    let _dbname = postgres_seams::process_postgres_switches::call(
        &argv_owned,
     ...
     */
    if !guc_seams::select_config_files::call(user_doption.as_deref(), "postgres")
        .unwrap_or(false)
    {
        statemachine::ExitPostmaster(2);
    }
     ...
     */
    {
        ...
        let _ = miscinit::process_shared_preload_libraries(spl_cx.mcx());
    }
    ...
    postgres_seams::process_shmem_requests::call()
        .unwrap_or_else(|e| panic!("process_shmem_requests: {e:?}"));
    postgres_seams::initialize_shmem_gucs::call()
        .unwrap_or_else(|e| panic!("InitializeShmemGUCs: {e:?}"));
    postgres_seams::initialize_wal_consistency_checking::call()
    ...
    postgres_seams::set_pg_start_time::call(
