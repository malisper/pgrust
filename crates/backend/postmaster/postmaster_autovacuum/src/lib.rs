...
fn auto_vac_launcher_main_entry(_startup_data: &StartupData) -> ! {
    match launcher::AutoVacLauncherMain() {
        Ok(()) => autovacuum_ext_seams::proc_exit::call(0),
        Err(_) => autovacuum_ext_seams::proc_exit::call(1),
    }
}
...
pub fn init_seams() {
    ...
    vacuum_seams::vacuum_update_costs::set(cost_balance::VacuumUpdateCosts);
    autovacuum_seams::auto_vac_launcher_main::set(auto_vac_launcher_main_entry);
    autovacuum_seams::auto_vac_worker_main::set(auto_vac_worker_main_entry);
    autovacuum_seams::am_autovacuum_launcher_process::set(
        am_autovacuum_launcher_process,
    );
    autovacuum_seams::am_autovacuum_worker_process::set(
        am_autovacuum_worker_process,
    );
    // Pure-wiring installs (assemble/seam-wiring-guard): owner bodies match.
    autovacuum_seams::autovacuum_worker_slots::set(core::autovacuum_worker_slots);
    autovacuum_seams::auto_vacuum_shmem_init::set(shmem::AutoVacuumShmemInit);
    ...
    autovacuum_seams::auto_vacuum_shmem_size::set(shmem::AutoVacuumShmemSize);
    autovacuum_seams::auto_vacuuming_active::set(shmem::AutoVacuumingActive);
    ...
    postmaster_seams::autovac_init::set(|| {
        let _ = shmem::autovac_init();
    });
    postmaster_seams::autovacuuming_active::set(shmem::AutoVacuumingActive);
    ...
    postmaster_seams::autovac_worker_failed::set(
    ...
    use autovacuum_ext_seams as ext;
