...
//! [`wal::rmgr::XLogRecordBuffer`] carrying the `XLogReaderHandle` the
...
seam_core::seam!(
    ...
    pub fn xlog_decode(ctx: &mut types_logical::LogicalDecodingContext, buf: &mut wal::rmgr::XLogRecordBuffer) -> types_error::PgResult<()>
);
...
seam_core::seam!(
    ...
    /// resource manager's records (`rm_decode` slot). `elog(ERROR)`s on
    /// unexpected record info, carried on `Err`.
    pub fn xact_decode(ctx: &mut types_logical::LogicalDecodingContext, buf: &mut wal::rmgr::XLogRecordBuffer) -> types_error::PgResult<()>
);
...
seam_core::seam!(
    ...
    /// resource manager's records (`rm_decode` slot). `elog(ERROR)`s on
    /// unexpected record info, carried on `Err`.
    pub fn standby_decode(ctx: &mut types_logical::LogicalDecodingContext, buf: &mut wal::rmgr::XLogRecordBuffer) -> types_error::PgResult<()>
);
...
seam_core::seam!(
    ...
    /// resource manager's records (`rm_decode` slot). `elog(ERROR)`s on
    /// unexpected record info, carried on `Err`.
    pub fn heap2_decode(ctx: &mut types_logical::LogicalDecodingContext, buf: &mut wal::rmgr::XLogRecordBuffer) -> types_error::PgResult<()>
);
...
seam_core::seam!(
    ...
    /// resource manager's records (`rm_decode` slot). `elog(ERROR)`s on
    /// unexpected record info, carried on `Err`.
    pub fn heap_decode(ctx: &mut types_logical::LogicalDecodingContext, buf: &mut wal::rmgr::XLogRecordBuffer) -> types_error::PgResult<()>
);
...
seam_core::seam!(
    ...
    /// resource manager's records (`rm_decode` slot). `elog(ERROR)`s on
    /// unexpected record info, carried on `Err`.
    pub fn logicalmsg_decode(ctx: &mut types_logical::LogicalDecodingContext, buf: &mut wal::rmgr::XLogRecordBuffer) -> types_error::PgResult<()>
);
