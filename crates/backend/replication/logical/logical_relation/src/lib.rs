...
use pg_subscription_seams as sub_sx;
use namespace_seams as nsp_sx;
use syscache_seams as syscache_sx;
use typcache_seams as typcache_sx;
use amapi_seams as amapi_sx;
use inval_seams as inval_sx;
use mcxt_seams as cachectx_sx;
use worker_seams as worker_sx;
...
fn logicalrep_relmap_invalidate_cb(_arg: datum::Datum, reloid: Oid) {
...
fn logicalrep_partmap_invalidate_cb(_arg: datum::Datum, reloid: Oid) {
