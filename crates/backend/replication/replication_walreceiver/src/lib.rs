...
use pgstat_wal_seams as pgstat_wal;
...
use guc_tables_seams as guc_tables;
...
pub fn init_seams() {
    walreceiver_seams::wal_receiver_main::set(wal_receiver_main);
    walreceiver_seams::wal_receiver_timeout::set(wal_receiver_timeout);
    walreceiver_seams::hot_standby_feedback::set(hot_standby_feedback);
    walreceiver_seams::wal_retrieve_retry_interval::set(
        wal_retrieve_retry_interval,
    );
    walreceiver_seams::get_wal_rcv_flush_rec_ptr::set(
        get_wal_rcv_flush_rec_ptr,
    );
    walreceiver_seams::wal_rcv_force_reply::set(WalRcvForceReply);
