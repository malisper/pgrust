...
seam_core::seam!(
    ...
    pub fn relation_has_security_invoker(relation: &rel::Relation<'_>) -> bool
);
...
seam_core::seam!(
    ...
    pub fn relation_is_security_view(relation: &rel::Relation<'_>) -> bool
);
...
seam_core::seam!(
    ...
    /// `backend-rewrite-rewritehandler`.
    pub fn relation_has_check_option(relation: &rel::Relation<'_>) -> bool
);
...
seam_core::seam!(
    ...
    pub fn relation_has_cascaded_check_option(relation: &rel::Relation<'_>) -> bool
);
