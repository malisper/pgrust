    ...
    *(*z).I.offset(2 as ::core::ffi::c_int as isize) = 0 as ::core::ffi::c_int;
    ...
    loop {
        ...
        loop {
            ...
            (*z).c = c5;
            let ret_1: ::core::ffi::c_int = skip_utf8(
                (*z).p,
                (*z).c,
                (*z).l,
                1 as ::core::ffi::c_int,
    ...
    *(*z).I.offset(0 as ::core::ffi::c_int as isize) = (*z).l;
    ...
    match current_block {
        15589577050911781860 => {
            (*z).c = c2;
            let ret: ::core::ffi::c_int = out_grouping_U(
                z,
                &raw const g_v as *const ::core::ffi::c_uchar,
                97 as ::core::ffi::c_int,
                121 as ::core::ffi::c_int,
            ...
            if ret < 0 as ::core::ffi::c_int {
                ...
                (*z).c += ret;
                let ret_0: ::core::ffi::c_int = in_grouping_U(
                    z,
                    &raw const g_v as *const ::core::ffi::c_uchar,
                    97 as ::core::ffi::c_int,
                    121 as ::core::ffi::c_int,
    ...
    match current_block {
        17725484746462877215 => {
            *(*z).I.offset(1 as ::core::ffi::c_int as isize) = (*z).c;
            let ret_1: ::core::ffi::c_int = out_grouping_U(
                z,
                &raw const g_v as *const ::core::ffi::c_uchar,
                97 as ::core::ffi::c_int,
                121 as ::core::ffi::c_int,
            ...
            if !(ret_1 < 0 as ::core::ffi::c_int) {
                (*z).c += ret_1;
                let ret_2: ::core::ffi::c_int = in_grouping_U(
                    z,
                    &raw const g_v as *const ::core::ffi::c_uchar,
                    97 as ::core::ffi::c_int,
                    121 as ::core::ffi::c_int,
...
unsafe fn r_Step_1a(z: *mut SN_env) -> ::core::ffi::c_int {
    ...
    match among_var {
        ...
        2 => {
            ...
            let ret_1: ::core::ffi::c_int = skip_b_utf8(
                (*z).p,
                (*z).c,
                (*z).lb,
                2 as ::core::ffi::c_int,
        ...
        3 => {
            let ret_4: ::core::ffi::c_int = skip_b_utf8(
                (*z).p,
                (*z).c,
                (*z).lb,
                1 as ::core::ffi::c_int,
            ...
            (*z).c = ret_4;
            let ret_5: ::core::ffi::c_int = out_grouping_b_U(
                z,
                &raw const g_v as *const ::core::ffi::c_uchar,
                97 as ::core::ffi::c_int,
                121 as ::core::ffi::c_int,
...
unsafe fn r_Step_1b(z: *mut SN_env) -> ::core::ffi::c_int {
    ...
    match among_var {
        ...
        2 => {
            ...
            let ret_1: ::core::ffi::c_int = out_grouping_b_U(
                z,
                &raw const g_v as *const ::core::ffi::c_uchar,
                97 as ::core::ffi::c_int,
                121 as ::core::ffi::c_int,
            ...
            (*z).c = (*z).l - m_test2;
            (*z).ket = (*z).c;
            let ret_6: ::core::ffi::c_int = skip_b_utf8(
                (*z).p,
                (*z).c,
                (*z).lb,
                1 as ::core::ffi::c_int,
            ...
            (*z).c = ret_6;
            (*z).bra = (*z).c;
            let ret_7: ::core::ffi::c_int = slice_del(z);
...
unsafe fn r_postlude(z: *mut SN_env) -> ::core::ffi::c_int {
    ...
    loop {
        ...
        loop {
            ...
            {
                (*z).c = c2;
                let ret: ::core::ffi::c_int = skip_utf8(
                    (*z).p,
                    (*z).c,
                    (*z).l,
                    1 as ::core::ffi::c_int,
...
pub unsafe fn english_UTF_8_stem(z: *mut SN_env) -> ::core::ffi::c_int {
    let c1: ::core::ffi::c_int = (*z).c;
    let ret: ::core::ffi::c_int = r_exception1(z);
    if ret == 0 as ::core::ffi::c_int {
        (*z).c = c1;
        let c2: ::core::ffi::c_int = (*z).c;
        let ret_0: ::core::ffi::c_int = skip_utf8(
            (*z).p,
            (*z).c,
            (*z).l,
            3 as ::core::ffi::c_int,
        ...
        if ret_0 < 0 as ::core::ffi::c_int {
            ...
            (*z).c = ret_0;
            (*z).c = c1;
            let ret_1: ::core::ffi::c_int = r_prelude(z);
            if ret_1 < 0 as ::core::ffi::c_int {
                return ret_1;
            }
            let ret_2: ::core::ffi::c_int = r_mark_regions(z);
            if ret_2 < 0 as ::core::ffi::c_int {
                return ret_2;
            }
            (*z).lb = (*z).c;
            (*z).c = (*z).l;
            let m3: ::core::ffi::c_int = (*z).l - (*z).c;
            let ret_3: ::core::ffi::c_int = r_Step_1a(z);
            if ret_3 < 0 as ::core::ffi::c_int {
                return ret_3;
            }
            (*z).c = (*z).l - m3;
            let m4: ::core::ffi::c_int = (*z).l - (*z).c;
            let ret_4: ::core::ffi::c_int = r_exception2(z);
            if ret_4 == 0 as ::core::ffi::c_int {
                (*z).c = (*z).l - m4;
                let m5: ::core::ffi::c_int = (*z).l - (*z).c;
                let ret_5: ::core::ffi::c_int = r_Step_1b(z);
                if ret_5 < 0 as ::core::ffi::c_int {
                    return ret_5;
                }
                (*z).c = (*z).l - m5;
                let m6: ::core::ffi::c_int = (*z).l - (*z).c;
                let ret_6: ::core::ffi::c_int = r_Step_1c(z);
                if ret_6 < 0 as ::core::ffi::c_int {
                    return ret_6;
                }
                (*z).c = (*z).l - m6;
                let m7: ::core::ffi::c_int = (*z).l - (*z).c;
                let ret_7: ::core::ffi::c_int = r_Step_2(z);
                if ret_7 < 0 as ::core::ffi::c_int {
                    return ret_7;
                }
                (*z).c = (*z).l - m7;
                let m8: ::core::ffi::c_int = (*z).l - (*z).c;
                let ret_8: ::core::ffi::c_int = r_Step_3(z);
                if ret_8 < 0 as ::core::ffi::c_int {
                    return ret_8;
                }
                (*z).c = (*z).l - m8;
                let m9: ::core::ffi::c_int = (*z).l - (*z).c;
                let ret_9: ::core::ffi::c_int = r_Step_4(z);
                if ret_9 < 0 as ::core::ffi::c_int {
                    return ret_9;
                }
                (*z).c = (*z).l - m9;
                let m10: ::core::ffi::c_int = (*z).l - (*z).c;
                let ret_10: ::core::ffi::c_int = r_Step_5(z);
                if ret_10 < 0 as ::core::ffi::c_int {
                    return ret_10;
                }
                (*z).c = (*z).l - m10;
            ...
            let ret_11: ::core::ffi::c_int = r_postlude(z);
            if ret_11 < 0 as ::core::ffi::c_int {
                return ret_11;
            }
            (*z).c = c11;
...
pub unsafe fn english_UTF_8_close_env(z: *mut SN_env) {
