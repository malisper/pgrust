            ...
            ) != 0)
            {
                ...
                if (*z).c == (*z).l
                    || *(*z).p.offset((*z).c as isize) as ::core::ffi::c_int
                        != 'u' as i32
                {
                    current_block = 3667884858854283484;
                } else {
                    (*z).c += 1;
                    (*z).ket = (*z).c;
                    if in_grouping_U(
                    ...
                    ) != 0
                    {
                        ...
                        current_block = 8769028758356355197;
                    }
                }
                match current_block {
                    3667884858854283484 => {
                        ...
                        if (*z).c == (*z).l
                            || *(*z).p.offset((*z).c as isize) as ::core::ffi::c_int
                                != 'y' as i32
                        {
                            current_block = 5970122274911847665;
                        } else {
                            (*z).c += 1;
                            (*z).ket = (*z).c;
                            if in_grouping_U(
        ...
        if !(among_var == 0) {
            ...
            if !(ret == 0 as ::core::ffi::c_int) {
                ...
                match among_var {
                    ...
                    2 => {
                        current_block = 5252886418925945957;
                        match current_block {
                            17878068175280500969 => {
                                let mut ret_5: ::core::ffi::c_int = slice_from_s(
                                    z,
                    ...
                    3 => {
                        current_block = 10614398376620164578;
                        match current_block {
                            17878068175280500969 => {
                                let mut ret_5: ::core::ffi::c_int = slice_from_s(
                                    z,
                    ...
                    4 => {
                        current_block = 4316509768827509139;
                        match current_block {
                            17878068175280500969 => {
                                let mut ret_5: ::core::ffi::c_int = slice_from_s(
                                    z,
                    ...
                    5 => {
                        current_block = 17878068175280500969;
                        match current_block {
                            17878068175280500969 => {
                                let mut ret_5: ::core::ffi::c_int = slice_from_s(
                                    z,
            ...
            & 1 as ::core::ffi::c_int == 0)
    {
        ...
        if !(among_var == 0) {
            ...
            if !(ret_6 == 0 as ::core::ffi::c_int) {
                ...
                match among_var {
                    1 => {
                        current_block = 18403587549558498242;
                        match current_block {
                            18403587549558498242 => {
                            ...
                            _ => {
                                ...
                                {
                                    let mut ret_8: ::core::ffi::c_int = skip_b_utf8(
                                        (*z).p,
                                        (*z).c,
                                        (*z).lb,
                                        3 as ::core::ffi::c_int,
                    ...
                    2 => {
                        current_block = 6496932521762800249;
                        match current_block {
                            18403587549558498242 => {
                                let mut ret_7: ::core::ffi::c_int = slice_del(z);
                                if ret_7 < 0 as ::core::ffi::c_int {
            ...
            & 1 as ::core::ffi::c_int == 0)
    {
        ...
        if !(among_var == 0) {
            ...
            if !(ret_10 == 0 as ::core::ffi::c_int) {
                ...
                match among_var {
                    1 => {
                        current_block = 7856689806717424568;
                        match current_block {
                            16160287814148931184 => {
                            ...
                            7856689806717424568 => {
                                ...
                                ) == 0
                                {
                                    ...
                                    {
                                        (*z).c = (*z).l - m7;
                                        let mut ret_12: ::core::ffi::c_int = r_R2(z);
                            ...
                            _ => {
                                ...
                                ) == 0
                                {
                                    ...
                                    {
                                        (*z).c = (*z).l - m9;
                                        current_block = 1874927180616273516;
                                    } else {
                                        current_block = 1695317997601294288;
                                    }
                                } else {
                                    current_block = 1695317997601294288;
                                }
                                match current_block {
                                    ...
                                    _ => {
                                        (*z).bra = (*z).c;
                                        let mut ret_16: ::core::ffi::c_int = r_R1(z);
                    ...
                    3 => {
                        current_block = 1816672648150535649;
                        match current_block {
                            16160287814148931184 => {
                                let mut ret_18: ::core::ffi::c_int = slice_del(z);
                                if ret_18 < 0 as ::core::ffi::c_int {
                    ...
                    4 => {
                        current_block = 16160287814148931184;
                        match current_block {
                            16160287814148931184 => {
                                let mut ret_18: ::core::ffi::c_int = slice_del(z);
                                if ret_18 < 0 as ::core::ffi::c_int {
...
pub unsafe fn german_UTF_8_stem(mut z: *mut SN_env) -> ::core::ffi::c_int {
    let mut c1: ::core::ffi::c_int = (*z).c;
...
pub unsafe fn german_UTF_8_create_env() -> *mut SN_env {
    return SN_create_env(0 as ::core::ffi::c_int, 3 as ::core::ffi::c_int);
}
pub unsafe fn german_UTF_8_close_env(mut z: *mut SN_env) {
