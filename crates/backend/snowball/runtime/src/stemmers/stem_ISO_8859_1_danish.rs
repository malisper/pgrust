...
static mut s_2_4: [symbol; 4] = [
    'l' as i32 as symbol,
    0xf8 as ::core::ffi::c_int as symbol,
    's' as i32 as symbol,
    't' as i32 as symbol,
];
...
pub unsafe fn danish_ISO_8859_1_stem(
    mut z: *mut SN_env,
) -> ::core::ffi::c_int {
...
pub unsafe fn danish_ISO_8859_1_create_env() -> *mut SN_env {
    return SN_create_env(1 as ::core::ffi::c_int, 2 as ::core::ffi::c_int);
}
pub unsafe fn danish_ISO_8859_1_close_env(mut z: *mut SN_env) {
