...
static mut s_0_1: [symbol; 1] = [0xe3 as ::core::ffi::c_int as symbol];
static mut s_0_2: [symbol; 1] = [0xf5 as ::core::ffi::c_int as symbol];
...
static mut s_5_2: [symbol; 5] = [
    0xea as ::core::ffi::c_int as symbol,
    'n' as i32 as symbol,
    'c' as i32 as symbol,
    'i' as i32 as symbol,
    'a' as i32 as symbol,
...
static mut s_5_22: [symbol; 5] = [
    'a' as i32 as symbol,
    0xe7 as ::core::ffi::c_int as symbol,
    'a' as i32 as symbol,
    '~' as i32 as symbol,
    'o' as i32 as symbol,
];
...
static mut s_6_84: [symbol; 4] = [
    0xed as ::core::ffi::c_int as symbol,
    'e' as i32 as symbol,
    'i' as i32 as symbol,
    's' as i32 as symbol,
];
static mut s_6_85: [symbol; 6] = [
    'a' as i32 as symbol,
    'r' as i32 as symbol,
    0xed as ::core::ffi::c_int as symbol,
    'e' as i32 as symbol,
...
static mut s_6_110: [symbol; 4] = [
    0xe1 as ::core::ffi::c_int as symbol,
    'm' as i32 as symbol,
    'o' as i32 as symbol,
    's' as i32 as symbol,
];
static mut s_6_111: [symbol; 4] = [
    'a' as i32 as symbol,
    'r' as i32 as symbol,
    0xe1 as ::core::ffi::c_int as symbol,
    's' as i32 as symbol,
];
static mut s_6_112: [symbol; 4] = [
    'e' as i32 as symbol,
    'r' as i32 as symbol,
    0xe1 as ::core::ffi::c_int as symbol,
    's' as i32 as symbol,
];
static mut s_6_113: [symbol; 4] = [
    'i' as i32 as symbol,
    'r' as i32 as symbol,
    0xe1 as ::core::ffi::c_int as symbol,
    's' as i32 as symbol,
...
static mut s_6_117: [symbol; 3] = [
    'a' as i32 as symbol,
    'r' as i32 as symbol,
    0xe1 as ::core::ffi::c_int as symbol,
];
static mut s_6_118: [symbol; 3] = [
    'e' as i32 as symbol,
    'r' as i32 as symbol,
    0xe1 as ::core::ffi::c_int as symbol,
];
static mut s_6_119: [symbol; 3] = [
    'i' as i32 as symbol,
    'r' as i32 as symbol,
    0xe1 as ::core::ffi::c_int as symbol,
];
...
static mut s_7_4: [symbol; 1] = [0xe1 as ::core::ffi::c_int as symbol];
static mut s_7_5: [symbol; 1] = [0xed as ::core::ffi::c_int as symbol];
static mut s_7_6: [symbol; 1] = [0xf3 as ::core::ffi::c_int as symbol];
...
static mut s_8_1: [symbol; 1] = [0xe7 as ::core::ffi::c_int as symbol];
static mut s_8_2: [symbol; 1] = [0xe9 as ::core::ffi::c_int as symbol];
static mut s_8_3: [symbol; 1] = [0xea as ::core::ffi::c_int as symbol];
...
static mut s_2: [symbol; 1] = [0xe3 as ::core::ffi::c_int as symbol];
static mut s_3: [symbol; 1] = [0xf5 as ::core::ffi::c_int as symbol];
    ...
    loop {
        ...
        if (*z).c >= (*z).l
            || *(*z).p.offset(((*z).c + 0 as ::core::ffi::c_int) as isize)
                as ::core::ffi::c_int != 227 as ::core::ffi::c_int
                && *(*z).p.offset(((*z).c + 0 as ::core::ffi::c_int) as isize)
                    as ::core::ffi::c_int != 245 as ::core::ffi::c_int
        {
...
unsafe fn r_mark_regions(mut z: *mut SN_env) -> ::core::ffi::c_int {
    ...
    *(*z).I.offset(0 as ::core::ffi::c_int as isize) = (*z).l;
    ...
    {
        current_block = 212507958473341680;
    } else {
        ...
        {
            current_block = 11465362375303154474;
        } else {
            ...
            if ret < 0 as ::core::ffi::c_int {
                ...
                (*z).c += ret;
                current_block = 4748073073278948606;
            }
        }
        match current_block {
            4748073073278948606 => {}
    ...
    match current_block {
        212507958473341680 => {
            ...
            {
                current_block = 2287270088237138123;
            } else {
                ...
                {
                    current_block = 3352051981063207803;
                } else {
...
unsafe fn r_residual_form(mut z: *mut SN_env) -> ::core::ffi::c_int {
    ...
    match among_var {
        1 => {
            ...
            {
                current_block = 12526985417364558066;
            } else {
                (*z).c -= 1;
                (*z).bra = (*z).c;
                        ...
                        as ::core::ffi::c_int != 'g' as i32
                {
                    ...
                    (*z).c -= 1;
                    (*z).c = (*z).l - m_test2;
                    current_block = 683604413777781111;
                }
            }
            match current_block {
                12526985417364558066 => {
                    (*z).c = (*z).l - m1;
                    if (*z).c <= (*z).lb
                        || *(*z).p.offset(((*z).c - 1 as ::core::ffi::c_int) as isize)
...
pub unsafe fn portuguese_ISO_8859_1_stem(
    mut z: *mut SN_env,
) -> ::core::ffi::c_int {
    let mut current_block: u64;
    let mut c1: ::core::ffi::c_int = (*z).c;
    ...
    if ret_1 == 0 as ::core::ffi::c_int {
        ...
        if ret_2 == 0 as ::core::ffi::c_int {
            ...
            if ret_5 == 0 as ::core::ffi::c_int {
                current_block = 17413616011419035081;
            } else {
                if ret_5 < 0 as ::core::ffi::c_int {
                    return ret_5;
                }
            ...
            current_block = 2494841932783644858;
        }
    } else {
        if ret_1 < 0 as ::core::ffi::c_int {
            return ret_1;
...
pub unsafe fn portuguese_ISO_8859_1_create_env() -> *mut SN_env {
    return SN_create_env(0 as ::core::ffi::c_int, 3 as ::core::ffi::c_int);
}
pub unsafe fn portuguese_ISO_8859_1_close_env(mut z: *mut SN_env) {
