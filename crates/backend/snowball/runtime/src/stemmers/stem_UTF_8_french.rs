...
static mut s_5: [symbol; 2] = ['H' as i32 as symbol, 'e' as i32 as symbol];
static mut s_6: [symbol; 2] = [
    0xc3 as ::core::ffi::c_int as symbol,
    0xaf as ::core::ffi::c_int as symbol,
];
static mut s_7: [symbol; 2] = ['H' as i32 as symbol, 'i' as i32 as symbol];
...
static mut s_11: [symbol; 1] = ['u' as i32 as symbol];
static mut s_12: [symbol; 1] = ['y' as i32 as symbol];
...
static mut s_15: [symbol; 2] = ['i' as i32 as symbol, 'c' as i32 as symbol];
...
static mut s_18: [symbol; 1] = ['u' as i32 as symbol];
static mut s_19: [symbol; 3] = [
    'e' as i32 as symbol,
    'n' as i32 as symbol,
    't' as i32 as symbol,
];
static mut s_20: [symbol; 2] = ['a' as i32 as symbol, 't' as i32 as symbol];
static mut s_21: [symbol; 3] = [
    'e' as i32 as symbol,
    'u' as i32 as symbol,
    'x' as i32 as symbol,
];
static mut s_22: [symbol; 1] = ['i' as i32 as symbol];
...
static mut s_25: [symbol; 2] = ['a' as i32 as symbol, 't' as i32 as symbol];
...
static mut s_29: [symbol; 2] = ['a' as i32 as symbol, 'l' as i32 as symbol];
...
static mut s_33: [symbol; 2] = ['H' as i32 as symbol, 'i' as i32 as symbol];
...
static mut s_37: [symbol; 1] = ['e' as i32 as symbol];
static mut s_38: [symbol; 1] = ['i' as i32 as symbol];
static mut s_39: [symbol; 2] = [
    0xc3 as ::core::ffi::c_int as symbol,
    0xa7 as ::core::ffi::c_int as symbol,
];
static mut s_40: [symbol; 1] = ['c' as i32 as symbol];
...
unsafe fn r_prelude(mut z: *mut SN_env) -> ::core::ffi::c_int {
    ...
    's_4: loop {
        ...
        loop {
            ...
            {
                current_block = 18252508940191652520;
            } else {
                (*z).bra = (*z).c;
                ...
                if (*z).c == (*z).l
                    || *(*z).p.offset((*z).c as isize) as ::core::ffi::c_int
                        != 'u' as i32
                {
                    current_block = 8488388515788011012;
                } else {
                    (*z).c += 1;
                    (*z).ket = (*z).c;
                    if in_grouping_U(
                    ...
                    ) != 0
                    {
                        ...
                        current_block = 12188266704805958889;
                    }
                }
                match current_block {
                    12188266704805958889 => {}
                    _ => {
                        (*z).c = c4;
                        if (*z).c == (*z).l
                            || *(*z).p.offset((*z).c as isize) as ::core::ffi::c_int
                                != 'i' as i32
                        {
                            current_block = 15433000514848582750;
                        } else {
                            (*z).c += 1;
                            (*z).ket = (*z).c;
                            if in_grouping_U(
            ...
            match current_block {
                18252508940191652520 => {
                    (*z).c = c3;
                    (*z).bra = (*z).c;
                    if eq_s(z, 2 as ::core::ffi::c_int, &raw const s_4 as *const symbol)
                        == 0
                    {
                        (*z).c = c3;
                        (*z).bra = (*z).c;
                        ...
                        ) == 0
                        {
                            ...
                            if (*z).c == (*z).l
                                || *(*z).p.offset((*z).c as isize) as ::core::ffi::c_int
                                    != 'y' as i32
                            {
                                current_block = 1918084249401379214;
                            } else {
                                (*z).c += 1;
                                (*z).ket = (*z).c;
                                if in_grouping_U(
                                ...
                                _ => {
                                    ...
                                    if (*z).c == (*z).l
                                        || *(*z).p.offset((*z).c as isize) as ::core::ffi::c_int
                                            != 'q' as i32
                                    {
                                        current_block = 13687250165563050243;
                                    } else {
                                        (*z).c += 1;
                                        (*z).bra = (*z).c;
                                        if (*z).c == (*z).l
                                    ...
                                    match current_block {
                                        ...
                                        _ => {
                                            (*z).c = c2;
                                            let mut ret_6: ::core::ffi::c_int = skip_utf8(
                                                (*z).p,
                                                (*z).c,
                                                (*z).l,
                                                1 as ::core::ffi::c_int,
...
unsafe fn r_mark_regions(mut z: *mut SN_env) -> ::core::ffi::c_int {
    ...
    *(*z).I.offset(0 as ::core::ffi::c_int as isize) = (*z).l;
    ...
    {
        current_block = 4720229880265746412;
    } else if in_grouping_U(
        z,
        &raw const g_v as *const ::core::ffi::c_uchar,
        97 as ::core::ffi::c_int,
        251 as ::core::ffi::c_int,
    ...
    ) != 0
    {
        ...
        if ret < 0 as ::core::ffi::c_int {
            ...
            (*z).c = ret;
            current_block = 14899811840617800167;
        }
    }
    match current_block {
        4720229880265746412 => {
            ...
            {
                current_block = 1589057914555711833;
            } else if find_among(
                z,
            ...
            match current_block {
                14899811840617800167 => {}
                _ => {
                    (*z).c = c2;
                    let mut ret_0: ::core::ffi::c_int = skip_utf8(
                        (*z).p,
                        (*z).c,
                        (*z).l,
                        1 as ::core::ffi::c_int,
                    ...
                    if ret_0 < 0 as ::core::ffi::c_int {
                        current_block = 8911107906729998279;
                    } else {
                        (*z).c = ret_0;
    ...
    (*z).c = c1;
    let mut c3: ::core::ffi::c_int = (*z).c;
    let mut ret_2: ::core::ffi::c_int = out_grouping_U(
        z,
        &raw const g_v as *const ::core::ffi::c_uchar,
        97 as ::core::ffi::c_int,
        251 as ::core::ffi::c_int,
    ...
    if !(ret_2 < 0 as ::core::ffi::c_int) {
        (*z).c += ret_2;
        let mut ret_3: ::core::ffi::c_int = in_grouping_U(
            z,
            &raw const g_v as *const ::core::ffi::c_uchar,
            97 as ::core::ffi::c_int,
            251 as ::core::ffi::c_int,
        ...
        if !(ret_3 < 0 as ::core::ffi::c_int) {
            ...
            *(*z).I.offset(1 as ::core::ffi::c_int as isize) = (*z).c;
            let mut ret_4: ::core::ffi::c_int = out_grouping_U(
                z,
                &raw const g_v as *const ::core::ffi::c_uchar,
                97 as ::core::ffi::c_int,
                251 as ::core::ffi::c_int,
            ...
            if !(ret_4 < 0 as ::core::ffi::c_int) {
                (*z).c += ret_4;
                let mut ret_5: ::core::ffi::c_int = in_grouping_U(
                    z,
                    &raw const g_v as *const ::core::ffi::c_uchar,
                    97 as ::core::ffi::c_int,
                    251 as ::core::ffi::c_int,
...
unsafe fn r_standard_suffix(mut z: *mut SN_env) -> ::core::ffi::c_int {
    ...
    match among_var {
        ...
        8 => {
            ...
            (*z).ket = (*z).c;
            if eq_s_b(z, 2 as ::core::ffi::c_int, &raw const s_25 as *const symbol) == 0
            {
                (*z).c = (*z).l - m8;
            } else {
                (*z).bra = (*z).c;
...
unsafe fn r_residual_suffix(mut z: *mut SN_env) -> ::core::ffi::c_int {
            ...
            as ::core::ffi::c_int != 's' as i32
    {
        ...
        let mut m3: ::core::ffi::c_int = (*z).l - (*z).c;
        if eq_s_b(z, 2 as ::core::ffi::c_int, &raw const s_33 as *const symbol) == 0 {
            (*z).c = (*z).l - m3;
            if out_grouping_b_U(
                z,
            ...
            ) != 0
            {
                ...
                current_block = 12423146064593165071;
            }
        } else {
            current_block = 12423146064593165071;
        }
...
unsafe fn r_un_accent(mut z: *mut SN_env) -> ::core::ffi::c_int {
    ...
    (*z).ket = (*z).c;
    let mut m1: ::core::ffi::c_int = (*z).l - (*z).c;
    if eq_s_b(z, 2 as ::core::ffi::c_int, &raw const s_35 as *const symbol) == 0 {
        (*z).c = (*z).l - m1;
        if eq_s_b(z, 2 as ::core::ffi::c_int, &raw const s_36 as *const symbol) == 0 {
            return 0 as ::core::ffi::c_int;
        }
    }
    (*z).bra = (*z).c;
...
pub unsafe fn french_UTF_8_stem(mut z: *mut SN_env) -> ::core::ffi::c_int {
    let mut current_block: u64;
    let mut c1: ::core::ffi::c_int = (*z).c;
    ...
    if ret_2 == 0 as ::core::ffi::c_int {
        ...
        if ret_3 == 0 as ::core::ffi::c_int {
            ...
            if ret_4 == 0 as ::core::ffi::c_int {
                ...
                if ret_7 == 0 as ::core::ffi::c_int {
                    current_block = 4989680839665771726;
                } else {
                    if ret_7 < 0 as ::core::ffi::c_int {
                        return ret_7;
                    }
                ...
                current_block = 14764511451966295680;
            }
        } else {
            if ret_3 < 0 as ::core::ffi::c_int {
                return ret_3;
    ...
    match current_block {
        14764511451966295680 => {
            ...
            {
                (*z).c = (*z).l - m8;
                if eq_s_b(z, 2 as ::core::ffi::c_int, &raw const s_39 as *const symbol)
                    == 0
                {
                    (*z).c = (*z).l - m7;
                } else {
...
pub unsafe fn french_UTF_8_create_env() -> *mut SN_env {
    return SN_create_env(0 as ::core::ffi::c_int, 3 as ::core::ffi::c_int);
}
pub unsafe fn french_UTF_8_close_env(mut z: *mut SN_env) {
