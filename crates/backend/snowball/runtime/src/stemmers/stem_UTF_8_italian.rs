...
static mut s_6_47: [symbol; 4] = [
    'i' as i32 as symbol,
    't' as i32 as symbol,
    0xc3 as ::core::ffi::c_int as symbol,
    0xa0 as ::core::ffi::c_int as symbol,
];
static mut s_6_48: [symbol; 5] = [
    'i' as i32 as symbol,
    's' as i32 as symbol,
    't' as i32 as symbol,
    0xc3 as ::core::ffi::c_int as symbol,
...
static mut s_7_83: [symbol; 4] = [
    'e' as i32 as symbol,
    'r' as i32 as symbol,
    0xc3 as ::core::ffi::c_int as symbol,
    0xa0 as ::core::ffi::c_int as symbol,
];
static mut s_7_84: [symbol; 4] = [
    'i' as i32 as symbol,
    'r' as i32 as symbol,
    0xc3 as ::core::ffi::c_int as symbol,
    0xa0 as ::core::ffi::c_int as symbol,
];
static mut s_7_85: [symbol; 4] = [
    'e' as i32 as symbol,
    'r' as i32 as symbol,
    0xc3 as ::core::ffi::c_int as symbol,
    0xb2 as ::core::ffi::c_int as symbol,
];
static mut s_7_86: [symbol; 4] = [
    'i' as i32 as symbol,
    'r' as i32 as symbol,
    0xc3 as ::core::ffi::c_int as symbol,
    0xb2 as ::core::ffi::c_int as symbol,
            ...
            ) != 0)
            {
                ...
                if (*z).c == (*z).l
                    || *(*z).p.offset((*z).c as isize) as ::core::ffi::c_int
                        != 'u' as i32
                {
                    current_block = 18285426872958990815;
                } else {
                    (*z).c += 1;
                    (*z).ket = (*z).c;
                    if in_grouping_U(
                    ...
                    ) != 0
                    {
                        ...
                        current_block = 11122371758720064166;
                    }
                }
                match current_block {
                    18285426872958990815 => {
                        (*z).c = c5;
                        if (*z).c == (*z).l
                            || *(*z).p.offset((*z).c as isize) as ::core::ffi::c_int
                                != 'i' as i32
                        {
                            current_block = 15445358081545638069;
                        } else {
                            (*z).c += 1;
                            (*z).ket = (*z).c;
                            if in_grouping_U(
...
unsafe fn r_mark_regions(mut z: *mut SN_env) -> ::core::ffi::c_int {
    ...
    *(*z).I.offset(0 as ::core::ffi::c_int as isize) = (*z).l;
    ...
    {
        current_block = 10820641762719878712;
    } else {
        let mut c3: ::core::ffi::c_int = (*z).c;
        if out_grouping_U(
            z,
        ...
        {
            current_block = 16724787900622143362;
        } else {
            ...
            if ret < 0 as ::core::ffi::c_int {
                ...
                (*z).c += ret;
                current_block = 16426564634721173671;
            }
        }
        match current_block {
            16426564634721173671 => {}
            _ => {
                (*z).c = c3;
                if in_grouping_U(
                    z,
    ...
    match current_block {
        10820641762719878712 => {
            ...
            {
                current_block = 11114210300505687229;
            } else {
                let mut c4: ::core::ffi::c_int = (*z).c;
                if out_grouping_U(
                    z,
                ...
                {
                    current_block = 7878332415988445584;
                } else {
...
pub unsafe fn italian_UTF_8_stem(mut z: *mut SN_env) -> ::core::ffi::c_int {
    let mut c1: ::core::ffi::c_int = (*z).c;
...
pub unsafe fn italian_UTF_8_create_env() -> *mut SN_env {
    return SN_create_env(0 as ::core::ffi::c_int, 3 as ::core::ffi::c_int);
}
pub unsafe fn italian_UTF_8_close_env(mut z: *mut SN_env) {
