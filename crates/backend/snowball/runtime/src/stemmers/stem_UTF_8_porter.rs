        ...
        2 => {
            ...
            match among_var {
                ...
                3 => {
                    ...
                    let mut ret_6: ::core::ffi::c_int = r_shortv(z);
                    if ret_6 <= 0 as ::core::ffi::c_int {
                        return ret_6;
                    }
                    (*z).c = (*z).l - m_test3;
                    let mut ret_7: ::core::ffi::c_int = 0;
...
unsafe fn r_Step_1c(mut z: *mut SN_env) -> ::core::ffi::c_int {
    ...
    (*z).bra = (*z).c;
    let mut ret: ::core::ffi::c_int = out_grouping_b_U(
        z,
        &raw const g_v as *const ::core::ffi::c_uchar,
        97 as ::core::ffi::c_int,
        121 as ::core::ffi::c_int,
...
pub unsafe fn porter_UTF_8_stem(mut z: *mut SN_env) -> ::core::ffi::c_int {
    ...
    *(*z).I.offset(2 as ::core::ffi::c_int as isize) = 0 as ::core::ffi::c_int;
    ...
    loop {
        ...
        loop {
            ...
            if ret_0 < 0 as ::core::ffi::c_int {
                current_block = 13080789833701393431;
                break;
            }
            (*z).c = ret_0;
        }
        match current_block {
            13080789833701393431 => {
                (*z).c = c3;
                break;
            }
            _ => {
    ...
    *(*z).I.offset(0 as ::core::ffi::c_int as isize) = (*z).l;
    ...
    let mut ret_6: ::core::ffi::c_int = r_Step_1a(z);
    if ret_6 < 0 as ::core::ffi::c_int {
        return ret_6;
    }
    (*z).c = (*z).l - m6;
    let mut m7: ::core::ffi::c_int = (*z).l - (*z).c;
    let mut ret_7: ::core::ffi::c_int = r_Step_1b(z);
    if ret_7 < 0 as ::core::ffi::c_int {
        return ret_7;
    }
    (*z).c = (*z).l - m7;
    let mut m8: ::core::ffi::c_int = (*z).l - (*z).c;
    let mut ret_8: ::core::ffi::c_int = r_Step_1c(z);
    if ret_8 < 0 as ::core::ffi::c_int {
        return ret_8;
    }
    (*z).c = (*z).l - m8;
    let mut m9: ::core::ffi::c_int = (*z).l - (*z).c;
    let mut ret_9: ::core::ffi::c_int = r_Step_2(z);
    if ret_9 < 0 as ::core::ffi::c_int {
        return ret_9;
    }
    (*z).c = (*z).l - m9;
    let mut m10: ::core::ffi::c_int = (*z).l - (*z).c;
    let mut ret_10: ::core::ffi::c_int = r_Step_3(z);
    if ret_10 < 0 as ::core::ffi::c_int {
        return ret_10;
    }
    (*z).c = (*z).l - m10;
    let mut m11: ::core::ffi::c_int = (*z).l - (*z).c;
    let mut ret_11: ::core::ffi::c_int = r_Step_4(z);
    if ret_11 < 0 as ::core::ffi::c_int {
        return ret_11;
    }
    (*z).c = (*z).l - m11;
    let mut m12: ::core::ffi::c_int = (*z).l - (*z).c;
    let mut ret_12: ::core::ffi::c_int = r_Step_5a(z);
    if ret_12 < 0 as ::core::ffi::c_int {
        return ret_12;
    }
    (*z).c = (*z).l - m12;
    let mut m13: ::core::ffi::c_int = (*z).l - (*z).c;
    let mut ret_13: ::core::ffi::c_int = r_Step_5b(z);
    ...
    if !(*(*z).I.offset(2 as ::core::ffi::c_int as isize) == 0) {
        ...
        loop {
            ...
            loop {
                ...
                {
                    (*z).c = c16;
                    let mut ret_14: ::core::ffi::c_int = skip_utf8(
                        (*z).p,
                        (*z).c,
                        (*z).l,
                        1 as ::core::ffi::c_int,
                    ...
                    (*z).ket = (*z).c;
                    (*z).c = c16;
                    current_block_91 = 18425699056680496821;
                    break;
                }
            }
...
pub unsafe fn porter_UTF_8_create_env() -> *mut SN_env {
    return SN_create_env(0 as ::core::ffi::c_int, 3 as ::core::ffi::c_int);
}
pub unsafe fn porter_UTF_8_close_env(mut z: *mut SN_env) {
