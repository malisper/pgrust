...
//! `statistics_core_seams` (panics until the owner installs them):
...
pub fn pg_stats_ext_mcvlist_items(fcinfo_id: u64) -> PgResult<datum::Datum> {
...
pub fn pg_mcv_list_out(fcinfo_id: u64) -> PgResult<datum::Datum> {
