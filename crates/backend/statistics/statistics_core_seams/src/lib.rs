...
seam_core::seam!(
    ...
    pub fn dependency_degree<'mcx>(
        data: &statistics::StatsBuildData<'mcx>,
        k: i32,
...
seam_core::seam!(
    ...
    pub fn statext_mcv_build<'mcx>(
        ...
        totalrows: f64,
        stattarget: i32,
    ) -> types_error::PgResult<Option<statistics::MCVList<'mcx>>>
);
...
seam_core::seam!(
    ...
    pub fn pg_stats_ext_mcvlist_items(fcinfo_id: u64) -> types_error::PgResult<datum::Datum>
);
...
seam_core::seam!(
    ...
    pub fn pg_mcv_list_out(fcinfo_id: u64) -> types_error::PgResult<datum::Datum>
);
