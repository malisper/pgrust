...
impl LocalBufferManager {
    ...
    pub fn LocalBufferAlloc(
        ...
        if let Some(bufid) = existing {
            ...
            bufmgr_seams::resowner_enlarge::call()?;
    ...
    pub fn FlushLocalBuffer(&self, bufid: i32) -> PgResult<()> {
        ...
        // off).
        {
            ...
            let mut page = page::PageMut::new(&mut storage.blocks[block_index][..])?;
            page::PageSetChecksumInplace(&mut page, tag.blockNum);
        }
    ...
    pub fn PinLocalBuffer(&self, bufid: i32, adjust_usagecount: bool) -> PgResult<bool> {
        ...
        bufmgr_seams::remember_buffer::call(Self::buffer_for_index(bufid));
    ...
    pub fn UnpinLocalBuffer(&self, buffer: Buffer) -> PgResult<()> {
        ...
        bufmgr_seams::forget_buffer::call(buffer);
        Ok(())
    }
