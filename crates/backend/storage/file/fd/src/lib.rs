...
pub fn init_seams() {
    ...
    postmaster_seams::remove_pg_temp_files::set(|| {
    ...
    utility_out_seams::close_all_vfds::set(|| {
    ...
    fileperm_seams::set_data_directory_create_perm::set(
    ...
    bufmgr_seams::io_direct_data::set(|| {
    ...
    {
        use tblspc_fs_seams as tfs_seams;
