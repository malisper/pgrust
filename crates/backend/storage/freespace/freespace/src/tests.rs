...
#[test]
fn vacuum_lanes_panic_named() {
    use std::panic::{catch_unwind, AssertUnwindSafe};
    let mcx = ::mcx::MemoryContext::new("fsm-test");
    let rel = ::types_rel::RelationData {
        ...
        rd_createSubid: Default::default(),
        rd_newRelfilelocatorSubid: Default::default(),
        rd_firstRelfilelocatorSubid: Default::default(),
        rd_droppedSubid: Default::default(),
        rd_lockInfo: Default::default(),
        rd_rel: ::types_rel::FormData_pg_class {
            relname: Default::default(),
            relnamespace: 0,
            reltype: 0,
            relowner: 0,
            relam: 0,
        ...
        rd_att: std::rc::Rc::new(::types_tuple::TupleDescData {
            natts: 0,
            tdtypeid: 0,
            tdtypmod: -1,
            tdrefcount: -1,
            constr: None,
            compact_attrs: ::mcx::PgVec::new_in(mcx.mcx()),
            attrs: ::mcx::PgVec::new_in(mcx.mcx()),
        }),
        rd_index: None,
        rd_opcintype: ::mcx::PgVec::new_in(mcx.mcx()),
        rd_opfamily: ::mcx::PgVec::new_in(mcx.mcx()),
        rd_indoption: ::mcx::PgVec::new_in(mcx.mcx()),
        rd_indcollation: ::mcx::PgVec::new_in(mcx.mcx()),
        rd_options: None,
