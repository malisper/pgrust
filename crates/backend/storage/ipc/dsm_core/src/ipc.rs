...
fn proc_exit_prepare(code: i32) {
    ...
    // is set.
    init_small_seams::set_interrupt_pending::call(false);
    init_small_seams::set_proc_die_pending::call(false);
    init_small_seams::set_query_cancel_pending::call(false);
    init_small_seams::set_interrupt_holdoff_count::call(1);
    ...
    postgres_seams::reset_debug_query_string::call();
...
pub fn shmem_exit(code: i32) -> PgResult<()> {
    ...
    let is_postmaster = init_small_seams::is_postmaster_environment::call()
