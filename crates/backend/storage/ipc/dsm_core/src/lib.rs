...
pub fn init_seams() {
    ...
    dsm_core_seams::dsm_estimate_size::set(|| Ok(dsm::dsm_estimate_size()));
    dsm_core_seams::dsm_shmem_init::set(dsm::dsm_shmem_init);
    ...
    dsm_core_seams::dsm_postmaster_startup::set(|shim| {
        let max_backends = init_small_seams::max_backends::call();
        dsm::dsm_postmaster_startup(shim, max_backends)
    });

    dsm_core_seams::proc_exit::set(ipc::proc_exit);
    ...
    dsm_core_seams::on_exit_reset::set(ipc::on_exit_reset);
    dsm_core_seams::check_on_shmem_exit_lists_are_empty::set(
        ipc::check_on_shmem_exit_lists_are_empty,
    );
    dsm_core_seams::dsm_cleanup_using_control_segment::set(
    ...
    postmaster_seams::shmem_exit::set(|code| {
