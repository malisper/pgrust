...
pub fn init_seams() {
    // barrier.c
    barrier_seams::BarrierInit::set(barrier::BarrierInit);
    barrier_seams::BarrierArriveAndWait::set(barrier::BarrierArriveAndWait);
    barrier_seams::BarrierArriveAndDetach::set(barrier::BarrierArriveAndDetach);
    barrier_seams::BarrierArriveAndDetachExceptLast::set(
        barrier::BarrierArriveAndDetachExceptLast,
    );
    barrier_seams::BarrierAttach::set(barrier::BarrierAttach);
    barrier_seams::BarrierDetach::set(barrier::BarrierDetach);
    barrier_seams::BarrierPhase::set(barrier::BarrierPhase);
    barrier_seams::BarrierParticipants::set(barrier::BarrierParticipants);

    // pmsignal.c
    pmsignal_seams::postmaster_is_alive::set(pmsignal::PostmasterIsAlive);
    pmsignal_seams::postmaster_death_signal_init::set(
        pmsignal::PostmasterDeathSignalInit_seam,
    );
    pmsignal_seams::send_postmaster_signal_bgworker_change::set(
        pmsignal::send_postmaster_signal_bgworker_change,
    );
    pmsignal_seams::send_postmaster_signal_start_autovac::set(
        pmsignal::send_postmaster_signal_start_autovac,
    );
    pmsignal_seams::send_postmaster_signal_xlog_is_shutdown::set(
        pmsignal::send_postmaster_signal_xlog_is_shutdown,
    );
    pmsignal_seams::send_postmaster_signal_recovery_started::set(
        pmsignal::send_postmaster_signal_recovery_started,
    );
    pmsignal_seams::send_postmaster_signal_recovery_consistent::set(
        pmsignal::send_postmaster_signal_recovery_consistent,
    );
    pmsignal_seams::send_postmaster_signal_begin_hot_standby::set(
        pmsignal::send_postmaster_signal_begin_hot_standby,
    );
    pmsignal_seams::pm_signal_shmem_size::set(pmsignal::PMSignalShmemSize);
    pmsignal_seams::pm_signal_shmem_init::set(pmsignal::PMSignalShmemInit);
