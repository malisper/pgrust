...
pub fn ProcSleep(
    ...
    let deadlock_timeout = guc_tables::vars::DeadlockTimeout.read();
    let lock_timeout = guc_tables::vars::LockTimeout.read();
    ...
    loop {
        ...
        if guc_tables::vars::log_lock_waits.read()
...
fn append_str(sbuf: &mut stringinfo::StringInfo<'_>, s: &str) -> PgResult<()> {
