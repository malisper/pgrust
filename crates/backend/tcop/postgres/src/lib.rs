...
pub fn init_seams() {
    ...
    guc_tables::vars::client_connection_check_interval.install(
    ...
    guc_tables::vars::Log_disconnections.install(
        guc_tables::GucVarAccessors {
    ...
    matview_deps_seams::check_for_interrupts::set(
    ...
    // does).
    execParallel_support_seams::set_debug_query_string::set(|s| {
    ...
    s::post_auth_delay::set(init_small::globals::post_auth_delay);
    ...
    s::set_idle_in_transaction_session_timeout_pending::set(
        init_small::globals::SetIdleInTransactionSessionTimeoutPending,
    );
    ...
    s::set_idle_stats_update_timeout_pending::set(
        init_small::globals::SetIdleStatsUpdateTimeoutPending,
    );
    s::set_check_client_connection_pending::set(
        init_small::globals::SetCheckClientConnectionPending,
    );

    // --- F6: GUC check/assign hooks + restrict_nonsystem_relation_kind reader ---
    guc_tables_seams::restrict_nonsystem_relation_kind::set(
    ...
    parallel_rt_seams::debug_parallel_query::set(|| {
        guc_tables::vars::debug_parallel_query.read()
    });
    ...
    parser_analyze_seams::pg_analyze_and_rewrite_fixedparams::set(
    ...
    parser_analyze_seams::pg_analyze_and_rewrite_fixedparams_params::set(
    ...
    parser_analyze_seams::analyze_and_rewrite_varparams::set(
