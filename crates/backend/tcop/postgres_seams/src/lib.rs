...
seam_core::seam!(
    ...
    pub fn pg_plan_query<'mcx>(
        mcx: mcx::Mcx<'mcx>,
        querytree: nodes::portalcmds::Query,
        query_string: std::string::String,
        cursor_options: i32,
        bound_params: nodes::portalcmds::ParamListInfo,
    ) -> types_error::PgResult<nodes::nodeindexscan::PlannedStmt<'mcx>>
);
...
seam_core::seam!(
    ...
    /// list of already-rewritten [`Query`](nodes::copy_query::Query)s,
    ...
    /// `planner_pc_seams::plan_queries`.
    pub fn pg_plan_queries_value<'mcx, 'q>(
        mcx: mcx::Mcx<'mcx>,
        querytrees: &[nodes::copy_query::Query<'q>],
        query_string: &str,
        cursor_options: i32,
        bound_params: nodes::params::ParamListInfo,
    ) -> types_error::PgResult<mcx::PgVec<'mcx, nodes::nodeindexscan::PlannedStmt<'mcx>>>
);
