...
pub fn init_seams() {
    parse_seams::config_lenmap::set(dispatch::config_lenmap);
    parse_seams::config_dict_ids::set(dispatch::config_dict_ids);
    parse_seams::dict_lexize::set(dispatch::dict_lexize);
    dict_seams::subdict_lexize::set(dispatch::subdict_lexize);
