...
pub fn init_seams() {
    ts_utils_seams::get_tsearch_config_filename::set(get_tsearch_config_filename);
    ts_utils_seams::readstoplist::set(readstoplist);
    ts_utils_seams::searchstoplist::set(searchstoplist);
}
