...
pub fn pgstat_count_io_op(
    ...
    pgstat_io_seams::pgstat_count_backend_io_op::call(
...
fn pgstat_prepare_io_time_seam() -> instr_time {
    pgstat_prepare_io_time(guc_tables::vars::track_wal_io_timing.read())
}
    ...
    if !start_time.is_zero() {
        ...
        if io_object != IOObject::IOOBJECT_WAL {
            if io_op == IOOp::IOOP_WRITE || io_op == IOOp::IOOP_EXTEND {
                stat_seams::pgstat_count_buffer_write_time::call(
                ...
                stat_seams::pgstat_count_buffer_read_time::call(
                    io_time.get_microsec(),
                );
                if io_object == IOObject::IOOBJECT_RELATION {
            ...
            pgstat_io_seams::pgstat_count_backend_io_op_time::call(
...
pub fn init_seams() {
    ...
    pgstat_io_seams::pgstat_prepare_io_time::set(pgstat_prepare_io_time_seam);
    pgstat_io_seams::pgstat_count_io_op_time::set(
        pgstat_count_io_op_time_wal_write_seam,
    );
    pgstat_io_seams::pgstat_count_io_op_time_wal_read::set(
    ...
    pgstat_io_seams::pgstat_flush_io::set(|nowait| {
    ...
    stat_seams::pgstat_flush_io::set(pgstat_io_flush_cb);
    ...
    bufmgr_seams::count_io_op_extend::set(|io_context, cnt, bytes| {
        pgstat_count_io_op(
    ...
    bufmgr_seams::count_io_op_read::set(|io_context, cnt, bytes| {
        pgstat_count_io_op(
            IOObject::IOOBJECT_RELATION,
            io_context,
            IOOp::IOOP_READ,
    ...
    bufmgr_seams::count_io_op_hit::set(|io_context, cnt| {
        pgstat_count_io_op(
            IOObject::IOOBJECT_RELATION,
            io_context,
            IOOp::IOOP_HIT,
    ...
    bufmgr_seams::count_io_op_evict::set(|io_context, cnt| {
        pgstat_count_io_op(
            IOObject::IOOBJECT_RELATION,
            io_context,
            IOOp::IOOP_EVICT,
    ...
    bufmgr_seams::count_io_op_reuse::set(|io_context, cnt| {
        pgstat_count_io_op(
            IOObject::IOOBJECT_RELATION,
            io_context,
            IOOp::IOOP_REUSE,
    ...
    bufmgr_seams::count_io_op_write::set(|io_context, cnt, bytes| {
        pgstat_count_io_op(
            IOObject::IOOBJECT_RELATION,
            io_context,
            IOOp::IOOP_WRITE,
    ...
    bufmgr_seams::count_io_op_temp::set(|io_op, cnt, bytes| {
        pgstat_count_io_op(
