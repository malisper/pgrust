...
fn store_current_wait_event(wait_event_info: uint32) {
    ...
    match target {
        ...
        Some(WaitEventTarget::Proc(procno)) => {
            lmgr_proc_seams::set_proc_wait_event_info::call(procno, wait_event_info)
        }
...
pub fn init_seams() {
    ...
    waitevent_seams::wait_event_custom_shmem_size::set(
        WaitEventCustomShmemSize,
    );
    waitevent_seams::wait_event_custom_shmem_init::set(
    ...
    pgstat_seams::pgstat_set_wait_event_storage_for_proc::set(
        pgstat_set_wait_event_storage_for_proc,
    );
    pgstat_seams::pgstat_reset_wait_event_storage::set(
