...
pub fn init_seams() {
    ...
    json_seams::escape_json::set(escape_json_into_pgstring);
    json_seams::escape_json_with_len::set(escape_json_with_len_into_pgstring);
    json_seams::json_encode_datetime::set(JsonEncodeDateTime);
    clauses_seams::to_json_is_immutable::set(to_json_is_immutable);
}
