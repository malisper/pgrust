...
pub fn init_seams() {
    ...
    seams::func_volatile::set(lsyscache::function::func_volatile);
    ...
    jsonb_seams::extract_variadic_array::set(
    ...
    jsonb_seams::deconstruct_text_array_with_dims::set(
