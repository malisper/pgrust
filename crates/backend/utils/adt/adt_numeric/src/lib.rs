...
pub fn init_seams() {
    ...
    jsonb_seams::numeric_int2::set(ops_sql::seam_numeric_int2);
    jsonb_seams::numeric_int4::set(ops_sql::seam_numeric_int4);
    jsonb_seams::numeric_int8::set(ops_sql::seam_numeric_int8);
    ...
    small1_seams::numeric_in::set(|mcx, s| io::numeric_in(mcx, s, -1));
