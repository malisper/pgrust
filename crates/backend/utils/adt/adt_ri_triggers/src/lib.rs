...
impl<'a, 'mcx> RelSide<'a, 'mcx> {
    ...
    pub fn oid(&self) -> Oid {
        match self {
            ...
            RelSide::Trigger(t) => trigger_seams::tg_relation_oid::call(*t),
        }
    }
    ...
    pub fn name_bytes(&self, mcx: Mcx<'_>) -> PgResult<Vec<u8>> {
        match self {
            ...
            RelSide::Trigger(t) => {
                Ok(trigger_seams::tg_relation_name::call(mcx, *t)?.to_vec())
            }
        }
    }
    ...
    pub fn namespace(&self) -> Oid {
        match self {
            ...
            RelSide::Trigger(t) => trigger_seams::tg_relation_namespace::call(*t),
        }
    }
    ...
    pub fn owner(&self) -> Oid {
        match self {
            ...
            RelSide::Trigger(t) => trigger_seams::tg_relation_owner::call(*t),
        }
    }
    ...
    pub fn att_name(&self, mcx: Mcx<'_>, attnum: i16) -> PgResult<Vec<u8>> {
        match self {
            ...
            RelSide::Trigger(t) => Ok(
                trigger_seams::tg_relation_att_name::call(mcx, *t, attnum)?
                    .to_vec(),
            ),
        }
    }
    ...
    pub fn att_type(&self, attnum: i16) -> Oid {
        match self {
            ...
            RelSide::Trigger(t) => {
                trigger_seams::tg_relation_att_type::call(*t, attnum)
            }
        }
    }
    ...
    pub fn att_collation(&self, attnum: i16) -> Oid {
        match self {
            ...
            RelSide::Trigger(t) => {
                trigger_seams::tg_relation_att_collation::call(*t, attnum)
            }
        }
    }
}
...
pub fn init_seams() {
    ri_triggers_seams::invalidate_constraint_cache_callback::set(
    ...
    ri_triggers_seams::ri_initial_check::set(triggers::ri_initial_check);
    ri_triggers_seams::ri_fkey_check_ins::set(triggers::ri_fkey_check_ins);
    ...
    ri_triggers_seams::ri_partition_remove_check::set(
    ...
    ri_triggers_seams::ri_fkey_trigger_type::set(checks::ri_fkey_trigger_type);
    ri_triggers_seams::ri_fkey_pk_upd_check_required::set(
        triggers::ri_fkey_pk_upd_check_required,
    );
    ri_triggers_seams::ri_fkey_fk_upd_check_required::set(
