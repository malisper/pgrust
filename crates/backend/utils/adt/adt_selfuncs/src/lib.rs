...
/// primitives declared in [`selfuncs_seams`]). Wired into
...
pub fn init_seams() {
    ...
    pathnode_seams::estimate_num_groups_simple::set(
    ...
    path_small_seams::boolvarsel::set(node_sel::seam_boolvarsel);
    path_small_seams::booltestsel::set(node_sel::seam_booltestsel);
    path_small_seams::nulltestsel::set(node_sel::seam_nulltestsel);
    path_small_seams::nulltestsel_var::set(node_sel::seam_nulltestsel);
    path_small_seams::rowcomparesel::set(node_sel::seam_rowcomparesel);
    path_small_seams::scalararraysel::set(node_sel::seam_scalararraysel);
    ...
    costsize_seams::amcostestimate::set(
    ...
    // context.
    costsize_seams::mergejoinscansel::set(
    ...
    costsize_seams::estimate_hash_bucket_stats::set(
        |run, root, hashkey, nbuckets| {
            mergejoin::estimate_hash_bucket_stats(run.mcx(), run, root, hashkey, nbuckets)
        },
    );
    costsize_seams::estimate_multivariate_bucketsize::set(
    ...
    costsize_seams::estimate_array_length::set(|root, node| {
...
pub(crate) const RTE_VALUES: pathnodes::RTEKind = 5;
