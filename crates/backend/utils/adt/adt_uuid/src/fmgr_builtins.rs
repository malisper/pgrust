...
mod tests {
    ...
    fn uuid_image(s: &str) -> Vec<u8> {
        ...
        let native =
            fmgr_core::native_builtin(2952).expect("uuid_in registered native");
    ...
    fn uuid_text(image: &[u8]) -> String {
        ...
        let native =
            fmgr_core::native_builtin(2953).expect("uuid_out registered native");
    ...
    fn byref_uuid_hash_through_registry() {
        ...
        let h = |oid: u32, img: &[u8]| -> i32 {
            ...
            let native = fmgr_core::native_builtin(oid).expect("registered native");
        ...
        let native = fmgr_core::native_builtin(3412).expect("registered native");
        ...
        let native2 = fmgr_core::native_builtin(3412).expect("registered native");
    ...
    fn byref_uuid_send_recv_through_registry() {
        ...
        let native =
            fmgr_core::native_builtin(2962).expect("uuid_send registered native");
        ...
        let native2 =
            fmgr_core::native_builtin(2961).expect("uuid_recv registered native");
