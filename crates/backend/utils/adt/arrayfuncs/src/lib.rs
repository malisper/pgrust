...
//! all have real bodies. The prerequisite ABI types live in [`array`]
...
pub fn init_seams() {
    ...
    seams::construct_md_array_like_input_v::set(construct::construct_md_array_like_input_v);
