...
pub fn init_seams() {
    float_seams::float8_mul::set(float8_mul);
    float_seams::float8_div::set(float8_div);
    float_seams::float8_pl::set(float8_pl);
    float_seams::float8_mi::set(float8_mi);
    float_seams::float8_eq::set(float8_eq);
    float_seams::float8_lt::set(float8_lt);
    float_seams::float8_gt::set(float8_gt);
    float_seams::float8_min::set(float8_min);
    float_seams::float8_max::set(float8_max);
    float_seams::get_float8_infinity::set(get_float8_infinity);
    float_seams::get_float8_nan::set(get_float8_nan);
    float_seams::float_overflow_error::set(float_overflow_error);
    float_seams::float_underflow_error::set(float_underflow_error);
    float_seams::float8in_internal_endptr::set(float8in_internal_endptr_seam);
    float_seams::float8out_internal::set(float8out_internal);
    ...
    guc_tables::vars::extra_float_digits.install(
