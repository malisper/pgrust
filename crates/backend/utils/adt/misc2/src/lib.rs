...
//! SortSupportData / SRF FuncCallContext / prng substrate the window/SRF
...
/// `seams-init::init_all()`.
pub fn init_seams() {
    misc2_seams::eoh_get_flat_size::set(expandeddatum::eoh_get_flat_size);
    misc2_seams::eoh_flatten_into::set(expandeddatum::eoh_flatten_into);
    misc2_seams::make_expanded_object_read_only_internal_v::set(
    ...
    domains_seams::plan_check_expr::set(domains::plan_check_expr);
    ...
    domains_seams::lookup_domain_type_level::set(
    ...
    regproc_seams::format_procedure::set(regproc::format_procedure);
    regproc_seams::format_operator::set(regproc::format_operator);
    regproc_seams::format_procedure_extended::set(
        regproc::format_procedure_extended,
    );
    regproc_seams::format_operator_extended::set(
        regproc::format_operator_extended,
    );
    misc2_seams::format_procedure_parts::set(regproc::format_procedure_parts);
    misc2_seams::format_operator_parts::set(regproc::format_operator_parts);
    ...
    xml_libxml_seams::regclass_name::set(|relid| {
    ...
    regproc_seams::regprocedurein::set(seam_regprocedurein);
    regproc_seams::regtypein::set(seam_regtypein);
    regproc_seams::string_to_qualified_name_list::set(
        seam_string_to_qualified_name_list,
    );
    dict_seams::get_ts_dict_oid_from_name::set(
