...
//! The transitional bare-word `datum::Datum` variant has been retired (its
//! sole consumer migrated to the unified carrier); `datum` survives here
//! only for the opaque [`datum::ExpandedObjectRef`] handle, which is a
