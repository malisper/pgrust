...
//! algorithm is a parity requirement: equal-key output order decides range
//! picksplit page assignment, which the index byte-parity gate observes. Comparators are fallible (fmgr); an error aborts the sort with
