...
pub fn pg_get_partition_constraintdef<'mcx>(
    ...
    let constr_expr =
        partcache_seams::get_partition_qual_relid::call(mcx, relation_id)?;
    ...
    let relname = lsyscache_seams::get_rel_name::call(mcx, relation_id)?
        .ok_or_else(|| {
...
pub fn pg_get_partconstrdef_string<'mcx>(
    ...
    let constr_expr =
        partcache_seams::get_partition_qual_relid::call(mcx, partition_id)?;
