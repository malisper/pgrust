...
pub fn init_seams() {
    ...
    partbounds_seams::get_range_partbound_string::set(
    ...
    ruleutils_seams::generate_collation_name::set(
        crate::generate_collation_name,
    );
    ruleutils_seams::generate_opclass_name::set(crate::generate_opclass_name);

    ruleutils_seams::quote_identifier::set(crate::quote_identifier);
    ruleutils_seams::quote_qualified_identifier::set(
    ...
    ruleutils_seams::deparse_expr_for_plan::set(
    ...
    ruleutils_seams::deparse_window_frame_for_plan::set(
    ...
    genam_seams::pg_get_indexdef_columns::set(
    ...
    ruleutils_seams::generate_relation_name::set(
    ...
    ruleutils_seams::generate_function_name::set(
    ...
    ruleutils_seams::generate_operator_clause::set(
    ...
    matview_deps_seams::generate_operator_clause::set(
    ...
    guc_funcs_seams::quote_identifier::set(|val| {
    ...
    typecmds_seams::deparse_expression::set(|mcx, expr| {
    ...
    ruleutils_seams::pg_get_partkeydef_columns::set(|mcx, relid, pretty| {
    ...
    ruleutils_seams::partition_constraint_def::set(|mcx, pk_relid| {
    ...
    ruleutils_seams::pg_get_expr_worker::set(|mcx, exprstr, relid, pretty| {
