...
pub fn init_seams() {
    ...
    parse_seams::ts_execute_hl::set(op::ts_execute_hl_seam);
    parse_seams::ts_execute_locations_hl::set(op::ts_execute_locations_hl_seam);
