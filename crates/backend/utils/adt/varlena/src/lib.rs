...
thread_local! {
    ...
    static BYTEA_OUTPUT: Cell<i32> =
        const { Cell::new(guc_tables::consts::BYTEA_OUTPUT_HEX) };
}
...
pub fn init_seams() {
    ...
    guc_tables::vars::bytea_output.install(
    ...
    comment_seams::cstring_get_text_datum::set(seam_cstring_get_text_datum);
    comment_seams::text_datum_get_cstring::set(seam_text_datum_get_cstring);
    seclabel_seams::cstring_get_text_datum::set(seam_cstring_get_text_datum);
    seclabel_seams::text_datum_get_cstring::set(seam_text_datum_get_cstring);
