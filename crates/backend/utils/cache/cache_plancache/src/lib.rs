...
use lmgr_pc_seams as lmgr_seams;
use inval_pc_seams as inval_seams;
use syscache_pc_seams as syscache_seams;
use backendstate_pc_seams as backend_seams;
use pc_seams as resowner_seams;
use snapmgr_pc_seams as snapmgr_seams;

use plancache_seams as inward;
use plancache_portal_seams as portal_inward;
...
pub fn init_seams() {
    ...
    guc_tables::vars::plan_cache_mode.install(
    ...
    backend_seams::plan_cache_mode::set(|| {
        Ok(guc_tables::vars::plan_cache_mode.read())
    });
}
