...
pub fn SearchSysCache<'mcx>(
    ...
    trace::trace!(trace::Category::Syscache, "SearchSysCache cacheId={}", cacheId);
...
pub fn SearchSysCache1<'mcx>(
    ...
    trace::trace!(trace::Category::Syscache, "SearchSysCache1 cacheId={}", cacheId);
...
pub fn SearchSysCache2<'mcx>(
    ...
    trace::trace!(trace::Category::Syscache, "SearchSysCache2 cacheId={}", cacheId);
...
pub fn SearchSysCache3<'mcx>(
    ...
    trace::trace!(trace::Category::Syscache, "SearchSysCache3 cacheId={}", cacheId);
...
pub fn SearchSysCache4<'mcx>(
    ...
    trace::trace!(trace::Category::Syscache, "SearchSysCache4 cacheId={}", cacheId);
...
pub fn ReleaseSysCache(tuple: FormedTuple<'_>) {
    trace::trace!(trace::Category::Syscache, "ReleaseSysCache");
    drop(tuple);
}
...
pub fn init_seams() {
    ...
    functioncmds_seams::lookup_language_by_name::set(|langname| {
    ...
    pg_proc_seams::search_proc_name_args_nsp::set(
        projections::search_proc_name_args_nsp,
    );
    // fmgr_sql_validator's PROCOID read (pg_proc.c:851); syscache.c is its owner.
    pg_proc_seams::search_proc_oid_sql::set(projections::search_proc_oid_sql);
    // CreateCast's PROCOID read of the cast function's pg_proc form
    // (functioncmds.c); syscache.c is its owner.
    functioncmds_seams::fetch_cast_func_form::set(
        projections::fetch_cast_func_form,
    );
    // CreateTransform's PROCOID read of the transform function's pg_proc form
    // (functioncmds.c); syscache.c is its owner.
    functioncmds_seams::fetch_transform_func_form::set(
        projections::fetch_transform_func_form,
    );
    statistics_core_seams::statext_ndistinct_load_bytea::set(
        projections::statext_ndistinct_load_bytea,
    );
    statistics_core_seams::mcv_load_bytea::set(projections::mcv_load_bytea);
    syscache_seams::lookup_enum_by_oid::set(projections::lookup_enum_by_oid);
    syscache_seams::lookup_enum_by_typoid_name::set(
        projections::lookup_enum_by_typoid_name,
    );
    syscache_seams::search_relation_relam::set(projections::search_relation_relam);
    syscache_seams::search_am_handler::set(projections::search_am_handler);
    syscache_seams::search_rewrite_oid::set(projections::search_rewrite_oid);
    syscache_seams::search_relation_reloftype::set(projections::search_relation_reloftype);
    syscache_seams::cast_by_source_target::set(projections::cast_by_source_target);
    syscache_seams::search_opclass::set(projections::search_opclass);
    syscache_seams::search_amop_list::set(projections::search_amop_list);
    syscache_seams::amop_by_strategy_full::set(projections::amop_by_strategy_full);
    syscache_seams::search_amproc_list::set(projections::search_amproc_list);
    syscache_seams::search_amproc_list2::set(projections::search_amproc_list2);
    syscache_seams::search_opclass_list_by_am::set(
        projections::search_opclass_list_by_am,
    );
    syscache_seams::pg_operator_form::set(projections::pg_operator_form);
    syscache_seams::oper_catlist3::set(projections::oper_catlist3);
    syscache_seams::oper_catlist1::set(projections::oper_catlist1);
    syscache_seams::oper_row_by_oid::set(projections::oper_row_by_oid);
    vacuum_seams::search_syscache_class::set(projections::search_syscache_class);
    clauses_seams::get_func_form::set(projections::get_func_form);
    clauses_seams::get_func_sql_body::set(projections::get_func_sql_body);
    clauses_seams::fetch_function_defaults::set(
        projections::fetch_function_defaults,
    );
    syscache_seams::amop_list_by_opr::set(projections::amop_list_by_opr);
    syscache_seams::oper_oprcode::set(projections::oper_oprcode);
    syscache_seams::oper_oprcom::set(projections::oper_oprcom);
    syscache_seams::oper_input_types::set(projections::oper_input_types);
    syscache_seams::proc_isstrict::set(projections::proc_isstrict);
    syscache_seams::proc_cost_rows::set(projections::proc_cost_rows);
    syscache_seams::proc_argdefaults::set(projections::proc_argdefaults);
    syscache_seams::open_partrel_tuple::set(projections::open_partrel_tuple);
    syscache_seams::agg_row_by_oid::set(projections::agg_row_by_oid);
    syscache_seams::agg_form_by_oid::set(projections::agg_form_by_oid);
    ...
    prepagg_seams::get_agg_catalog_info::set(
        projections::get_agg_catalog_info,
    );
    syscache_seams::foreign_data_wrapper_options::set(
        projections::foreign_data_wrapper_options,
    );
    syscache_seams::foreign_server_options::set(
        projections::foreign_server_options,
    );
    syscache_seams::user_mapping_options_by_oid::set(
        projections::user_mapping_options_by_oid,
    );
    syscache_seams::foreign_data_wrapper_form::set(
        projections::foreign_data_wrapper_form,
    );
    syscache_seams::foreign_server_form::set(projections::foreign_server_form);
    syscache_seams::foreign_data_wrapper_oid_by_name::set(
    ...
    // proclang owner.
    syscache_seams::language_oid_by_name::set(projections::language_oid_by_name);
    syscache_seams::language_tuple_by_name::set(
        projections::language_tuple_by_name,
    );
    syscache_seams::foreign_server_oid_by_name::set(
        projections::foreign_server_oid_by_name,
    );
    syscache_seams::foreign_table_server_by_relid::set(
        projections::foreign_table_server_by_relid,
    );
    syscache_seams::foreign_table_form::set(projections::foreign_table_form);
    syscache_seams::user_mapping_form::set(projections::user_mapping_form);
    syscache_seams::attribute_fdwoptions::set(
        projections::attribute_fdwoptions,
    );
    syscache_seams::relation_supports_syscache::set(
        projections::relation_supports_syscache,
    );
    syscache_seams::init_catalog_cache_phase2::set(
        projections::init_catalog_cache_phase2,
    );
    syscache_seams::search_syscache_exists_reloid::set(
    ...
    functioncmds_seams::function_exists_in_namespace::set(
        projections::function_exists_in_namespace,
    );
    syscache_seams::rel_relkind::set(projections::rel_relkind);
    syscache_seams::rel_relhastriggers::set(
        projections::rel_relhastriggers,
    );
    syscache_seams::pg_proc_form::set(projections::pg_proc_form);
    syscache_seams::proc_prosrc::set(projections::proc_prosrc);
    syscache_seams::pg_type_form::set(projections::pg_type_form);
    syscache_seams::type_form::set(projections::type_form);
    syscache_seams::search_type_attr_info::set(
        projections::search_type_attr_info,
    );
    syscache_seams::get_opclass_oid::set(projections::get_opclass_oid);
    syscache_seams::search_syscache_attname::set(
        projections::search_syscache_attname,
    );
    syscache_seams::lookup_authid_by_oid::set(projections::lookup_authid_by_oid);
    syscache_seams::authid_rolname::set(projections::authid_rolname);
    syscache_seams::get_namespace_oid_cached::set(
        projections::get_namespace_oid_cached,
    );
    syscache_seams::relname_relid::set(projections::relname_relid);
    ...
    syscache_seams::lookup_authmem_list_by_role::set(
        projections::lookup_authmem_list_by_role,
    );
    syscache_seams::lookup_language::set(projections::lookup_language);
    syscache_seams::pg_index_has_predicate::set(
        projections::pg_index_has_predicate,
    );
    syscache_seams::pg_index_tid_and_hasexprs::set(
        projections::pg_index_tid_and_hasexprs,
    );
    syscache_seams::pg_index_exprs_text::set(
        projections::pg_index_exprs_text,
    );
    syscache_seams::pg_index_pred_text::set(
        projections::pg_index_pred_text,
    );
    syscache_seams::pg_class_relpartbound_text::set(
        projections::pg_class_relpartbound_text,
    );
    syscache_seams::pg_class_relpartbound_text_direct::set(
        projections::pg_class_relpartbound_text,
    );
    syscache_seams::search_pg_index_info::set(
        projections::search_pg_index_info,
    );
    syscache_seams::rule_tuple_by_relname::set(
        projections::rule_tuple_by_relname,
    );
    syscache_seams::class_relkind_namespace::set(
        projections::class_relkind_namespace,
    );
    syscache_seams::collation_qualified_name::set(
        projections::collation_qualified_name,
    );
    syscache_seams::pg_constraint_clone_info::set(
        projections::pg_constraint_clone_info,
    );
    syscache_seams::search_pg_class_full_form::set(
        projections::search_pg_class_full_form,
    );
    syscache_seams::database_syscache_hash_value::set(
    ...
    pg_locale_catalog_seams::database_locale_row::set(
        projections::database_locale_row,
    );
    pg_locale_catalog_seams::collation_locale_row::set(
        projections::collation_locale_row,
    );
    pg_locale_catalog_seams::my_database_id::set(|| {
    ...
    syscache_seams::get_syscache_hash_value_constroid::set(
        projections::get_syscache_hash_value_constroid,
    );
    syscache_seams::get_syscache_hash_value_typeoid::set(
        projections::get_syscache_hash_value_typeoid,
    );
    syscache_seams::get_syscache_hash_value_oid::set(
        projections::get_syscache_hash_value_oid,
    );
    syscache_seams::opfamily_namespace_method_name::set(
        projections::opfamily_namespace_method_name,
    );
    syscache_seams::proc_row_by_oid::set(projections::proc_row_by_oid);
    syscache_seams::proc_catlist::set(projections::proc_catlist);
    syscache_seams::proc_arg_attrs::set(projections::proc_arg_attrs);
    syscache_seams::proc_compile_row::set(projections::proc_compile_row);
    syscache_seams::search_constraint_form_by_oid::set(
        projections::search_constraint_form_by_oid,
    );
    syscache_seams::search_pg_constraintdef_info::set(
        projections::search_pg_constraintdef_info,
    );
    syscache_seams::search_pg_functiondef_info::set(
        projections::search_pg_functiondef_info,
    );
    syscache_seams::fetch_relchecks::set(projections::fetch_relchecks);
    syscache_seams::search_syscache_copy_pg_class_tuple::set(
        projections::search_syscache_copy_pg_class_tuple,
    );
    syscache_seams::search_syscache_copy_pg_class::set(
        projections::search_syscache_copy_pg_class,
    );
    syscache_seams::search_syscache_copy_pg_index::set(
        projections::search_syscache_copy_pg_index,
    );
    syscache_seams::lookup_proc::set(projections::lookup_proc);
    syscache_seams::lookup_proc_result_info::set(
        projections::lookup_proc_result_info,
    );
    syscache_seams::pg_index_indclass::set(projections::pg_index_indclass);
    syscache_seams::read_constraint_form::set(
        projections::read_constraint_form,
    );
    syscache_seams::get_conkey_array::set(projections::get_conkey_array);
    syscache_seams::heap_get_conkey::set(projections::heap_get_conkey);
    syscache_seams::deconstruct_fk_arrays::set(
        projections::deconstruct_fk_arrays,
    );
    syscache_seams::search_constraint_tuple_by_oid::set(
    ...
    amutils_seams::index_relation::set(projections::amutils_index_relation);
    amutils_seams::index_form::set(projections::amutils_index_form);

    // ACL/owner catalog-row projections (the aclmask/aclcheck F0 keystone).
    syscache_seams::pg_class_owner_acl::set(projections::pg_class_owner_acl);
    syscache_seams::pg_attribute_owner_acl::set(
    ...
    syscache_seams::pg_attribute_form::set(projections::pg_attribute_form);
    syscache_seams::pg_attribute_attoptions::set(
        projections::pg_attribute_attoptions,
    );
    syscache_seams::pg_attribute_attstattarget::set(
        projections::pg_attribute_attstattarget,
    );
    syscache_seams::pg_namespace_owner_acl::set(
        projections::pg_namespace_owner_acl,
    );
    syscache_seams::pg_type_owner_acl::set(projections::pg_type_owner_acl);
    syscache_seams::object_owner_acl::set(projections::object_owner_acl);
    syscache_seams::parameter_acl_by_name::set(
        projections::parameter_acl_by_name,
    );
    syscache_seams::parameter_acl_by_oid::set(
        projections::parameter_acl_by_oid,
    );

    // pg_statistic (STATRELATTINH) — the selfuncs / lsyscache statistics path.
    syscache_seams::search_statrelattinh::set(
        projections::search_statrelattinh,
    );
    syscache_seams::release_stats_tuple::set(
        projections::release_stats_tuple,
    );
    syscache_seams::statext_expressions_load::set(
        projections::statext_expressions_load,
    );
    syscache_seams::release_dummy_stats_tuple::set(
        projections::release_dummy_stats_tuple,
    );
    syscache_seams::pg_statistic_stanullfrac::set(
        projections::pg_statistic_stanullfrac,
    );
    syscache_seams::pg_statistic_stadistinct::set(
        projections::pg_statistic_stadistinct,
    );
    syscache_seams::pg_statistic_slot_meta::set(
        projections::pg_statistic_slot_meta,
    );
    syscache_seams::syscache_get_attr_not_null_statistic::set(
        projections::syscache_get_attr_not_null_statistic,
    );
    syscache_seams::pg_statistic_stawidth::set(
    ...
    funccache_seams::search_proc_compile_info::set(
    ...
    dbcommands_seams::user_rolcreatedb::set(|_mcx, roleid| {
    ...
    syscache_pc_seams::syscache_id::set(syscache_id_for);
}
