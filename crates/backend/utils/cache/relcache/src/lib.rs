...
//!
//! The cross-unit value-slice [`rel::RelationData`] is what an *open
...
pub(crate) fn elog_warning(message: String) -> utils_error::PgResult<()> {
    utils_error::elog(types_error::WARNING, message)
}
