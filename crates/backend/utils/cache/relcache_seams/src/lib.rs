...
//! trimmed [`rel::RelationData`] copy (see `crates/types-rel`), so
...
pub struct RewriteRuleImage<'mcx> {
    ...
    pub qual: Option<mcx::PgBox<'mcx, nodes::nodes::Node<'mcx>>>,
    /// `List *actions` — the rule's action `Query` trees, re-homed into `mcx`.
    pub actions: mcx::PgVec<'mcx, nodes::copy_query::Query<'mcx>>,
}
...
/// CLONE of C's live `RelationData *` into the cache. `rel::Relation`
...
/// The concrete shared relcache cell a [`rel::Relation`] carries, if it
...
/// [`rel::Relation::entry_as`] over the relcache owner's `RelationData`.
pub fn relation_entry_cell(rel: &rel::Relation<'_>) -> Option<RelcacheEntryCell> {
    rel.entry_as::<RelationData>()
}

/// Borrow the shared relcache entry a [`rel::Relation`] carries and run
/// `f` against it (the live entry — sees in-place rebuilds). `None` for a
/// cache-less handle. Monomorphizes [`rel::Relation::with_entry`] over
...
seam_core::seam!(
    ...
    ) -> types_error::PgResult<Option<rel::RelationData<'mcx>>>
);
...
seam_core::seam!(
    ...
    /// wave can re-key `rel::Relation` onto the shared entry cell across
...
seam_core::seam!(
    ...
    pub fn relation_needs_wal(rel: &rel::RelationData<'_>) -> bool
);
...
seam_core::seam!(
    ...
    pub fn relation_is_local(rel: &rel::RelationData<'_>) -> bool
);
...
seam_core::seam!(
    ...
    pub fn relation_get_partcheck<'mcx>(
        mcx: mcx::Mcx<'mcx>,
        relid: types_core::Oid,
    ) -> types_error::PgResult<(bool, mcx::PgVec<'mcx, nodes::nodes::Node<'mcx>>)>
);
...
seam_core::seam!(
    ...
    pub fn relation_set_partcheck<'mcx>(
        relid: types_core::Oid,
        partcheck: mcx::PgVec<'mcx, nodes::nodes::Node<'mcx>>,
    ) -> types_error::PgResult<()>
);
...
seam_core::seam!(
    /// `rel->rd_rel->relam`.
    pub fn rd_rel_relam(rel: &rel::Relation<'_>) -> types_error::PgResult<types_core::Oid>
);
seam_core::seam!(
    /// `rel->rd_rel->reltablespace`.
    pub fn rd_rel_reltablespace(rel: &rel::Relation<'_>) -> types_error::PgResult<types_core::Oid>
);
seam_core::seam!(
    ...
    pub fn rd_rel_relnatts(rel: &rel::Relation<'_>) -> types_error::PgResult<i16>
);
seam_core::seam!(
    /// `rel->rd_rel->relispartition` — read by `catalog/index.c`
    /// `index_check_primary_key` (a CREATE TABLE .. PARTITION OF check).
    pub fn rd_rel_relispartition(rel: &rel::Relation<'_>) -> types_error::PgResult<bool>
);
seam_core::seam!(
...
seam_core::seam!(
    ...
    ) -> types_error::PgResult<Option<mcx::PgVec<'mcx, nodes::primnodes::Expr<'mcx>>>>
);
seam_core::seam!(
    /// `rel->rd_rel->relowner`.
    pub fn rd_rel_relowner(rel: &rel::Relation<'_>) -> types_error::PgResult<types_core::Oid>
);
seam_core::seam!(
    /// `rel->rd_rel->relisshared`.
    pub fn rd_rel_relisshared(rel: &rel::Relation<'_>) -> types_error::PgResult<bool>
);
seam_core::seam!(
    /// `RelationGetNamespace(rel)` = `rel->rd_rel->relnamespace`.
    pub fn rd_rel_relnamespace(rel: &rel::Relation<'_>) -> types_error::PgResult<types_core::Oid>
);
seam_core::seam!(
    /// `rel->rd_rel->relfrozenxid`.
    pub fn rd_rel_relfrozenxid(rel: &rel::Relation<'_>) -> types_error::PgResult<types_core::TransactionId>
);
seam_core::seam!(
    /// `rel->rd_rel->relminmxid`.
    pub fn rd_rel_relminmxid(rel: &rel::Relation<'_>) -> types_error::PgResult<types_core::MultiXactId>
);
seam_core::seam!(
    /// `rel->rd_islocaltemp` — this backend's own temp relation.
    pub fn rd_islocaltemp(rel: &rel::Relation<'_>) -> types_error::PgResult<bool>
);
seam_core::seam!(
    /// `index->rd_index->indrelid` — `None` if `rd_index == NULL` (not an index).
    pub fn rd_index_indrelid(index: &rel::Relation<'_>) -> types_error::PgResult<Option<types_core::Oid>>
);
seam_core::seam!(
    /// `index->rd_index->indisvalid`.
    pub fn rd_index_indisvalid(index: &rel::Relation<'_>) -> types_error::PgResult<bool>
);
seam_core::seam!(
    /// `!heap_attisnull(index->rd_indextuple, Anum_pg_index_indpred, NULL)` —
    /// the index has a partial-index predicate.
    pub fn rd_index_has_indpred(index: &rel::Relation<'_>) -> types_error::PgResult<bool>
);
seam_core::seam!(
    ...
    /// carrier (`rel`) keeps only `indkey0`; the full vector lives in the
    ...
    pub fn rd_index_indkey(index: &rel::Relation<'_>) -> types_error::PgResult<Option<std::vec::Vec<types_core::primitive::AttrNumber>>>
);
seam_core::seam!(
    ...
    /// index). Pure read.
    pub fn rd_index_indnatts(index: &rel::Relation<'_>) -> types_error::PgResult<Option<i16>>
);
seam_core::seam!(
    ...
    /// read.
    pub fn rd_index_indnkeyatts(index: &rel::Relation<'_>) -> types_error::PgResult<Option<i16>>
);
seam_core::seam!(
    ...
    pub fn rd_index_indisunique(index: &rel::Relation<'_>) -> types_error::PgResult<bool>
);
seam_core::seam!(
    /// `index->rd_index->indisprimary` — is this index for a primary key?
    /// `false` if `rd_index == NULL` (not an index). Pure read.
    pub fn rd_index_indisprimary(index: &rel::Relation<'_>) -> types_error::PgResult<bool>
);
seam_core::seam!(
    ...
    /// index). Pure read.
    pub fn rd_index_indisexclusion(index: &rel::Relation<'_>) -> types_error::PgResult<bool>
);
seam_core::seam!(
    /// `index->rd_index->indisready` — is this index ready for inserts? Read
    /// by `BuildIndexInfo` (`indexStruct->indisready`) for `makeIndexInfo`.
    /// `false` if `rd_index == NULL` (not an index). Pure read.
    pub fn rd_index_indisready(index: &rel::Relation<'_>) -> types_error::PgResult<bool>
);
seam_core::seam!(
    ...
    pub fn rd_index_indnullsnotdistinct(index: &rel::Relation<'_>) -> types_error::PgResult<bool>
);
seam_core::seam!(
    ...
    pub fn rd_rel_relpersistence(rel: &rel::Relation<'_>) -> types_error::PgResult<i8>
);
seam_core::seam!(
    ...
    pub fn rd_rel_relkind(rel: &rel::Relation<'_>) -> types_error::PgResult<i8>
);
seam_core::seam!(
    /// `index->rd_indam->amclusterable`.
    pub fn rd_indam_amclusterable(index: &rel::Relation<'_>) -> types_error::PgResult<bool>
);
seam_core::seam!(
    /// `RelationIsMapped(rel)` — the relation uses the relation map.
    pub fn relation_is_mapped(rel: &rel::Relation<'_>) -> types_error::PgResult<bool>
);
seam_core::seam!(
...
seam_core::seam!(
    ...
    pub fn relation_get_number_of_blocks(rel: &rel::Relation<'_>) -> types_error::PgResult<u32>
);
seam_core::seam!(
    /// Set `NewHeap->rd_toastoid = value` (relcache, transient setting honored
    /// while NewHeap stays open during the cluster copy).
    pub fn set_rd_toastoid(new_heap: &rel::Relation<'_>, value: types_core::Oid) -> types_error::PgResult<()>
);
seam_core::seam!(
...
seam_core::seam!(
    ...
    ) -> types_error::PgResult<rel::RelationData<'mcx>>
);
...
seam_core::seam!(
    ...
    pub fn free_fake_relcache_entry(fakerel: rel::RelationData<'_>)
);
...
seam_core::seam!(
    ...
    pub fn rd_indam_amcanorder(index: &rel::Relation<'_>) -> types_error::PgResult<bool>
);
seam_core::seam!(
    ...
    pub fn rd_indam_amsearcharray(index: &rel::Relation<'_>) -> types_error::PgResult<bool>
);
...
seam_core::seam!(
    ...
    pub fn relation_fdwroutine(
        relation_id: types_core::primitive::Oid,
    ) -> types_error::PgResult<Option<nodes::FdwRoutine>>
);
...
seam_core::seam!(
    ...
    pub fn rd_amcache_hashmeta(
        index_oid: types_core::primitive::Oid,
    ) -> types_error::PgResult<Option<hash::hashpage::HashMetaPageData>>
);
...
seam_core::seam!(
    ...
    pub fn rd_amcache_spgist(
        index_oid: types_core::primitive::Oid,
    ) -> types_error::PgResult<Option<spgist::SpGistCache>>
);
...
seam_core::seam!(
    ...
    pub fn relation_get_index_expressions<'mcx>(
        mcx: mcx::Mcx<'mcx>,
        rel: &rel::Relation<'mcx>,
    ) -> types_error::PgResult<Option<mcx::PgVec<'mcx, nodes::Expr<'mcx>>>>
);
...
pub struct RowSecurityPolicyImage<'mcx> {
    ...
    pub with_check_qual: Option<mcx::PgBox<'mcx, nodes::nodes::Node<'mcx>>>,
    /// `bool hassublinks`.
...
seam_core::seam!(
    ...
    /// `rel::Relation<'mcx>` handle carries no `rd_rsdesc`. This seam
...
seam_core::seam!(
    ...
    /// relcache owner — the trimmed cross-unit `rel::Relation<'mcx>` handle
