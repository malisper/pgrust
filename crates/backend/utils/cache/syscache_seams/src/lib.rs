...
seam_core::seam!(
    ...
    pub fn search_type_attr_info(
        oidtypeid: Oid,
    ) -> PgResult<Option<types_tuple::tupdesc::PgTypeInfo>>
);
...
seam_core::seam!(
    ...
    pub fn lookup_proc<'mcx>(
        mcx: Mcx<'mcx>,
        function_id: Oid,
    ) -> PgResult<Option<fmgr::ProcInfo<'mcx>>>
);
...
seam_core::seam!(
    ...
    pub fn lookup_proc_result_info<'mcx>(
        mcx: Mcx<'mcx>,
        funcid: Oid,
    ) -> PgResult<Option<fmgr::ProcResultInfo<'mcx>>>
);
...
seam_core::seam!(
    ...
    pub fn lookup_language<'mcx>(
        mcx: Mcx<'mcx>,
        language_id: Oid,
    ) -> PgResult<Option<fmgr::LangInfo<'mcx>>>
);
...
seam_core::seam!(
    ...
    pub fn search_am_by_name<'mcx>(
        mcx: Mcx<'mcx>,
        amname: &str,
    ) -> PgResult<Option<types_namespace::catalog_namespace::PgAmInfo<'mcx>>>
);
