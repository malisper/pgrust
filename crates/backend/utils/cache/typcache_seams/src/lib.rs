...
seam_core::seam!(
    ...
    /// [`statistics::ArrayAnalyzeExtraData`] (with `coll_id` set to
    ...
    ) -> types_error::PgResult<Option<statistics::ArrayAnalyzeExtraData>>
);
...
seam_core::seam!(
    ...
    /// `cache::TypeCacheEntry` shape the range/multirange ports use
    ...
    pub fn lookup_type_cache_entry(
        type_id: types_core::primitive::Oid,
        flags: i32,
    ) -> types_error::PgResult<cache::TypeCacheEntry>
);
...
seam_core::seam!(
    ...
    pub fn record_column_cmp(
        ...
        v1: &types_tuple::heaptuple::Datum<'_>,
        v2: &types_tuple::heaptuple::Datum<'_>,
    ) -> types_error::PgResult<i32>
);
...
seam_core::seam!(
    ...
    pub fn record_column_hash(
        coltype: types_core::primitive::Oid,
        collation: types_core::primitive::Oid,
        v: &types_tuple::heaptuple::Datum<'_>,
    ) -> types_error::PgResult<u32>
);
...
seam_core::seam!(
    ...
    pub fn domain_constraint_list(
        ...
        std::vec::Vec<cache::typcache::DomainConstraintState>,
    >
);
