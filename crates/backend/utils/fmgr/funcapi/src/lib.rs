...
// `utils_error::PgResult` (== `Result<_, PgError>`); `PgError`'s size is
...
pub fn init_seams() {
    funcapi_seams::InitMaterializedSRF::set(srf_support::InitMaterializedSRF);
    funcapi_seams::init_materialized_srf_with_desc::set(
        srf_support::init_materialized_srf_with_desc,
    );
    funcapi_seams::materialized_srf_putvalues::set(
        srf_support::materialized_srf_putvalues,
    );
    funcapi_seams::get_func_arg_info::set(proc_info::get_func_arg_info_seam);
    ...
    // Datum via `heaptuple::HeapTupleGetDatum`.
    funcapi_seams::record_from_values::set(tupledesc::record_from_values);
    funcapi_seams::srf_arg0_oid::set(srf_support::srf_arg0_oid);
    funcapi_seams::srf_arg_int64::set(srf_support::srf_arg_int64);
    funcapi_seams::srf_arg_lsn::set(srf_support::srf_arg_lsn);
    ...
    funcapi_seams::srf_arg_varlena_bytes::set(
    ...
    funcapi_seams::srf_arg_record::set(srf_support::srf_arg_record);
    funcapi_seams::cstring_get_text_datum::set(
    ...
    funcapi_seams::init_MultiFuncCall::set(srf_support::init_MultiFuncCall);
    funcapi_seams::per_MultiFuncCall::set(srf_support::per_MultiFuncCall);
    funcapi_seams::end_MultiFuncCall::set(srf_support::end_MultiFuncCall);
    ...
    funcapi_seams::value_srf_unported::set(srf_support::value_srf_unported);
    funcapi_seams::get_expr_result_tupdesc::set(
    ...
    funcapi_seams::build_function_result_tupdesc_t::set(
    ...
    funcapi_seams::get_expr_result_type::set(
    ...
    pg_proc_seams::check_input_param_names_unchanged::set(
    ...
    pg_proc_seams::record_type_change::set(proc_info::record_type_change);
}
