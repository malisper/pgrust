...
seam_core::seam!(
    ...
    pub fn with_my_proc_port(f: &mut dyn FnMut(Option<&mut net::Port>))
);
...
seam_core::seam!(
    ...
    /// stores it here.
    pub fn set_my_proc_port(port: net::Port)
);
...
seam_core::seam!(
    ...
    pub fn set_my_client_socket(client_sock: net::ClientSocket)
);
...
seam_core::seam!(
    ...
    pub fn my_client_socket() -> Option<net::ClientSocket>
);
