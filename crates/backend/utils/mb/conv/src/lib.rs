...
// pub visibility (doc-hidden): the mbconv differential drivers (fuzz/core
// mbconv_diff) enumerate the combined-map entries to drive the two-codepoint
// UtfToLocal paths exhaustively; table data unchanged.
#[doc(hidden)]
pub mod maps;
