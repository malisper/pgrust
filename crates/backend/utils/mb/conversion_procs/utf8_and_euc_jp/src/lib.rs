//! Port of `src/backend/utils/mb/conversion_procs/utf8_and_euc_jp/utf8_and_euc_jp.c` —
...
pub fn euc_jp_to_utf8(
    ...
    check_encoding_conversion_args::call(src_encoding, dest_encoding, src.len() as i32, PG_EUC_JP, PG_UTF8)?;
    LocalToUtf(
        src,
        Some(&tables::euc_jp_to_unicode_tree()),
        &[],
        None,
        PG_EUC_JP,
        no_error,
...
/// `utf8_to_euc_jp` (utf8_and_euc_jp.c): convert PG_UTF8 <-> PG_EUC_JP.
pub fn utf8_to_euc_jp(
    src_encoding: pg_enc,
    dest_encoding: pg_enc,
    src: &[u8],
    no_error: bool,
) -> PgResult<ConversionResult> {
    check_encoding_conversion_args::call(src_encoding, dest_encoding, src.len() as i32, PG_UTF8, PG_EUC_JP)?;
    UtfToLocal(
        src,
        Some(&tables::euc_jp_from_unicode_tree()),
        &[],
        None,
        PG_EUC_JP,
        no_error,
