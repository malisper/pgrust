...
pub fn init_seams() {
    ...
    fe_seams::get_database_encoding_name::set(|| {
    ...
    pg_locale_env_seams::set_message_encoding::set(|encoding| {
    ...
    parallel_rt_seams::get_database_encoding::set(|| {
        Ok(GetDatabaseEncoding())
    });
    parallel_rt_seams::set_client_encoding::set(SetClientEncoding);
}
