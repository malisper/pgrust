...
pub static assign_backtrace_functions: GucStringAssignHook = GucSlot::new("assign_backtrace_functions");
pub static assign_checkpoint_completion_target: GucRealAssignHook = GucSlot::new("assign_checkpoint_completion_target");
pub static assign_client_encoding: GucStringAssignHook = GucSlot::new("assign_client_encoding");
pub static assign_createrole_self_grant: GucStringAssignHook = GucSlot::new("assign_createrole_self_grant");
...
pub static assign_maintenance_io_concurrency: GucIntAssignHook = GucSlot::new("assign_maintenance_io_concurrency");
...
pub static assign_recovery_target_lsn: GucStringAssignHook = GucSlot::new("assign_recovery_target_lsn");
pub static assign_recovery_target_name: GucStringAssignHook = GucSlot::new("assign_recovery_target_name");
pub static assign_recovery_target_time: GucStringAssignHook = GucSlot::new("assign_recovery_target_time");
pub static assign_recovery_target_timeline: GucStringAssignHook = GucSlot::new("assign_recovery_target_timeline");
pub static assign_recovery_target_xid: GucStringAssignHook = GucSlot::new("assign_recovery_target_xid");
pub static assign_restrict_nonsystem_relation_kind: GucStringAssignHook = GucSlot::new("assign_restrict_nonsystem_relation_kind");
...
pub static assign_session_authorization: GucStringAssignHook = GucSlot::new("assign_session_authorization");
pub static assign_session_replication_role: GucEnumAssignHook = GucSlot::new("assign_session_replication_role");
pub static assign_stats_fetch_consistency: GucEnumAssignHook = GucSlot::new("assign_stats_fetch_consistency");
pub static assign_synchronized_standby_slots: GucStringAssignHook = GucSlot::new("assign_synchronized_standby_slots");
pub static assign_synchronous_commit: GucEnumAssignHook = GucSlot::new("assign_synchronous_commit");
pub static assign_synchronous_standby_names: GucStringAssignHook = GucSlot::new("assign_synchronous_standby_names");
...
pub static assign_tcp_keepalives_count: GucIntAssignHook = GucSlot::new("assign_tcp_keepalives_count");
pub static assign_tcp_keepalives_idle: GucIntAssignHook = GucSlot::new("assign_tcp_keepalives_idle");
pub static assign_tcp_keepalives_interval: GucIntAssignHook = GucSlot::new("assign_tcp_keepalives_interval");
...
pub static assign_timezone_abbreviations: GucStringAssignHook = GucSlot::new("assign_timezone_abbreviations");
pub static assign_transaction_timeout: GucIntAssignHook = GucSlot::new("assign_transaction_timeout");
pub static assign_wal_consistency_checking: GucStringAssignHook = GucSlot::new("assign_wal_consistency_checking");
...
pub static check_backtrace_functions: GucStringCheckHook = GucSlot::new("check_backtrace_functions");
...
pub static check_client_connection_check_interval: GucIntCheckHook = GucSlot::new("check_client_connection_check_interval");
...
pub static check_createrole_self_grant: GucStringCheckHook = GucSlot::new("check_createrole_self_grant");
...
pub static check_default_table_access_method: GucStringCheckHook = GucSlot::new("check_default_table_access_method");
pub static check_default_tablespace: GucStringCheckHook = GucSlot::new("check_default_tablespace");
pub static check_default_text_search_config: GucStringCheckHook = GucSlot::new("check_default_text_search_config");
...
pub static check_recovery_target_lsn: GucStringCheckHook = GucSlot::new("check_recovery_target_lsn");
pub static check_recovery_target_name: GucStringCheckHook = GucSlot::new("check_recovery_target_name");
pub static check_recovery_target_time: GucStringCheckHook = GucSlot::new("check_recovery_target_time");
pub static check_recovery_target_timeline: GucStringCheckHook = GucSlot::new("check_recovery_target_timeline");
pub static check_recovery_target_xid: GucStringCheckHook = GucSlot::new("check_recovery_target_xid");
pub static check_restrict_nonsystem_relation_kind: GucStringCheckHook = GucSlot::new("check_restrict_nonsystem_relation_kind");
...
pub static check_session_authorization: GucStringCheckHook = GucSlot::new("check_session_authorization");
...
pub static check_synchronized_standby_slots: GucStringCheckHook = GucSlot::new("check_synchronized_standby_slots");
pub static check_synchronous_standby_names: GucStringCheckHook = GucSlot::new("check_synchronous_standby_names");
...
pub static check_timezone_abbreviations: GucStringCheckHook = GucSlot::new("check_timezone_abbreviations");
pub static check_transaction_buffers: GucIntCheckHook = GucSlot::new("check_transaction_buffers");
pub static check_transaction_deferrable: GucBoolCheckHook = GucSlot::new("check_transaction_deferrable");
pub static check_transaction_isolation: GucEnumCheckHook = GucSlot::new("check_transaction_isolation");
pub static check_transaction_read_only: GucBoolCheckHook = GucSlot::new("check_transaction_read_only");
pub static check_vacuum_buffer_usage_limit: GucIntCheckHook = GucSlot::new("check_vacuum_buffer_usage_limit");
