...
pub static ConfigureNamesInt: &[GucIntSetting] = &[
    ...
    GucIntSetting { name: "max_active_queries", context: PGC_SIGHUP, group: CONN_AUTH_SETTINGS, short_desc: Some("Sets the maximum number of concurrently executing statements."), long_desc: Some("0 disables the gate. Excess statements queue FIFO before taking a snapshot or any locks; superusers and replication connections are exempt."), flags: 0, variable: &vars::max_active_queries, boot_val: GucDefaultValue::Int(0), min: 0, max: i32::MAX, check_hook: None, assign_hook: None, show_hook: None },
