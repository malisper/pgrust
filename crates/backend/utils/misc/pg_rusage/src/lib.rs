...
pub fn init_seams() {
    rusage_seams::pg_rusage_init::set(pg_rusage_new);
    rusage_seams::pg_rusage_show::set(|ru0| pg_rusage_show(&ru0));
    ...
    // current context.
    clean_seams::pg_rusage_init::set(pg_rusage_new);
    clean_seams::pg_rusage_show::set(|mcx, ru0| {
