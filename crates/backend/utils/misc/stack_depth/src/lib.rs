...
pub fn check_max_stack_depth(newval: i32, _source: GucSource) -> bool {
    ...
    if stack_rlimit > 0 && newval_bytes > stack_rlimit - STACK_DEPTH_SLOP {
        ...
        guc_seams::guc_check_errhint::call(
...
pub fn init_seams() {
    stack_depth_seams::check_stack_depth::set(check_stack_depth);
    ...
    postgres_seams::set_stack_base::set(|| {
    ...
    guc_tables::vars::max_stack_depth.install(
