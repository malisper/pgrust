...
//!
//! `Tuplestorestate` is the opaque carrier from `nodes::funcapi`; only
...
pub struct LogicalTapeSet<'mcx> {
    ...
    pub pfile: Option<mcx::PgBox<'mcx, nodes::nodehashjoin::BufFile>>,
...
seam_core::seam!(
    ...
    pub fn tuplestore_begin_heap<'mcx>(
        ...
        interXact: bool,
        maxKBytes: i32,
    ) -> types_error::PgResult<mcx::PgBox<'mcx, nodes::Tuplestorestate<'mcx>>>
);
...
seam_core::seam!(
    ...
    pub fn tuplestore_ateof(state: &nodes::Tuplestorestate<'_>) -> bool
);
...
seam_core::seam!(
    ...
    pub fn tuplestore_gettupleslot<'mcx>(
        state: &mut nodes::Tuplestorestate<'mcx>,
        forward: bool,
        copy: bool,
        slot: nodes::SlotId,
...
seam_core::seam!(
    ...
    pub fn tuplestore_gettupleslot_standalone<'s, 'm>(
        mcx: mcx::Mcx<'m>,
        state: &mut nodes::Tuplestorestate<'s>,
        forward: bool,
        copy: bool,
...
seam_core::seam!(
    ...
    /// [`types_tuple::heaptuple::Datum`] (the ByVal/ByRef
...
seam_core::seam!(
    ...
    pub fn tuplestore_trim(state: &mut nodes::Tuplestorestate<'_>)
);
...
seam_core::seam!(
    ...
    pub fn tuplestore_rescan(state: &mut nodes::Tuplestorestate<'_>) -> types_error::PgResult<()>
);
...
seam_core::seam!(
    ...
    pub fn tuplestore_clear(state: &mut nodes::Tuplestorestate<'_>)
);
...
seam_core::seam!(
    ...
    pub fn tuplestore_end(state: mcx::PgBox<'_, nodes::Tuplestorestate<'_>>)
);
...
// `nodes::nodehashjoin::SharedTuplestoreAccessor` struct (the `&mut`
// seams below), while nodeHash threads it as the
// `execparallel::SharedTuplestoreAccessorHandle` token (the `*_handle`
...
seam_core::seam!(
    ...
    pub fn sts_begin_parallel_scan(
        accessor: &mut nodes::nodehashjoin::SharedTuplestoreAccessor,
    ) -> types_error::PgResult<()>
);
...
seam_core::seam!(
    ...
    pub fn tuplestore_in_memory(state: &nodes::Tuplestorestate<'_>) -> bool
);
...
seam_core::seam!(
    ...
    pub fn sts_initialize(
        sts: execparallel::SharedTuplestoreHandle,
        participants: i32,
        my_participant_number: i32,
        meta_data_size: types_core::Size,
        flags: i32,
        fileset: execparallel::SharedFileSetHandle,
        name: &str,
    ) -> types_error::PgResult<execparallel::SharedTuplestoreAccessorHandle>
);
