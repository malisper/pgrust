...
seam_core::seam!(
    ...
    pub fn unregister_snapshot(snapshot: snapshot::SnapshotData)
);

seam_core::seam!(
    /// `EstimateSnapshotSpace(snapshot)` (snapmgr.c): bytes needed to
    /// serialize the snapshot. Pure size computation; cannot `ereport`.
    pub fn estimate_snapshot_space(snapshot: &snapshot::SnapshotData) -> usize
);
...
seam_core::seam!(
    ...
    /// `portal::ResourceOwner` handle.
    pub fn unregister_snapshot_from_owner(
        snapshot: std::rc::Rc<snapshot::SnapshotData>,
        owner: portal::ResourceOwner,
    )
);
...
seam_core::seam!(
    ...
    pub fn get_active_snapshot() -> PgResult<Option<std::rc::Rc<snapshot::SnapshotData>>>
);
...
seam_core::seam!(
    ...
    pub fn get_latest_snapshot() -> PgResult<snapshot::SnapshotData>
);
...
seam_core::seam!(
    ...
    pub fn get_transaction_snapshot() -> PgResult<snapshot::SnapshotData>
);
...
seam_core::seam!(
    ...
    pub fn setup_historic_snapshot(
        historic_snapshot: snapshot::SnapshotData,
...
seam_core::seam!(
    ...
    pub fn register_snapshot_on_top_owner(
        snapshot: std::rc::Rc<snapshot::SnapshotData>,
    ) -> PgResult<std::rc::Rc<snapshot::SnapshotData>>
);
