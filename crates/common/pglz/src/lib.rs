...
/// Seam adapter for `pglz_seams::pglz_decompress_to_slice`.
///
...
pub fn init_seams() {
    pglz_seams::pglz_decompress_to_slice::set(seam_pglz_decompress_to_slice);
    pglz_seams::pglz_maximum_compressed_size::set(pglz_maximum_compressed_size);
}
