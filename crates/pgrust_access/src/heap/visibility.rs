...
pub trait SnapshotVisibility {
    ...
    fn tuple_bytes_visible(&self, txns: &dyn AccessTransactionServices, bytes: &[u8]) -> bool;
    fn tuple_bytes_visible_with_hints(
        &self,
        txns: &dyn AccessTransactionServices,
        bytes: &[u8],
    ) -> (bool, u16);
    fn tuple_visible(&self, txns: &dyn AccessTransactionServices, tuple: &HeapTuple) -> bool;
...
impl SnapshotVisibility for Snapshot {
    ...
    fn tuple_bytes_visible_with_hints(
        ...
        let _xmin_settled = if infomask & (HEAP_XMIN_COMMITTED | HEAP_XMIN_INVALID) != 0 {
            ...
            match txns.transaction_status(xmin) {
...
fn check_visibility(
    ...
    if xmin == INVALID_TRANSACTION_ID || xmin == FROZEN_TRANSACTION_ID {
        ...
        return match txns.transaction_status(xmax) {
