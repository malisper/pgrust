...
use crate::access::heapam_xlog::{XLOG_HEAP2_VISIBLE, XlHeapVisible};
use crate::crc32c;
use crate::transam::CheckpointRecord;
use crate::transam::xloginsert::RegisteredXLogRecord;
use crate::transam::xlogreader::{
...
use pgrust_storage::buffer::{BufferTag, PAGE_SIZE, Page};
use pgrust_storage::smgr::{ForkNumber, RelFileLocator};

pub mod replay {
    pub use crate::transam::xlogrecovery::*;
}
...
pub fn has_wal_segments(wal_dir: &Path) -> Result<bool, WalError> {
...
impl WalWriter {
    ...
    fn fsync_segment(
        ...
        if guard.current_segno == Some(segno) {
            if let Some(file) = guard.file.as_mut() {
                file.flush()?;
                pgrust_storage::fsync_file(file.get_ref())?;
            }
            return Ok(());
        }
        let file = OpenOptions::new()
        ...
        pgrust_storage::fsync_file(&file)?;
        Ok(())
    }
    ...
    pub fn write_record_with_rmgr(
        ...
        crate::transam::xloginsert::xlog_begin_insert();
        crate::transam::xloginsert::xlog_register_buffer(
            0,
            tag,
            REGBUF_FORCE_IMAGE | REGBUF_STANDARD,
        );
        crate::transam::xloginsert::xlog_register_buffer_image(0, page);
        let lsn = crate::transam::xloginsert::xlog_insert(self, xid, rmid, XLOG_FPI)?;
    ...
    pub fn write_insert(
        ...
        crate::transam::xloginsert::xlog_begin_insert();
        crate::transam::xloginsert::xlog_register_buffer(0, tag, REGBUF_STANDARD);
        crate::transam::xloginsert::xlog_register_buf_data(0, &payload);
        crate::transam::xloginsert::xlog_insert(self, xid, RM_HEAP_ID, XLOG_HEAP_INSERT)
    }
    ...
    pub fn write_heap_visible(
        ...
        crate::transam::xloginsert::xlog_begin_insert();
        crate::transam::xloginsert::xlog_register_data(
            &record.snapshot_conflict_horizon.to_le_bytes(),
        );
        crate::transam::xloginsert::xlog_register_data(&[record.flags]);
        crate::transam::xloginsert::xlog_register_buffer(
            0,
            vm_tag,
            REGBUF_FORCE_IMAGE | REGBUF_STANDARD,
        );
        crate::transam::xloginsert::xlog_register_buffer_image(0, vm_page);
        crate::transam::xloginsert::xlog_register_buffer(
            1,
            heap_tag,
            REGBUF_FORCE_IMAGE | REGBUF_STANDARD,
        );
        crate::transam::xloginsert::xlog_register_buffer_image(1, heap_page);
        crate::transam::xloginsert::xlog_insert(self, xid, RM_HEAP2_ID, XLOG_HEAP2_VISIBLE)
    }

    pub fn write_commit(&self, xid: u32) -> Result<Lsn, WalError> {
        crate::transam::xloginsert::xlog_begin_insert();
        crate::transam::xloginsert::xlog_insert(self, xid, RM_XACT_ID, XLOG_XACT_COMMIT)
    }

    pub fn write_prepare(&self, xid: u32, data: &[u8]) -> Result<Lsn, WalError> {
        crate::transam::xloginsert::xlog_begin_insert();
        crate::transam::xloginsert::xlog_register_data(data);
        crate::transam::xloginsert::xlog_insert(self, xid, RM_XACT_ID, XLOG_XACT_PREPARE)
    }

    pub fn write_abort(&self, xid: u32) -> Result<Lsn, WalError> {
        crate::transam::xloginsert::xlog_begin_insert();
        crate::transam::xloginsert::xlog_insert(self, xid, RM_XACT_ID, XLOG_XACT_ABORT)
    }
    ...
    pub fn write_checkpoint_record(
        ...
        crate::transam::xloginsert::xlog_begin_insert();
        crate::transam::xloginsert::xlog_register_data(&record.redo_lsn.to_le_bytes());
        crate::transam::xloginsert::xlog_insert(
            self,
            0,
            RM_XLOG_ID,
            if shutdown {
