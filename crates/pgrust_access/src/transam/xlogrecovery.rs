...
fn smgr_to_wal(e: SmgrError) -> WalError {
...
mod tests {
    use super::*;
    use crate::access::htup::heap_page_init;
    use crate::transam::CheckpointRecord;
    use crate::transam::xact::{
        FIRST_NORMAL_TRANSACTION_ID, TransactionManager, TransactionStatus,
    };
    use crate::transam::xlog::{WalReader, WalRecord, WalWriter, wal_segment_path_for_lsn};
    use pgrust_storage::buffer::{BufferTag, PAGE_SIZE};
    use pgrust_storage::page::bufpage::{page_add_item, page_get_item, page_get_max_offset_number};
    use pgrust_storage::smgr::md::MdStorageManager;
