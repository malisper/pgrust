...
fn build_bootstrap_pg_amproc_rows() -> Vec<PgAmprocRow> {
    ...
    for (family, type_oid, proc_oid) in [
        ...
        (
            crate::BTREE_CHAR_FAMILY_OID,
            INTERNAL_CHAR_TYPE_OID,
            BTEQUALIMAGE_PROC_OID,
        ),
        (
            crate::BTREE_DATETIME_FAMILY_OID,
            TIMESTAMP_TYPE_OID,
            BTEQUALIMAGE_PROC_OID,
        ),
        (
        ...
        (
            crate::BTREE_OID_FAMILY_OID,
            OID_TYPE_OID,
            BTEQUALIMAGE_PROC_OID,
        ),
        (
            crate::BTREE_OIDVECTOR_FAMILY_OID,
            crate::OIDVECTOR_TYPE_OID,
            BTEQUALIMAGE_PROC_OID,
        ),
        (
    ...
    for (procnum, proc_oid) in [
        ...
        (8, GIST_POINT_DISTANCE_PROC_OID),
        (11, GIST_POINT_SORTSUPPORT_PROC_OID),
    ] {
        rows.push(PgAmprocRow {
            oid,
            amprocfamily: GIST_POINT_FAMILY_OID,
            amproclefttype: crate::POINT_TYPE_OID,
            amprocrighttype: crate::POINT_TYPE_OID,
            amprocnum: procnum,
            amproc: proc_oid,
        });
        oid = oid.saturating_add(1);
    ...
    for (family, type_oid) in [
        ...
        (BRIN_INTEGER_MINMAX_MULTI_FAMILY_OID, INT2_TYPE_OID),
        (BRIN_INTEGER_MINMAX_MULTI_FAMILY_OID, INT4_TYPE_OID),
        (BRIN_INTEGER_MINMAX_MULTI_FAMILY_OID, INT8_TYPE_OID),
        ...
        (BRIN_FLOAT_MINMAX_MULTI_FAMILY_OID, FLOAT4_TYPE_OID),
        (BRIN_FLOAT_MINMAX_MULTI_FAMILY_OID, FLOAT8_TYPE_OID),
        (BRIN_TIME_MINMAX_MULTI_FAMILY_OID, TIME_TYPE_OID),
        (BRIN_DATETIME_MINMAX_MULTI_FAMILY_OID, DATE_TYPE_OID),
        (BRIN_DATETIME_MINMAX_MULTI_FAMILY_OID, TIMESTAMP_TYPE_OID),
        (BRIN_DATETIME_MINMAX_MULTI_FAMILY_OID, TIMESTAMPTZ_TYPE_OID),
        ...
        (BRIN_NETWORK_MINMAX_MULTI_FAMILY_OID, INET_TYPE_OID),
...
fn operator_proc_oid(rows: &[crate::PgOperatorRow], name: &str, left: u32, right: u32) -> u32 {
    rows.iter()
