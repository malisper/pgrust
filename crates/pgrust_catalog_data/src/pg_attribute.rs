...
use crate::desc::{catalog_attmissingval_for_column, catalog_attribute_collation_oid, column_desc};
use crate::{
    ACLITEM_ARRAY_TYPE_OID, ACLITEM_TYPE_OID, ANYARRAYOID, BIT_ARRAY_TYPE_OID, BIT_TYPE_OID,
    BOOL_ARRAY_TYPE_OID, BOOL_TYPE_OID, BOX_TYPE_OID, BPCHAR_ARRAY_TYPE_OID, BPCHAR_TYPE_OID,
...
pub fn pg_attribute_desc() -> RelationDesc {
    RelationDesc {
        columns: vec![
            ...
            column_desc("attstattarget", SqlType::new(SqlTypeKind::Int2), true),
...
fn catalog_type_row_by_oid(oid: u32) -> Option<crate::PgTypeRow> {
    builtin_type_rows()
        .into_iter()
...
pub fn sql_type_oid(sql_type: SqlType) -> u32 {
    ...
    if let Some(multirange_type) = crate::multirange_type_ref_for_sql_type(sql_type) {
        if sql_type.is_array {
    ...
    match (sql_type.kind, sql_type.is_array) {
        ...
        (SqlTypeKind::AnyElement, false) => crate::ANYELEMENTOID,
        (SqlTypeKind::AnyElement, true) => unreachable!("anyelement arrays are unsupported"),
        (SqlTypeKind::AnyEnum, false) => crate::ANYENUMOID,
        ...
        (SqlTypeKind::Record, true) => crate::RECORD_ARRAY_TYPE_OID,
        (SqlTypeKind::Composite, false) => sql_type.type_oid,
        (SqlTypeKind::Composite, true) => crate::RECORD_ARRAY_TYPE_OID,
        ...
        (SqlTypeKind::Internal, false) => crate::INTERNAL_TYPE_OID,
        (SqlTypeKind::Internal, true) => unreachable!("internal arrays are unsupported"),
        (SqlTypeKind::Cstring, false) => crate::CSTRING_TYPE_OID,
        (SqlTypeKind::Cstring, true) => crate::CSTRING_ARRAY_TYPE_OID,
        (SqlTypeKind::Void, false) => crate::VOID_TYPE_OID,
        (SqlTypeKind::Void, true) => unreachable!("void arrays are unsupported"),
        (SqlTypeKind::Trigger, false) => crate::TRIGGER_TYPE_OID,
        (SqlTypeKind::Trigger, true) => unreachable!("trigger arrays are unsupported"),
        (SqlTypeKind::EventTrigger, false) => crate::EVENT_TRIGGER_TYPE_OID,
        (SqlTypeKind::EventTrigger, true) => unreachable!("event_trigger arrays are unsupported"),
        (SqlTypeKind::FdwHandler, false) => crate::FDW_HANDLER_TYPE_OID,
        ...
        (SqlTypeKind::RegProc, false) => crate::REGPROC_TYPE_OID,
        (SqlTypeKind::RegProc, true) => crate::REGPROC_ARRAY_TYPE_OID,
        (SqlTypeKind::RegClass, false) => crate::REGCLASS_TYPE_OID,
        (SqlTypeKind::RegClass, true) => crate::REGCLASS_ARRAY_TYPE_OID,
        (SqlTypeKind::RegType, false) => crate::REGTYPE_TYPE_OID,
        (SqlTypeKind::RegType, true) => crate::REGTYPE_ARRAY_TYPE_OID,
        (SqlTypeKind::RegRole, false) => crate::REGROLE_TYPE_OID,
        (SqlTypeKind::RegRole, true) => crate::REGROLE_ARRAY_TYPE_OID,
        (SqlTypeKind::RegNamespace, false) => crate::REGNAMESPACE_TYPE_OID,
        (SqlTypeKind::RegNamespace, true) => crate::REGNAMESPACE_ARRAY_TYPE_OID,
        (SqlTypeKind::RegOper, false) => crate::REGOPER_TYPE_OID,
        (SqlTypeKind::RegOper, true) => crate::REGOPER_ARRAY_TYPE_OID,
        (SqlTypeKind::RegOperator, false) => crate::REGOPERATOR_TYPE_OID,
        (SqlTypeKind::RegOperator, true) => crate::REGOPERATOR_ARRAY_TYPE_OID,
        (SqlTypeKind::RegProcedure, false) => crate::REGPROCEDURE_TYPE_OID,
        (SqlTypeKind::RegProcedure, true) => crate::REGPROCEDURE_ARRAY_TYPE_OID,
        (SqlTypeKind::RegCollation, false) => crate::REGCOLLATION_TYPE_OID,
        (SqlTypeKind::RegCollation, true) => crate::REGCOLLATION_ARRAY_TYPE_OID,
        ...
        (SqlTypeKind::Inet, false) => crate::INET_TYPE_OID,
        (SqlTypeKind::Inet, true) => crate::INET_ARRAY_TYPE_OID,
        (SqlTypeKind::Cidr, false) => crate::CIDR_TYPE_OID,
        (SqlTypeKind::Cidr, true) => crate::CIDR_ARRAY_TYPE_OID,
        (SqlTypeKind::MacAddr, false) => MACADDR_TYPE_OID,
        (SqlTypeKind::MacAddr, true) => MACADDR_ARRAY_TYPE_OID,
        (SqlTypeKind::MacAddr8, false) => MACADDR8_TYPE_OID,
        (SqlTypeKind::MacAddr8, true) => MACADDR8_ARRAY_TYPE_OID,
        ...
        (SqlTypeKind::PgLsn, false) => PG_LSN_TYPE_OID,
        (SqlTypeKind::PgLsn, true) => PG_LSN_ARRAY_TYPE_OID,
...
mod tests {
    use super::*;
    use crate::{INTERNAL_CHAR_TYPE_OID, PG_CLASS_RELATION_OID};
