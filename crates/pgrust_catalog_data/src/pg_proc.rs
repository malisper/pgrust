...
fn build_bootstrap_pg_proc_rows() -> Vec<PgProcRow> {
    ...
    let mut rows = vec![
        ...
        proc_row(
            ...
            "uuidv7",
            UUID_TYPE_OID,
            &oid_argtypes(&[crate::INTERVAL_TYPE_OID]),
            "uuidv7_interval",
            1,
            false,
            false,
        ...
        record_out_proc_row(
            ...
            1,
            &[
                ("start_value", INT8_TYPE_OID),
                ("minimum_value", INT8_TYPE_OID),
                ("maximum_value", INT8_TYPE_OID),
                ("increment", INT8_TYPE_OID),
                ("cycle_option", BOOL_TYPE_OID),
                ("cache_size", INT8_TYPE_OID),
                ("data_type", OID_TYPE_OID),
            ],
        ),
        proc_row(
            4032,
        ...
        record_out_proc_row(
            ...
            "pg_get_sequence_data",
            1,
            &[("last_value", INT8_TYPE_OID), ("is_called", BOOL_TYPE_OID)],
        ),
        proc_row(
            1642,
            "pg_get_userbyid",
        ...
        proc_row(
            ...
            "lo_from_bytea",
            OID_TYPE_OID,
            &oid_argtypes(&[OID_TYPE_OID, BYTEA_TYPE_OID]),
            "lo_from_bytea",
            2,
            false,
            true,
        ...
        proc_row(
            ...
            "lo_put",
            VOID_TYPE_OID,
            &oid_argtypes(&[OID_TYPE_OID, INT8_TYPE_OID, BYTEA_TYPE_OID]),
            "lo_put",
            3,
            false,
            true,
        ...
        proc_row(
            ...
            "json_to_tsvector",
            TSVECTOR_TYPE_OID,
            &oid_argtypes(&[JSON_TYPE_OID, JSONB_TYPE_OID]),
            "json_to_tsvector",
            2,
            false,
            false,
        ...
        proc_row(
            ...
            "json_to_tsvector",
            TSVECTOR_TYPE_OID,
            &oid_argtypes(&[REGCONFIG_TYPE_OID, JSON_TYPE_OID, JSONB_TYPE_OID]),
    ...
    rows.extend(system_view_srf_proc_rows());
...
fn system_view_srf_proc_rows() -> Vec<PgProcRow> {
    vec![
        ...
        record_out_proc_row(
            ...
            &[
                ("name", NAME_TYPE_OID),
                ("default_version", TEXT_TYPE_OID),
                ("comment", TEXT_TYPE_OID),
            ],
        ),
        record_out_proc_row(
            3083,
            ...
            &[
                ("name", NAME_TYPE_OID),
                ("version", TEXT_TYPE_OID),
                ("superuser", BOOL_TYPE_OID),
                ("trusted", BOOL_TYPE_OID),
                ("relocatable", BOOL_TYPE_OID),
                ("schema", NAME_TYPE_OID),
                ("requires", NAME_ARRAY_TYPE_OID),
                ("comment", TEXT_TYPE_OID),
            ],
        ),
        record_out_proc_row(
            ...
            &[
                ...
                ("type", TEXT_TYPE_OID),
                ("level", INT4_TYPE_OID),
                ("path", INT4_ARRAY_TYPE_OID),
                ("total_bytes", INT8_TYPE_OID),
                ("total_nblocks", INT8_TYPE_OID),
                ("free_bytes", INT8_TYPE_OID),
                ("free_chunks", INT8_TYPE_OID),
                ("used_bytes", INT8_TYPE_OID),
            ],
        ),
        record_out_proc_row(
            3400,
            ...
            "pg_config",
            0,
            &[("name", TEXT_TYPE_OID), ("setting", TEXT_TYPE_OID)],
        ),
        record_out_proc_row(
            3329,
        ...
        record_out_proc_row(
            ...
            0,
            &[
                ("rule_number", INT4_TYPE_OID),
                ("file_name", TEXT_TYPE_OID),
                ("line_number", INT4_TYPE_OID),
                ("type", TEXT_TYPE_OID),
                ("database", TEXT_ARRAY_TYPE_OID),
                ("user_name", TEXT_ARRAY_TYPE_OID),
                ("address", TEXT_TYPE_OID),
                ("netmask", TEXT_TYPE_OID),
                ("auth_method", TEXT_TYPE_OID),
                ("options", TEXT_ARRAY_TYPE_OID),
                ("error", TEXT_TYPE_OID),
            ],
        ),
        record_out_proc_row(
            ...
            0,
            &[
                ("map_number", INT4_TYPE_OID),
                ("file_name", TEXT_TYPE_OID),
                ("line_number", INT4_TYPE_OID),
                ("map_name", TEXT_TYPE_OID),
                ("sys_name", TEXT_TYPE_OID),
                ("pg_username", TEXT_TYPE_OID),
                ("error", TEXT_TYPE_OID),
            ],
        ),
        record_out_proc_row(
            ...
            0,
            &[
                ("transaction", XID_TYPE_OID),
                ("gid", TEXT_TYPE_OID),
                ("prepared", TIMESTAMPTZ_TYPE_OID),
                ("ownerid", OID_TYPE_OID),
                ("dbid", OID_TYPE_OID),
            ],
        ),
        record_out_proc_row(
            ...
            &[
                ("name", TEXT_TYPE_OID),
                ("statement", TEXT_TYPE_OID),
                ("is_holdable", BOOL_TYPE_OID),
                ("is_binary", BOOL_TYPE_OID),
                ("is_scrollable", BOOL_TYPE_OID),
                ("creation_time", TIMESTAMPTZ_TYPE_OID),
            ],
        ),
        record_out_proc_row(
            2510,
            ...
            &[
                ("name", TEXT_TYPE_OID),
                ("statement", TEXT_TYPE_OID),
                ("prepare_time", TIMESTAMPTZ_TYPE_OID),
                ("parameter_types", REGTYPE_ARRAY_TYPE_OID),
                ("result_types", REGTYPE_ARRAY_TYPE_OID),
                ("from_sql", BOOL_TYPE_OID),
                ("generic_plans", INT8_TYPE_OID),
                ("custom_plans", INT8_TYPE_OID),
            ],
        ),
        record_out_proc_row(
            3317,
            ...
            &[
                ("pid", INT4_TYPE_OID),
                ("status", TEXT_TYPE_OID),
                ("receive_start_lsn", PG_LSN_TYPE_OID),
                ("receive_start_tli", INT4_TYPE_OID),
                ("written_lsn", PG_LSN_TYPE_OID),
                ("flushed_lsn", PG_LSN_TYPE_OID),
                ("received_tli", INT4_TYPE_OID),
                ("last_msg_send_time", TIMESTAMPTZ_TYPE_OID),
                ("last_msg_receipt_time", TIMESTAMPTZ_TYPE_OID),
                ("latest_end_lsn", PG_LSN_TYPE_OID),
                ("latest_end_time", TIMESTAMPTZ_TYPE_OID),
                ("slot_name", TEXT_TYPE_OID),
                ("sender_host", TEXT_TYPE_OID),
                ("sender_port", INT4_TYPE_OID),
                ("conninfo", TEXT_TYPE_OID),
            ],
        ),
        record_out_proc_row(
            6318,
...
fn text_search_proc_rows() -> Vec<PgProcRow> {
    let mut rows = vec![
        ...
        proc_row(
            ...
            "ts_headline",
            JSONB_TYPE_OID,
            &oid_argtypes(&[REGCONFIG_TYPE_OID, JSONB_TYPE_OID, TSQUERY_TYPE_OID]),
        ...
        proc_row(
            ...
            "ts_headline",
            JSONB_TYPE_OID,
            &oid_argtypes(&[JSONB_TYPE_OID, TSQUERY_TYPE_OID, TEXT_TYPE_OID]),
        ...
        proc_row(
            ...
            "ts_headline",
            JSONB_TYPE_OID,
            &oid_argtypes(&[JSONB_TYPE_OID, TSQUERY_TYPE_OID]),
            "ts_headline_jsonb",
            2,
            false,
            true,
        ...
        proc_row(
            ...
            "ts_headline",
            JSON_TYPE_OID,
            &oid_argtypes(&[REGCONFIG_TYPE_OID, JSON_TYPE_OID, TSQUERY_TYPE_OID]),
        ...
        proc_row(
            ...
            "ts_headline",
            JSON_TYPE_OID,
            &oid_argtypes(&[JSON_TYPE_OID, TSQUERY_TYPE_OID, TEXT_TYPE_OID]),
        ...
        proc_row(
            ...
            "ts_headline",
            JSON_TYPE_OID,
            &oid_argtypes(&[JSON_TYPE_OID, TSQUERY_TYPE_OID]),
            "ts_headline_json",
            2,
            false,
            true,
...
fn missing_leakproof_proc_rows() -> Vec<PgProcRow> {
    let specs: &[(u32, &str, u32, &[u32], &str)] = &[
        ...
        (
            ...
            "interval_cmp",
            INT4_TYPE_OID,
            &[crate::INTERVAL_TYPE_OID, crate::INTERVAL_TYPE_OID],
            "interval_cmp",
        ),
        (
            1358,
