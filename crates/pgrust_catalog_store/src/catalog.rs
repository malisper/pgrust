...
use pgrust_nodes::primnodes::{ColumnDesc, RelationDesc, ScalarType};
...
pub fn column_desc(name: impl Into<String>, sql_type: SqlType, nullable: bool) -> ColumnDesc {
    ...
    ColumnDesc {
        name: name.clone(),
        storage: pgrust_core::AttributeDesc {
            name,
            attlen,
            attalign,
...
pub fn default_column_collation_oid(sql_type: SqlType) -> u32 {
...
pub fn catalog_attribute_collation_oid(relation_oid: u32, collation_oid: u32) -> u32 {
...
pub fn scalar_type_for_sql_type(sql_type: SqlType) -> ScalarType {
    if sql_type.is_array {
