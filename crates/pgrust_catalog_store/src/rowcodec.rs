...
pub fn catalog_row_values_for_kind(
...
pub fn decode_catalog_tuple_values_from_raw(
    desc: &RelationDesc,
    raw: &[Option<&[u8]>],
...
pub fn parse_indkey(indkey: &str) -> Vec<i16> {
...
pub fn parse_oidvector(values: &str) -> Vec<u32> {
...
pub fn namespace_row_from_values(values: Vec<Value>) -> Result<PgNamespaceRow, CatalogError> {
    Ok(PgNamespaceRow {
...
pub fn pg_class_row_from_values(values: Vec<Value>) -> Result<PgClassRow, CatalogError> {
...
pub fn pg_partitioned_table_row_from_values(
    values: Vec<Value>,
...
pub fn pg_am_row_from_values(values: Vec<Value>) -> Result<PgAmRow, CatalogError> {
    Ok(PgAmRow {
        oid: expect_oid(&values[0])?,
...
pub fn pg_trigger_row_from_values(values: Vec<Value>) -> Result<PgTriggerRow, CatalogError> {
    Ok(PgTriggerRow {
        oid: expect_oid(&values[0])?,
...
pub fn pg_event_trigger_row_from_values(
    values: Vec<Value>,
...
pub fn pg_publication_row_from_values(
    values: Vec<Value>,
...
pub fn pg_publication_rel_row_from_values(
    values: Vec<Value>,
...
pub fn pg_publication_namespace_row_from_values(
    values: Vec<Value>,
...
pub fn pg_policy_row_from_values(values: Vec<Value>) -> Result<PgPolicyRow, CatalogError> {
    Ok(PgPolicyRow {
        oid: expect_oid(&values[0])?,
        polname: expect_text(&values[1])?,
        polrelid: expect_oid(&values[2])?,
        polcmd: pgrust_core::PolicyCommand::from_char(expect_char(&values[3], "polcmd")?)
...
pub fn pg_amop_row_from_values(values: Vec<Value>) -> Result<PgAmopRow, CatalogError> {
    Ok(PgAmopRow {
        oid: expect_oid(&values[0])?,
...
pub fn pg_amproc_row_from_values(values: Vec<Value>) -> Result<PgAmprocRow, CatalogError> {
    Ok(PgAmprocRow {
        oid: expect_oid(&values[0])?,
...
pub fn pg_authid_row_from_values(values: Vec<Value>) -> Result<PgAuthIdRow, CatalogError> {
    Ok(PgAuthIdRow {
        oid: expect_oid(&values[0])?,
...
pub fn pg_auth_members_row_from_values(
    values: Vec<Value>,
...
pub fn pg_language_row_from_values(values: Vec<Value>) -> Result<PgLanguageRow, CatalogError> {
    Ok(PgLanguageRow {
        oid: expect_oid(&values[0])?,
...
pub fn pg_largeobject_row_from_values(
    values: Vec<Value>,
...
pub fn pg_largeobject_metadata_row_from_values(
    values: Vec<Value>,
...
pub fn pg_default_acl_row_from_values(values: Vec<Value>) -> Result<PgDefaultAclRow, CatalogError> {
    Ok(PgDefaultAclRow {
        oid: expect_oid(&values[0])?,
...
pub fn pg_ts_parser_row_from_values(values: Vec<Value>) -> Result<PgTsParserRow, CatalogError> {
    Ok(PgTsParserRow {
        oid: expect_oid(&values[0])?,
...
pub fn pg_ts_template_row_from_values(values: Vec<Value>) -> Result<PgTsTemplateRow, CatalogError> {
    Ok(PgTsTemplateRow {
        oid: expect_oid(&values[0])?,
...
pub fn pg_ts_dict_row_from_values(values: Vec<Value>) -> Result<PgTsDictRow, CatalogError> {
    Ok(PgTsDictRow {
        oid: expect_oid(&values[0])?,
...
pub fn pg_ts_config_row_from_values(values: Vec<Value>) -> Result<PgTsConfigRow, CatalogError> {
    Ok(PgTsConfigRow {
        oid: expect_oid(&values[0])?,
...
pub fn pg_ts_config_map_row_from_values(
    values: Vec<Value>,
...
pub fn pg_sequence_row_from_values(values: Vec<Value>) -> Result<PgSequenceRow, CatalogError> {
    Ok(PgSequenceRow {
...
pub fn pg_operator_row_from_values(values: Vec<Value>) -> Result<PgOperatorRow, CatalogError> {
    Ok(PgOperatorRow {
        oid: expect_oid(&values[0])?,
...
pub fn pg_proc_row_from_values(values: Vec<Value>) -> Result<PgProcRow, CatalogError> {
...
pub fn pg_aggregate_row_from_values(values: Vec<Value>) -> Result<PgAggregateRow, CatalogError> {
    Ok(PgAggregateRow {
...
pub fn pg_collation_row_from_values(values: Vec<Value>) -> Result<PgCollationRow, CatalogError> {
    Ok(PgCollationRow {
        oid: expect_oid(&values[0])?,
...
pub fn pg_foreign_data_wrapper_row_from_values(
    values: Vec<Value>,
...
pub fn pg_foreign_server_row_from_values(
    values: Vec<Value>,
...
pub fn pg_user_mapping_row_from_values(
    values: Vec<Value>,
...
pub fn pg_foreign_table_row_from_values(
    values: Vec<Value>,
...
pub fn pg_cast_row_from_values(values: Vec<Value>) -> Result<PgCastRow, CatalogError> {
    Ok(PgCastRow {
        oid: expect_oid(&values[0])?,
...
pub fn pg_conversion_row_from_values(values: Vec<Value>) -> Result<PgConversionRow, CatalogError> {
    Ok(PgConversionRow {
        oid: expect_oid(&values[0])?,
...
pub fn pg_constraint_row_from_values(values: Vec<Value>) -> Result<PgConstraintRow, CatalogError> {
    Ok(PgConstraintRow {
        oid: expect_oid(&values[0])?,
        conname: expect_text(&values[1])?,
        connamespace: expect_oid(&values[2])?,
...
pub fn pg_database_row_from_values(values: Vec<Value>) -> Result<PgDatabaseRow, CatalogError> {
...
pub fn pg_tablespace_row_from_values(values: Vec<Value>) -> Result<PgTablespaceRow, CatalogError> {
    Ok(PgTablespaceRow {
        oid: expect_oid(&values[0])?,
...
pub fn pg_attribute_row_from_values(values: Vec<Value>) -> Result<PgAttributeRow, CatalogError> {
...
fn default_attcollation_for_type_oid(type_oid: u32) -> u32 {
    builtin_type_rows()
        ...
        .map(|row| crate::catalog::default_column_collation_oid(row.sql_type))
        .unwrap_or(0)
}

pub fn pg_inherits_row_from_values(values: Vec<Value>) -> Result<PgInheritsRow, CatalogError> {
    Ok(PgInheritsRow {
...
pub fn pg_attrdef_row_from_values(values: Vec<Value>) -> Result<PgAttrdefRow, CatalogError> {
    Ok(PgAttrdefRow {
        oid: expect_oid(&values[0])?,
...
pub fn pg_depend_row_from_values(values: Vec<Value>) -> Result<PgDependRow, CatalogError> {
    Ok(PgDependRow {
...
pub fn pg_shdepend_row_from_values(values: Vec<Value>) -> Result<PgShdependRow, CatalogError> {
    Ok(PgShdependRow {
...
pub fn pg_description_row_from_values(
    values: Vec<Value>,
...
pub fn pg_opclass_row_from_values(values: Vec<Value>) -> Result<PgOpclassRow, CatalogError> {
    Ok(PgOpclassRow {
        oid: expect_oid(&values[0])?,
...
pub fn pg_opfamily_row_from_values(values: Vec<Value>) -> Result<PgOpfamilyRow, CatalogError> {
    Ok(PgOpfamilyRow {
        oid: expect_oid(&values[0])?,
...
pub fn pg_index_row_from_values(values: Vec<Value>) -> Result<PgIndexRow, CatalogError> {
...
pub fn pg_type_row_from_values(values: Vec<Value>) -> Result<PgTypeRow, CatalogError> {
...
pub fn pg_statistic_row_from_values(values: Vec<Value>) -> Result<PgStatisticRow, CatalogError> {
    Ok(PgStatisticRow {
...
pub fn pg_statistic_ext_row_from_values(
    values: Vec<Value>,
...
pub fn pg_statistic_ext_data_row_from_values(
    values: Vec<Value>,
...
pub fn pg_rewrite_row_from_values(values: Vec<Value>) -> Result<PgRewriteRow, CatalogError> {
    Ok(PgRewriteRow {
        oid: expect_oid(&values[0])?,
...
pub fn namespace_row_values(row: PgNamespaceRow) -> Vec<Value> {
    vec![
...
fn pg_proc_row_values(row: PgProcRow) -> Vec<Value> {
    vec![
        ...
        nullable_array_value(row.proargmodes.map(|modes| {
            ...
            .with_element_type_oid(pgrust_catalog_data::INTERNAL_CHAR_TYPE_OID)
        })),
...
fn pg_statistic_record_value(row: PgStatisticRow) -> RecordValue {
    ...
    let desc = pgrust_catalog_data::pg_statistic_desc();
    RecordValue::named(
