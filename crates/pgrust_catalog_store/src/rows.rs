...
pub struct PhysicalCatalogRows {
...
pub fn create_table_sync_kinds(entry: &CatalogEntry) -> Vec<BootstrapCatalogKind> {
    let mut kinds = vec![
...
pub fn create_index_sync_kinds() -> Vec<BootstrapCatalogKind> {
    vec![
        BootstrapCatalogKind::PgClass,
        BootstrapCatalogKind::PgAttribute,
...
pub fn create_view_sync_kinds() -> Vec<BootstrapCatalogKind> {
    vec![
        BootstrapCatalogKind::PgClass,
        BootstrapCatalogKind::PgType,
        BootstrapCatalogKind::PgAttribute,
...
pub fn create_composite_type_sync_kinds() -> Vec<BootstrapCatalogKind> {
    vec![
        BootstrapCatalogKind::PgClass,
        BootstrapCatalogKind::PgType,
        BootstrapCatalogKind::PgAttribute,
...
pub fn drop_relation_sync_kinds() -> Vec<BootstrapCatalogKind> {
    vec![
        BootstrapCatalogKind::PgClass,
        BootstrapCatalogKind::PgType,
        BootstrapCatalogKind::PgAttribute,
...
pub fn drop_relation_delete_kinds() -> Vec<BootstrapCatalogKind> {
    vec![
        BootstrapCatalogKind::PgIndex,
        BootstrapCatalogKind::PgAttrdef,
        BootstrapCatalogKind::PgConstraint,
...
pub fn extend_physical_catalog_rows(target: &mut PhysicalCatalogRows, source: PhysicalCatalogRows) {
...
pub fn physical_catalog_rows_from_catcache(catcache: &CatCache) -> PhysicalCatalogRows {
...
pub fn add_builtin_description_rows(descriptions: &mut Vec<PgDescriptionRow>, catcache: &CatCache) {
...
pub fn physical_catalog_rows_for_catalog_entry(
    catalog: &Catalog,
    relation_name: &str,
    entry: &CatalogEntry,
) -> PhysicalCatalogRows {
...
fn catalog_sql_type_oid(catalog: &Catalog, sql_type: SqlType) -> u32 {
    if sql_type.is_array
        && matches!(
            sql_type.kind,
            pgrust_nodes::SqlTypeKind::Composite | pgrust_nodes::SqlTypeKind::Record
        )
        && sql_type.type_oid != 0
