...
use crate::pg_catalog_view_definitions::PG_CATALOG_VIEW_DEFINITIONS;
...
use pgrust_catalog_store::role_memberships::has_effective_membership;
use pgrust_executor::DatabaseStatsStore;
use pgrust_executor::statistics::types::{PgMcvItem, decode_pg_mcv_list_payload};
pub use pgrust_executor::{
    CopyProgressGuard, CopyProgressSnapshot, current_pg_stat_progress_copy_rows,
    install_copy_progress,
};
use pgrust_expr::compare_order_values;
use pgrust_nodes::Value;
use pgrust_nodes::datum::ArrayValue;
use pgrust_rewrite::format_stored_rule_definition;
...
pub struct PgPublicationTableInfo {
    pub pubid: u32,
    pub relid: u32,
    pub attrs: Vec<i16>,
...
pub fn build_pg_get_publication_tables_info(
...
pub fn build_pg_get_publication_tables_rows(
    publications: Vec<PgPublicationRow>,
    publication_rels: Vec<PgPublicationRelRow>,
    publication_namespaces: Vec<PgPublicationNamespaceRow>,
    classes: Vec<PgClassRow>,
...
pub fn format_pg_get_expr_policy_sql(expr_sql: &str) -> String {
...
pub fn build_pg_stat_user_tables_rows(
    namespaces: Vec<PgNamespaceRow>,
    classes: Vec<PgClassRow>,
    indexes: Vec<PgIndexRow>,
...
pub fn build_pg_stat_all_tables_rows(
    namespaces: Vec<PgNamespaceRow>,
    classes: Vec<PgClassRow>,
    indexes: Vec<PgIndexRow>,
    stats: &DatabaseStatsStore,
...
pub fn build_pg_statio_user_tables_rows(
    namespaces: Vec<PgNamespaceRow>,
    classes: Vec<PgClassRow>,
    indexes: Vec<PgIndexRow>,
    stats: &DatabaseStatsStore,
...
pub fn build_pg_stat_user_functions_rows(
    namespaces: Vec<PgNamespaceRow>,
    procs: Vec<PgProcRow>,
    stats: &DatabaseStatsStore,
) -> Vec<Vec<Value>> {
...
pub fn build_pg_stat_activity_rows(current_pid: i32, datname: &str) -> Vec<Vec<Value>> {
    vec![
        vec![
...
pub fn build_pg_stat_database_rows(
...
pub fn build_pg_stat_archiver_rows(stats: &DatabaseStatsStore) -> Vec<Vec<Value>> {
    vec![vec![
        Value::Int64(0),
        Value::Null,
        Value::Null,
...
pub fn build_pg_stat_bgwriter_rows(stats: &DatabaseStatsStore) -> Vec<Vec<Value>> {
    vec![vec![
        Value::Int64(0),
        Value::Int64(0),
        Value::Int64(0),
...
pub fn build_pg_stat_checkpointer_rows(
...
pub fn build_pg_stat_wal_rows(stats: &DatabaseStatsStore) -> Vec<Vec<Value>> {
    vec![vec![
        Value::Int64(0),
        Value::Int64(0),
...
pub fn build_pg_stat_slru_rows(stats: &DatabaseStatsStore) -> Vec<Vec<Value>> {
    stats
        .shared
        .slru_reset
        .iter()
...
pub fn build_pg_stat_recovery_prefetch_rows(stats: &DatabaseStatsStore) -> Vec<Vec<Value>> {
    vec![vec![
...
pub fn build_pg_user_mappings_rows(
    authids: Vec<PgAuthIdRow>,
    auth_members: Vec<PgAuthMembersRow>,
...
pub fn build_information_schema_foreign_data_wrappers_rows(
    authids: Vec<PgAuthIdRow>,
    auth_members: Vec<PgAuthMembersRow>,
...
pub fn build_information_schema_foreign_data_wrapper_options_rows(
    authids: Vec<PgAuthIdRow>,
    auth_members: Vec<PgAuthMembersRow>,
    wrappers: Vec<PgForeignDataWrapperRow>,
    current_user_oid: u32,
...
pub fn build_information_schema_foreign_servers_rows(
    authids: Vec<PgAuthIdRow>,
    auth_members: Vec<PgAuthMembersRow>,
    wrappers: Vec<PgForeignDataWrapperRow>,
...
pub fn build_information_schema_foreign_server_options_rows(
    authids: Vec<PgAuthIdRow>,
    auth_members: Vec<PgAuthMembersRow>,
    servers: Vec<PgForeignServerRow>,
    current_user_oid: u32,
...
pub fn build_information_schema_user_mappings_rows(
    authids: Vec<PgAuthIdRow>,
    auth_members: Vec<PgAuthMembersRow>,
    servers: Vec<PgForeignServerRow>,
...
pub fn build_information_schema_user_mapping_options_rows(
    authids: Vec<PgAuthIdRow>,
    auth_members: Vec<PgAuthMembersRow>,
    servers: Vec<PgForeignServerRow>,
    mappings: Vec<PgUserMappingRow>,
...
pub fn build_information_schema_usage_privileges_rows(
    authids: Vec<PgAuthIdRow>,
    auth_members: Vec<PgAuthMembersRow>,
    wrappers: Vec<PgForeignDataWrapperRow>,
    servers: Vec<PgForeignServerRow>,
...
pub fn build_information_schema_foreign_tables_rows(
    namespaces: Vec<PgNamespaceRow>,
    classes: Vec<PgClassRow>,
    servers: Vec<PgForeignServerRow>,
...
pub fn build_information_schema_foreign_table_options_rows(
    namespaces: Vec<PgNamespaceRow>,
    classes: Vec<PgClassRow>,
    foreign_tables: Vec<PgForeignTableRow>,
) -> Vec<Vec<Value>> {
...
pub fn build_pg_stat_io_rows(stats: &DatabaseStatsStore) -> Vec<Vec<Value>> {
    stats
        .io
        .iter()
        .map(|(key, entry)| {
