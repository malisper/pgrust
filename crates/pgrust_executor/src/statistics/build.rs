...
mod tests {
    ...
    fn ndistinct_builds_pair_and_triple_items() {
        ...
        let decoded =
            crate::statistics::types::decode_pg_ndistinct_payload(&payload.stxdndistinct.unwrap())
                .unwrap();
        assert!(
            decoded
                .items
    ...
    fn dependencies_detect_perfect_and_partial_degrees() {
        ...
        let decoded = crate::statistics::types::decode_pg_dependencies_payload(
    ...
    fn mcv_builds_frequency_and_base_frequency() {
        ...
        let decoded =
            crate::statistics::types::decode_pg_mcv_list_payload(&payload.stxdmcv.unwrap())
                .unwrap();
