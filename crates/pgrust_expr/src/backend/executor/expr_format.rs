...
pub fn to_char_int(value: i128, format: &str) -> Result<String, ExecError> {
...
pub fn to_char_numeric(value: &NumericValue, format: &str) -> Result<String, ExecError> {
...
pub fn to_char_float(value: f64, format: &str) -> Result<String, ExecError> {
    to_char_float_with_max_digits(value, format, f64::DIGITS as usize)
}

pub fn to_char_float4(value: f64, format: &str) -> Result<String, ExecError> {
...
pub fn to_number_numeric(input: &str, format: &str) -> Result<NumericValue, ExecError> {
    let mut parser = FormatParser::new(format);
    let spec = parser.parse()?;
    if spec.roman {
...
pub fn format_roman(value: i128, fill_mode: bool, lower: bool) -> String {
...
pub fn ordinal_suffix(value: i128) -> &'static str {
