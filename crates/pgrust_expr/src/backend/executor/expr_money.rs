...
pub fn money_parse_text(input: &str) -> Result<i64, ExecError> {
...
pub fn money_numeric_text(value: i64) -> String {
    let negative = value < 0;
    let cents = value.unsigned_abs();
...
pub fn money_add(left: i64, right: i64) -> Result<i64, ExecError> {
    left.checked_add(right).ok_or_else(money_out_of_range)
}

pub fn money_sub(left: i64, right: i64) -> Result<i64, ExecError> {
    left.checked_sub(right).ok_or_else(money_out_of_range)
}

pub fn money_mul_int(left: i64, right: i64) -> Result<i64, ExecError> {
    left.checked_mul(right).ok_or_else(money_out_of_range)
}

pub fn money_div_int(left: i64, right: i64) -> Result<i64, ExecError> {
    if right == 0 {
...
pub fn money_mul_float(left: i64, right: f64) -> Result<i64, ExecError> {
...
pub fn money_div_float(left: i64, right: f64) -> Result<i64, ExecError> {
    if right == 0.0 {
        return Err(ExecError::DivisionByZero("/"));
    }
    let result = (left as f64 / right).round();
...
pub fn money_from_float(value: f64) -> Result<i64, ExecError> {
...
pub fn money_cash_div(left: i64, right: i64) -> Result<f64, ExecError> {
    if right == 0 {
        return Err(ExecError::DivisionByZero("/"));
    }
...
pub fn money_cmp(left: i64, right: i64) -> std::cmp::Ordering {
    left.cmp(&right)
}

pub fn money_larger(left: i64, right: i64) -> i64 {
    left.max(right)
}

pub fn money_smaller(left: i64, right: i64) -> i64 {
    left.min(right)
}
...
pub fn cash_words_text(value: i64) -> String {
...
pub fn money_value(value: &Value) -> Option<i64> {
    match value {
