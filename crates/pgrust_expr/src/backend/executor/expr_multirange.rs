...
pub fn render_multirange(multirange: &MultirangeValue) -> String {
    render_multirange_with_config(multirange, &DateTimeConfig::default())
}

pub fn render_multirange_with_config(
...
pub fn compare_multirange_values(left: &MultirangeValue, right: &MultirangeValue) -> Ordering {
    match left
        .multirange_type
        .type_oid()
...
pub fn encode_multirange_bytes(multirange: &MultirangeValue) -> Result<Vec<u8>, ExecError> {
    let mut out = Vec::new();
...
pub fn decode_multirange_bytes(
...
pub fn multirange_from_range(range: &RangeValue) -> Result<MultirangeValue, ExecError> {
...
pub fn multirange_intersection_agg_transition(
...
pub fn eval_multirange_function(
...
pub fn multirange_contains_element(
    multirange: &MultirangeValue,
    value: &Value,
...
pub fn multirange_contains_range(multirange: &MultirangeValue, range: &RangeValue) -> bool {
    if range.empty {
        return true;
    }
    multirange
...
pub fn range_contains_multirange(range: &RangeValue, multirange: &MultirangeValue) -> bool {
    multirange
        .ranges
        .iter()
...
pub fn multirange_contains_multirange(left: &MultirangeValue, right: &MultirangeValue) -> bool {
    right
        .ranges
        .iter()
...
pub fn multirange_overlaps_range(multirange: &MultirangeValue, range: &RangeValue) -> bool {
    multirange
        .ranges
        .iter()
...
pub fn multirange_overlaps_multirange(left: &MultirangeValue, right: &MultirangeValue) -> bool {
...
pub fn multirange_adjacent_range(multirange: &MultirangeValue, range: &RangeValue) -> bool {
...
pub fn multirange_adjacent_multirange(left: &MultirangeValue, right: &MultirangeValue) -> bool {
...
pub fn span_multirange(multirange: &MultirangeValue) -> RangeValue {
