use super::ExecError;
use crate::compat::backend::parser::{
...
impl CatalogLookup for BootstrapLookup {
    fn lookup_any_relation(
        &self,
        _name: &str,
    ) -> Option<crate::compat::backend::parser::BoundRelation> {
        None
    }
}
...
pub fn parse_sql_name_parts(input: &str) -> Result<Vec<String>, ExecError> {
...
pub fn resolve_regoperator_oid(
    input: &str,
    catalog: Option<&dyn CatalogLookup>,
) -> Result<u32, ExecError> {
    if let Some(oid) = parse_numeric_oid(input)? {
...
pub fn resolve_regdictionary_oid(
    input: &str,
    catalog: Option<&dyn CatalogLookup>,
) -> Result<u32, ExecError> {
    if let Some(oid) = parse_numeric_oid(input)? {
...
pub fn is_hard_regtype_input_error(err: &ExecError) -> bool {
    match err {
...
pub fn cast_text_to_reg_object(
    input: &str,
    kind: SqlTypeKind,
    catalog: Option<&dyn CatalogLookup>,
...
pub fn to_regtypemod(value: &Value, catalog: Option<&dyn CatalogLookup>) -> Value {
    if matches!(value, Value::Null) {
        return Value::Null;
    }
    let Some(text) = value.as_text() else {
...
pub fn format_type(oid: Option<u32>, typmod: Option<i32>, catalog: &dyn CatalogLookup) -> Value {
...
pub fn format_type_text(oid: u32, typmod: Option<i32>, catalog: &dyn CatalogLookup) -> String {
    match oid {
...
pub fn format_regproc_oid(oid: u32, catalog: &dyn CatalogLookup) -> Option<String> {
    if oid == 0 {
        return Some("-".into());
    }
    catalog
...
pub fn format_regproc_oid_optional(
    oid: u32,
    catalog: Option<&dyn CatalogLookup>,
) -> Option<String> {
...
pub fn format_regprocedure_oid(oid: u32, catalog: &dyn CatalogLookup) -> Option<String> {
    if oid == 0 {
        return Some("-".into());
    }
    catalog
...
pub fn format_regprocedure_oid_optional(
    oid: u32,
    catalog: Option<&dyn CatalogLookup>,
) -> Option<String> {
...
pub fn format_regoper_oid(oid: u32, catalog: &dyn CatalogLookup) -> Option<String> {
    if oid == 0 {
        return Some("-".into());
    }
...
pub fn format_regoper_oid_optional(
    oid: u32,
    catalog: Option<&dyn CatalogLookup>,
) -> Option<String> {
...
pub fn format_regoperator_oid(oid: u32, catalog: &dyn CatalogLookup) -> Option<String> {
    if oid == 0 {
        return Some("-".into());
    }
    catalog
...
pub fn format_regoperator_oid_optional(
    oid: u32,
    catalog: Option<&dyn CatalogLookup>,
) -> Option<String> {
...
pub fn format_regcollation_oid(oid: u32, catalog: &dyn CatalogLookup) -> Option<String> {
    if oid == 0 {
        return Some("-".into());
    }
    catalog
...
pub fn format_regcollation_oid_optional(
    oid: u32,
    catalog: Option<&dyn CatalogLookup>,
) -> Option<String> {
...
pub fn type_oid_to_sql_type(oid: u32, catalog: &dyn CatalogLookup) -> Option<SqlType> {
