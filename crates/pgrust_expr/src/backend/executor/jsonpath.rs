...
pub struct EvaluationContext<'a> {
    ...
    pub vars: Option<&'a JsonbValue>,
    pub datetime_config: &'a DateTimeConfig,
    pub allow_timezone: bool,
    pub silent: bool,
    pub preserve_step_prefix: bool,
    pub preserve_unary_prefix: bool,
}
...
fn apply_datetime_cast_method(
    ...
    if let Some(precision) = precision {
        converted = crate::compat::backend::executor::expr_datetime::apply_time_precision(
            converted,
            Some(precision),
        );
    }
