...
pub fn tsquery_and(left: TsQuery, right: TsQuery) -> TsQuery {
    TsQuery {
        root: TsQueryNode::And(Box::new(left.root), Box::new(right.root)),
    }
}

pub fn tsquery_or(left: TsQuery, right: TsQuery) -> TsQuery {
    TsQuery {
        root: TsQueryNode::Or(Box::new(left.root), Box::new(right.root)),
    }
}

pub fn tsquery_not(query: TsQuery) -> TsQuery {
    TsQuery {
        root: TsQueryNode::Not(Box::new(query.root)),
    }
}

pub fn tsquery_phrase(left: TsQuery, right: TsQuery, distance: u16) -> TsQuery {
    TsQuery {
...
pub fn tsquery_rewrite(query: TsQuery, target: TsQuery, substitute: TsQuery) -> TsQuery {
...
pub fn canonicalize_tsquery_rewrite_result(query: TsQuery) -> TsQuery {
    canonicalize_rewrite_result_node(query.root).into()
}

pub fn tsquery_contains(left: &TsQuery, right: &TsQuery) -> bool {
...
pub fn tsquery_contained_by(left: &TsQuery, right: &TsQuery) -> bool {
    tsquery_contains(right, left)
}

pub fn numnode(query: &TsQuery) -> i32 {
...
pub fn tsquery_operands(query: &TsQuery) -> Vec<String> {
