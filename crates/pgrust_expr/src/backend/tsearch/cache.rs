...
pub fn resolve_config_with_gucs(
    config_name: Option<&str>,
...
pub fn dictionaries_for_asciiword(config: &TextSearchConfig) -> Vec<TextSearchDictionary> {
    match config {
...
#[allow(dead_code)]
pub fn sort_map_rows(rows: &mut [PgTsConfigMapRow]) {
