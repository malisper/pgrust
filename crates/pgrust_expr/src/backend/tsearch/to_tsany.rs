...
use crate::compat::backend::tsearch::cache::{
    TextSearchConfig, TextSearchDictionary, dictionaries_for_asciiword, resolve_config,
    resolve_dictionary,
};
use crate::compat::backend::tsearch::parser::{DocumentToken, document_tokens};
use crate::compat::backend::tsearch::ts_utils::{
...
pub fn tsvector_lexemes_with_config_name(
    config_name: Option<&str>,
    text: &str,
    start_position: u16,
    catalog: Option<&dyn CatalogLookup>,
...
pub fn to_tsquery_with_config_name(
    config_name: Option<&str>,
    text: &str,
    catalog: Option<&dyn CatalogLookup>,
...
pub fn plainto_tsquery_with_config_name(
    config_name: Option<&str>,
    text: &str,
    catalog: Option<&dyn CatalogLookup>,
) -> Result<TsQuery, String> {
...
pub fn phraseto_tsquery_with_config_name(
    config_name: Option<&str>,
    text: &str,
    catalog: Option<&dyn CatalogLookup>,
) -> Result<TsQuery, String> {
...
pub fn websearch_to_tsquery_with_config_name(
    config_name: Option<&str>,
    text: &str,
    catalog: Option<&dyn CatalogLookup>,
) -> Result<TsQuery, String> {
...
pub fn ts_lexize_with_dictionary_name(
    dictionary_name: &str,
    text: &str,
    catalog: Option<&dyn CatalogLookup>,
