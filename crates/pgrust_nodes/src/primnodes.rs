...
use crate::datum::{MultirangeTypeRef, RangeTypeRef, RecordDescriptor, Value};
use crate::parsenodes::{
    ColumnGeneratedKind, Query, SqlType, SqlTypeKind, SubqueryComparisonOp, XmlOption,
    XmlRootVersion, XmlStandalone,
};
use pgrust_core::{AttributeDesc, RelFileLocator};
...
pub struct ColumnDesc {
    ...
    pub identity: Option<crate::parsenodes::ColumnIdentityKind>,
...
pub struct WindowFrame {
    pub mode: crate::parsenodes::WindowFrameMode,
    pub start_bound: WindowFrameBound,
    pub end_bound: WindowFrameBound,
    pub exclusion: crate::parsenodes::WindowFrameExclusion,
}

impl WindowFrame {
    pub fn default_range() -> Self {
        Self {
            mode: crate::parsenodes::WindowFrameMode::Range,
            start_bound: WindowFrameBound::UnboundedPreceding,
            end_bound: WindowFrameBound::CurrentRow,
            exclusion: crate::parsenodes::WindowFrameExclusion::NoOthers,
        }
    }
}
...
fn scalar_function_collation_oid(implementation: ScalarFunctionImpl, args: &[Expr]) -> Option<u32> {
    ...
    args.iter().find_map(expr_collation_oid_hint).or_else(|| {
        args.iter()
            ...
            .then_some(pgrust_core::DEFAULT_COLLATION_OID)
    })
}
