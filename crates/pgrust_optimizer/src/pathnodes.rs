...
use pgrust_nodes::pathnodes::{Path, PathKey, PathTarget, PlannerInfo};
use pgrust_nodes::plannodes::{AggregatePhase, AggregateStrategy, Plan, PlanEstimate};
...
pub fn rte_slot_id(rtindex: usize) -> usize {
...
fn slot_var(slot_id: usize, attno: pgrust_nodes::primnodes::AttrNumber, vartype: SqlType) -> Expr {
    Expr::Var(Var {
        varno: slot_id,
        varattno: attno,
        varlevelsup: 0,
