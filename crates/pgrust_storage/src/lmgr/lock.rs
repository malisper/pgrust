...
impl TableLockMode {
    pub fn strongest(self, other: TableLockMode) -> TableLockMode {
    ...
    pub fn pg_mode_name(self) -> &'static str {
        match self {
...
pub fn lock_relations_interruptible(
    table_locks: &TableLockManager,
    client_id: ClientId,
    rels: &[RelFileLocator],
    interrupts: &InterruptState,
...
pub fn lock_tables_interruptible(
    table_locks: &TableLockManager,
    client_id: ClientId,
    rels: &[RelFileLocator],
    mode: TableLockMode,
...
pub fn lock_table_requests_interruptible(
    table_locks: &TableLockManager,
    client_id: ClientId,
