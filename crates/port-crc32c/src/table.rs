//! CRC-32C slicing-by-8 lookup tables (Castagnoli polynomial 0x1EDC6F41).
//!
//! On big-endian systems PostgreSQL stores these byte-reversed; PG only
//! supports the little-endian layout in practice and the seam signature is
//! little-endian, so this crate carries the little-endian tables only,
//! verbatim from `src/port/pg_crc32c_sb8.c`.

pub(crate) static PG_CRC32C_TABLE: [[u32; 256]; 8] = [
    [
