...
pub fn init_seams() {
    port_pg_numa_seams::pg_numa_init::set(pg_numa_init);
    port_pg_numa_seams::pg_numa_query_pages::set(pg_numa_query_pages);
    port_pg_numa_seams::pg_numa_get_max_node::set(pg_numa_get_max_node);
}
