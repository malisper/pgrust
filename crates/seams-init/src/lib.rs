...
pub fn init_all() {
    ...
    backend_backup_copy_dest::init_seams();
    ...
    backend_commands_constraint::init_seams();
    ...
    backend_statistics_mcv::init_seams();
    backend_statistics_import::init_seams();
    ...
    backend_nodes_queryjumble::init_seams();
    ...
    backend_rewrite_rewriteDefine::init_seams();
