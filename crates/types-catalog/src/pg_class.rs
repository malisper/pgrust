...
//! distinct from the relcache-read projection `types_rel::FormData_pg_class`
...
pub const Anum_pg_class_relrowsecurity: i16 = 23;
pub const Anum_pg_class_relforcerowsecurity: i16 = 24;
pub const Anum_pg_class_relhassubclass: i16 = 25;
