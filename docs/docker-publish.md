...
The publish flow is local/manual. It builds from the main [Dockerfile](/Users/malisper/workspace/work/postgres-rewrite/pgrust/Dockerfile) and pushes a multi-arch image for:
...
This publish flow does not use [Dockerfile.early-access](/Users/malisper/workspace/work/postgres-rewrite/pgrust/Dockerfile.early-access). The early-access image/tarball path remains separate and manual.
