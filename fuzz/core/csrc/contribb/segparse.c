...
#line 1 "/Users/malisper/dev/pgrust-fabled/vendor/postgres-src/contrib/seg/segparse.y"
...
{
       0,    62,    62,    78,    96,   106,   116,   124,   136,   150
};
#endif
...
/*ARGSUSED*/
     ...
     || defined __cplusplus || defined _MSC_VER)
static void
yy_symbol_value_print (FILE *yyoutput, int yytype, YYSTYPE const * const yyvaluep, SEG *result, struct Node *escontext, yyscan_t yyscanner)
#else
static void
...
`--------------------------------*/
     ...
     || defined __cplusplus || defined _MSC_VER)
static void
yy_symbol_print (FILE *yyoutput, int yytype, YYSTYPE const * const yyvaluep, SEG *result, struct Node *escontext, yyscan_t yyscanner)
#else
static void
...
`------------------------------------------------*/
     ...
     || defined __cplusplus || defined _MSC_VER)
static void
yy_reduce_print (YYSTYPE *yyvsp, int yyrule, SEG *result, struct Node *escontext, yyscan_t yyscanner)
#else
static void
...
/*ARGSUSED*/
     ...
     || defined __cplusplus || defined _MSC_VER)
static void
yydestruct (const char *yymsg, int yytype, YYSTYPE *yyvaluep, SEG *result, struct Node *escontext, yyscan_t yyscanner)
#else
static void
...
#else /* ! YYPARSE_PARAM */
#if defined __STDC__ || defined __cplusplus
int yyparse (SEG *result, struct Node *escontext, yyscan_t yyscanner);
#else
int yyparse ();
#endif
#endif /* ! YYPARSE_PARAM */
...
yyparse (YYPARSE_PARAM)
    void *YYPARSE_PARAM;
     ...
     || defined __cplusplus || defined _MSC_VER)
int
yyparse (SEG *result, struct Node *escontext, yyscan_t yyscanner)
#else
int
...
yyreduce:
  ...
  switch (yyn)
    {
        case 2:
#line 63 "/Users/malisper/dev/pgrust-fabled/vendor/postgres-src/contrib/seg/segparse.y"
    {
		char		strbuf[25];
		...
		result->l_sigd = Max(sig_digits(strbuf), Max((yyvsp[(1) - (3)].bnd).sigd, (yyvsp[(3) - (3)].bnd).sigd));
		snprintf(strbuf, sizeof(strbuf), "%g", result->upper);
		result->u_sigd = Max(sig_digits(strbuf), Max((yyvsp[(1) - (3)].bnd).sigd, (yyvsp[(3) - (3)].bnd).sigd));
		result->l_ext = '\0';
		result->u_ext = '\0';
  ...
  case 3:
#line 79 "/Users/malisper/dev/pgrust-fabled/vendor/postgres-src/contrib/seg/segparse.y"
    {
  ...
  case 4:
#line 97 "/Users/malisper/dev/pgrust-fabled/vendor/postgres-src/contrib/seg/segparse.y"
    {
  ...
  case 5:
#line 107 "/Users/malisper/dev/pgrust-fabled/vendor/postgres-src/contrib/seg/segparse.y"
    {
  ...
  case 6:
#line 117 "/Users/malisper/dev/pgrust-fabled/vendor/postgres-src/contrib/seg/segparse.y"
    {
  ...
  case 7:
#line 125 "/Users/malisper/dev/pgrust-fabled/vendor/postgres-src/contrib/seg/segparse.y"
    {
		/* temp variable avoids a gcc 3.3.x bug on Sparc64 */
		float		val;

		if (!seg_atof((yyvsp[(1) - (1)].text), &val, escontext))
			YYABORT;

		(yyval.bnd).ext = '\0';
		(yyval.bnd).sigd = sig_digits((yyvsp[(1) - (1)].text));
		(yyval.bnd).val = val;
	;}
    break;

  case 8:
#line 137 "/Users/malisper/dev/pgrust-fabled/vendor/postgres-src/contrib/seg/segparse.y"
    {
		/* temp variable avoids a gcc 3.3.x bug on Sparc64 */
		float		val;

		if (!seg_atof((yyvsp[(2) - (2)].text), &val, escontext))
			YYABORT;

		(yyval.bnd).ext = (yyvsp[(1) - (2)].text)[0];
		(yyval.bnd).sigd = sig_digits((yyvsp[(2) - (2)].text));
		(yyval.bnd).val = val;
	;}
    break;

  case 9:
#line 151 "/Users/malisper/dev/pgrust-fabled/vendor/postgres-src/contrib/seg/segparse.y"
    {
		/* temp variable avoids a gcc 3.3.x bug on Sparc64 */
		float		val;
...
#line 164 "/Users/malisper/dev/pgrust-fabled/vendor/postgres-src/contrib/seg/segparse.y"
