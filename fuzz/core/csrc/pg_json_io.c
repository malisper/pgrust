 ...
 *
 * GENERATED by fuzz/corpus/jsonbio_diff/assemble_json_oracle.py (prologue =
 * this file up to the SECTION V1 banner, epilogue = SECTION S onward) from
 * the upstream tree $PG_ORACLE_SRC — do not hand-edit the VERBATIM sections;
 * re-run the assembler instead. Provenance: PostgreSQL REL_18_6 (upstream
 * sha 724edf9bde9d356724ad384a2e196edc3c9f80f7; regenerated 2026-09-02 from the
 * Stamp-18.3 @ 62d6c7d3df extraction — the only 18.3→18.6 change in the
 * extracted bodies is json.c d1d9688b1f, escape_json_char's pg_always_inline
 * spelling; jsonfuncs.c and string.c are byte-identical at REL_18_6).
 *
...
#include "postgres.h"
/* c.h @ REL_18_6 (d1d9688b1f): the short always-inline spelling */
...
/* =====================================================================
 * SECTION V2: VERBATIM from src/backend/utils/adt/json.c @ REL_18_6
...
/* =====================================================================
 * SECTION V3: VERBATIM from src/backend/utils/adt/jsonfuncs.c @ REL_18_6
