/*
 * pg_like_io.c: vendored PostgreSQL C oracle for the like_diff differential
 * fuzz target (100%-coverage campaign; crate crates/backend/utils/adt/like).
 *
 ...
 * .file("csrc/pg_like_io.c") line in core/build.rs is uncommented. A
 * half-filled shim can therefore never silently build or link.
 *
 * Provenance (fill in as you paste; follow csrc/pg_uuid_io.c):
 *   - Vendor sections 1..N byte-for-byte from src/backend/utils/adt/like.c
 ...
 *   - Functions to vendor: textlike, textnlike, namelike, namenlike, texticlike, texticnlike, nameiclike, nameicnlike, like_escape, bytealike, byteanlike, like_escape_bytea.
...
/* ==================== SECTION 1: like.c (VERBATIM) ==================== */

/*
 * TODO(scaffold): paste here, byte-for-byte from
 * src/backend/utils/adt/like.c @ 62d6c7d3df6287f1bd83199c1a746e50d31571a0,
 * the bodies backing: textlike, textnlike, namelike, namenlike, texticlike, texticnlike, nameiclike, nameicnlike, like_escape, bytealike, byteanlike, like_escape_bytea
 ...
 */
#error "SCAFFOLD-TODO(like_diff): verbatim C from like.c not pasted yet"
 ...
 */
/*
 * TODO(scaffold): int pg_diff_textlike(...)   [oid 850, like.c]
 * (first line of the body: pg_diff_arena_reset(); — see the arena header)
 */
#error "SCAFFOLD-TODO(like_diff): pg_diff_textlike driver entry not written yet"
/*
 * TODO(scaffold): int pg_diff_textnlike(...)   [oid 851, like.c]
 * (first line of the body: pg_diff_arena_reset(); — see the arena header)
 */
#error "SCAFFOLD-TODO(like_diff): pg_diff_textnlike driver entry not written yet"
/*
 * TODO(scaffold): int pg_diff_namelike(...)   [oid 858, like.c]
 * (first line of the body: pg_diff_arena_reset(); — see the arena header)
 */
#error "SCAFFOLD-TODO(like_diff): pg_diff_namelike driver entry not written yet"
/*
 * TODO(scaffold): int pg_diff_namenlike(...)   [oid 859, like.c]
 * (first line of the body: pg_diff_arena_reset(); — see the arena header)
 */
#error "SCAFFOLD-TODO(like_diff): pg_diff_namenlike driver entry not written yet"
/*
 * TODO(scaffold): int pg_diff_texticlike(...)   [oid 1633, like.c]
 * (first line of the body: pg_diff_arena_reset(); — see the arena header)
 */
#error "SCAFFOLD-TODO(like_diff): pg_diff_texticlike driver entry not written yet"
/*
 * TODO(scaffold): int pg_diff_texticnlike(...)   [oid 1634, like.c]
 * (first line of the body: pg_diff_arena_reset(); — see the arena header)
 */
#error "SCAFFOLD-TODO(like_diff): pg_diff_texticnlike driver entry not written yet"
/*
 * TODO(scaffold): int pg_diff_nameiclike(...)   [oid 1635, like.c]
 * (first line of the body: pg_diff_arena_reset(); — see the arena header)
 */
#error "SCAFFOLD-TODO(like_diff): pg_diff_nameiclike driver entry not written yet"
/*
 * TODO(scaffold): int pg_diff_nameicnlike(...)   [oid 1636, like.c]
 * (first line of the body: pg_diff_arena_reset(); — see the arena header)
 */
#error "SCAFFOLD-TODO(like_diff): pg_diff_nameicnlike driver entry not written yet"
/*
 * TODO(scaffold): int pg_diff_like_escape(...)   [oid 1637, like.c]
 * (first line of the body: pg_diff_arena_reset(); — see the arena header)
 */
#error "SCAFFOLD-TODO(like_diff): pg_diff_like_escape driver entry not written yet"
/*
 * TODO(scaffold): int pg_diff_bytealike(...)   [oid 2005, like.c]
 * (first line of the body: pg_diff_arena_reset(); — see the arena header)
 */
#error "SCAFFOLD-TODO(like_diff): pg_diff_bytealike driver entry not written yet"
/*
 * TODO(scaffold): int pg_diff_byteanlike(...)   [oid 2006, like.c]
 * (first line of the body: pg_diff_arena_reset(); — see the arena header)
 */
#error "SCAFFOLD-TODO(like_diff): pg_diff_byteanlike driver entry not written yet"
/*
 * TODO(scaffold): int pg_diff_like_escape_bytea(...)   [oid 2009, like.c]
 * (first line of the body: pg_diff_arena_reset(); — see the arena header)
 */
#error "SCAFFOLD-TODO(like_diff): pg_diff_like_escape_bytea driver entry not written yet"
