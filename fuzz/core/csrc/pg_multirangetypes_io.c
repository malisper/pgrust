 ...
 *
 * GENERATED by the lane assembler (csrc/gen/assemble_mr.py) from VERBATIM
 * upstream extracts — regenerate rather than hand-editing bodies.
 *
 * Provenance (ALL bodies verbatim, upstream sha
 * 724edf9bde9d356724ad384a2e196edc3c9f80f7 = PostgreSQL 18.6 REL_18_6; regenerated
 * 2026-09-02 from the REL_18_3 62d6c7d3df assembly — the one upstream change
 * in the copied code is 01e568b8c1 "Fix assorted places that need to use
 * palloc_array()": multirange_recv reads range_count as int32 and sizes the
 * RangeType *[] through palloc_array, as do multirange_deserialize and
 ...
 *   - src/include/utils/palloc.h palloc_array over src/backend/utils/mmgr/
 *     mcxt.c palloc_mul + mul_size_error and src/include/common/int.h
 *     pg_mul_size_overflow (verbatim bodies, single-TU linkage): the
 *     REL_18_6 overflow-checked array allocation the three bodies above use.
