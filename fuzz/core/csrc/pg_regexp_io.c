 ...
 * .file("csrc/pg_regexp_io.c") line in core/build.rs is uncommented. A
 * half-filled shim can therefore never silently build or link.
 *
 * Provenance (fill in as you paste; follow csrc/pg_uuid_io.c):
 *   - Vendor sections 1..N byte-for-byte from src/backend/utils/adt/regexp.c
 ...
 *   - Functions to vendor: textregexeq, textregexne, texticregexeq, texticregexne, nameregexeq, nameregexne, similar_escape, similar_to_escape_1, similar_to_escape_2, textregexsubstr, textregexreplace_noopt, textregexreplace, regexp_count, regexp_instr, regexp_like, regexp_substr, regexp_match, regexp_split_to_array, textregexreplace_extended.
 ...
 * src/backend/utils/adt/regexp.c @ 62d6c7d3df6287f1bd83199c1a746e50d31571a0,
 * the bodies backing: textregexeq, textregexne, texticregexeq, texticregexne, nameregexeq, nameregexne, similar_escape, similar_to_escape_1, similar_to_escape_2, textregexsubstr, textregexreplace_noopt, textregexreplace, regexp_count, regexp_instr, regexp_like, regexp_substr, regexp_match, regexp_split_to_array, textregexreplace_extended
 ...
 */
#error "SCAFFOLD-TODO(regexp_diff): verbatim C from regexp.c not pasted yet"
 ...
 */
/*
 * TODO(scaffold): int pg_diff_textregexeq(...)   [oid 1254, regexp.c]
 * (first line of the body: pg_diff_arena_reset(); — see the arena header)
 */
#error "SCAFFOLD-TODO(regexp_diff): pg_diff_textregexeq driver entry not written yet"
/*
 * TODO(scaffold): int pg_diff_textregexne(...)   [oid 1256, regexp.c]
 * (first line of the body: pg_diff_arena_reset(); — see the arena header)
 */
#error "SCAFFOLD-TODO(regexp_diff): pg_diff_textregexne driver entry not written yet"
/*
 * TODO(scaffold): int pg_diff_texticregexeq(...)   [oid 1238, regexp.c]
 * (first line of the body: pg_diff_arena_reset(); — see the arena header)
 */
#error "SCAFFOLD-TODO(regexp_diff): pg_diff_texticregexeq driver entry not written yet"
/*
 * TODO(scaffold): int pg_diff_texticregexne(...)   [oid 1239, regexp.c]
 * (first line of the body: pg_diff_arena_reset(); — see the arena header)
 */
#error "SCAFFOLD-TODO(regexp_diff): pg_diff_texticregexne driver entry not written yet"
/*
 * TODO(scaffold): int pg_diff_nameregexeq(...)   [oid 79, regexp.c]
 * (first line of the body: pg_diff_arena_reset(); — see the arena header)
 */
#error "SCAFFOLD-TODO(regexp_diff): pg_diff_nameregexeq driver entry not written yet"
/*
 * TODO(scaffold): int pg_diff_nameregexne(...)   [oid 1252, regexp.c]
 * (first line of the body: pg_diff_arena_reset(); — see the arena header)
 */
#error "SCAFFOLD-TODO(regexp_diff): pg_diff_nameregexne driver entry not written yet"
/*
 * TODO(scaffold): int pg_diff_similar_escape(...)   [oid 1623, regexp.c]
 * (first line of the body: pg_diff_arena_reset(); — see the arena header)
 */
#error "SCAFFOLD-TODO(regexp_diff): pg_diff_similar_escape driver entry not written yet"
/*
 * TODO(scaffold): int pg_diff_similar_to_escape_1(...)   [oid 1987, regexp.c]
 * (first line of the body: pg_diff_arena_reset(); — see the arena header)
 */
#error "SCAFFOLD-TODO(regexp_diff): pg_diff_similar_to_escape_1 driver entry not written yet"
/*
 * TODO(scaffold): int pg_diff_similar_to_escape_2(...)   [oid 1986, regexp.c]
 * (first line of the body: pg_diff_arena_reset(); — see the arena header)
 */
#error "SCAFFOLD-TODO(regexp_diff): pg_diff_similar_to_escape_2 driver entry not written yet"
/*
 * TODO(scaffold): int pg_diff_textregexsubstr(...)   [oid 2073, regexp.c]
 * (first line of the body: pg_diff_arena_reset(); — see the arena header)
 */
#error "SCAFFOLD-TODO(regexp_diff): pg_diff_textregexsubstr driver entry not written yet"
/*
 * TODO(scaffold): int pg_diff_textregexreplace_noopt(...)   [oid 2284, regexp.c]
 * (first line of the body: pg_diff_arena_reset(); — see the arena header)
 */
#error "SCAFFOLD-TODO(regexp_diff): pg_diff_textregexreplace_noopt driver entry not written yet"
/*
 * TODO(scaffold): int pg_diff_textregexreplace(...)   [oid 2285, regexp.c]
 * (first line of the body: pg_diff_arena_reset(); — see the arena header)
 */
#error "SCAFFOLD-TODO(regexp_diff): pg_diff_textregexreplace driver entry not written yet"
/*
 * TODO(scaffold): int pg_diff_regexp_count(...)   [oid 6256, regexp.c]
 * (first line of the body: pg_diff_arena_reset(); — see the arena header)
 */
#error "SCAFFOLD-TODO(regexp_diff): pg_diff_regexp_count driver entry not written yet"
/*
 * TODO(scaffold): int pg_diff_regexp_instr(...)   [oid 6262, regexp.c]
 * (first line of the body: pg_diff_arena_reset(); — see the arena header)
 */
#error "SCAFFOLD-TODO(regexp_diff): pg_diff_regexp_instr driver entry not written yet"
/*
 * TODO(scaffold): int pg_diff_regexp_like(...)   [oid 6264, regexp.c]
 * (first line of the body: pg_diff_arena_reset(); — see the arena header)
 */
#error "SCAFFOLD-TODO(regexp_diff): pg_diff_regexp_like driver entry not written yet"
/*
 * TODO(scaffold): int pg_diff_regexp_substr(...)   [oid 6269, regexp.c]
 * (first line of the body: pg_diff_arena_reset(); — see the arena header)
 */
#error "SCAFFOLD-TODO(regexp_diff): pg_diff_regexp_substr driver entry not written yet"
/*
 * TODO(scaffold): int pg_diff_regexp_match(...)   [oid 3397, regexp.c]
 * (first line of the body: pg_diff_arena_reset(); — see the arena header)
 */
#error "SCAFFOLD-TODO(regexp_diff): pg_diff_regexp_match driver entry not written yet"
/*
 * TODO(scaffold): int pg_diff_regexp_split_to_array(...)   [oid 2768, regexp.c]
 * (first line of the body: pg_diff_arena_reset(); — see the arena header)
 */
#error "SCAFFOLD-TODO(regexp_diff): pg_diff_regexp_split_to_array driver entry not written yet"
/*
 * TODO(scaffold): int pg_diff_textregexreplace_extended(...)   [oid 6251, regexp.c]
 * (first line of the body: pg_diff_arena_reset(); — see the arena header)
 */
#error "SCAFFOLD-TODO(regexp_diff): pg_diff_textregexreplace_extended driver entry not written yet"
