/*
 * pg_rowtypes_io.c: vendored PostgreSQL C oracle for the rowtypes_diff differential
 * fuzz target (100%-coverage campaign; crate crates/backend/utils/adt/rowtypes).
 *
 ...
 * .file("csrc/pg_rowtypes_io.c") line in core/build.rs is uncommented. A
 * half-filled shim can therefore never silently build or link.
 *
 * Provenance (fill in as you paste; follow csrc/pg_uuid_io.c):
 *   - Vendor sections 1..N byte-for-byte from src/backend/utils/adt/rowtypes.c
 ...
 *   - Functions to vendor: record_in, record_out, record_recv, record_send, record_image_cmp, record_image_eq, hash_record, hash_record_extended, record_larger, record_smaller.
...
/* ==================== SECTION 1: rowtypes.c (VERBATIM) ==================== */

/*
 * TODO(scaffold): paste here, byte-for-byte from
 * src/backend/utils/adt/rowtypes.c @ 62d6c7d3df6287f1bd83199c1a746e50d31571a0,
 * the bodies backing: record_in, record_out, record_recv, record_send, record_image_cmp, record_image_eq, hash_record, hash_record_extended, record_larger, record_smaller
 ...
 */
#error "SCAFFOLD-TODO(rowtypes_diff): verbatim C from rowtypes.c not pasted yet"
 ...
 */
/*
 * TODO(scaffold): int pg_diff_record_in(...)   [oid 2290, rowtypes.c]
 * (first line of the body: pg_diff_arena_reset(); — see the arena header)
 */
#error "SCAFFOLD-TODO(rowtypes_diff): pg_diff_record_in driver entry not written yet"
/*
 * TODO(scaffold): int pg_diff_record_out(...)   [oid 2291, rowtypes.c]
 * (first line of the body: pg_diff_arena_reset(); — see the arena header)
 */
#error "SCAFFOLD-TODO(rowtypes_diff): pg_diff_record_out driver entry not written yet"
/*
 * TODO(scaffold): int pg_diff_record_recv(...)   [oid 2402, rowtypes.c]
 * (first line of the body: pg_diff_arena_reset(); — see the arena header)
 */
#error "SCAFFOLD-TODO(rowtypes_diff): pg_diff_record_recv driver entry not written yet"
/*
 * TODO(scaffold): int pg_diff_record_send(...)   [oid 2403, rowtypes.c]
 * (first line of the body: pg_diff_arena_reset(); — see the arena header)
 */
#error "SCAFFOLD-TODO(rowtypes_diff): pg_diff_record_send driver entry not written yet"
/*
 * TODO(scaffold): int pg_diff_record_image_cmp(...)   [oid 3187, rowtypes.c]
 * (first line of the body: pg_diff_arena_reset(); — see the arena header)
 */
#error "SCAFFOLD-TODO(rowtypes_diff): pg_diff_record_image_cmp driver entry not written yet"
/*
 * TODO(scaffold): int pg_diff_record_image_eq(...)   [oid 3181, rowtypes.c]
 * (first line of the body: pg_diff_arena_reset(); — see the arena header)
 */
#error "SCAFFOLD-TODO(rowtypes_diff): pg_diff_record_image_eq driver entry not written yet"
/*
 * TODO(scaffold): int pg_diff_hash_record(...)   [oid 6192, rowtypes.c]
 * (first line of the body: pg_diff_arena_reset(); — see the arena header)
 */
#error "SCAFFOLD-TODO(rowtypes_diff): pg_diff_hash_record driver entry not written yet"
/*
 * TODO(scaffold): int pg_diff_hash_record_extended(...)   [oid 6193, rowtypes.c]
 * (first line of the body: pg_diff_arena_reset(); — see the arena header)
 */
#error "SCAFFOLD-TODO(rowtypes_diff): pg_diff_hash_record_extended driver entry not written yet"
/*
 * TODO(scaffold): int pg_diff_record_larger(...)   [oid 6375, rowtypes.c]
 * (first line of the body: pg_diff_arena_reset(); — see the arena header)
 */
#error "SCAFFOLD-TODO(rowtypes_diff): pg_diff_record_larger driver entry not written yet"
/*
 * TODO(scaffold): int pg_diff_record_smaller(...)   [oid 6376, rowtypes.c]
 * (first line of the body: pg_diff_arena_reset(); — see the arena header)
 */
#error "SCAFFOLD-TODO(rowtypes_diff): pg_diff_record_smaller driver entry not written yet"
