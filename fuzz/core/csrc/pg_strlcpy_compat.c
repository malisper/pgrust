/*
 * pg_strlcpy_compat.c — WEAK-linkage strlcpy for pre-2.38 glibc CI cluster pods.
 *
 ...
 * CI cluster pod glibc does not, which broke the Linux link of the test binary
