 ...
 * the postgres.h / port/pg_bswap.h environment (typedefs, palloc,
 * pg_hton32/pg_hton64, Assert) is provided by pg_vlmisc_io.c's shim
 * prelude before it includes this file. FRONTEND is never defined,
 * so the #ifndef FRONTEND arms compile exactly as the backend build.
 */
/*-------------------------------------------------------------------------
 * unicode_norm.c
