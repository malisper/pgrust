 ...
 * Generated Unicode data tables (static const) — data, not logic.
 * Only permitted edit: internal #include paths flattened to this
 * directory (plumbing; noted inline where it occurs).
 */
/* generated by src/common/unicode/generate-unicode_normprops_table.pl, do not edit */

#include "unicode_norm.h" /* SHIM: path flattened (was "common/unicode_norm.h") */
