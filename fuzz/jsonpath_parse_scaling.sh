...
# minimized out of CI cluster slow-unit 899856ad3a5f72f09a52598b9bc434076004cd93
...
# The original CI cluster slow-unit's exact source text (committed).
SLOW="$(dirname "$0")/testdata/jsonpath-slow/slow-unit-899856ad-text.bin"
[ -f "$SLOW" ] && run_one "$(cat "$SLOW")" "CI-slow-unit"
