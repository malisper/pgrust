/*
 * Vendored verbatim from PostgreSQL REL_18_3 src/common/base64.c
 * (postgres-src 62d6c7d3df6287f1bd83199c1a746e50d31571a0, "Stamp 18.3"):
 * _base64 table, b64lookup table, pg_b64_encode, pg_b64_decode,
 * pg_b64_enc_len, pg_b64_dec_len — all bodies byte-for-byte.
 *
 * Shims (plumbing only, never logic):
 *   - postgres.h/c.h replaced by the typedef block below (fixed-width LP64
 *     int8/uint8/uint32, memset via string.h).
 *   - Assert -> no-op, matching an NDEBUG production build.
 */
