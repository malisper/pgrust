...
- Fuzz axis: CI cluster fuzz-campaign lcovs (gzipped here; S3 has 7-day
  ...
  campaigns and both platforms (macOS host libc + CI cluster aarch64-linux/glibc).
...
- **Plane gap FOUND AND CLOSED**: 12 fc_pg_lsn_hash(_extended) fold mutants
  ...
  KILLED), CI cluster confirm job pgrust-fuzz-campaign-1785477282-2e31-75971.
