/*
 * Vendored VERBATIM from PostgreSQL REL_18_STABLE:
 *   https://raw.githubusercontent.com/postgres/postgres/REL_18_STABLE/src/include/utils/pg_crc.h
 *   (fetched 2026-07-30; Portions Copyright (c) 1996-2025, PostgreSQL Global
 *   Development Group; Portions Copyright (c) 1994, Regents of the University
 *   of California)
 *
 * SHIMS (plumbing only):
 *   - PGDLLIMPORT defined empty below (Windows DLL storage-class macro).
 *   - uint32 comes from ../../support/c/pg_proof_shim.h (included by
 *     pg_crc.c before this header).
 * Macro bodies (INIT/COMP/FIN_TRADITIONAL_CRC32, COMP_CRC32_NORMAL_TABLE,
 * the legacy variants) are unmodified.
 */
#ifndef PGDLLIMPORT
#define PGDLLIMPORT
#endif
