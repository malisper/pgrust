/*
 * pg_conv_euc_jp_sjis.c — vendored from euc_jp_and_sjis/euc_jp_and_sjis.c + sjis.map
...
/* euc_jp_and_sjis.c lines 22-23 verbatim */
...
int			sjis2mic(const unsigned char *a, unsigned char *b, int c, bool d);
int			mic2sjis(const unsigned char *a, unsigned char *b, int c, bool d);
int			euc_jp2mic(const unsigned char *a, unsigned char *b, int c, bool d);
int			mic2euc_jp(const unsigned char *a, unsigned char *b, int c, bool d);
int			euc_jp2sjis(const unsigned char *a, unsigned char *b, int c, bool d);
int			sjis2euc_jp(const unsigned char *a, unsigned char *b, int c, bool d);
...
int
pg_euc_jp_to_sjis(const unsigned char *src, unsigned char *dest, int len, bool noError)
{
	int			converted;
...
int
pg_sjis_to_euc_jp(const unsigned char *src, unsigned char *dest, int len, bool noError)
{
	int			converted;
...
int
pg_euc_jp_to_mic(const unsigned char *src, unsigned char *dest, int len, bool noError)
{
	int			converted;
...
int
pg_sjis_to_mic(const unsigned char *src, unsigned char *dest, int len, bool noError)
{
	int			converted;
...
int
pg_mic_to_euc_jp(const unsigned char *src, unsigned char *dest, int len, bool noError)
{
	int			converted;
...
int
pg_mic_to_sjis(const unsigned char *src, unsigned char *dest, int len, bool noError)
{
	int			converted;
