/*
 * pg_conv_euc_tw_big5.c — vendored from euc_tw_and_big5/euc_tw_and_big5.c
 * and euc_tw_and_big5/big5.c (fetched 2026-07-28 from
 * https://raw.githubusercontent.com/postgres/postgres/REL_18_STABLE/src/
 * backend/utils/mb/conversion_procs). big5.c vendored WHOLE (tables +
 * BinarySearchRange + BIG5toCNS + CNStoBIG5, bodies verbatim, includes
 * dropped); euc_tw_and_big5.c helpers VERBATIM (static dropped); shims per
 * gen_shim.awk conventions (see pg_conv_cyrillic_mic.c header); error
 * paths per PROOF_EREPORT_FLAG (pg_mbconv.h).
 */
#include "pg_mbconv.h"

/* ---- big5.c, lines 18..377 verbatim (typedef + tables + functions) ---- */
typedef struct
{
	unsigned short code,
				peer;
...
/* ---- euc_tw_and_big5.c helpers (verbatim) + shims ---- */
int			euc_tw2big5(const unsigned char *a, unsigned char *b, int c, bool d);
int			big52euc_tw(const unsigned char *a, unsigned char *b, int c, bool d);
int			big52mic(const unsigned char *a, unsigned char *b, int c, bool d);
int			mic2big5(const unsigned char *a, unsigned char *b, int c, bool d);
int			euc_tw2mic(const unsigned char *a, unsigned char *b, int c, bool d);
int			mic2euc_tw(const unsigned char *a, unsigned char *b, int c, bool d);
...
int
pg_euc_tw_to_big5(const unsigned char *src, unsigned char *dest, int len, bool noError)
{
	int			converted;
...
int
pg_big5_to_euc_tw(const unsigned char *src, unsigned char *dest, int len, bool noError)
{
	int			converted;
...
int
pg_euc_tw_to_mic(const unsigned char *src, unsigned char *dest, int len, bool noError)
{
	int			converted;
...
int
pg_big5_to_mic(const unsigned char *src, unsigned char *dest, int len, bool noError)
{
	int			converted;
...
int
pg_mic_to_euc_tw(const unsigned char *src, unsigned char *dest, int len, bool noError)
{
	int			converted;
...
int
pg_mic_to_big5(const unsigned char *src, unsigned char *dest, int len, bool noError)
{
	int			converted;
