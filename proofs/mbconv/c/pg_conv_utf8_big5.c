/*
 * pg_conv_utf8_big5.c — vendored from utf8_and_big5.c + map files
...
#include "orig/maps/big5_to_utf8.map"
#include "orig/maps/utf8_to_big5.map"

int
pg_big5_to_utf8(const unsigned char *src, unsigned char *dest, int len, bool noError)
{
	int			converted;
...
int
pg_utf8_to_big5(const unsigned char *src, unsigned char *dest, int len, bool noError)
{
	int			converted;
