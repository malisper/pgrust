/*
 * pg_conv_utf8_gb18030.c — vendored from utf8_and_gb18030.c + map files
...
#include "orig/maps/gb18030_to_utf8.map"
#include "orig/maps/utf8_to_gb18030.map"
...
int
pg_gb18030_to_utf8(const unsigned char *src, unsigned char *dest, int len, bool noError)
{
	int			converted;
...
int
pg_utf8_to_gb18030(const unsigned char *src, unsigned char *dest, int len, bool noError)
{
	int			converted;
