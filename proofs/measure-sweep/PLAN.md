...
`33d7d09d31fad10a3009a7125acdb6f3246cbaa4` via the CI cluster kani-suite job's new
`--tier measure` mode (reference branch `CI cluster/measure-sweep`, commit 25b1b1881 —
...
- CI smoke: `--tier measure --rows 1-6` on c8g.2xlarge
...
Per-shard artifacts: s3://ci-results/kani-suite/33d7d09d31fad10a3009a7125acdb6f3246cbaa4/<job>/
