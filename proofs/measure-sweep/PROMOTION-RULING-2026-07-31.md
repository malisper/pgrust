...
The 7 owed CI cluster CONFIRM legs (branch `proofs/sweep-confirm-legs` @
...
`~/pgrust-CI-archive/kani-suite-e4f99485c89d/`) came back:
...
recorded `time_s` is the CI cluster measure-sweep wall — an UPPER bound
