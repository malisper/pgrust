...
// harnesses for the CI cluster 40GB retry tier (uuid[] precedent).
#[cfg(kani)]
mod proofs_w10 {
    ...
    // live proofs for the CI cluster 40GB retry tier; bitoverlay's ledger claim
    ...
    // (CI cluster 40GB retry owed); the short-header, short-body, negative-len,
