...
use crate::include::catalog::{
    ...
    GIST_POLY_CONSISTENT_PROC_OID, GIST_POLY_DISTANCE_PROC_OID, GIST_POLY_PENALTY_PROC_OID,
    GIST_POLY_PICKSPLIT_PROC_OID, GIST_POLY_SAME_PROC_OID, GIST_POLY_UNION_PROC_OID,
    GIST_TRANSLATE_CMPTYPE_COMMON_PROC_OID, GIST_TSQUERY_CONSISTENT_PROC_OID,
    GIST_TSQUERY_PENALTY_PROC_OID, GIST_TSQUERY_PICKSPLIT_PROC_OID, GIST_TSQUERY_SAME_PROC_OID,
    GIST_TSQUERY_UNION_PROC_OID, GIST_TSVECTOR_CONSISTENT_PROC_OID, GIST_TSVECTOR_PENALTY_PROC_OID,
