use crate::backend::access::transam::xlog::RM_HEAP2_ID;
...
impl From<VisibilityMapError> for crate::backend::access::heap::heapam::HeapError {
...
fn ensure_vm_page_initialized(page: &mut Page) {
    if crate::backend::storage::page::bufpage::page_header(page).is_err() {
        page_init(page, 0);
    }
}
