...
pub(crate) fn catalog_from_physical_rows_scoped(
    ...
    pgrust_catalog_store::materialize::catalog_from_physical_rows_scoped_with_index_options(
        rows,
        db_oid,
        legacy_default_exprs,
        |rel, class_row| pgrust_catalog_store::materialize::PhysicalIndexStorageOptions {
            brin_options: load_brin_options_from_metapage(
                base_dir,
                rel,
                class_row.relam,
                class_row.relkind,
            ),
            gin_options: load_gin_options_from_metapage(
                base_dir,
                rel,
                class_row.relam,
                class_row.relkind,
            ),
            hash_options: load_hash_options_from_metapage(
                base_dir,
                rel,
                class_row.relam,
                class_row.relkind,
