...
use super::expr_string::{
    ...
    eval_right_function, eval_rpad_function, eval_regexp_count, eval_regexp_instr,
    eval_regexp_like, eval_regexp_replace, eval_regexp_split_to_array,
    eval_regexp_substr, eval_repeat_function, eval_replace_function,
    eval_reverse_function, eval_set_bit_bytes, eval_set_byte, eval_sha224_function,
    eval_sha256_function, eval_sha384_function, eval_sha512_function, eval_similar,
