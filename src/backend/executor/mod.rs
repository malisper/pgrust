...
mod tests {
    ...
    fn records_relation_desc() -> RelationDesc {
        ...
        RelationDesc {
            columns: vec![
                ...
                crate::backend::catalog::catalog::column_desc("tags", SqlType::array_of(SqlType::new(SqlTypeKind::Varchar)), true),
                crate::backend::catalog::catalog::column_desc("category_tags", SqlType::array_of(SqlType::new(SqlTypeKind::Varchar)), true),
                crate::backend::catalog::catalog::column_desc("size_tags", SqlType::array_of(SqlType::new(SqlTypeKind::Varchar)), true),
            ],
        }
    }
    ...
    fn numeric_cast_typmod_rejects_precision_overflow() {
        ...
        let err = run_sql(&base, &txns, INVALID_TRANSACTION_ID, "select '1234.56'::numeric(5,2)")
            .unwrap_err();
        assert!(matches!(err, ExecError::TypeMismatch { op: "::numeric", .. }));
    }
