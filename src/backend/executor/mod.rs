...
pub(crate) use expr_network::{
    compare_network_values, encode_network_bytes, eval_network_function, network_contains,
    network_merge, parse_cidr_bytes, parse_cidr_text, parse_inet_bytes, parse_inet_text,
    render_network_text,
};
