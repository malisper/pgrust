...
use crate::backend::tsearch::cache::{TextSearchConfig, resolve_config};
use crate::backend::tsearch::lexize_token_for_config_and_type;
...
pub(crate) fn ts_headline(
    ...
    if crate::backend::executor::render_tsquery_text(query).is_empty() {
