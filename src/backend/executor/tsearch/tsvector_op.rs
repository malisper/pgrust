...
use crate::include::catalog::{INT2_TYPE_OID, TEXT_TYPE_OID};
use crate::include::nodes::datum::{ArrayValue, Value};
use crate::include::nodes::tsearch::{TsLexeme, TsPosition, TsVector, TsWeight};
...
pub(crate) fn parse_ts_weight(value: &Value, op: &'static str) -> Result<TsWeight, ExecError> {
    let text = match value {
        Value::InternalChar(byte) => crate::backend::executor::render_internal_char_text(*byte),
