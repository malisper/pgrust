...
use crate::include::catalog::{
    ...
    PgAttrdefRow, PgAttributeRow, PgAuthIdRow, PgAuthMembersRow, PgClassRow, PgCollationRow,
    ...
    bootstrap_pg_authid_rows, bootstrap_pg_collation_rows, bootstrap_pg_database_rows,
