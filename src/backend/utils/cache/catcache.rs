...
use crate::include::catalog::{
    ...
    PgDependRow, PgForeignDataWrapperRow, PgIndexRow, PgInheritsRow, PgLanguageRow,
    PgNamespaceRow, PgOpclassRow, PgOperatorRow, PgOpfamilyRow, PgPartitionedTableRow,
    ...
    XML_ARRAY_TYPE_OID, XML_TYPE_OID, bootstrap_composite_type_rows,
    ...
    bootstrap_pg_database_rows, bootstrap_pg_foreign_data_wrapper_rows,
    ...
    bootstrap_pg_tablespace_rows, bootstrap_pg_ts_config_map_rows,
...
impl CatCache {
    ...
    pub fn partitioned_table_rows(&self) -> Vec<PgPartitionedTableRow> {
        self.partitioned_tables_by_relid
            .values()
            .cloned()
            .collect()
    }
