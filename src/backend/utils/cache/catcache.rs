...
use crate::include::catalog::{
    ...
    PgDependRow, PgIndexRow, PgLanguageRow, PgNamespaceRow, PgOpclassRow, PgOperatorRow,
    PgOpfamilyRow, PgProcRow, PgRewriteRow, PgStatisticRow, PgTablespaceRow, PgTsConfigMapRow,
