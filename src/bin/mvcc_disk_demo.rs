...
fn inspect_relation(base_dir: &Path, desc: &[AttributeDesc], title: &str, show_file_state: bool) {
    ...
    for block in 0..nblocks {
        ...
        for off in 1..=max_offset {
            ...
            let tuple = pgrust::access::heap::tuple::heap_page_get_tuple(&page, off).unwrap();
            println!(
