...
use crate::include::catalog::{
    ANYRANGEOID, BIT_TYPE_OID, BOOL_TYPE_OID, BOX_TYPE_OID, BPCHAR_TYPE_OID, BRIN_AM_OID,
    ...
    HASH_NUMERIC_FAMILY_OID, HASH_OID_FAMILY_OID, HASH_RANGE_FAMILY_OID, HASH_TEXT_FAMILY_OID,
    HASH_TIME_FAMILY_OID, HASH_TIMESTAMP_FAMILY_OID, HASH_TIMESTAMPTZ_FAMILY_OID,
    HASH_TIMETZ_FAMILY_OID, HASH_UUID_FAMILY_OID, INT2_TYPE_OID, INT4_TYPE_OID, INT4RANGE_TYPE_OID,
    ...
    SPGIST_BOX_FAMILY_OID, SPGIST_POLY_FAMILY_OID, SPGIST_RANGE_FAMILY_OID, TEXT_ARRAY_TYPE_OID,
