...
use crate::include::catalog::{
    ...
    BRIN_FLOAT_MINMAX_FAMILY_OID, BRIN_INTEGER_MINMAX_FAMILY_OID, BRIN_OID_MINMAX_FAMILY_OID,
    BRIN_TEXT_MINMAX_FAMILY_OID, BRIN_TIME_MINMAX_FAMILY_OID, BRIN_TIMETZ_MINMAX_FAMILY_OID,
    BRIN_VARBIT_MINMAX_FAMILY_OID, BTREE_AM_OID, BTREE_BIT_FAMILY_OID, BTREE_BOOL_FAMILY_OID,
    BTREE_BYTEA_FAMILY_OID, BTREE_FLOAT_FAMILY_OID, BTREE_INTEGER_FAMILY_OID,
    ...
    GIN_JSONB_FAMILY_OID, GIST_AM_OID, GIST_BOX_FAMILY_OID, GIST_MULTIRANGE_FAMILY_OID,
    ...
    HASH_FLOAT_FAMILY_OID, HASH_INTEGER_FAMILY_OID, HASH_MULTIRANGE_FAMILY_OID,
