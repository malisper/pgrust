...
use crate::include::catalog::{
    ...
    DATERANGE_TYPE_OID, DATE_TYPE_OID, FLOAT4_TYPE_OID, FLOAT8_TYPE_OID, GIST_AM_OID,
    GIST_BOX_FAMILY_OID, GIST_RANGE_FAMILY_OID, INT2_TYPE_OID, INT4_TYPE_OID, INT4RANGE_TYPE_OID,
    INT8_TYPE_OID, INT8RANGE_TYPE_OID, INTERNAL_CHAR_TYPE_OID, NUMRANGE_TYPE_OID, OID_TYPE_OID,
    TEXT_TYPE_OID, TIME_TYPE_OID, TIMESTAMP_TYPE_OID, TIMESTAMPTZ_TYPE_OID, TIMETZ_TYPE_OID,
    TSRANGE_TYPE_OID, TSTZRANGE_TYPE_OID, VARBIT_TYPE_OID, bootstrap_pg_operator_rows,
};
