...
use crate::include::catalog::{
    ...
    GIST_RANGE_FAMILY_OID, INT2_TYPE_OID, INT4_TYPE_OID, INT4RANGE_TYPE_OID, INT8_TYPE_OID,
    ...
    JSONB_TYPE_OID, NUMRANGE_TYPE_OID, OID_TYPE_OID, POINT_TYPE_OID, SPGIST_AM_OID,
    SPGIST_BOX_FAMILY_OID, TEXT_ARRAY_TYPE_OID, TEXT_TYPE_OID, TIME_TYPE_OID, TIMESTAMP_TYPE_OID,
    TIMESTAMPTZ_TYPE_OID, TIMETZ_TYPE_OID, TSRANGE_TYPE_OID, TSTZRANGE_TYPE_OID, VARBIT_TYPE_OID,
