...
use crate::include::catalog::{
    ...
    FLOAT8_TYPE_OID, GIST_AM_OID, GIST_BOX_FAMILY_OID, GIST_RANGE_FAMILY_OID, INT2_TYPE_OID,
    INT4_TYPE_OID, INT4RANGE_TYPE_OID, INT8_TYPE_OID, INT8RANGE_TYPE_OID, INTERNAL_CHAR_TYPE_OID,
    NUMRANGE_TYPE_OID, OID_TYPE_OID, POINT_TYPE_OID, SPGIST_AM_OID, SPGIST_BOX_FAMILY_OID,
