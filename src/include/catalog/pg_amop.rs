...
use crate::include::catalog::{
    ...
    HASH_OID_FAMILY_OID, HASH_RANGE_FAMILY_OID, HASH_TEXT_FAMILY_OID, HASH_TIME_FAMILY_OID,
    ...
    INT8RANGE_TYPE_OID, INTERNAL_CHAR_TYPE_OID, INTERVAL_TYPE_OID, JSONB_CONTAINS_OPERATOR_OID,
    ...
    SPGIST_BOX_FAMILY_OID, SPGIST_KD_POINT_FAMILY_OID, SPGIST_POLY_FAMILY_OID,
    SPGIST_QUAD_POINT_FAMILY_OID, SPGIST_TEXT_FAMILY_OID, TEXT_ARRAY_TYPE_OID, TEXT_TYPE_OID,
