...
use crate::include::catalog::{
    ANYOID, ANYRANGEOID, BIT_CMP_EQ_PROC_OID, BIT_TYPE_OID, BOOL_CMP_EQ_PROC_OID, BOOL_TYPE_OID,
    BOX_TYPE_OID, BPCHAR_TYPE_OID, BRIN_BIT_MINMAX_FAMILY_OID, BRIN_BPCHAR_MINMAX_FAMILY_OID,
    ...
    BRIN_MACADDR8_MINMAX_MULTI_FAMILY_OID, BRIN_MINMAX_ADD_VALUE_PROC_OID,
    ...
    GIST_BOX_SAME_PROC_OID, GIST_BOX_UNION_PROC_OID, GIST_NETWORK_CONSISTENT_PROC_OID,
    GIST_NETWORK_FAMILY_OID, GIST_NETWORK_PENALTY_PROC_OID, GIST_NETWORK_PICKSPLIT_PROC_OID,
    GIST_NETWORK_SAME_PROC_OID, GIST_NETWORK_UNION_PROC_OID, GIST_POINT_CONSISTENT_PROC_OID,
    GIST_POINT_FAMILY_OID, GIST_POINT_PENALTY_PROC_OID, GIST_POINT_PICKSPLIT_PROC_OID,
    GIST_POINT_SAME_PROC_OID, GIST_POINT_UNION_PROC_OID, GIST_RANGE_FAMILY_OID,
    GIST_TRANSLATE_CMPTYPE_COMMON_PROC_OID, HASH_BOOL_FAMILY_OID, HASH_BOOL_PROC_OID,
    HASH_BPCHAR_FAMILY_OID, HASH_BPCHAR_PROC_OID, HASH_BYTEA_FAMILY_OID, HASH_BYTEA_PROC_OID,
    HASH_CHAR_FAMILY_OID, HASH_CHAR_PROC_OID, HASH_DATE_FAMILY_OID, HASH_DATE_PROC_OID,
    HASH_FLOAT_FAMILY_OID, HASH_FLOAT4_PROC_OID, HASH_FLOAT8_PROC_OID, HASH_INT2_PROC_OID,
    HASH_INT4_PROC_OID, HASH_INT8_PROC_OID, HASH_INTEGER_FAMILY_OID, HASH_MACADDR_FAMILY_OID,
    HASH_MACADDR_PROC_OID, HASH_MACADDR8_FAMILY_OID, HASH_MACADDR8_PROC_OID, HASH_NAME_PROC_OID,
    HASH_NUMERIC_FAMILY_OID, HASH_NUMERIC_PROC_OID, HASH_OID_FAMILY_OID, HASH_OID_PROC_OID,
    HASH_RANGE_FAMILY_OID, HASH_RANGE_PROC_OID, HASH_TEXT_FAMILY_OID, HASH_TEXT_PROC_OID,
    ...
    INET_TYPE_OID, INT2_TYPE_OID, INT4_CMP_EQ_PROC_OID, INT4_TYPE_OID, INT4RANGE_TYPE_OID,
    INT8_TYPE_OID, INT8RANGE_TYPE_OID, INTERNAL_CHAR_TYPE_OID, JSONB_TYPE_OID,
    MACADDR_CMP_PROC_OID, MACADDR_TYPE_OID, MACADDR8_CMP_PROC_OID, MACADDR8_TYPE_OID,
    NAME_TYPE_OID, NUMERIC_TYPE_OID, NUMRANGE_TYPE_OID, OID_TYPE_OID, POLYGON_TYPE_OID,
    ...
    SPG_RANGE_PICKSPLIT_PROC_OID, SPGIST_BOX_FAMILY_OID, SPGIST_NETWORK_FAMILY_OID,
    SPGIST_POLY_FAMILY_OID, SPGIST_RANGE_FAMILY_OID, TEXT_CMP_EQ_PROC_OID, TEXT_TYPE_OID,
