...
use crate::include::catalog::{
    ...
    BTREE_NETWORK_FAMILY_OID, BTREE_TEXT_FAMILY_OID, BTREE_UUID_FAMILY_OID,
    BTREE_VARBIT_FAMILY_OID, BYTEA_CMP_EQ_PROC_OID, BYTEA_TYPE_OID, CIDR_TYPE_OID, DATE_TYPE_OID,
    DATERANGE_TYPE_OID, FLOAT4_TYPE_OID, FLOAT8_TYPE_OID, GIN_COMPARE_JSONB_PROC_OID,
    GIN_CONSISTENT_JSONB_PROC_OID, GIN_EXTRACT_JSONB_PROC_OID, GIN_EXTRACT_JSONB_QUERY_PROC_OID,
