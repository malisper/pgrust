...
use crate::include::catalog::{
    ...
    INT8_TYPE_OID, INT8RANGE_TYPE_OID, INTERNAL_CHAR_TYPE_OID, INTERVAL_TYPE_OID, JSONB_TYPE_OID,
    ...
    SPGIST_QUAD_POINT_FAMILY_OID, SPGIST_RANGE_FAMILY_OID, SPGIST_TEXT_FAMILY_OID,
    TEXT_CMP_EQ_PROC_OID, TEXT_TYPE_OID, TIME_TYPE_OID, TIMESTAMP_TYPE_OID, TIMESTAMPTZ_TYPE_OID,
    TIMETZ_TYPE_OID, TSRANGE_TYPE_OID, TSTZRANGE_TYPE_OID, UUID_CMP_PROC_OID, UUID_TYPE_OID,
    VARBIT_CMP_EQ_PROC_OID, VARBIT_TYPE_OID, VARCHAR_TYPE_OID, bootstrap_pg_operator_rows,
};
