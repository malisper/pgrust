...
use crate::include::catalog::{
    ...
    HASH_INTEGER_FAMILY_OID, HASH_MACADDR_FAMILY_OID, HASH_MACADDR_PROC_OID,
    HASH_MACADDR8_FAMILY_OID, HASH_MACADDR8_PROC_OID, HASH_NAME_PROC_OID, HASH_NUMERIC_FAMILY_OID,
    HASH_NUMERIC_PROC_OID, HASH_OID_FAMILY_OID, HASH_OID_PROC_OID, HASH_TEXT_FAMILY_OID,
    ...
    HASH_VARCHAR_PROC_OID, INT2_TYPE_OID, INT4_CMP_EQ_PROC_OID, INT4_TYPE_OID, INT4RANGE_TYPE_OID,
