...
use crate::include::catalog::{
    ...
    GIST_BOX_UNION_PROC_OID, GIST_RANGE_FAMILY_OID, GIST_TRANSLATE_CMPTYPE_COMMON_PROC_OID,
    ...
    NUMRANGE_TYPE_OID, OID_TYPE_OID, RANGE_GIST_CONSISTENT_PROC_OID, RANGE_GIST_PENALTY_PROC_OID,
