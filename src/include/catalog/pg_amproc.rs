...
use crate::include::catalog::{
    ...
    HASH_TIMESTAMPTZ_PROC_OID, HASH_TIMETZ_FAMILY_OID, HASH_TIMETZ_PROC_OID,
    HASH_UUID_FAMILY_OID, HASH_UUID_PROC_OID, HASH_VARCHAR_PROC_OID, INET_TYPE_OID,
    INT2_TYPE_OID, INT4_CMP_EQ_PROC_OID, INT4_TYPE_OID, INT4RANGE_TYPE_OID, INT8_TYPE_OID,
    INT8RANGE_TYPE_OID, INTERNAL_CHAR_TYPE_OID, INTERVAL_TYPE_OID, JSONB_TYPE_OID,
