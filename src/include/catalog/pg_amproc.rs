...
use crate::include::catalog::{
    ...
    JSONB_TYPE_OID, MACADDR_CMP_PROC_OID, MACADDR_TYPE_OID, MACADDR8_CMP_PROC_OID,
    ...
    SPG_NETWORK_PICKSPLIT_PROC_OID, SPGIST_BOX_FAMILY_OID, SPGIST_NETWORK_FAMILY_OID,
