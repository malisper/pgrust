...
use crate::include::catalog::{
    ANYMULTIRANGEOID, ANYOID, BIT_CMP_EQ_PROC_OID, BIT_TYPE_OID, BOOL_CMP_EQ_PROC_OID,
    BOOL_TYPE_OID, BOX_TYPE_OID, BPCHAR_TYPE_OID, BRIN_BIT_MINMAX_FAMILY_OID,
    ...
    BTREE_MACADDR_FAMILY_OID, BTREE_MACADDR8_FAMILY_OID, BTREE_NETWORK_FAMILY_OID,
    BTREE_TEXT_FAMILY_OID, BTREE_UUID_FAMILY_OID, BTREE_VARBIT_FAMILY_OID, BYTEA_CMP_EQ_PROC_OID,
    BYTEA_TYPE_OID, CIDR_TYPE_OID, DATE_TYPE_OID, DATERANGE_TYPE_OID, FLOAT4_TYPE_OID,
    FLOAT8_TYPE_OID, GIN_COMPARE_JSONB_PROC_OID, GIN_CONSISTENT_JSONB_PROC_OID,
    GIN_EXTRACT_JSONB_PROC_OID, GIN_EXTRACT_JSONB_QUERY_PROC_OID, GIN_JSONB_FAMILY_OID,
    GIN_TRICONSISTENT_JSONB_PROC_OID, GIST_BOX_CONSISTENT_PROC_OID, GIST_BOX_DISTANCE_PROC_OID,
    GIST_BOX_FAMILY_OID, GIST_BOX_PENALTY_PROC_OID, GIST_BOX_PICKSPLIT_PROC_OID,
    GIST_BOX_SAME_PROC_OID, GIST_BOX_UNION_PROC_OID, GIST_MULTIRANGE_FAMILY_OID,
    GIST_NETWORK_CONSISTENT_PROC_OID, GIST_NETWORK_FAMILY_OID, GIST_NETWORK_PENALTY_PROC_OID,
    ...
    HASH_DATE_PROC_OID, HASH_FLOAT_FAMILY_OID, HASH_FLOAT4_PROC_OID, HASH_FLOAT8_PROC_OID,
    HASH_INT2_PROC_OID, HASH_INT4_PROC_OID, HASH_INT8_PROC_OID, HASH_INTEGER_FAMILY_OID,
    HASH_INTERVAL_FAMILY_OID, HASH_INTERVAL_PROC_OID, HASH_MACADDR_FAMILY_OID,
    HASH_MACADDR_PROC_OID, HASH_MACADDR8_FAMILY_OID, HASH_MACADDR8_PROC_OID,
    HASH_MULTIRANGE_FAMILY_OID, HASH_MULTIRANGE_PROC_OID, HASH_NAME_PROC_OID,
    HASH_NUMERIC_FAMILY_OID, HASH_NUMERIC_PROC_OID, HASH_OID_FAMILY_OID, HASH_OID_PROC_OID,
    HASH_TEXT_FAMILY_OID, HASH_TEXT_PROC_OID, HASH_TIME_FAMILY_OID, HASH_TIME_PROC_OID,
    HASH_TIMESTAMP_FAMILY_OID, HASH_TIMESTAMP_PROC_OID, HASH_TIMESTAMPTZ_FAMILY_OID,
    HASH_TIMESTAMPTZ_PROC_OID, HASH_TIMETZ_FAMILY_OID, HASH_TIMETZ_PROC_OID, HASH_UUID_FAMILY_OID,
    HASH_UUID_PROC_OID, HASH_VARCHAR_PROC_OID, INET_TYPE_OID, INT2_TYPE_OID, INT4_CMP_EQ_PROC_OID,
    INT4_TYPE_OID, INT4RANGE_TYPE_OID, INT8_TYPE_OID, INT8RANGE_TYPE_OID, INTERNAL_CHAR_TYPE_OID,
    INTERVAL_TYPE_OID, JSONB_TYPE_OID, MACADDR_CMP_PROC_OID, MACADDR_TYPE_OID,
    MACADDR8_CMP_PROC_OID, MACADDR8_TYPE_OID, MULTIRANGE_GIST_CONSISTENT_PROC_OID,
    MULTIRANGE_GIST_PENALTY_PROC_OID, MULTIRANGE_GIST_PICKSPLIT_PROC_OID,
    MULTIRANGE_GIST_SAME_PROC_OID, MULTIRANGE_GIST_UNION_PROC_OID, MULTIRANGE_SORTSUPPORT_PROC_OID,
    NAME_TYPE_OID, NUMERIC_TYPE_OID, NUMRANGE_TYPE_OID, OID_TYPE_OID, POINT_TYPE_OID,
    POLYGON_TYPE_OID, RANGE_GIST_CONSISTENT_PROC_OID, RANGE_GIST_PENALTY_PROC_OID,
    RANGE_GIST_PICKSPLIT_PROC_OID, RANGE_GIST_SAME_PROC_OID, RANGE_GIST_UNION_PROC_OID,
    RANGE_SORTSUPPORT_PROC_OID, SPG_BOX_QUAD_CHOOSE_PROC_OID, SPG_BOX_QUAD_CONFIG_PROC_OID,
    ...
    SPG_TEXT_LEAF_CONSISTENT_PROC_OID, SPG_TEXT_PICKSPLIT_PROC_OID, SPGIST_BOX_FAMILY_OID,
    SPGIST_KD_POINT_FAMILY_OID, SPGIST_NETWORK_FAMILY_OID, SPGIST_POLY_FAMILY_OID,
    SPGIST_QUAD_POINT_FAMILY_OID, SPGIST_TEXT_FAMILY_OID, TEXT_CMP_EQ_PROC_OID, TEXT_TYPE_OID,
    TIME_TYPE_OID, TIMESTAMP_TYPE_OID, TIMESTAMPTZ_TYPE_OID, TIMETZ_TYPE_OID, TSRANGE_TYPE_OID,
    TSTZRANGE_TYPE_OID, UUID_CMP_PROC_OID, UUID_TYPE_OID, VARBIT_CMP_EQ_PROC_OID, VARBIT_TYPE_OID,
