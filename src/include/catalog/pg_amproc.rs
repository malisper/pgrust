...
use crate::include::catalog::{
    ...
    BTREE_VARBIT_FAMILY_OID, BYTEA_CMP_EQ_PROC_OID, BYTEA_TYPE_OID, CIDR_TYPE_OID,
    ...
    GIST_BOX_UNION_PROC_OID, GIST_NETWORK_CONSISTENT_PROC_OID, GIST_NETWORK_FAMILY_OID,
    ...
    SPGIST_POLY_FAMILY_OID, TEXT_CMP_EQ_PROC_OID, TEXT_TYPE_OID, TIME_TYPE_OID,
    TIMESTAMP_TYPE_OID, TIMESTAMPTZ_TYPE_OID, TIMETZ_TYPE_OID, TSRANGE_TYPE_OID,
    TSTZRANGE_TYPE_OID, UUID_CMP_PROC_OID, UUID_TYPE_OID, VARBIT_CMP_EQ_PROC_OID,
