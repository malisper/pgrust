...
use crate::include::catalog::{
    ...
    GIST_MULTIRANGE_FAMILY_OID, GIST_NETWORK_CONSISTENT_PROC_OID, GIST_NETWORK_FAMILY_OID,
    GIST_NETWORK_PENALTY_PROC_OID, GIST_NETWORK_PICKSPLIT_PROC_OID, GIST_NETWORK_SAME_PROC_OID,
    GIST_NETWORK_UNION_PROC_OID, GIST_POINT_CONSISTENT_PROC_OID, GIST_POINT_FAMILY_OID,
    ...
    HASH_INTEGER_FAMILY_OID, HASH_MULTIRANGE_FAMILY_OID, HASH_MULTIRANGE_PROC_OID,
