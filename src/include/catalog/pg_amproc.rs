...
use crate::include::catalog::{
    ...
    BTREE_VARBIT_FAMILY_OID, BYTEA_CMP_EQ_PROC_OID, BYTEA_TYPE_OID, DATE_TYPE_OID,
    ...
    HASH_TIMETZ_PROC_OID, HASH_VARCHAR_PROC_OID, INT2_TYPE_OID, INT4_CMP_EQ_PROC_OID,
    ...
    SPG_BOX_QUAD_PICKSPLIT_PROC_OID, SPGIST_BOX_FAMILY_OID, SPGIST_POLY_FAMILY_OID,
    TEXT_CMP_EQ_PROC_OID, TEXT_TYPE_OID, TIME_TYPE_OID, TIMESTAMP_TYPE_OID, TIMESTAMPTZ_TYPE_OID,
    TIMETZ_TYPE_OID, TSRANGE_TYPE_OID, TSTZRANGE_TYPE_OID, VARBIT_CMP_EQ_PROC_OID, VARBIT_TYPE_OID,
