...
use crate::include::catalog::{
    ...
    SPG_BOX_QUAD_PICKSPLIT_PROC_OID, SPGIST_BOX_FAMILY_OID, TEXT_CMP_EQ_PROC_OID, TEXT_TYPE_OID,
    TIME_TYPE_OID, TIMESTAMP_TYPE_OID, TIMESTAMPTZ_TYPE_OID, TIMETZ_TYPE_OID, TSRANGE_TYPE_OID,
    TSTZRANGE_TYPE_OID, VARBIT_CMP_EQ_PROC_OID, VARBIT_TYPE_OID, VARCHAR_TYPE_OID,
