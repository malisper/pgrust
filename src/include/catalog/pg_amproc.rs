...
use crate::include::catalog::{
    ANYMULTIRANGEOID, ANYOID, ANYRANGEOID, BIT_CMP_EQ_PROC_OID, BIT_TYPE_OID, BOOL_CMP_EQ_PROC_OID,
    ...
    HASH_MACADDR_FAMILY_OID, HASH_MACADDR_PROC_OID, HASH_MACADDR8_FAMILY_OID,
    HASH_MACADDR8_PROC_OID, HASH_MULTIRANGE_FAMILY_OID, HASH_MULTIRANGE_PROC_OID,
    HASH_NAME_PROC_OID, HASH_NUMERIC_FAMILY_OID, HASH_NUMERIC_PROC_OID, HASH_OID_FAMILY_OID,
    HASH_OID_PROC_OID, HASH_RANGE_FAMILY_OID, HASH_RANGE_PROC_OID, HASH_TEXT_FAMILY_OID,
    HASH_TEXT_PROC_OID, HASH_TIME_FAMILY_OID, HASH_TIME_PROC_OID, HASH_TIMESTAMP_FAMILY_OID,
    HASH_TIMESTAMP_PROC_OID, HASH_TIMESTAMPTZ_FAMILY_OID, HASH_TIMESTAMPTZ_PROC_OID,
    HASH_TIMETZ_FAMILY_OID, HASH_TIMETZ_PROC_OID, HASH_UUID_FAMILY_OID, HASH_UUID_PROC_OID,
    HASH_VARCHAR_PROC_OID, INET_TYPE_OID, INT2_TYPE_OID, INT4_CMP_EQ_PROC_OID, INT4_TYPE_OID,
    INT4RANGE_TYPE_OID, INT8_TYPE_OID, INT8RANGE_TYPE_OID, INTERNAL_CHAR_TYPE_OID, JSONB_TYPE_OID,
    ...
    MULTIRANGE_GIST_UNION_PROC_OID, MULTIRANGE_SORTSUPPORT_PROC_OID, NAME_TYPE_OID,
    NUMERIC_TYPE_OID, NUMRANGE_TYPE_OID, OID_TYPE_OID, POLYGON_TYPE_OID,
