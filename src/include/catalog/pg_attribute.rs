...
use crate::include::catalog::{
    ...
    INTERVAL_TYPE_OID, JSON_ARRAY_TYPE_OID, JSON_TYPE_OID,
    ...
    PG_INHERITS_RELATION_OID, PG_LANGUAGE_RELATION_OID, PG_NAMESPACE_RELATION_OID,
    ...
    TIME_ARRAY_TYPE_OID, TIME_TYPE_OID,
