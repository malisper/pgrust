...
use crate::include::catalog::{
    ...
    JSONPATH_ARRAY_TYPE_OID, JSONPATH_TYPE_OID, LINE_TYPE_OID, LSEG_TYPE_OID, NAME_ARRAY_TYPE_OID,
    NAME_TYPE_OID, NUMERIC_ARRAY_TYPE_OID, NUMERIC_TYPE_OID, OID_ARRAY_TYPE_OID, OID_TYPE_OID,
    OIDVECTOR_TYPE_OID, PATH_TYPE_OID, PG_AM_RELATION_OID, PG_AMOP_RELATION_OID,
    ...
    TIME_TYPE_OID, TIMETZ_ARRAY_TYPE_OID, TIMETZ_TYPE_OID, TSQUERY_ARRAY_TYPE_OID,
