...
use crate::include::catalog::{
    ...
    CAST_PROC_TEXT_BPCHAR_OID, CIRCLE_TYPE_OID, DATERANGE_TYPE_OID, DATE_TYPE_OID,
    FLOAT4_ARRAY_TYPE_OID,
    FLOAT4_TYPE_OID, FLOAT8_ARRAY_TYPE_OID, FLOAT8_TYPE_OID, INT2_ARRAY_TYPE_OID, INT2_TYPE_OID,
    INT4_ARRAY_TYPE_OID, INT4_TYPE_OID, INT4RANGE_TYPE_OID, INT8_ARRAY_TYPE_OID, INT8_TYPE_OID,
    INT8RANGE_TYPE_OID,
    ...
    NAME_TYPE_OID, NUMERIC_ARRAY_TYPE_OID, NUMERIC_TYPE_OID, NUMRANGE_TYPE_OID,
    ...
    TIMESTAMP_ARRAY_TYPE_OID, TIMESTAMP_TYPE_OID, TSRANGE_TYPE_OID, TSQUERY_ARRAY_TYPE_OID,
    TSQUERY_TYPE_OID, TSTZRANGE_TYPE_OID, TSVECTOR_ARRAY_TYPE_OID, TSVECTOR_TYPE_OID,
    VARBIT_ARRAY_TYPE_OID, VARBIT_TYPE_OID,
