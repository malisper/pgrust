...
use crate::include::catalog::{
    ...
    CAST_PROC_TEXT_BPCHAR_OID, CIRCLE_TYPE_OID, DATEMULTIRANGE_TYPE_OID, DATE_TYPE_OID,
    DATERANGE_TYPE_OID, FLOAT4_ARRAY_TYPE_OID, FLOAT4_TYPE_OID, FLOAT8_ARRAY_TYPE_OID,
    FLOAT8_TYPE_OID, INT2_ARRAY_TYPE_OID, INT2_TYPE_OID, INT4MULTIRANGE_TYPE_OID,
    INT4_ARRAY_TYPE_OID, INT4_TYPE_OID, INT4RANGE_TYPE_OID, INT8MULTIRANGE_TYPE_OID,
    ...
    REGROLE_TYPE_OID, TEXT_ARRAY_TYPE_OID, TEXT_TYPE_OID, TIMESTAMP_ARRAY_TYPE_OID,
