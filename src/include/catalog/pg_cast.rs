...
use crate::include::catalog::{
    ...
    REGPROCEDURE_ARRAY_TYPE_OID, REGPROCEDURE_TYPE_OID, TEXT_ARRAY_TYPE_OID, TEXT_TYPE_OID,
    TIMESTAMP_ARRAY_TYPE_OID, TIMESTAMP_TYPE_OID, TSQUERY_ARRAY_TYPE_OID, TSQUERY_TYPE_OID,
    TSRANGE_TYPE_OID, TSTZRANGE_TYPE_OID, TSVECTOR_ARRAY_TYPE_OID, TSVECTOR_TYPE_OID,
