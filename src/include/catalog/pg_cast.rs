...
use crate::include::catalog::{
    ...
    CAST_PROC_TEXT_BPCHAR_OID, CID_TYPE_OID, CIDR_ARRAY_TYPE_OID, CIDR_TYPE_OID, CIRCLE_TYPE_OID,
    DATE_TYPE_OID, DATEMULTIRANGE_TYPE_OID, DATERANGE_TYPE_OID, FLOAT4_ARRAY_TYPE_OID,
    ...
    OID_ARRAY_TYPE_OID, OID_TYPE_OID, OIDVECTOR_TYPE_OID, PATH_TYPE_OID, PG_DEPENDENCIES_TYPE_OID,
    PG_LSN_TYPE_OID, PG_MCV_LIST_TYPE_OID, PG_NDISTINCT_TYPE_OID, PG_NODE_TREE_TYPE_OID,
    PG_SNAPSHOT_TYPE_OID, POINT_TYPE_OID, POLYGON_TYPE_OID, REGCLASS_TYPE_OID,
    REGCOLLATION_ARRAY_TYPE_OID, REGCOLLATION_TYPE_OID, REGCONFIG_ARRAY_TYPE_OID,
    ...
    TID_ARRAY_TYPE_OID, TID_TYPE_OID, TIME_TYPE_OID, TIMESTAMP_ARRAY_TYPE_OID, TIMESTAMP_TYPE_OID,
