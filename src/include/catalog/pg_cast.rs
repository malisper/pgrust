...
use crate::include::catalog::{
    ...
    CAST_PROC_TEXT_BPCHAR_OID, CIRCLE_TYPE_OID, DATE_TYPE_OID, DATEMULTIRANGE_TYPE_OID,
    ...
    REGTYPE_TYPE_OID, TEXT_ARRAY_TYPE_OID, TEXT_TYPE_OID, TIMESTAMP_ARRAY_TYPE_OID,
