...
use crate::include::catalog::{
    ...
    BTREE_OIDVECTOR_FAMILY_OID, BTREE_TEXT_FAMILY_OID, BTREE_UUID_FAMILY_OID,
    ...
    JSONB_TYPE_OID, NAME_TYPE_OID, NUMERIC_TYPE_OID, NUMMULTIRANGE_TYPE_OID, OID_TYPE_OID,
