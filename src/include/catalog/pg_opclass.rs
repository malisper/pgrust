...
use crate::include::catalog::{
    ANYMULTIRANGEOID, BIT_TYPE_OID, BOOL_TYPE_OID, BOOTSTRAP_SUPERUSER_OID, BPCHAR_TYPE_OID,
    ...
    BTREE_VARBIT_FAMILY_OID, BYTEA_TYPE_OID, DATEMULTIRANGE_TYPE_OID, FLOAT4_TYPE_OID,
    FLOAT8_TYPE_OID, INT2_TYPE_OID, INT4MULTIRANGE_TYPE_OID, INT4_TYPE_OID,
