...
use crate::include::catalog::{
    ...
    BTREE_MULTIRANGE_FAMILY_OID, BTREE_NUMERIC_FAMILY_OID, BTREE_OID_FAMILY_OID,
    ...
    HASH_MACADDR8_FAMILY_OID, HASH_NUMERIC_FAMILY_OID, HASH_OID_FAMILY_OID, HASH_TEXT_FAMILY_OID,
    HASH_TIME_FAMILY_OID, HASH_TIMESTAMP_FAMILY_OID, HASH_TIMESTAMPTZ_FAMILY_OID,
    HASH_TIMETZ_FAMILY_OID, HASH_UUID_FAMILY_OID, INT2_TYPE_OID, INT4_TYPE_OID,
    INT4MULTIRANGE_TYPE_OID, INT4RANGE_TYPE_OID, INT8_TYPE_OID, INT8MULTIRANGE_TYPE_OID,
    INTERNAL_CHAR_TYPE_OID, JSONB_TYPE_OID, MACADDR_TYPE_OID, MACADDR8_TYPE_OID, NAME_TYPE_OID,
    ...
    SPGIST_BOX_FAMILY_OID, SPGIST_POLY_FAMILY_OID, TEXT_TYPE_OID, TIME_TYPE_OID,
    TIMESTAMP_TYPE_OID, TIMESTAMPTZ_TYPE_OID, TIMETZ_TYPE_OID, TSMULTIRANGE_TYPE_OID,
    TSTZMULTIRANGE_TYPE_OID, UUID_TYPE_OID, VARBIT_TYPE_OID, VARCHAR_TYPE_OID,
};
