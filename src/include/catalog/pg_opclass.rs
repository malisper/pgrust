...
use crate::include::catalog::{
    ...
    BTREE_INTEGER_FAMILY_OID, BTREE_MULTIRANGE_FAMILY_OID, BTREE_NETWORK_FAMILY_OID,
    ...
    HASH_DATE_FAMILY_OID, HASH_FLOAT_FAMILY_OID, HASH_INTEGER_FAMILY_OID,
    HASH_MULTIRANGE_FAMILY_OID, HASH_NUMERIC_FAMILY_OID, HASH_OID_FAMILY_OID, HASH_TEXT_FAMILY_OID,
    ...
    SPGIST_NETWORK_FAMILY_OID, SPGIST_POLY_FAMILY_OID, TEXT_TYPE_OID, TIME_TYPE_OID,
