...
use crate::include::catalog::{
    ...
    GIN_AM_OID, GIN_JSONB_FAMILY_OID, GIST_AM_OID, GIST_BOX_FAMILY_OID,
    ...
    INT8MULTIRANGE_TYPE_OID, INTERNAL_CHAR_TYPE_OID, INTERVAL_TYPE_OID, JSONB_TYPE_OID,
    MACADDR_TYPE_OID, MACADDR8_TYPE_OID, NAME_TYPE_OID, NUMERIC_TYPE_OID, NUMMULTIRANGE_TYPE_OID,
    OID_TYPE_OID, OIDVECTOR_TYPE_OID, PG_CATALOG_NAMESPACE_OID, POINT_TYPE_OID, POLYGON_TYPE_OID,
    SPGIST_AM_OID, SPGIST_BOX_FAMILY_OID, SPGIST_NETWORK_FAMILY_OID, SPGIST_POLY_FAMILY_OID,
...
pub const INTERVAL_BTREE_OPCLASS_OID: u32 = 10034;
