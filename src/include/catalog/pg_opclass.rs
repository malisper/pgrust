...
use crate::include::catalog::{
    ...
    BTREE_NUMERIC_FAMILY_OID, BTREE_OID_FAMILY_OID, BTREE_TEXT_FAMILY_OID,
    BTREE_VARBIT_FAMILY_OID, BYTEA_TYPE_OID, FLOAT4_TYPE_OID, FLOAT8_TYPE_OID, INT2_TYPE_OID,
    INT4_TYPE_OID, INT8_TYPE_OID, NUMERIC_TYPE_OID, OID_TYPE_OID, PG_CATALOG_NAMESPACE_OID,
...
pub fn bootstrap_pg_opclass_rows() -> Vec<PgOpclassRow> {
    vec![
        ...
        row(FLOAT4_BTREE_OPCLASS_OID, "float4_ops", BTREE_FLOAT_FAMILY_OID, FLOAT4_TYPE_OID),
        row(FLOAT8_BTREE_OPCLASS_OID, "float8_ops", BTREE_FLOAT_FAMILY_OID, FLOAT8_TYPE_OID),
        row(NUMERIC_BTREE_OPCLASS_OID, "numeric_ops", BTREE_NUMERIC_FAMILY_OID, NUMERIC_TYPE_OID),
        row(TIMESTAMP_BTREE_OPCLASS_OID, "timestamp_ops", BTREE_DATETIME_FAMILY_OID, TIMESTAMP_TYPE_OID),
        row(BYTEA_BTREE_OPCLASS_OID, "bytea_ops", BTREE_BYTEA_FAMILY_OID, BYTEA_TYPE_OID),
        row(BIT_BTREE_OPCLASS_OID, "bit_ops", BTREE_BIT_FAMILY_OID, BIT_TYPE_OID),
        row(VARBIT_BTREE_OPCLASS_OID, "varbit_ops", BTREE_VARBIT_FAMILY_OID, VARBIT_TYPE_OID),
    ]
}
