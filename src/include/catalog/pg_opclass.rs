...
use crate::include::catalog::{
    ...
    GIST_MULTIRANGE_FAMILY_OID, GIST_NETWORK_FAMILY_OID, GIST_POINT_FAMILY_OID,
    ...
    HASH_MULTIRANGE_FAMILY_OID, HASH_NUMERIC_FAMILY_OID, HASH_OID_FAMILY_OID,
...
pub const RANGE_SPGIST_OPCLASS_OID: u32 = 76019;
