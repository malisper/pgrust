...
use crate::include::catalog::{
    ...
    SPGIST_BOX_FAMILY_OID, SPGIST_KD_POINT_FAMILY_OID, SPGIST_NETWORK_FAMILY_OID,
    SPGIST_POLY_FAMILY_OID, SPGIST_QUAD_POINT_FAMILY_OID, SPGIST_TEXT_FAMILY_OID, TEXT_TYPE_OID,
