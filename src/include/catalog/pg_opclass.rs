...
use crate::include::catalog::{
    ...
    BTREE_BOOL_FAMILY_OID, BTREE_INTEGER_FAMILY_OID, BTREE_NUMERIC_FAMILY_OID,
    BTREE_OID_FAMILY_OID, BTREE_TEXT_FAMILY_OID, BYTEA_TYPE_OID, FLOAT4_TYPE_OID, FLOAT8_TYPE_OID,
    INT2_TYPE_OID, INT4_TYPE_OID, INT8_TYPE_OID, NUMERIC_TYPE_OID, OID_TYPE_OID,
    PG_CATALOG_NAMESPACE_OID, TEXT_TYPE_OID, TIMESTAMP_TYPE_OID, VARBIT_TYPE_OID,
    VARCHAR_TYPE_OID,
};
...
pub fn pg_opclass_desc() -> RelationDesc {
    RelationDesc {
        columns: vec![
            ...
            column_desc("opcname", SqlType::new(SqlTypeKind::Text), false),
...
pub fn bootstrap_pg_opclass_rows() -> Vec<PgOpclassRow> {
    vec![
        row(BOOL_BTREE_OPCLASS_OID, "bool_ops", BTREE_BOOL_FAMILY_OID, BOOL_TYPE_OID),
        row(INT2_BTREE_OPCLASS_OID, "int2_ops", BTREE_INTEGER_FAMILY_OID, INT2_TYPE_OID),
        row(INT4_BTREE_OPCLASS_OID, "int4_ops", BTREE_INTEGER_FAMILY_OID, INT4_TYPE_OID),
        row(INT8_BTREE_OPCLASS_OID, "int8_ops", BTREE_INTEGER_FAMILY_OID, INT8_TYPE_OID),
        row(OID_BTREE_OPCLASS_OID, "oid_ops", BTREE_OID_FAMILY_OID, OID_TYPE_OID),
        row(TEXT_BTREE_OPCLASS_OID, "text_ops", BTREE_TEXT_FAMILY_OID, TEXT_TYPE_OID),
        row(VARCHAR_BTREE_OPCLASS_OID, "varchar_ops", BTREE_TEXT_FAMILY_OID, VARCHAR_TYPE_OID),
        row(BPCHAR_BTREE_OPCLASS_OID, "bpchar_ops", BTREE_TEXT_FAMILY_OID, BPCHAR_TYPE_OID),
        row(FLOAT4_BTREE_OPCLASS_OID, "float4_ops", BTREE_NUMERIC_FAMILY_OID, FLOAT4_TYPE_OID),
        row(FLOAT8_BTREE_OPCLASS_OID, "float8_ops", BTREE_NUMERIC_FAMILY_OID, FLOAT8_TYPE_OID),
        row(NUMERIC_BTREE_OPCLASS_OID, "numeric_ops", BTREE_NUMERIC_FAMILY_OID, NUMERIC_TYPE_OID),
        row(TIMESTAMP_BTREE_OPCLASS_OID, "timestamp_ops", BTREE_NUMERIC_FAMILY_OID, TIMESTAMP_TYPE_OID),
        row(BYTEA_BTREE_OPCLASS_OID, "bytea_ops", BTREE_TEXT_FAMILY_OID, BYTEA_TYPE_OID),
        row(BIT_BTREE_OPCLASS_OID, "bit_ops", BTREE_TEXT_FAMILY_OID, BIT_TYPE_OID),
        row(VARBIT_BTREE_OPCLASS_OID, "varbit_ops", BTREE_TEXT_FAMILY_OID, VARBIT_TYPE_OID),
    ]
}
