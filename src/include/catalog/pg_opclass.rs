...
use crate::include::catalog::{
    ...
    GIST_BOX_FAMILY_OID, GIST_NETWORK_FAMILY_OID, GIST_POINT_FAMILY_OID, GIST_RANGE_FAMILY_OID,
    ...
    HASH_MACADDR_FAMILY_OID, HASH_MACADDR8_FAMILY_OID, HASH_NUMERIC_FAMILY_OID,
    ...
    INT8MULTIRANGE_TYPE_OID, INTERNAL_CHAR_TYPE_OID, JSONB_TYPE_OID, MACADDR_TYPE_OID,
    MACADDR8_TYPE_OID, NAME_TYPE_OID, NUMERIC_TYPE_OID, NUMMULTIRANGE_TYPE_OID, OID_TYPE_OID,
