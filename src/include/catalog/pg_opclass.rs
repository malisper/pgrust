...
use crate::include::catalog::{
    ...
    BTREE_INTEGER_FAMILY_OID, BTREE_NUMERIC_FAMILY_OID, BTREE_OIDVECTOR_FAMILY_OID,
    BTREE_OID_FAMILY_OID, BTREE_TEXT_FAMILY_OID, BTREE_VARBIT_FAMILY_OID, BYTEA_TYPE_OID,
    FLOAT4_TYPE_OID, FLOAT8_TYPE_OID, INT2_TYPE_OID, INT4_TYPE_OID, INT8_TYPE_OID,
    INTERNAL_CHAR_TYPE_OID, NAME_TYPE_OID, NUMERIC_TYPE_OID, OID_TYPE_OID, OIDVECTOR_TYPE_OID,
