...
use crate::include::catalog::{
    ...
    BTREE_OID_FAMILY_OID, BTREE_OIDVECTOR_FAMILY_OID, BTREE_TEXT_FAMILY_OID, BTREE_UUID_FAMILY_OID,
    BTREE_VARBIT_FAMILY_OID, BYTEA_TYPE_OID, CIDR_TYPE_OID, DATE_TYPE_OID, DATEMULTIRANGE_TYPE_OID,
    ...
    HASH_FLOAT_FAMILY_OID, HASH_INTEGER_FAMILY_OID, HASH_MACADDR_FAMILY_OID,
