...
use crate::include::catalog::{
    ANYARRAYOID, ANYMULTIRANGEOID, ANYRANGEOID, BIT_TYPE_OID, BOOL_TYPE_OID,
    ...
    BTREE_AM_OID, BTREE_ARRAY_FAMILY_OID, BTREE_BIT_FAMILY_OID, BTREE_BOOL_FAMILY_OID,
    ...
    BTREE_NETWORK_FAMILY_OID, BTREE_NUMERIC_FAMILY_OID, BTREE_OID_FAMILY_OID,
    BTREE_OIDVECTOR_FAMILY_OID, BTREE_RANGE_FAMILY_OID, BTREE_TEXT_FAMILY_OID,
    BTREE_UUID_FAMILY_OID, BTREE_VARBIT_FAMILY_OID, BYTEA_TYPE_OID, CIDR_TYPE_OID, DATE_TYPE_OID,
    DATEMULTIRANGE_TYPE_OID, DATERANGE_TYPE_OID, FLOAT4_TYPE_OID, FLOAT8_TYPE_OID, GIN_AM_OID,
    GIN_JSONB_FAMILY_OID, GIST_AM_OID, GIST_BOX_FAMILY_OID, GIST_NETWORK_FAMILY_OID,
    ...
    HASH_TIMESTAMPTZ_FAMILY_OID, HASH_TIMETZ_FAMILY_OID, HASH_UUID_FAMILY_OID, INET_TYPE_OID,
    INT2_TYPE_OID, INT4_TYPE_OID, INT4MULTIRANGE_TYPE_OID, INT4RANGE_TYPE_OID, INT8_TYPE_OID,
    INT8MULTIRANGE_TYPE_OID, INT8RANGE_TYPE_OID, INTERNAL_CHAR_TYPE_OID, JSONB_TYPE_OID,
    NAME_TYPE_OID, NUMERIC_TYPE_OID, NUMMULTIRANGE_TYPE_OID, NUMRANGE_TYPE_OID, OID_TYPE_OID,
    OIDVECTOR_TYPE_OID, PG_CATALOG_NAMESPACE_OID, POINT_TYPE_OID, POLYGON_TYPE_OID, SPGIST_AM_OID,
    SPGIST_BOX_FAMILY_OID, SPGIST_NETWORK_FAMILY_OID, SPGIST_POLY_FAMILY_OID,
    SPGIST_RANGE_FAMILY_OID, TEXT_TYPE_OID, TIME_TYPE_OID, TIMESTAMP_TYPE_OID,
    TIMESTAMPTZ_TYPE_OID, TIMETZ_TYPE_OID, TSMULTIRANGE_TYPE_OID, TSRANGE_TYPE_OID,
    TSTZMULTIRANGE_TYPE_OID, TSTZRANGE_TYPE_OID, UUID_TYPE_OID, VARBIT_TYPE_OID, VARCHAR_TYPE_OID,
};
...
pub const RANGE_BTREE_OPCLASS_OID: u32 = 10006;
...
pub const RANGE_SPGIST_OPCLASS_OID: u32 = 76018;
...
pub const RANGE_HASH_OPCLASS_OID: u32 = 76220;
