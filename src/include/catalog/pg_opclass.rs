...
use crate::include::catalog::{
    ...
    GIST_BOX_FAMILY_OID, GIST_RANGE_FAMILY_OID, HASH_AM_OID, HASH_BOOL_FAMILY_OID,
    ...
    INT8MULTIRANGE_TYPE_OID, INTERNAL_CHAR_TYPE_OID, JSONB_TYPE_OID, NAME_TYPE_OID,
    NUMERIC_TYPE_OID, NUMMULTIRANGE_TYPE_OID, OID_TYPE_OID, OIDVECTOR_TYPE_OID,
    PG_CATALOG_NAMESPACE_OID, POLYGON_TYPE_OID, SPGIST_AM_OID, SPGIST_BOX_FAMILY_OID,
    SPGIST_POLY_FAMILY_OID, TEXT_TYPE_OID, TIME_TYPE_OID, TIMESTAMP_TYPE_OID, TIMESTAMPTZ_TYPE_OID,
    TIMETZ_TYPE_OID, TSMULTIRANGE_TYPE_OID, TSTZMULTIRANGE_TYPE_OID, UUID_TYPE_OID,
