...
use crate::include::catalog::{
    ...
    BOX_TYPE_OID, BPCHAR_TYPE_OID, BTREE_AM_OID, BTREE_ARRAY_FAMILY_OID, BTREE_BIT_FAMILY_OID,
    BTREE_BOOL_FAMILY_OID, BTREE_BYTEA_FAMILY_OID, BTREE_CHAR_FAMILY_OID,
    ...
    DATEMULTIRANGE_TYPE_OID, FLOAT4_TYPE_OID, FLOAT8_TYPE_OID, GIST_AM_OID, GIST_BOX_FAMILY_OID,
    ...
    TIMESTAMP_TYPE_OID, TSMULTIRANGE_TYPE_OID, TSTZMULTIRANGE_TYPE_OID, VARBIT_TYPE_OID,
    VARCHAR_TYPE_OID,
};
