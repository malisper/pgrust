...
use crate::include::catalog::{
    ...
    BTREE_MULTIRANGE_FAMILY_OID, BTREE_NETWORK_FAMILY_OID, BTREE_NUMERIC_FAMILY_OID,
    BTREE_OID_FAMILY_OID, BTREE_OIDVECTOR_FAMILY_OID, BTREE_RANGE_FAMILY_OID,
    BTREE_TEXT_FAMILY_OID, BTREE_UUID_FAMILY_OID, BTREE_VARBIT_FAMILY_OID, BYTEA_TYPE_OID,
    CIDR_TYPE_OID, DATE_TYPE_OID, DATEMULTIRANGE_TYPE_OID, DATERANGE_TYPE_OID, FLOAT4_TYPE_OID,
    ...
    HASH_MACADDR8_FAMILY_OID, HASH_NUMERIC_FAMILY_OID, HASH_OID_FAMILY_OID, HASH_RANGE_FAMILY_OID,
    ...
    MACADDR_TYPE_OID, MACADDR8_TYPE_OID, NAME_TYPE_OID, NUMERIC_TYPE_OID, NUMMULTIRANGE_TYPE_OID,
    NUMRANGE_TYPE_OID, OID_TYPE_OID, OIDVECTOR_TYPE_OID, PG_CATALOG_NAMESPACE_OID, POINT_TYPE_OID,
    POLYGON_TYPE_OID, SPGIST_AM_OID, SPGIST_BOX_FAMILY_OID, SPGIST_NETWORK_FAMILY_OID,
    SPGIST_POLY_FAMILY_OID, SPGIST_RANGE_FAMILY_OID, TEXT_TYPE_OID, TIME_TYPE_OID,
    TIMESTAMP_TYPE_OID, TIMESTAMPTZ_TYPE_OID, TIMETZ_TYPE_OID, TSMULTIRANGE_TYPE_OID,
    TSRANGE_TYPE_OID, TSTZMULTIRANGE_TYPE_OID, TSTZRANGE_TYPE_OID, UUID_TYPE_OID, VARBIT_TYPE_OID,
    VARCHAR_TYPE_OID,
};
