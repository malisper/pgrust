...
use crate::include::catalog::{
    ...
    TSRANGE_TYPE_OID, TSTZRANGE_TYPE_OID, VARBIT_CMP_EQ_PROC_OID, VARBIT_CMP_GE_PROC_OID,
    VARBIT_CMP_GT_PROC_OID, VARBIT_CMP_LE_PROC_OID, VARBIT_CMP_LT_PROC_OID, VARBIT_CMP_NE_PROC_OID,
    VARBIT_TYPE_OID, VARCHAR_CMP_EQ_PROC_OID, VARCHAR_TYPE_OID, bootstrap_pg_proc_rows,
};
