...
use crate::include::catalog::{
    ...
    BOOL_CMP_NE_PROC_OID, BOOL_TYPE_OID, BOOTSTRAP_SUPERUSER_OID, INT4_CMP_EQ_PROC_OID,
    INT4_CMP_GE_PROC_OID, INT4_CMP_GT_PROC_OID, INT4_CMP_LE_PROC_OID, INT4_CMP_LT_PROC_OID,
    INT4_CMP_NE_PROC_OID, INT4_TYPE_OID, JSONB_CMP_EQ_PROC_OID, JSONB_CMP_GE_PROC_OID,
    JSONB_CMP_GT_PROC_OID, JSONB_CMP_LE_PROC_OID, JSONB_CMP_LT_PROC_OID, JSONB_CMP_NE_PROC_OID,
    JSONB_TYPE_OID, PG_CATALOG_NAMESPACE_OID, TEXT_CMP_EQ_PROC_OID, TEXT_CMP_GE_PROC_OID,
    TEXT_CMP_GT_PROC_OID, TEXT_CMP_LE_PROC_OID, TEXT_CMP_LT_PROC_OID, TEXT_CMP_NE_PROC_OID,
    TEXT_STARTS_WITH_PROC_OID, TEXT_TYPE_OID, VARBIT_CMP_EQ_PROC_OID, VARBIT_CMP_GE_PROC_OID,
    VARBIT_CMP_GT_PROC_OID, VARBIT_CMP_LE_PROC_OID, VARBIT_CMP_LT_PROC_OID,
...
pub fn bootstrap_pg_operator_rows() -> [PgOperatorRow; 37] {
    [
        operator_row(
            58,
            "<",
