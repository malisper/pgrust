...
use crate::include::catalog::{
    ...
    INTERVAL_CMP_EQ_PROC_OID, INTERVAL_CMP_GE_PROC_OID, INTERVAL_CMP_GT_PROC_OID,
    INTERVAL_CMP_LE_PROC_OID, INTERVAL_CMP_LT_PROC_OID, INTERVAL_CMP_NE_PROC_OID,
    INTERVAL_TYPE_OID, JSONB_CMP_EQ_PROC_OID, JSONB_CMP_GE_PROC_OID, JSONB_CMP_GT_PROC_OID,
    JSONB_CMP_LE_PROC_OID, JSONB_CMP_LT_PROC_OID, JSONB_CMP_NE_PROC_OID,
    JSONB_CONTAINED_PROC_OID, JSONB_CONTAINS_PROC_OID, JSONB_EXISTS_ALL_PROC_OID,
    JSONB_EXISTS_ANY_PROC_OID, JSONB_EXISTS_PROC_OID, JSONB_TYPE_OID, LINE_TYPE_OID,
    LSEG_TYPE_OID, MACADDR_AND_PROC_OID, MACADDR_EQ_PROC_OID, MACADDR_GE_PROC_OID,
    MACADDR_GT_PROC_OID, MACADDR_LE_PROC_OID, MACADDR_LT_PROC_OID, MACADDR_NE_PROC_OID,
    MACADDR_NOT_PROC_OID, MACADDR_OR_PROC_OID, MACADDR_TYPE_OID, MACADDR8_AND_PROC_OID,
    MACADDR8_EQ_PROC_OID, MACADDR8_GE_PROC_OID, MACADDR8_GT_PROC_OID, MACADDR8_LE_PROC_OID,
    MACADDR8_LT_PROC_OID, MACADDR8_NE_PROC_OID, MACADDR8_NOT_PROC_OID, MACADDR8_OR_PROC_OID,
    MACADDR8_TYPE_OID, NAME_CMP_EQ_PROC_OID, NAME_TYPE_OID, NUMERIC_CMP_EQ_PROC_OID,
    NUMERIC_TYPE_OID, NUMRANGE_TYPE_OID, OID_TYPE_OID, PATH_TYPE_OID, PG_CATALOG_NAMESPACE_OID,
    POINT_TYPE_OID, POLYGON_TYPE_OID, TEXT_ARRAY_TYPE_OID, TEXT_CMP_EQ_PROC_OID,
    ...
    TSTZRANGE_TYPE_OID, UUID_CMP_EQ_PROC_OID, UUID_CMP_GE_PROC_OID, UUID_CMP_GT_PROC_OID,
    UUID_CMP_LE_PROC_OID, UUID_CMP_LT_PROC_OID, UUID_CMP_NE_PROC_OID, UUID_TYPE_OID,
