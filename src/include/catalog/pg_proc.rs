...
use crate::include::catalog::{
    ...
    RECORD_TYPE_OID, REGCLASS_TYPE_OID, REGCONFIG_TYPE_OID, TEXT_ARRAY_TYPE_OID, TEXT_TYPE_OID,
    TIME_TYPE_OID, TIMESTAMP_TYPE_OID, TIMESTAMPTZ_TYPE_OID, TIMETZ_TYPE_OID, TRIGGER_TYPE_OID,
    TSQUERY_TYPE_OID, TSRANGE_TYPE_OID, TSTZRANGE_TYPE_OID, TSVECTOR_TYPE_OID, VARBIT_TYPE_OID,
