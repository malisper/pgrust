...
use crate::include::catalog::{
    ...
    JSONPATH_TYPE_OID, LINE_TYPE_OID, LSEG_TYPE_OID, MACADDR_TYPE_OID, MACADDR8_TYPE_OID,
    MONEY_TYPE_OID, NAME_TYPE_OID, NUMERIC_TYPE_OID, NUMRANGE_TYPE_OID, OID_TYPE_OID,
    PATH_TYPE_OID, PG_CATALOG_NAMESPACE_OID, PG_LANGUAGE_INTERNAL_OID, PG_NODE_TREE_TYPE_OID,
    POINT_TYPE_OID, POLYGON_TYPE_OID, RECORD_TYPE_OID, REGCLASS_TYPE_OID, REGCOLLATION_TYPE_OID,
    ...
    TSVECTOR_TYPE_OID, TXID_SNAPSHOT_TYPE_OID, UUID_TYPE_OID, VARBIT_TYPE_OID, VARCHAR_TYPE_OID,
