...
use crate::include::catalog::{
    ANYARRAYOID, ANYOID, BIT_TYPE_OID, BOOL_TYPE_OID, BOOTSTRAP_SUPERUSER_OID, BPCHAR_TYPE_OID,
    BYTEA_TYPE_OID, FLOAT8_TYPE_OID, INT2_TYPE_OID, INT4_TYPE_OID, INT8_TYPE_OID, JSON_TYPE_OID,
    JSONB_TYPE_OID, JSONPATH_TYPE_OID, NUMERIC_TYPE_OID, PG_CATALOG_NAMESPACE_OID,
    PG_LANGUAGE_INTERNAL_OID, RECORD_TYPE_OID, TEXT_ARRAY_TYPE_OID, TEXT_TYPE_OID, VARBIT_TYPE_OID,
};
