...
use crate::include::catalog::{
    ANYARRAYOID, ANYMULTIRANGEOID, ANYOID, ARRAYRANGE_TYPE_OID, BIT_TYPE_OID, BOOL_TYPE_OID,
    BOOTSTRAP_SUPERUSER_OID, BOX_TYPE_OID, BPCHAR_TYPE_OID, BYTEA_TYPE_OID, CIRCLE_TYPE_OID,
    DATE_TYPE_OID, DATERANGE_TYPE_OID, FDW_HANDLER_TYPE_OID, FLOAT4_TYPE_OID,
