...
use crate::include::catalog::{
    ...
    NUMERIC_TYPE_OID, NUMRANGE_TYPE_OID, OID_TYPE_OID, PATH_TYPE_OID,
    PG_CATALOG_NAMESPACE_OID, PG_LANGUAGE_INTERNAL_OID, POINT_TYPE_OID, POLYGON_TYPE_OID,
    RECORD_TYPE_OID, TEXT_ARRAY_TYPE_OID, TEXT_TYPE_OID, TIMESTAMP_TYPE_OID,
    TIMESTAMPTZ_TYPE_OID, TSQUERY_TYPE_OID, TSRANGE_TYPE_OID, TSTZRANGE_TYPE_OID,
    VARBIT_TYPE_OID,
};
...
pub fn bootstrap_pg_proc_rows() -> Vec<PgProcRow> {
    ...
    let mut rows = vec![
        ...
        aggregate_row(931000, "any_value", ANYOID, &oid_argtypes(&[ANYOID]), 1),
        aggregate_row(
            6220,
            "sum",
            NUMERIC_TYPE_OID,
