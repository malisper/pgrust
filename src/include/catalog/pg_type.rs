...
use crate::include::catalog::{
    ...
    MONEY_ARRAY_TYPE_OID, MONEY_TYPE_OID, NAME_TYPE_OID, NUMERIC_ARRAY_TYPE_OID, NUMERIC_TYPE_OID,
    OID_ARRAY_TYPE_OID, OID_TYPE_OID,
    ...
    PG_TYPE_RELATION_OID, PG_TYPE_ROWTYPE_OID, POINT_TYPE_OID, POLYGON_TYPE_OID, RECORD_TYPE_OID,
