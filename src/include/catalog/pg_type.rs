...
use crate::include::catalog::{
    ...
    REFCURSOR_ARRAY_TYPE_OID, REFCURSOR_TYPE_OID, REGCLASS_ARRAY_TYPE_OID, REGCLASS_TYPE_OID,
    ...
    REGNAMESPACE_ARRAY_TYPE_OID, REGNAMESPACE_TYPE_OID, REGOPER_ARRAY_TYPE_OID, REGOPER_TYPE_OID,
    ...
    TSVECTOR_TYPE_OID, TXID_SNAPSHOT_ARRAY_TYPE_OID, TXID_SNAPSHOT_TYPE_OID, VARBIT_ARRAY_TYPE_OID,
