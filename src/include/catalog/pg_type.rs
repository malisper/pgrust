...
use crate::include::catalog::{
    ...
    INT2VECTOR_TYPE_OID, INT4_ARRAY_TYPE_OID, INT4_TYPE_OID, INT4MULTIRANGE_ARRAY_TYPE_OID,
    INT4MULTIRANGE_TYPE_OID, INT4RANGE_ARRAY_TYPE_OID, INT4RANGE_TYPE_OID, INT8_ARRAY_TYPE_OID,
    INT8_TYPE_OID, INT8MULTIRANGE_ARRAY_TYPE_OID, INT8MULTIRANGE_TYPE_OID,
    INT8RANGE_ARRAY_TYPE_OID, INT8RANGE_TYPE_OID, INTERNAL_CHAR_ARRAY_TYPE_OID,
    INTERNAL_CHAR_TYPE_OID, INTERNAL_TYPE_OID, INTERVAL_ARRAY_TYPE_OID, INTERVAL_TYPE_OID,
    JSON_ARRAY_TYPE_OID, JSON_TYPE_OID, JSONB_ARRAY_TYPE_OID, JSONB_TYPE_OID, JSONPATH_ARRAY_TYPE_OID,
