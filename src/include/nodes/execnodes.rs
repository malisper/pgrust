...
pub struct SeqScanState {
    ...
    pub(crate) parallel_next_block: u32,
...
pub struct IndexScanState {
    ...
    pub(crate) parallel_tuple_index: usize,
    pub(crate) slot: TupleSlot,
    pub(crate) qual: Option<crate::backend::executor::expr::CompiledPredicate>,
    pub(crate) qual_expr: Option<Expr>,
    pub(crate) source_id: usize,
...
pub struct GatherState {
    ...
    pub(crate) initialized: bool,
    pub(crate) receiver:
        Option<std::sync::mpsc::Receiver<crate::backend::executor::parallel::WorkerMessage>>,
    ...
    pub(crate) leader_done: bool,
    pub(crate) parallel_runtime:
        Option<std::sync::Arc<crate::backend::executor::parallel::ParallelRuntime>>,
    pub(crate) workers_launched: usize,
    pub(crate) plan_info: PlanEstimate,
    pub(crate) stats: NodeExecStats,
}
...
pub struct GatherMergeState {
    ...
    pub(crate) initialized: bool,
    pub(crate) rows: Vec<crate::backend::executor::parallel::WorkerTuple>,
...
impl TupleSlot {
    ...
    pub fn xmax(&self) -> Option<u32> {
        match &self.kind {
            SlotKind::HeapTuple { tuple, .. } => Some(tuple.header.xmax),
            SlotKind::BufferHeapTuple {
                tuple_ptr,
                tuple_len,
                ..
